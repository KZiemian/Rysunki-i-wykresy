...
\begin{figure}
  ...
  \begin{tikzpicture}[scale=3]
    ...
    % x axis
    \draw[axis arrow] (-2.1,0) -- (2.4,0);

    \pic at (2.4,0) {x mark for horizontal axis 1};


    % y axis
    \draw[axis arrow] (0,-0.1) -- (0,1.4);
    ...
    (-0.87,0.044) -- (-0.86,0.058) -- (-0.85,0.073) -- (-0.84,0.091) --
    (-0.83,0.109) -- (-0.82,0.128) -- (-0.81,0.148) -- (-0.8,0.168) --
    (-0.79,0.19) -- (-0.78,0.211) -- (-0.77,0.233) -- (-0.76,0.254) --
    (-0.75,0.276) -- (-0.74,0.298) -- (-0.73,0.319) -- (-0.72,0.34) --
    (-0.71,0.361) -- (-0.7,0.382) -- (-0.69,0.403) -- (-0.68,0.423) --
    (-0.67,0.442) -- (-0.66,0.462) -- (-0.65,0.481) -- (-0.64,0.499) --
    (-0.63,0.517) -- (-0.62,0.535) -- (-0.61,0.552) -- (-0.6,0.569) --
    (-0.55,0.648) -- (-0.525,0.683) -- (-0.5,0.716) -- (-0.475,0.747) --
    (-0.45,0.775) -- (-0.425,0.802) -- (-0.4,0.826) -- (-0.35,0.869) --
    (-0.3,0.905) -- (-0.25,0.935) -- (-0.2,0.959) -- (-0.15,0.977) --
    (-0.1,0.989) -- (-0.05,0.997) -- (0,0.999) -- (0.05,0.997) --
    (0.1,0.989) -- (0.15,0.977) -- (0.2,0.959) -- (0.25,0.935) --
    (0.3,0.905) -- (0.35,0.869) -- (0.4,0.826) -- (0.425,0.802) --
    (0.45,0.775) -- (0.475,0.747) -- (0.5,0.716) -- (0.525,0.683) --
    (0.55,0.648) -- (0.575,0.61) -- (0.6,0.569) -- (0.61,0.552) --
    (0.62,0.535) -- (0.63,0.517) -- (0.64,0.499) -- (0.65,0.481) --
    (0.66,0.462) -- (0.67,0.442) -- (0.68,0.423) -- (0.69,0.403) --
    (0.7,0.382) -- (0.71,0.361) -- (0.72,0.34) -- (0.73,0.319) --
    (0.74,0.298) -- (0.75,0.276) -- (0.76,0.254) -- (0.77,0.233) --
    (0.78,0.211) -- (0.79,0.19) -- (0.8,0.168) -- (0.81,0.148) --
    (0.82,0.128) -- (0.83,0.109) -- (0.84,0.091) -- (0.85,0.073) --
    (0.86,0.058) -- (0.87,0.044) -- (0.88,0.032) -- (0.89,0.022) --
    (0.9,0.014) -- (0.91,0.008) -- (0.92,0.004) -- (0.93,0) --
    (2,0);
  ...
  \caption{Funkcja $f( x ) =
    2.718 \exp\!\big( -1 / \big( 1 - x^{ 2 } \HorSpaceTen \big) \big)$
