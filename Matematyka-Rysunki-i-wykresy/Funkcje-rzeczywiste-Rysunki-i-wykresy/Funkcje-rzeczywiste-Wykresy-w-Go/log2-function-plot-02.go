...
func main() {
	...
	pointsOfFunctionPlot[142].Y = 0.505
	...
	pointsOfFunctionPlot[157].Y = 0.65
	...
	pointsOfFunctionPlot[219].Y = 1.13
	...
	pointsOfFunctionPlot[630].Y = 2.657

	pointsOfFunctionPlot[631].X = 6.31
	pointsOfFunctionPlot[631].Y = 2.659

	pointsOfFunctionPlot[632].X = 6.32
	pointsOfFunctionPlot[632].Y = 2.662

	pointsOfFunctionPlot[633].X = 6.33
	pointsOfFunctionPlot[633].Y = 2.664

	pointsOfFunctionPlot[634].X = 6.34
	pointsOfFunctionPlot[634].Y = 2.666

	pointsOfFunctionPlot[635].X = 6.35
	pointsOfFunctionPlot[635].Y = 2.669

	pointsOfFunctionPlot[636].X = 6.36
	pointsOfFunctionPlot[636].Y = 2.671

	pointsOfFunctionPlot[637].X = 6.37
	pointsOfFunctionPlot[637].Y = 2.673

	pointsOfFunctionPlot[638].X = 6.38
	pointsOfFunctionPlot[638].Y = 2.675

	pointsOfFunctionPlot[639].X = 6.39
	pointsOfFunctionPlot[639].Y = 2.678
	...
	pointsOfFunctionPlot[914].Y = 3.192
	...
	pointsOfFunctionPlot[945].Y = 3.24
	...
	if err := plotOfFunction.Save(10*vg.Inch, 10*vg.Inch,
		"log2-function-plot-02.png"); err != nil {
