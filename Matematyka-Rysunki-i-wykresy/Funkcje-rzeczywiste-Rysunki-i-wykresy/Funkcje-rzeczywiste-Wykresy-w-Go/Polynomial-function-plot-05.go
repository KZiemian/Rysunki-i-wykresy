...
func main() {
	// Plot of polynomial f(x) = 0.001 x^4 - 0.01 x^3 - 0.1 x^2 - x.
	...
	pointsOfPolynomialPlot[28].Y = -0.287
	...
	pointsOfPolynomialPlot[33].Y = -0.34
	...
	pointsOfPolynomialPlot[37].Y = -0.383

	pointsOfPolynomialPlot[38].X = 0.38
	pointsOfPolynomialPlot[38].Y = -0.394
	...
	pointsOfPolynomialPlot[41].Y = -0.426

	pointsOfPolynomialPlot[42].X = 0.42
	pointsOfPolynomialPlot[42].Y = -0.437

	pointsOfPolynomialPlot[43].X = 0.43
	pointsOfPolynomialPlot[43].Y = -0.448

	pointsOfPolynomialPlot[44].X = 0.44
	pointsOfPolynomialPlot[44].Y = -0.459

	pointsOfPolynomialPlot[45].X = 0.45
	pointsOfPolynomialPlot[45].Y = -0.47

	pointsOfPolynomialPlot[46].X = 0.46
	pointsOfPolynomialPlot[46].Y = -0.481

	pointsOfPolynomialPlot[47].X = 0.47
	pointsOfPolynomialPlot[47].Y = -0.492

	pointsOfPolynomialPlot[48].X = 0.48
	pointsOfPolynomialPlot[48].Y = -0.503

	pointsOfPolynomialPlot[49].X = 0.49
	pointsOfPolynomialPlot[49].Y = -0.514

	pointsOfPolynomialPlot[50].X = 0.50
	pointsOfPolynomialPlot[50].Y = -0.525

	pointsOfPolynomialPlot[51].X = 0.51
	pointsOfPolynomialPlot[51].Y = -0.536

	pointsOfPolynomialPlot[52].X = 0.52
	pointsOfPolynomialPlot[52].Y = -0.547

	pointsOfPolynomialPlot[53].X = 0.53
	pointsOfPolynomialPlot[53].Y = -0.558

	pointsOfPolynomialPlot[54].X = 0.54
	pointsOfPolynomialPlot[54].Y = -0.569

	pointsOfPolynomialPlot[55].X = 0.55
	pointsOfPolynomialPlot[55].Y = -0.58

	pointsOfPolynomialPlot[56].X = 0.56
	pointsOfPolynomialPlot[56].Y = -0.591

	pointsOfPolynomialPlot[57].X = 0.57
	pointsOfPolynomialPlot[57].Y = -0.602

	pointsOfPolynomialPlot[58].X = 0.58
	pointsOfPolynomialPlot[58].Y = -0.613

	pointsOfPolynomialPlot[59].X = 0.59
	pointsOfPolynomialPlot[59].Y = -0.624

	pointsOfPolynomialPlot[60].X = 0.60
	pointsOfPolynomialPlot[60].Y = -0.636

	pointsOfPolynomialPlot[61].X = 0.61
	pointsOfPolynomialPlot[61].Y = -0.647

	pointsOfPolynomialPlot[62].X = 0.62
	pointsOfPolynomialPlot[62].Y = -0.658

	pointsOfPolynomialPlot[63].X = 0.63
	pointsOfPolynomialPlot[63].Y = -0.669

	pointsOfPolynomialPlot[64].X = 0.64
	pointsOfPolynomialPlot[64].Y = -0.681

	pointsOfPolynomialPlot[65].X = 0.65
	pointsOfPolynomialPlot[65].Y = -0.692

	pointsOfPolynomialPlot[66].X = 0.66
	pointsOfPolynomialPlot[66].Y = -0.703

	pointsOfPolynomialPlot[67].X = 0.67
	pointsOfPolynomialPlot[67].Y = -0.715

	pointsOfPolynomialPlot[68].X = 0.68
	pointsOfPolynomialPlot[68].Y = -0.726

	pointsOfPolynomialPlot[69].X = 0.69
	pointsOfPolynomialPlot[69].Y = -0.737

	pointsOfPolynomialPlot[70].X = 0.70
	pointsOfPolynomialPlot[70].Y = -0.749

	pointsOfPolynomialPlot[71].X = 0.71
	pointsOfPolynomialPlot[71].Y = -0.76

	pointsOfPolynomialPlot[72].X = 0.72
	pointsOfPolynomialPlot[72].Y = -0.771

	pointsOfPolynomialPlot[73].X = 0.73
	pointsOfPolynomialPlot[73].Y = -0.783

	pointsOfPolynomialPlot[74].X = 0.74
	pointsOfPolynomialPlot[74].Y = -0.794

	pointsOfPolynomialPlot[75].X = 0.75
	pointsOfPolynomialPlot[75].Y = -0.806

	pointsOfPolynomialPlot[76].X = 0.76
	pointsOfPolynomialPlot[76].Y = -0.817

	pointsOfPolynomialPlot[77].X = 0.77
	pointsOfPolynomialPlot[77].Y = -0.829

	pointsOfPolynomialPlot[78].X = 0.78
	pointsOfPolynomialPlot[78].Y = -0.84

	pointsOfPolynomialPlot[79].X = 0.79
	pointsOfPolynomialPlot[79].Y = -0.852

	pointsOfPolynomialPlot[80].X = 0.80
	pointsOfPolynomialPlot[80].Y = -0.864

	pointsOfPolynomialPlot[81].X = 0.81
	pointsOfPolynomialPlot[81].Y = -0.875

	pointsOfPolynomialPlot[82].X = 0.82
	pointsOfPolynomialPlot[82].Y = -0.887

	pointsOfPolynomialPlot[83].X = 0.83
	pointsOfPolynomialPlot[83].Y = -0.899

	pointsOfPolynomialPlot[84].X = 0.84
	pointsOfPolynomialPlot[84].Y = -0.91

	pointsOfPolynomialPlot[85].X = 0.85
	pointsOfPolynomialPlot[85].Y = -0.922

	pointsOfPolynomialPlot[86].X = 0.86
	pointsOfPolynomialPlot[86].Y = -0.934

	pointsOfPolynomialPlot[87].X = 0.87
	pointsOfPolynomialPlot[87].Y = -0.945

	pointsOfPolynomialPlot[88].X = 0.88
	pointsOfPolynomialPlot[88].Y = -0.957

	pointsOfPolynomialPlot[89].X = 0.89
	pointsOfPolynomialPlot[89].Y = -0.969

	pointsOfPolynomialPlot[90].X = 0.90
	pointsOfPolynomialPlot[90].Y = -0.981

	pointsOfPolynomialPlot[91].X = 0.91
	pointsOfPolynomialPlot[91].Y = -0.992

	pointsOfPolynomialPlot[92].X = 0.92
	pointsOfPolynomialPlot[92].Y = -1.004

	pointsOfPolynomialPlot[93].X = 0.93
	pointsOfPolynomialPlot[93].Y = -1.016

	pointsOfPolynomialPlot[94].X = 0.94
	pointsOfPolynomialPlot[94].Y = -1.028

	pointsOfPolynomialPlot[95].X = 0.95
	pointsOfPolynomialPlot[95].Y = -1.04

	pointsOfPolynomialPlot[96].X = 0.96
	pointsOfPolynomialPlot[96].Y = -1.052

	pointsOfPolynomialPlot[97].X = 0.97
	pointsOfPolynomialPlot[97].Y = -1.064

	pointsOfPolynomialPlot[98].X = 0.98
	pointsOfPolynomialPlot[98].Y = -1.076

	pointsOfPolynomialPlot[99].X = 0.99
	pointsOfPolynomialPlot[99].Y = -1.088

	pointsOfPolynomialPlot[100].X = 1.0
	pointsOfPolynomialPlot[100].Y = -1.1

	pointsOfPolynomialPlot[101].X = 1.01
	pointsOfPolynomialPlot[101].Y = -1.112

	pointsOfPolynomialPlot[102].X = 1.02
	pointsOfPolynomialPlot[102].Y = -1.124

	pointsOfPolynomialPlot[103].X = 1.03
	pointsOfPolynomialPlot[103].Y = -1.136

	pointsOfPolynomialPlot[104].X = 1.04
	pointsOfPolynomialPlot[104].Y = -1.148

	pointsOfPolynomialPlot[105].X = 1.05
	pointsOfPolynomialPlot[105].Y = -1.16

	pointsOfPolynomialPlot[106].X = 1.06
	pointsOfPolynomialPlot[106].Y = -1.172

	pointsOfPolynomialPlot[107].X = 1.07
	pointsOfPolynomialPlot[107].Y = -1.184

	pointsOfPolynomialPlot[108].X = 1.08
	pointsOfPolynomialPlot[108].Y = -1.196

	pointsOfPolynomialPlot[109].X = 1.09
	pointsOfPolynomialPlot[109].Y = -1.208

	pointsOfPolynomialPlot[110].X = 1.10
	pointsOfPolynomialPlot[110].Y = -1.22

	pointsOfPolynomialPlot[111].X = 1.11
	pointsOfPolynomialPlot[111].Y = -1.233

	pointsOfPolynomialPlot[112].X = 1.12
	pointsOfPolynomialPlot[112].Y = -1.245

	pointsOfPolynomialPlot[113].X = 1.13
	pointsOfPolynomialPlot[113].Y = -1.257

	pointsOfPolynomialPlot[114].X = 1.14
	pointsOfPolynomialPlot[114].Y = -1.269

	pointsOfPolynomialPlot[115].X = 1.15
	pointsOfPolynomialPlot[115].Y = -1.282

	pointsOfPolynomialPlot[116].X = 1.16
	pointsOfPolynomialPlot[116].Y = -1.294

	pointsOfPolynomialPlot[117].X = 1.17
	pointsOfPolynomialPlot[117].Y = -1.306

	pointsOfPolynomialPlot[118].X = 1.18
	pointsOfPolynomialPlot[118].Y = -1.318

	pointsOfPolynomialPlot[119].X = 1.19
	pointsOfPolynomialPlot[119].Y = -1.331

	pointsOfPolynomialPlot[120].X = 1.20
	pointsOfPolynomialPlot[120].Y = -1.343

	pointsOfPolynomialPlot[121].X = 1.21
	pointsOfPolynomialPlot[121].Y = -1.356

	pointsOfPolynomialPlot[122].X = 1.22
	pointsOfPolynomialPlot[122].Y = -1.368

	pointsOfPolynomialPlot[123].X = 1.23
	pointsOfPolynomialPlot[123].Y = -1.38

	pointsOfPolynomialPlot[124].X = 1.24
	pointsOfPolynomialPlot[124].Y = -1.393

	pointsOfPolynomialPlot[125].X = 1.25
	pointsOfPolynomialPlot[125].Y = -1.405

	pointsOfPolynomialPlot[126].X = 1.26
	pointsOfPolynomialPlot[126].Y = -1.418

	pointsOfPolynomialPlot[127].X = 1.27
	pointsOfPolynomialPlot[127].Y = -1.43

	pointsOfPolynomialPlot[128].X = 1.28
	pointsOfPolynomialPlot[128].Y = -1.443

	pointsOfPolynomialPlot[129].X = 1.29
	pointsOfPolynomialPlot[129].Y = -1.455

	pointsOfPolynomialPlot[130].X = 1.30
	pointsOfPolynomialPlot[130].Y = -1.468

	pointsOfPolynomialPlot[131].X = 1.31
	pointsOfPolynomialPlot[131].Y = -1.48

	pointsOfPolynomialPlot[132].X = 1.32
	pointsOfPolynomialPlot[132].Y = -1.493

	pointsOfPolynomialPlot[133].X = 1.33
	pointsOfPolynomialPlot[133].Y = -1.506

	pointsOfPolynomialPlot[134].X = 1.34
	pointsOfPolynomialPlot[134].Y = -1.518

	pointsOfPolynomialPlot[135].X = 1.35
	pointsOfPolynomialPlot[135].Y = -1.531

	pointsOfPolynomialPlot[136].X = 1.36
	pointsOfPolynomialPlot[136].Y = -1.544

	pointsOfPolynomialPlot[137].X = 1.37
	pointsOfPolynomialPlot[137].Y = -1.556

	pointsOfPolynomialPlot[138].X = 1.38
	pointsOfPolynomialPlot[138].Y = -1.569

	pointsOfPolynomialPlot[139].X = 1.39
	pointsOfPolynomialPlot[139].Y = -1.582

	pointsOfPolynomialPlot[140].X = 1.40
	pointsOfPolynomialPlot[140].Y = -1.594

	pointsOfPolynomialPlot[141].X = 1.41
	pointsOfPolynomialPlot[141].Y = -1.607

	pointsOfPolynomialPlot[142].X = 1.42
	pointsOfPolynomialPlot[142].Y = -1.62

	pointsOfPolynomialPlot[143].X = 1.43
	pointsOfPolynomialPlot[143].Y = -1.633

	pointsOfPolynomialPlot[144].X = 1.44
	pointsOfPolynomialPlot[144].Y = -1.646

	pointsOfPolynomialPlot[145].X = 1.45
	pointsOfPolynomialPlot[145].Y = -1.658

	pointsOfPolynomialPlot[146].X = 1.46
	pointsOfPolynomialPlot[146].Y = -1.671

	pointsOfPolynomialPlot[147].X = 1.47
	pointsOfPolynomialPlot[147].Y = -1.684

	pointsOfPolynomialPlot[148].X = 1.48
	pointsOfPolynomialPlot[148].Y = -1.697

	pointsOfPolynomialPlot[149].X = 1.49
	pointsOfPolynomialPlot[149].Y = -1.71

	pointsOfPolynomialPlot[150].X = 1.50
	pointsOfPolynomialPlot[150].Y = -1.723

	pointsOfPolynomialPlot[151].X = 1.51
	pointsOfPolynomialPlot[151].Y = -1.736

	pointsOfPolynomialPlot[152].X = 1.52
	pointsOfPolynomialPlot[152].Y = -1.749

	pointsOfPolynomialPlot[153].X = 1.53
	pointsOfPolynomialPlot[153].Y = -1.762

	pointsOfPolynomialPlot[154].X = 1.54
	pointsOfPolynomialPlot[154].Y = -1.775

	pointsOfPolynomialPlot[155].X = 1.55
	pointsOfPolynomialPlot[155].Y = -1.788

	pointsOfPolynomialPlot[156].X = 1.56
	pointsOfPolynomialPlot[156].Y = -1.801

	pointsOfPolynomialPlot[157].X = 1.57
	pointsOfPolynomialPlot[157].Y = -1.814

	pointsOfPolynomialPlot[158].X = 1.58
	pointsOfPolynomialPlot[158].Y = -1.827

	pointsOfPolynomialPlot[159].X = 1.59
	pointsOfPolynomialPlot[159].Y = -1.84

	pointsOfPolynomialPlot[160].X = 1.60
	pointsOfPolynomialPlot[160].Y = -1.853

	pointsOfPolynomialPlot[161].X = 1.61
	pointsOfPolynomialPlot[161].Y = -1.866

	pointsOfPolynomialPlot[162].X = 1.62
	pointsOfPolynomialPlot[162].Y = -1.879

	pointsOfPolynomialPlot[163].X = 1.63
	pointsOfPolynomialPlot[163].Y = -1.893

	pointsOfPolynomialPlot[164].X = 1.64
	pointsOfPolynomialPlot[164].Y = -1.906

	pointsOfPolynomialPlot[165].X = 1.65
	pointsOfPolynomialPlot[165].Y = -1.919

	pointsOfPolynomialPlot[166].X = 1.66
	pointsOfPolynomialPlot[166].Y = -1.932

	pointsOfPolynomialPlot[167].X = 1.67
	pointsOfPolynomialPlot[167].Y = -1.945

	pointsOfPolynomialPlot[168].X = 1.68
	pointsOfPolynomialPlot[168].Y = -1.959

	pointsOfPolynomialPlot[169].X = 1.69
	pointsOfPolynomialPlot[169].Y = -1.972

	pointsOfPolynomialPlot[170].X = 1.70
	pointsOfPolynomialPlot[170].Y = -1.985

	pointsOfPolynomialPlot[171].X = 1.71
	pointsOfPolynomialPlot[171].Y = -1.998

	pointsOfPolynomialPlot[172].X = 1.72
	pointsOfPolynomialPlot[172].Y = -2.012

	pointsOfPolynomialPlot[173].X = 1.73
	pointsOfPolynomialPlot[173].Y = -2.025

	pointsOfPolynomialPlot[174].X = 1.74
	pointsOfPolynomialPlot[174].Y = -2.038

	pointsOfPolynomialPlot[175].X = 1.75
	pointsOfPolynomialPlot[175].Y = -2.052

	pointsOfPolynomialPlot[176].X = 1.76
	pointsOfPolynomialPlot[176].Y = -2.065

	pointsOfPolynomialPlot[177].X = 1.77
	pointsOfPolynomialPlot[177].Y = -2.079

	pointsOfPolynomialPlot[178].X = 1.78
	pointsOfPolynomialPlot[178].Y = -2.092

	pointsOfPolynomialPlot[179].X = 1.79
	pointsOfPolynomialPlot[179].Y = -2.105

	pointsOfPolynomialPlot[180].X = 1.80
	pointsOfPolynomialPlot[180].Y = -2.119

	pointsOfPolynomialPlot[181].X = 1.81
	pointsOfPolynomialPlot[181].Y = -2.132

	pointsOfPolynomialPlot[182].X = 1.82
	pointsOfPolynomialPlot[182].Y = -2.146

	pointsOfPolynomialPlot[183].X = 1.83
	pointsOfPolynomialPlot[183].Y = -2.159

	pointsOfPolynomialPlot[184].X = 1.84
	pointsOfPolynomialPlot[184].Y = -2.173

	pointsOfPolynomialPlot[185].X = 1.85
	pointsOfPolynomialPlot[185].Y = -2.186

	pointsOfPolynomialPlot[186].X = 1.86
	pointsOfPolynomialPlot[186].Y = -2.2

	pointsOfPolynomialPlot[187].X = 1.87
	pointsOfPolynomialPlot[187].Y = -2.214

	pointsOfPolynomialPlot[188].X = 1.88
	pointsOfPolynomialPlot[188].Y = -2.227

	pointsOfPolynomialPlot[189].X = 1.89
	pointsOfPolynomialPlot[189].Y = -2.241

	pointsOfPolynomialPlot[190].X = 1.90
	pointsOfPolynomialPlot[190].Y = -2.254

	pointsOfPolynomialPlot[191].X = 1.91
	pointsOfPolynomialPlot[191].Y = -2.268

	pointsOfPolynomialPlot[192].X = 1.92
	pointsOfPolynomialPlot[192].Y = -2.282

	pointsOfPolynomialPlot[193].X = 1.93
	pointsOfPolynomialPlot[193].Y = -2.295

	pointsOfPolynomialPlot[194].X = 1.94
	pointsOfPolynomialPlot[194].Y = -2.309

	pointsOfPolynomialPlot[195].X = 1.95
	pointsOfPolynomialPlot[195].Y = -2.323

	pointsOfPolynomialPlot[196].X = 1.96
	pointsOfPolynomialPlot[196].Y = -2.336

	pointsOfPolynomialPlot[197].X = 1.97
	pointsOfPolynomialPlot[197].Y = -2.35

	pointsOfPolynomialPlot[198].X = 1.98
	pointsOfPolynomialPlot[198].Y = -2.364

	pointsOfPolynomialPlot[199].X = 1.99
	pointsOfPolynomialPlot[199].Y = -2.378

	pointsOfPolynomialPlot[200].X = 2.0
	pointsOfPolynomialPlot[200].Y = -2.392

	pointsOfPolynomialPlot[201].X = 2.01
	pointsOfPolynomialPlot[201].Y = -2.405

	pointsOfPolynomialPlot[202].X = 2.02
	pointsOfPolynomialPlot[202].Y = -2.419

	pointsOfPolynomialPlot[203].X = 2.03
	pointsOfPolynomialPlot[203].Y = -2.433

	pointsOfPolynomialPlot[204].X = 2.04
	pointsOfPolynomialPlot[204].Y = -2.447

	pointsOfPolynomialPlot[205].X = 2.05
	pointsOfPolynomialPlot[205].Y = -2.461

	pointsOfPolynomialPlot[206].X = 2.06
	pointsOfPolynomialPlot[206].Y = -2.475

	pointsOfPolynomialPlot[207].X = 2.07
	pointsOfPolynomialPlot[207].Y = -2.489

	pointsOfPolynomialPlot[208].X = 2.08
	pointsOfPolynomialPlot[208].Y = -2.502

	pointsOfPolynomialPlot[209].X = 2.09
	pointsOfPolynomialPlot[209].Y = -2.516

	pointsOfPolynomialPlot[210].X = 2.10
	pointsOfPolynomialPlot[210].Y = -2.53

	pointsOfPolynomialPlot[211].X = 2.11
	pointsOfPolynomialPlot[211].Y = -2.544

	pointsOfPolynomialPlot[212].X = 2.12
	pointsOfPolynomialPlot[212].Y = -2.558

	pointsOfPolynomialPlot[213].X = 2.13
	pointsOfPolynomialPlot[213].Y = -2.572

	pointsOfPolynomialPlot[214].X = 2.14
	pointsOfPolynomialPlot[214].Y = -2.586

	pointsOfPolynomialPlot[215].X = 2.15
	pointsOfPolynomialPlot[215].Y = -2.6

	pointsOfPolynomialPlot[216].X = 2.16
	pointsOfPolynomialPlot[216].Y = -2.614

	pointsOfPolynomialPlot[217].X = 2.17
	pointsOfPolynomialPlot[217].Y = -2.628

	pointsOfPolynomialPlot[218].X = 2.18
	pointsOfPolynomialPlot[218].Y = -2.643

	pointsOfPolynomialPlot[219].X = 2.19
	pointsOfPolynomialPlot[219].Y = -2.657

	pointsOfPolynomialPlot[220].X = 2.20
	pointsOfPolynomialPlot[220].Y = -2.671

	pointsOfPolynomialPlot[221].X = 2.21
	pointsOfPolynomialPlot[221].Y = -2.685

	pointsOfPolynomialPlot[222].X = 2.22
	pointsOfPolynomialPlot[222].Y = -2.699

	pointsOfPolynomialPlot[223].X = 2.23
	pointsOfPolynomialPlot[223].Y = -2.713

	pointsOfPolynomialPlot[224].X = 2.24
	pointsOfPolynomialPlot[224].Y = -2.727

	pointsOfPolynomialPlot[225].X = 2.25
	pointsOfPolynomialPlot[225].Y = -2.742

	pointsOfPolynomialPlot[226].X = 2.26
	pointsOfPolynomialPlot[226].Y = -2.756

	pointsOfPolynomialPlot[227].X = 2.27
	pointsOfPolynomialPlot[227].Y = -2.77

	pointsOfPolynomialPlot[228].X = 2.28
	pointsOfPolynomialPlot[228].Y = -2.784

	pointsOfPolynomialPlot[229].X = 2.29
	pointsOfPolynomialPlot[229].Y = -2.798

	pointsOfPolynomialPlot[230].X = 2.30
	pointsOfPolynomialPlot[230].Y = -2.813

	pointsOfPolynomialPlot[231].X = 2.31
	pointsOfPolynomialPlot[231].Y = -2.827

	pointsOfPolynomialPlot[232].X = 2.32
	pointsOfPolynomialPlot[232].Y = -2.841

	pointsOfPolynomialPlot[233].X = 2.33
	pointsOfPolynomialPlot[233].Y = -2.856

	pointsOfPolynomialPlot[234].X = 2.34
	pointsOfPolynomialPlot[234].Y = -2.87

	pointsOfPolynomialPlot[235].X = 2.35
	pointsOfPolynomialPlot[235].Y = -2.884

	pointsOfPolynomialPlot[236].X = 2.36
	pointsOfPolynomialPlot[236].Y = -2.899

	pointsOfPolynomialPlot[237].X = 2.37
	pointsOfPolynomialPlot[237].Y = -2.913

	pointsOfPolynomialPlot[238].X = 2.38
	pointsOfPolynomialPlot[238].Y = -2.927

	pointsOfPolynomialPlot[239].X = 2.39
	pointsOfPolynomialPlot[239].Y = -2.942

	pointsOfPolynomialPlot[240].X = 2.40
	pointsOfPolynomialPlot[240].Y = -2.956

	pointsOfPolynomialPlot[241].X = 2.41
	pointsOfPolynomialPlot[241].Y = -2.971

	pointsOfPolynomialPlot[242].X = 2.42
	pointsOfPolynomialPlot[242].Y = -2.985

	pointsOfPolynomialPlot[243].X = 2.43
	pointsOfPolynomialPlot[243].Y = -3.0

	pointsOfPolynomialPlot[244].X = 2.44
	pointsOfPolynomialPlot[244].Y = -3.014

	pointsOfPolynomialPlot[245].X = 2.45
	pointsOfPolynomialPlot[245].Y = -3.028

	pointsOfPolynomialPlot[246].X = 2.46
	pointsOfPolynomialPlot[246].Y = -3.043

	pointsOfPolynomialPlot[247].X = 2.47
	pointsOfPolynomialPlot[247].Y = -3.057

	pointsOfPolynomialPlot[248].X = 2.48
	pointsOfPolynomialPlot[248].Y = -3.072

	pointsOfPolynomialPlot[249].X = 2.49
	pointsOfPolynomialPlot[249].Y = -3.087

	pointsOfPolynomialPlot[250].X = 2.50
	pointsOfPolynomialPlot[250].Y = -3.101

	pointsOfPolynomialPlot[251].X = 2.51
	pointsOfPolynomialPlot[251].Y = -3.116

	pointsOfPolynomialPlot[252].X = 2.52
	pointsOfPolynomialPlot[252].Y = -3.13

	pointsOfPolynomialPlot[253].X = 2.53
	pointsOfPolynomialPlot[253].Y = -3.145

	pointsOfPolynomialPlot[254].X = 2.54
	pointsOfPolynomialPlot[254].Y = -3.159

	pointsOfPolynomialPlot[255].X = 2.55
	pointsOfPolynomialPlot[255].Y = -3.174

	pointsOfPolynomialPlot[256].X = 2.56
	pointsOfPolynomialPlot[256].Y = -3.189

	pointsOfPolynomialPlot[257].X = 2.57
	pointsOfPolynomialPlot[257].Y = -3.202

	pointsOfPolynomialPlot[258].X = 2.58
	pointsOfPolynomialPlot[258].Y = -3.218

	pointsOfPolynomialPlot[259].X = 2.59
	pointsOfPolynomialPlot[259].Y = -3.233

	pointsOfPolynomialPlot[260].X = 2.60
	pointsOfPolynomialPlot[260].Y = -3.247

	pointsOfPolynomialPlot[261].X = 2.61
	pointsOfPolynomialPlot[261].Y = -3.262

	pointsOfPolynomialPlot[262].X = 2.62
	pointsOfPolynomialPlot[262].Y = -3.277

	pointsOfPolynomialPlot[263].X = 2.63
	pointsOfPolynomialPlot[263].Y = -3.292

	pointsOfPolynomialPlot[264].X = 2.64
	pointsOfPolynomialPlot[264].Y = -3.306

	pointsOfPolynomialPlot[265].X = 2.65
	pointsOfPolynomialPlot[265].Y = -3.321

	pointsOfPolynomialPlot[266].X = 2.66
	pointsOfPolynomialPlot[266].Y = -3.336

	pointsOfPolynomialPlot[267].X = 2.67
	pointsOfPolynomialPlot[267].Y = -3.351

	pointsOfPolynomialPlot[268].X = 2.68
	pointsOfPolynomialPlot[268].Y = -3.365

	pointsOfPolynomialPlot[269].X = 2.69
	pointsOfPolynomialPlot[269].Y = -3.38

	pointsOfPolynomialPlot[270].X = 2.70
	pointsOfPolynomialPlot[270].Y = -3.395

	pointsOfPolynomialPlot[271].X = 2.71
	pointsOfPolynomialPlot[271].Y = -3.41

	pointsOfPolynomialPlot[272].X = 2.72
	pointsOfPolynomialPlot[272].Y = -3.425

	pointsOfPolynomialPlot[273].X = 2.73
	pointsOfPolynomialPlot[273].Y = -3.44

	pointsOfPolynomialPlot[274].X = 2.74
	pointsOfPolynomialPlot[274].Y = -3.455

	pointsOfPolynomialPlot[275].X = 2.75
	pointsOfPolynomialPlot[275].Y = -3.469

	pointsOfPolynomialPlot[276].X = 2.76
	pointsOfPolynomialPlot[276].Y = -3.484

	pointsOfPolynomialPlot[277].X = 2.77
	pointsOfPolynomialPlot[277].Y = -3.499

	pointsOfPolynomialPlot[278].X = 2.78
	pointsOfPolynomialPlot[278].Y = -3.514

	pointsOfPolynomialPlot[279].X = 2.79
	pointsOfPolynomialPlot[279].Y = -3.529

	pointsOfPolynomialPlot[280].X = 2.80
	pointsOfPolynomialPlot[280].Y = -3.544

	pointsOfPolynomialPlot[281].X = 2.81
	pointsOfPolynomialPlot[281].Y = -3.559

	pointsOfPolynomialPlot[282].X = 2.82
	pointsOfPolynomialPlot[282].Y = -3.574

	pointsOfPolynomialPlot[283].X = 2.83
	pointsOfPolynomialPlot[283].Y = -3.589

	pointsOfPolynomialPlot[284].X = 2.84
	pointsOfPolynomialPlot[284].Y = -3.604

	pointsOfPolynomialPlot[285].X = 2.85
	pointsOfPolynomialPlot[285].Y = -3.619

	pointsOfPolynomialPlot[286].X = 2.86
	pointsOfPolynomialPlot[286].Y = -3.634

	pointsOfPolynomialPlot[287].X = 2.87
	pointsOfPolynomialPlot[287].Y = -3.649

	pointsOfPolynomialPlot[288].X = 2.88
	pointsOfPolynomialPlot[288].Y = -3.664

	pointsOfPolynomialPlot[289].X = 2.89
	pointsOfPolynomialPlot[289].Y = -3.679

	pointsOfPolynomialPlot[290].X = 2.90
	pointsOfPolynomialPlot[290].Y = -3.694

	pointsOfPolynomialPlot[291].X = 2.91
	pointsOfPolynomialPlot[291].Y = -3.709

	pointsOfPolynomialPlot[292].X = 2.92
	pointsOfPolynomialPlot[292].Y = -3.724

	pointsOfPolynomialPlot[293].X = 2.93
	pointsOfPolynomialPlot[293].Y = -3.739

	pointsOfPolynomialPlot[294].X = 2.94
	pointsOfPolynomialPlot[294].Y = -3.755

	pointsOfPolynomialPlot[295].X = 2.95
	pointsOfPolynomialPlot[295].Y = -3.77

	pointsOfPolynomialPlot[296].X = 2.96
	pointsOfPolynomialPlot[296].Y = -3.785

	pointsOfPolynomialPlot[297].X = 2.97
	pointsOfPolynomialPlot[297].Y = -3.8

	pointsOfPolynomialPlot[298].X = 2.98
	pointsOfPolynomialPlot[298].Y = -3.815

	pointsOfPolynomialPlot[299].X = 2.99
	pointsOfPolynomialPlot[299].Y = -3.83

	pointsOfPolynomialPlot[300].X = 3.0
	pointsOfPolynomialPlot[300].Y = -3.846

	pointsOfPolynomialPlot[301].X = 3.01
	pointsOfPolynomialPlot[301].Y = -3.861

	pointsOfPolynomialPlot[302].X = 3.02
	pointsOfPolynomialPlot[302].Y = -3.876

	pointsOfPolynomialPlot[303].X = 3.03
	pointsOfPolynomialPlot[303].Y = -3.891

	pointsOfPolynomialPlot[304].X = 3.04
	pointsOfPolynomialPlot[304].Y = -3.906

	pointsOfPolynomialPlot[305].X = 3.05
	pointsOfPolynomialPlot[305].Y = -3.922

	pointsOfPolynomialPlot[306].X = 3.06
	pointsOfPolynomialPlot[306].Y = -3.937

	pointsOfPolynomialPlot[307].X = 3.07
	pointsOfPolynomialPlot[307].Y = -3.952

	pointsOfPolynomialPlot[308].X = 3.08
	pointsOfPolynomialPlot[308].Y = -3.967

	pointsOfPolynomialPlot[309].X = 3.09
	pointsOfPolynomialPlot[309].Y = -3.983

	pointsOfPolynomialPlot[310].X = 3.10
	pointsOfPolynomialPlot[310].Y = -3.998

	pointsOfPolynomialPlot[311].X = 3.11
	pointsOfPolynomialPlot[311].Y = -4.013

	pointsOfPolynomialPlot[312].X = 3.12
	pointsOfPolynomialPlot[312].Y = -4.029

	pointsOfPolynomialPlot[313].X = 3.13
	pointsOfPolynomialPlot[313].Y = -4.044

	pointsOfPolynomialPlot[314].X = 3.14
	pointsOfPolynomialPlot[314].Y = -4.059

	pointsOfPolynomialPlot[315].X = 3.15
	pointsOfPolynomialPlot[315].Y = -4.075

	pointsOfPolynomialPlot[316].X = 3.16
	pointsOfPolynomialPlot[316].Y = -4.09

	pointsOfPolynomialPlot[317].X = 3.17
	pointsOfPolynomialPlot[317].Y = -4.105

	pointsOfPolynomialPlot[318].X = 3.18
	pointsOfPolynomialPlot[318].Y = -4.121

	pointsOfPolynomialPlot[319].X = 3.19
	pointsOfPolynomialPlot[319].Y = -4.136

	pointsOfPolynomialPlot[320].X = 3.20
	pointsOfPolynomialPlot[320].Y = -4.151

	pointsOfPolynomialPlot[321].X = 3.21
	pointsOfPolynomialPlot[321].Y = -4.167

	pointsOfPolynomialPlot[322].X = 3.22
	pointsOfPolynomialPlot[322].Y = -4.182

	pointsOfPolynomialPlot[323].X = 3.23
	pointsOfPolynomialPlot[323].Y = -4.198

	pointsOfPolynomialPlot[324].X = 3.24
	pointsOfPolynomialPlot[324].Y = -4.213

	pointsOfPolynomialPlot[325].X = 3.25
	pointsOfPolynomialPlot[325].Y = -4.229

	pointsOfPolynomialPlot[326].X = 3.26
	pointsOfPolynomialPlot[326].Y = -4.244

	pointsOfPolynomialPlot[327].X = 3.27
	pointsOfPolynomialPlot[327].Y = -4.259

	pointsOfPolynomialPlot[328].X = 3.28
	pointsOfPolynomialPlot[328].Y = -4.275

	pointsOfPolynomialPlot[329].X = 3.29
	pointsOfPolynomialPlot[329].Y = -4.29

	pointsOfPolynomialPlot[330].X = 3.30
	pointsOfPolynomialPlot[330].Y = -4.306

	pointsOfPolynomialPlot[331].X = 3.31
	pointsOfPolynomialPlot[331].Y = -4.321

	pointsOfPolynomialPlot[332].X = 3.32
	pointsOfPolynomialPlot[332].Y = -4.337

	pointsOfPolynomialPlot[333].X = 3.33
	pointsOfPolynomialPlot[333].Y = -4.352

	pointsOfPolynomialPlot[334].X = 3.34
	pointsOfPolynomialPlot[334].Y = -4.368

	pointsOfPolynomialPlot[335].X = 3.35
	pointsOfPolynomialPlot[335].Y = -4.383

	pointsOfPolynomialPlot[336].X = 3.36
	pointsOfPolynomialPlot[336].Y = -4.399

	pointsOfPolynomialPlot[337].X = 3.37
	pointsOfPolynomialPlot[337].Y = -4.415

	pointsOfPolynomialPlot[338].X = 3.38
	pointsOfPolynomialPlot[338].Y = -4.43

	pointsOfPolynomialPlot[339].X = 3.39
	pointsOfPolynomialPlot[339].Y = -4.446

	pointsOfPolynomialPlot[340].X = 3.40
	pointsOfPolynomialPlot[340].Y = -4.461

	pointsOfPolynomialPlot[341].X = 3.41
	pointsOfPolynomialPlot[341].Y = -4.477

	pointsOfPolynomialPlot[342].X = 3.42
	pointsOfPolynomialPlot[342].Y = -4.492

	pointsOfPolynomialPlot[343].X = 3.43
	pointsOfPolynomialPlot[343].Y = -4.508

	pointsOfPolynomialPlot[344].X = 3.44
	pointsOfPolynomialPlot[344].Y = -4.524

	pointsOfPolynomialPlot[345].X = 3.45
	pointsOfPolynomialPlot[345].Y = -4.539

	pointsOfPolynomialPlot[346].X = 3.46
	pointsOfPolynomialPlot[346].Y = -4.555

	pointsOfPolynomialPlot[347].X = 3.47
	pointsOfPolynomialPlot[347].Y = -4.57

	pointsOfPolynomialPlot[348].X = 3.48
	pointsOfPolynomialPlot[348].Y = -4.586

	pointsOfPolynomialPlot[349].X = 3.49
	pointsOfPolynomialPlot[349].Y = -4.602

	pointsOfPolynomialPlot[350].X = 3.50
	pointsOfPolynomialPlot[350].Y = -4.617

	pointsOfPolynomialPlot[351].X = 3.51
	pointsOfPolynomialPlot[351].Y = -4.633

	pointsOfPolynomialPlot[352].X = 3.52
	pointsOfPolynomialPlot[352].Y = -4.649

	pointsOfPolynomialPlot[353].X = 3.53
	pointsOfPolynomialPlot[353].Y = -4.664

	pointsOfPolynomialPlot[354].X = 3.54
	pointsOfPolynomialPlot[354].Y = -4.68

	pointsOfPolynomialPlot[355].X = 3.55
	pointsOfPolynomialPlot[355].Y = -4.696

	pointsOfPolynomialPlot[356].X = 3.56
	pointsOfPolynomialPlot[356].Y = -4.711

	pointsOfPolynomialPlot[357].X = 3.57
	pointsOfPolynomialPlot[357].Y = -4.727

	pointsOfPolynomialPlot[358].X = 3.58
	pointsOfPolynomialPlot[358].Y = -4.743

	pointsOfPolynomialPlot[359].X = 3.59
	pointsOfPolynomialPlot[359].Y = -4.759

	pointsOfPolynomialPlot[360].X = 3.60
	pointsOfPolynomialPlot[360].Y = -4.774

	pointsOfPolynomialPlot[361].X = 3.61
	pointsOfPolynomialPlot[361].Y = -4.79

	pointsOfPolynomialPlot[362].X = 3.62
	pointsOfPolynomialPlot[362].Y = -4.806

	pointsOfPolynomialPlot[363].X = 3.63
	pointsOfPolynomialPlot[363].Y = -4.821

	pointsOfPolynomialPlot[364].X = 3.64
	pointsOfPolynomialPlot[364].Y = -4.837

	pointsOfPolynomialPlot[365].X = 3.65
	pointsOfPolynomialPlot[365].Y = -4.853

	pointsOfPolynomialPlot[366].X = 3.66
	pointsOfPolynomialPlot[366].Y = -4.869

	pointsOfPolynomialPlot[367].X = 3.67
	pointsOfPolynomialPlot[367].Y = -4.884

	pointsOfPolynomialPlot[368].X = 3.68
	pointsOfPolynomialPlot[368].Y = -4.9

	pointsOfPolynomialPlot[369].X = 3.69
	pointsOfPolynomialPlot[369].Y = -4.915

	pointsOfPolynomialPlot[370].X = 3.70
	pointsOfPolynomialPlot[370].Y = -4.932

	pointsOfPolynomialPlot[371].X = 3.71
	pointsOfPolynomialPlot[371].Y = -4.948

	pointsOfPolynomialPlot[372].X = 3.72
	pointsOfPolynomialPlot[372].Y = -4.963

	pointsOfPolynomialPlot[373].X = 3.73
	pointsOfPolynomialPlot[373].Y = -4.979

	pointsOfPolynomialPlot[374].X = 3.74
	pointsOfPolynomialPlot[374].Y = -4.995

	pointsOfPolynomialPlot[375].X = 3.75
	pointsOfPolynomialPlot[375].Y = -5.011

	pointsOfPolynomialPlot[376].X = 3.76
	pointsOfPolynomialPlot[376].Y = -5.027

	pointsOfPolynomialPlot[377].X = 3.77
	pointsOfPolynomialPlot[377].Y = -5.042

	pointsOfPolynomialPlot[378].X = 3.78
	pointsOfPolynomialPlot[378].Y = -5.058

	pointsOfPolynomialPlot[379].X = 3.79
	pointsOfPolynomialPlot[379].Y = -5.074

	pointsOfPolynomialPlot[380].X = 3.80
	pointsOfPolynomialPlot[380].Y = -5.09

	pointsOfPolynomialPlot[381].X = 3.81
	pointsOfPolynomialPlot[381].Y = -5.106

	pointsOfPolynomialPlot[382].X = 3.82
	pointsOfPolynomialPlot[382].Y = -5.122

	pointsOfPolynomialPlot[383].X = 3.83
	pointsOfPolynomialPlot[383].Y = -5.137

	pointsOfPolynomialPlot[384].X = 3.84
	pointsOfPolynomialPlot[384].Y = -5.153

	pointsOfPolynomialPlot[385].X = 3.85
	pointsOfPolynomialPlot[385].Y = -5.169

	pointsOfPolynomialPlot[386].X = 3.86
	pointsOfPolynomialPlot[386].Y = -5.185

	pointsOfPolynomialPlot[387].X = 3.87
	pointsOfPolynomialPlot[387].Y = -5.201

	pointsOfPolynomialPlot[388].X = 3.88
	pointsOfPolynomialPlot[388].Y = -5.217

	pointsOfPolynomialPlot[389].X = 3.89
	pointsOfPolynomialPlot[389].Y = -5.233

	pointsOfPolynomialPlot[390].X = 3.90
	pointsOfPolynomialPlot[390].Y = -5.249

	pointsOfPolynomialPlot[391].X = 3.91
	pointsOfPolynomialPlot[391].Y = -5.264

	pointsOfPolynomialPlot[392].X = 3.92
	pointsOfPolynomialPlot[392].Y = -5.28

	pointsOfPolynomialPlot[393].X = 3.93
	pointsOfPolynomialPlot[393].Y = -5.296

	pointsOfPolynomialPlot[394].X = 3.94
	pointsOfPolynomialPlot[394].Y = -5.312

	pointsOfPolynomialPlot[395].X = 3.95
	pointsOfPolynomialPlot[395].Y = -5.328

	pointsOfPolynomialPlot[396].X = 3.96
	pointsOfPolynomialPlot[396].Y = -5.344

	pointsOfPolynomialPlot[397].X = 3.97
	pointsOfPolynomialPlot[397].Y = -5.36

	pointsOfPolynomialPlot[398].X = 3.98
	pointsOfPolynomialPlot[398].Y = -5.376

	pointsOfPolynomialPlot[399].X = 3.99
	pointsOfPolynomialPlot[399].Y = -5.392

	pointsOfPolynomialPlot[400].X = 4.0
	pointsOfPolynomialPlot[400].Y = -5.408

	pointsOfPolynomialPlot[401].X = 4.01
	pointsOfPolynomialPlot[401].Y = -5.423

	pointsOfPolynomialPlot[402].X = 4.02
	pointsOfPolynomialPlot[402].Y = -5.439

	pointsOfPolynomialPlot[403].X = 4.03
	pointsOfPolynomialPlot[403].Y = -5.455

	pointsOfPolynomialPlot[404].X = 4.04
	pointsOfPolynomialPlot[404].Y = -5.471

	pointsOfPolynomialPlot[405].X = 4.05
	pointsOfPolynomialPlot[405].Y = -5.487

	pointsOfPolynomialPlot[406].X = 4.06
	pointsOfPolynomialPlot[406].Y = -5.503

	pointsOfPolynomialPlot[407].X = 4.07
	pointsOfPolynomialPlot[407].Y = -5.519

	pointsOfPolynomialPlot[408].X = 4.08
	pointsOfPolynomialPlot[408].Y = -5.535

	pointsOfPolynomialPlot[409].X = 4.09
	pointsOfPolynomialPlot[409].Y = -5.551

	pointsOfPolynomialPlot[410].X = 4.10
	pointsOfPolynomialPlot[410].Y = -5.567

	pointsOfPolynomialPlot[411].X = 4.11
	pointsOfPolynomialPlot[411].Y = -5.583

	pointsOfPolynomialPlot[412].X = 4.12
	pointsOfPolynomialPlot[412].Y = -5.599

	pointsOfPolynomialPlot[413].X = 4.13
	pointsOfPolynomialPlot[413].Y = -5.615

	pointsOfPolynomialPlot[414].X = 4.14
	pointsOfPolynomialPlot[414].Y = -5.631

	pointsOfPolynomialPlot[415].X = 4.15
	pointsOfPolynomialPlot[415].Y = -5.647

	pointsOfPolynomialPlot[416].X = 4.16
	pointsOfPolynomialPlot[416].Y = -5.663

	pointsOfPolynomialPlot[417].X = 4.17
	pointsOfPolynomialPlot[417].Y = -5.679

	pointsOfPolynomialPlot[418].X = 4.18
	pointsOfPolynomialPlot[418].Y = -5.695

	pointsOfPolynomialPlot[419].X = 4.19
	pointsOfPolynomialPlot[419].Y = -5.711

	pointsOfPolynomialPlot[420].X = 4.20
	pointsOfPolynomialPlot[420].Y = -5.726

	pointsOfPolynomialPlot[421].X = 4.21
	pointsOfPolynomialPlot[421].Y = -5.742

	pointsOfPolynomialPlot[422].X = 4.22
	pointsOfPolynomialPlot[422].Y = -5.758

	pointsOfPolynomialPlot[423].X = 4.23
	pointsOfPolynomialPlot[423].Y = -5.774

	pointsOfPolynomialPlot[424].X = 4.24
	pointsOfPolynomialPlot[424].Y = -5.79

	pointsOfPolynomialPlot[425].X = 4.25
	pointsOfPolynomialPlot[425].Y = -5.806

	pointsOfPolynomialPlot[426].X = 4.26
	pointsOfPolynomialPlot[426].Y = -5.822

	pointsOfPolynomialPlot[427].X = 4.27
	pointsOfPolynomialPlot[427].Y = -5.838

	pointsOfPolynomialPlot[428].X = 4.28
	pointsOfPolynomialPlot[428].Y = -5.854

	pointsOfPolynomialPlot[429].X = 4.29
	pointsOfPolynomialPlot[429].Y = -5.87

	pointsOfPolynomialPlot[430].X = 4.30
	pointsOfPolynomialPlot[430].Y = -5.886

	pointsOfPolynomialPlot[431].X = 4.31
	pointsOfPolynomialPlot[431].Y = -5.902

	pointsOfPolynomialPlot[432].X = 4.32
	pointsOfPolynomialPlot[432].Y = -5.918

	pointsOfPolynomialPlot[433].X = 4.33
	pointsOfPolynomialPlot[433].Y = -5.934

	pointsOfPolynomialPlot[434].X = 4.34
	pointsOfPolynomialPlot[434].Y = -5.95

	pointsOfPolynomialPlot[435].X = 4.35
	pointsOfPolynomialPlot[435].Y = -5.966

	pointsOfPolynomialPlot[436].X = 4.36
	pointsOfPolynomialPlot[436].Y = -5.982

	pointsOfPolynomialPlot[437].X = 4.37
	pointsOfPolynomialPlot[437].Y = -5.998

	pointsOfPolynomialPlot[438].X = 4.38
	pointsOfPolynomialPlot[438].Y = -6.014

	pointsOfPolynomialPlot[439].X = 4.39
	pointsOfPolynomialPlot[439].Y = -6.03

	pointsOfPolynomialPlot[440].X = 4.40
	pointsOfPolynomialPlot[440].Y = -6.046

	pointsOfPolynomialPlot[441].X = 4.41
	pointsOfPolynomialPlot[441].Y = -6.062

	pointsOfPolynomialPlot[442].X = 4.42
	pointsOfPolynomialPlot[442].Y = -6.078

	pointsOfPolynomialPlot[443].X = 4.43
	pointsOfPolynomialPlot[443].Y = -6.094

	pointsOfPolynomialPlot[444].X = 4.44
	pointsOfPolynomialPlot[444].Y = -6.11

	pointsOfPolynomialPlot[445].X = 4.45
	pointsOfPolynomialPlot[445].Y = -6.126

	pointsOfPolynomialPlot[446].X = 4.46
	pointsOfPolynomialPlot[446].Y = -6.142

	pointsOfPolynomialPlot[447].X = 4.47
	pointsOfPolynomialPlot[447].Y = -6.158

	pointsOfPolynomialPlot[448].X = 4.48
	pointsOfPolynomialPlot[448].Y = -6.174

	pointsOfPolynomialPlot[449].X = 4.49
	pointsOfPolynomialPlot[449].Y = -6.19

	pointsOfPolynomialPlot[450].X = 4.50
	pointsOfPolynomialPlot[450].Y = -6.206

	pointsOfPolynomialPlot[451].X = 4.51
	pointsOfPolynomialPlot[451].Y = -6.222

	pointsOfPolynomialPlot[452].X = 4.52
	pointsOfPolynomialPlot[452].Y = -6.238

	pointsOfPolynomialPlot[453].X = 4.53
	pointsOfPolynomialPlot[453].Y = -6.252

	pointsOfPolynomialPlot[454].X = 4.54
	pointsOfPolynomialPlot[454].Y = -6.269

	pointsOfPolynomialPlot[455].X = 4.55
	pointsOfPolynomialPlot[455].Y = -6.285

	pointsOfPolynomialPlot[456].X = 4.56
	pointsOfPolynomialPlot[456].Y = -6.301

	pointsOfPolynomialPlot[457].X = 4.57
	pointsOfPolynomialPlot[457].Y = -6.317

	pointsOfPolynomialPlot[458].X = 4.58
	pointsOfPolynomialPlot[458].Y = -6.333

	pointsOfPolynomialPlot[459].X = 4.59
	pointsOfPolynomialPlot[459].Y = -6.349

	pointsOfPolynomialPlot[460].X = 4.60
	pointsOfPolynomialPlot[460].Y = -6.365

	pointsOfPolynomialPlot[461].X = 4.61
	pointsOfPolynomialPlot[461].Y = -6.381

	pointsOfPolynomialPlot[462].X = 4.62
	pointsOfPolynomialPlot[462].Y = -6.397

	pointsOfPolynomialPlot[463].X = 4.63
	pointsOfPolynomialPlot[463].Y = -6.413

	pointsOfPolynomialPlot[464].X = 4.64
	pointsOfPolynomialPlot[464].Y = -6.429

	pointsOfPolynomialPlot[465].X = 4.65
	pointsOfPolynomialPlot[465].Y = -6.445

	pointsOfPolynomialPlot[466].X = 4.66
	pointsOfPolynomialPlot[466].Y = -6.461

	pointsOfPolynomialPlot[467].X = 4.67
	pointsOfPolynomialPlot[467].Y = -6.477

	pointsOfPolynomialPlot[468].X = 4.68
	pointsOfPolynomialPlot[468].Y = -6.493

	pointsOfPolynomialPlot[469].X = 4.69
	pointsOfPolynomialPlot[469].Y = -6.508

	pointsOfPolynomialPlot[470].X = 4.70
	pointsOfPolynomialPlot[470].Y = -6.524

	pointsOfPolynomialPlot[471].X = 4.71
	pointsOfPolynomialPlot[471].Y = -6.54

	pointsOfPolynomialPlot[472].X = 4.72
	pointsOfPolynomialPlot[472].Y = -6.556

	pointsOfPolynomialPlot[473].X = 4.73
	pointsOfPolynomialPlot[473].Y = -6.572

	pointsOfPolynomialPlot[474].X = 4.74
	pointsOfPolynomialPlot[474].Y = -6.588

	pointsOfPolynomialPlot[475].X = 4.75
	pointsOfPolynomialPlot[475].Y = -6.604

	pointsOfPolynomialPlot[476].X = 4.76
	pointsOfPolynomialPlot[476].Y = -6.62

	pointsOfPolynomialPlot[477].X = 4.77
	pointsOfPolynomialPlot[477].Y = -6.636

	pointsOfPolynomialPlot[478].X = 4.78
	pointsOfPolynomialPlot[478].Y = -6.652

	pointsOfPolynomialPlot[479].X = 4.79
	pointsOfPolynomialPlot[479].Y = -6.667

	pointsOfPolynomialPlot[480].X = 4.80
	pointsOfPolynomialPlot[480].Y = -6.683

	pointsOfPolynomialPlot[481].X = 4.81
	pointsOfPolynomialPlot[481].Y = -6.699

	pointsOfPolynomialPlot[482].X = 4.82
	pointsOfPolynomialPlot[482].Y = -6.715

	pointsOfPolynomialPlot[483].X = 4.83
	pointsOfPolynomialPlot[483].Y = -6.731

	pointsOfPolynomialPlot[484].X = 4.84
	pointsOfPolynomialPlot[484].Y = -6.747

	pointsOfPolynomialPlot[485].X = 4.85
	pointsOfPolynomialPlot[485].Y = -6.763

	pointsOfPolynomialPlot[486].X = 4.86
	pointsOfPolynomialPlot[486].Y = -6.778

	pointsOfPolynomialPlot[487].X = 4.87
	pointsOfPolynomialPlot[487].Y = -6.794

	pointsOfPolynomialPlot[488].X = 4.88
	pointsOfPolynomialPlot[488].Y = -6.81

	pointsOfPolynomialPlot[489].X = 4.89
	pointsOfPolynomialPlot[489].Y = -6.826

	pointsOfPolynomialPlot[490].X = 4.90
	pointsOfPolynomialPlot[490].Y = -6.842

	pointsOfPolynomialPlot[491].X = 4.91
	pointsOfPolynomialPlot[491].Y = -6.858

	pointsOfPolynomialPlot[492].X = 4.92
	pointsOfPolynomialPlot[492].Y = -6.873

	pointsOfPolynomialPlot[493].X = 4.93
	pointsOfPolynomialPlot[493].Y = -6.889

	pointsOfPolynomialPlot[494].X = 4.94
	pointsOfPolynomialPlot[494].Y = -6.905

	pointsOfPolynomialPlot[495].X = 4.95
	pointsOfPolynomialPlot[495].Y = -6.921

	pointsOfPolynomialPlot[496].X = 4.96
	pointsOfPolynomialPlot[496].Y = -6.936

	pointsOfPolynomialPlot[497].X = 4.97
	pointsOfPolynomialPlot[497].Y = -6.952

	pointsOfPolynomialPlot[498].X = 4.98
	pointsOfPolynomialPlot[498].Y = -6.968

	pointsOfPolynomialPlot[499].X = 4.99
	pointsOfPolynomialPlot[499].Y = -6.984

	pointsOfPolynomialPlot[500].X = 5.0
	pointsOfPolynomialPlot[500].Y = -7.0

	pointsOfPolynomialPlot[501].X = 5.01
	pointsOfPolynomialPlot[501].Y = -7.015

	pointsOfPolynomialPlot[502].X = 5.02
	pointsOfPolynomialPlot[502].Y = -7.031

	pointsOfPolynomialPlot[503].X = 5.03
	pointsOfPolynomialPlot[503].Y = -7.047

	pointsOfPolynomialPlot[504].X = 5.04
	pointsOfPolynomialPlot[504].Y = -7.062

	pointsOfPolynomialPlot[505].X = 5.05
	pointsOfPolynomialPlot[505].Y = -7.078

	pointsOfPolynomialPlot[506].X = 5.06
	pointsOfPolynomialPlot[506].Y = -7.094

	pointsOfPolynomialPlot[507].X = 5.07
	pointsOfPolynomialPlot[507].Y = -7.11

	pointsOfPolynomialPlot[508].X = 5.08
	pointsOfPolynomialPlot[508].Y = -7.125

	pointsOfPolynomialPlot[509].X = 5.09
	pointsOfPolynomialPlot[509].Y = -7.141

	pointsOfPolynomialPlot[510].X = 5.10
	pointsOfPolynomialPlot[510].Y = -7.157

	pointsOfPolynomialPlot[511].X = 5.11
	pointsOfPolynomialPlot[511].Y = -7.172

	pointsOfPolynomialPlot[512].X = 5.12
	pointsOfPolynomialPlot[512].Y = -7.188

	pointsOfPolynomialPlot[513].X = 5.13
	pointsOfPolynomialPlot[513].Y = -7.204

	pointsOfPolynomialPlot[514].X = 5.14
	pointsOfPolynomialPlot[514].Y = -7.219

	pointsOfPolynomialPlot[515].X = 5.15
	pointsOfPolynomialPlot[515].Y = -7.235

	pointsOfPolynomialPlot[516].X = 5.16
	pointsOfPolynomialPlot[516].Y = -7.251

	pointsOfPolynomialPlot[517].X = 5.17
	pointsOfPolynomialPlot[517].Y = -7.266

	pointsOfPolynomialPlot[518].X = 5.18
	pointsOfPolynomialPlot[518].Y = -7.282

	pointsOfPolynomialPlot[519].X = 5.19
	pointsOfPolynomialPlot[519].Y = -7.297

	pointsOfPolynomialPlot[520].X = 5.20
	pointsOfPolynomialPlot[520].Y = -7.313

	pointsOfPolynomialPlot[521].X = 5.21
	pointsOfPolynomialPlot[521].Y = -7.329

	pointsOfPolynomialPlot[522].X = 5.22
	pointsOfPolynomialPlot[522].Y = -7.344

	pointsOfPolynomialPlot[523].X = 5.23
	pointsOfPolynomialPlot[523].Y = -7.36

	pointsOfPolynomialPlot[524].X = 5.24
	pointsOfPolynomialPlot[524].Y = -7.375

	pointsOfPolynomialPlot[525].X = 5.25
	pointsOfPolynomialPlot[525].Y = -7.391

	pointsOfPolynomialPlot[526].X = 5.26
	pointsOfPolynomialPlot[526].Y = -7.406

	pointsOfPolynomialPlot[527].X = 5.27
	pointsOfPolynomialPlot[527].Y = -7.422

	pointsOfPolynomialPlot[528].X = 5.28
	pointsOfPolynomialPlot[528].Y = -7.437

	pointsOfPolynomialPlot[529].X = 5.29
	pointsOfPolynomialPlot[529].Y = -7.453

	pointsOfPolynomialPlot[530].X = 5.30
	pointsOfPolynomialPlot[530].Y = -7.468

	pointsOfPolynomialPlot[531].X = 5.31
	pointsOfPolynomialPlot[531].Y = -7.484

	pointsOfPolynomialPlot[532].X = 5.32
	pointsOfPolynomialPlot[532].Y = -7.499

	pointsOfPolynomialPlot[533].X = 5.33
	pointsOfPolynomialPlot[533].Y = -7.515

	pointsOfPolynomialPlot[534].X = 5.34
	pointsOfPolynomialPlot[534].Y = -7.53

	pointsOfPolynomialPlot[535].X = 5.35
	pointsOfPolynomialPlot[535].Y = -7.546

	pointsOfPolynomialPlot[536].X = 5.36
	pointsOfPolynomialPlot[536].Y = -7.561

	pointsOfPolynomialPlot[537].X = 5.37
	pointsOfPolynomialPlot[537].Y = -7.577

	pointsOfPolynomialPlot[538].X = 5.38
	pointsOfPolynomialPlot[538].Y = -7.592

	pointsOfPolynomialPlot[539].X = 5.39
	pointsOfPolynomialPlot[539].Y = -7.607

	pointsOfPolynomialPlot[540].X = 5.40
	pointsOfPolynomialPlot[540].Y = -7.623

	pointsOfPolynomialPlot[541].X = 5.41
	pointsOfPolynomialPlot[541].Y = -7.638

	pointsOfPolynomialPlot[542].X = 5.42
	pointsOfPolynomialPlot[542].Y = -7.653

	pointsOfPolynomialPlot[543].X = 5.43
	pointsOfPolynomialPlot[543].Y = -7.669

	pointsOfPolynomialPlot[544].X = 5.44
	pointsOfPolynomialPlot[544].Y = -7.684

	pointsOfPolynomialPlot[545].X = 5.45
	pointsOfPolynomialPlot[545].Y = -7.699

	pointsOfPolynomialPlot[546].X = 5.46
	pointsOfPolynomialPlot[546].Y = -7.715

	pointsOfPolynomialPlot[547].X = 5.47
	pointsOfPolynomialPlot[547].Y = -7.73

	pointsOfPolynomialPlot[548].X = 5.48
	pointsOfPolynomialPlot[548].Y = -7.745

	pointsOfPolynomialPlot[549].X = 5.49
	pointsOfPolynomialPlot[549].Y = -7.761

	pointsOfPolynomialPlot[550].X = 5.50
	pointsOfPolynomialPlot[550].Y = -7.776

	pointsOfPolynomialPlot[551].X = 5.51
	pointsOfPolynomialPlot[551].Y = -7.791

	pointsOfPolynomialPlot[552].X = 5.52
	pointsOfPolynomialPlot[552].Y = -7.806

	pointsOfPolynomialPlot[553].X = 5.53
	pointsOfPolynomialPlot[553].Y = -7.822

	pointsOfPolynomialPlot[554].X = 5.54
	pointsOfPolynomialPlot[554].Y = -7.837

	pointsOfPolynomialPlot[555].X = 5.55
	pointsOfPolynomialPlot[555].Y = -7.852

	pointsOfPolynomialPlot[556].X = 5.56
	pointsOfPolynomialPlot[556].Y = -7.867

	pointsOfPolynomialPlot[557].X = 5.57
	pointsOfPolynomialPlot[557].Y = -7.882

	pointsOfPolynomialPlot[558].X = 5.58
	pointsOfPolynomialPlot[558].Y = -7.897

	pointsOfPolynomialPlot[559].X = 5.59
	pointsOfPolynomialPlot[559].Y = -7.913

	pointsOfPolynomialPlot[560].X = 5.60
	pointsOfPolynomialPlot[560].Y = -7.928

	pointsOfPolynomialPlot[561].X = 5.61
	pointsOfPolynomialPlot[561].Y = -7.943

	pointsOfPolynomialPlot[562].X = 5.62
	pointsOfPolynomialPlot[562].Y = -7.958

	pointsOfPolynomialPlot[563].X = 5.63
	pointsOfPolynomialPlot[563].Y = -7.973

	pointsOfPolynomialPlot[564].X = 5.64
	pointsOfPolynomialPlot[564].Y = -7.988

	pointsOfPolynomialPlot[565].X = 5.65
	pointsOfPolynomialPlot[565].Y = -8.003

	pointsOfPolynomialPlot[566].X = 5.66
	pointsOfPolynomialPlot[566].Y = -8.018

	pointsOfPolynomialPlot[567].X = 5.67
	pointsOfPolynomialPlot[567].Y = -8.033

	pointsOfPolynomialPlot[568].X = 5.68
	pointsOfPolynomialPlot[568].Y = -8.048

	pointsOfPolynomialPlot[569].X = 5.69
	pointsOfPolynomialPlot[569].Y = -8.063

	pointsOfPolynomialPlot[570].X = 5.70
	pointsOfPolynomialPlot[570].Y = -8.078

	pointsOfPolynomialPlot[571].X = 5.71
	pointsOfPolynomialPlot[571].Y = -8.093

	pointsOfPolynomialPlot[572].X = 5.72
	pointsOfPolynomialPlot[572].Y = -8.108

	pointsOfPolynomialPlot[573].X = 5.73
	pointsOfPolynomialPlot[573].Y = -8.123

	pointsOfPolynomialPlot[574].X = 5.74
	pointsOfPolynomialPlot[574].Y = -8.138

	pointsOfPolynomialPlot[575].X = 5.75
	pointsOfPolynomialPlot[575].Y = -8.153

	pointsOfPolynomialPlot[576].X = 5.76
	pointsOfPolynomialPlot[576].Y = -8.168

	pointsOfPolynomialPlot[577].X = 5.77
	pointsOfPolynomialPlot[577].Y = -8.183

	pointsOfPolynomialPlot[578].X = 5.78
	pointsOfPolynomialPlot[578].Y = -8.197

	pointsOfPolynomialPlot[579].X = 5.79
	pointsOfPolynomialPlot[579].Y = -8.212

	pointsOfPolynomialPlot[580].X = 5.80
	pointsOfPolynomialPlot[580].Y = -8.227

	pointsOfPolynomialPlot[581].X = 5.81
	pointsOfPolynomialPlot[581].Y = -8.242

	pointsOfPolynomialPlot[582].X = 5.82
	pointsOfPolynomialPlot[582].Y = -8.257

	pointsOfPolynomialPlot[583].X = 5.83
	pointsOfPolynomialPlot[583].Y = -8.271

	pointsOfPolynomialPlot[584].X = 5.84
	pointsOfPolynomialPlot[584].Y = -8.286

	pointsOfPolynomialPlot[585].X = 5.85
	pointsOfPolynomialPlot[585].Y = -8.301

	pointsOfPolynomialPlot[586].X = 5.86
	pointsOfPolynomialPlot[586].Y = -8.316

	pointsOfPolynomialPlot[587].X = 5.87
	pointsOfPolynomialPlot[587].Y = -8.33

	pointsOfPolynomialPlot[588].X = 5.88
	pointsOfPolynomialPlot[588].Y = -8.345

	pointsOfPolynomialPlot[589].X = 5.89
	pointsOfPolynomialPlot[589].Y = -8.36

	pointsOfPolynomialPlot[590].X = 5.90
	pointsOfPolynomialPlot[590].Y = -8.374

	pointsOfPolynomialPlot[591].X = 5.91
	pointsOfPolynomialPlot[591].Y = -8.389

	pointsOfPolynomialPlot[592].X = 5.92
	pointsOfPolynomialPlot[592].Y = -8.403

	pointsOfPolynomialPlot[593].X = 5.93
	pointsOfPolynomialPlot[593].Y = -8.418

	pointsOfPolynomialPlot[594].X = 5.94
	pointsOfPolynomialPlot[594].Y = -8.433

	pointsOfPolynomialPlot[595].X = 5.95
	pointsOfPolynomialPlot[595].Y = -8.447

	pointsOfPolynomialPlot[596].X = 5.96
	pointsOfPolynomialPlot[596].Y = -8.462

	pointsOfPolynomialPlot[597].X = 5.97
	pointsOfPolynomialPlot[597].Y = -8.476

	pointsOfPolynomialPlot[598].X = 5.98
	pointsOfPolynomialPlot[598].Y = -8.491

	pointsOfPolynomialPlot[599].X = 5.99
	pointsOfPolynomialPlot[599].Y = -8.505

	pointsOfPolynomialPlot[600].X = 6.0
	pointsOfPolynomialPlot[600].Y = -8.52

	pointsOfPolynomialPlot[601].X = 6.01
	pointsOfPolynomialPlot[601].Y = -8.534

	pointsOfPolynomialPlot[602].X = 6.02
	pointsOfPolynomialPlot[602].Y = -8.548

	pointsOfPolynomialPlot[603].X = 6.03
	pointsOfPolynomialPlot[603].Y = -8.563

	pointsOfPolynomialPlot[604].X = 6.04
	pointsOfPolynomialPlot[604].Y = -8.577

	pointsOfPolynomialPlot[605].X = 6.05
	pointsOfPolynomialPlot[605].Y = -8.592

	pointsOfPolynomialPlot[606].X = 6.06
	pointsOfPolynomialPlot[606].Y = -8.606

	pointsOfPolynomialPlot[607].X = 6.07
	pointsOfPolynomialPlot[607].Y = -8.62

	pointsOfPolynomialPlot[608].X = 6.08
	pointsOfPolynomialPlot[608].Y = -8.634

	pointsOfPolynomialPlot[609].X = 6.09
	pointsOfPolynomialPlot[609].Y = -8.649

	pointsOfPolynomialPlot[610].X = 6.10
	pointsOfPolynomialPlot[610].Y = -8.663

	pointsOfPolynomialPlot[611].X = 6.11
	pointsOfPolynomialPlot[611].Y = -8.677

	pointsOfPolynomialPlot[612].X = 6.12
	pointsOfPolynomialPlot[612].Y = -8.691

	pointsOfPolynomialPlot[613].X = 6.13
	pointsOfPolynomialPlot[613].Y = -8.706

	pointsOfPolynomialPlot[614].X = 6.14
	pointsOfPolynomialPlot[614].Y = -8.72

	pointsOfPolynomialPlot[615].X = 6.15
	pointsOfPolynomialPlot[615].Y = -8.734

	pointsOfPolynomialPlot[616].X = 6.16
	pointsOfPolynomialPlot[616].Y = -8.748

	pointsOfPolynomialPlot[617].X = 6.17
	pointsOfPolynomialPlot[617].Y = -8.762

	pointsOfPolynomialPlot[618].X = 6.18
	pointsOfPolynomialPlot[618].Y = -8.776

	pointsOfPolynomialPlot[619].X = 6.19
	pointsOfPolynomialPlot[619].Y = -8.79

	pointsOfPolynomialPlot[620].X = 6.20
	pointsOfPolynomialPlot[620].Y = -8.804

	pointsOfPolynomialPlot[621].X = 6.21
	pointsOfPolynomialPlot[621].Y = -8.818

	pointsOfPolynomialPlot[622].X = 6.22
	pointsOfPolynomialPlot[622].Y = -8.832

	pointsOfPolynomialPlot[623].X = 6.23
	pointsOfPolynomialPlot[623].Y = -8.846

	pointsOfPolynomialPlot[624].X = 6.24
	pointsOfPolynomialPlot[624].Y = -8.86

	pointsOfPolynomialPlot[625].X = 6.25
	pointsOfPolynomialPlot[625].Y = -8.874

	pointsOfPolynomialPlot[626].X = 6.26
	pointsOfPolynomialPlot[626].Y = -8.888

	pointsOfPolynomialPlot[627].X = 6.27
	pointsOfPolynomialPlot[627].Y = -8.902

	pointsOfPolynomialPlot[628].X = 6.28
	pointsOfPolynomialPlot[628].Y = -8.916

	pointsOfPolynomialPlot[629].X = 6.29
	pointsOfPolynomialPlot[629].Y = -8.93

	pointsOfPolynomialPlot[630].X = 6.30
	pointsOfPolynomialPlot[630].Y = -8.943

	pointsOfPolynomialPlot[631].X = 6.31
	pointsOfPolynomialPlot[631].Y = -8.957

	pointsOfPolynomialPlot[632].X = 6.32
	pointsOfPolynomialPlot[632].Y = -8.971

	pointsOfPolynomialPlot[633].X = 6.33
	pointsOfPolynomialPlot[633].Y = -8.985

	pointsOfPolynomialPlot[634].X = 6.34
	pointsOfPolynomialPlot[634].Y = -8.998

	pointsOfPolynomialPlot[635].X = 6.35
	pointsOfPolynomialPlot[635].Y = -9.012

	pointsOfPolynomialPlot[636].X = 6.36
	pointsOfPolynomialPlot[636].Y = -9.026

	pointsOfPolynomialPlot[637].X = 6.37
	pointsOfPolynomialPlot[637].Y = -9.039

	pointsOfPolynomialPlot[638].X = 6.38
	pointsOfPolynomialPlot[638].Y = -9.053

	pointsOfPolynomialPlot[639].X = 6.39
	pointsOfPolynomialPlot[639].Y = -9.066

	pointsOfPolynomialPlot[640].X = 6.40
	pointsOfPolynomialPlot[640].Y = -9.08

	pointsOfPolynomialPlot[641].X = 6.41
	pointsOfPolynomialPlot[641].Y = -9.094

	pointsOfPolynomialPlot[642].X = 6.42
	pointsOfPolynomialPlot[642].Y = -9.107

	pointsOfPolynomialPlot[643].X = 6.43
	pointsOfPolynomialPlot[643].Y = -9.12

	pointsOfPolynomialPlot[644].X = 6.44
	pointsOfPolynomialPlot[644].Y = -9.134

	pointsOfPolynomialPlot[645].X = 6.45
	pointsOfPolynomialPlot[645].Y = -9.147

	pointsOfPolynomialPlot[646].X = 6.46
	pointsOfPolynomialPlot[646].Y = -9.161

	pointsOfPolynomialPlot[647].X = 6.47
	pointsOfPolynomialPlot[647].Y = -9.174

	pointsOfPolynomialPlot[648].X = 6.48
	pointsOfPolynomialPlot[648].Y = -9.187

	pointsOfPolynomialPlot[649].X = 6.49
	pointsOfPolynomialPlot[649].Y = -9.201

	pointsOfPolynomialPlot[650].X = 6.50
	pointsOfPolynomialPlot[650].Y = -9.214

	pointsOfPolynomialPlot[651].X = 6.51
	pointsOfPolynomialPlot[651].Y = -9.227

	pointsOfPolynomialPlot[652].X = 6.52
	pointsOfPolynomialPlot[652].Y = -9.241

	pointsOfPolynomialPlot[653].X = 6.53
	pointsOfPolynomialPlot[653].Y = -9.254

	pointsOfPolynomialPlot[654].X = 6.54
	pointsOfPolynomialPlot[654].Y = -9.267

	pointsOfPolynomialPlot[655].X = 6.55
	pointsOfPolynomialPlot[655].Y = -9.28

	pointsOfPolynomialPlot[656].X = 6.56
	pointsOfPolynomialPlot[656].Y = -9.293

	pointsOfPolynomialPlot[657].X = 6.57
	pointsOfPolynomialPlot[657].Y = -9.306

	pointsOfPolynomialPlot[658].X = 6.58
	pointsOfPolynomialPlot[658].Y = -9.32

	pointsOfPolynomialPlot[659].X = 6.59
	pointsOfPolynomialPlot[659].Y = -9.333

	pointsOfPolynomialPlot[660].X = 6.60
	pointsOfPolynomialPlot[660].Y = -9.346

	pointsOfPolynomialPlot[661].X = 6.61
	pointsOfPolynomialPlot[661].Y = -9.359

	pointsOfPolynomialPlot[662].X = 6.62
	pointsOfPolynomialPlot[662].Y = -9.372

	pointsOfPolynomialPlot[663].X = 6.63
	pointsOfPolynomialPlot[663].Y = -9.384

	pointsOfPolynomialPlot[664].X = 6.64
	pointsOfPolynomialPlot[664].Y = -9.397

	pointsOfPolynomialPlot[665].X = 6.65
	pointsOfPolynomialPlot[665].Y = -9.41

	pointsOfPolynomialPlot[666].X = 6.66
	pointsOfPolynomialPlot[666].Y = -9.423

	pointsOfPolynomialPlot[667].X = 6.67
	pointsOfPolynomialPlot[667].Y = -9.436

	pointsOfPolynomialPlot[668].X = 6.68
	pointsOfPolynomialPlot[668].Y = -9.449

	pointsOfPolynomialPlot[669].X = 6.69
	pointsOfPolynomialPlot[669].Y = -9.461

	pointsOfPolynomialPlot[670].X = 6.70
	pointsOfPolynomialPlot[670].Y = -9.474

	pointsOfPolynomialPlot[671].X = 6.71
	pointsOfPolynomialPlot[671].Y = -9.487

	pointsOfPolynomialPlot[672].X = 6.72
	pointsOfPolynomialPlot[672].Y = -9.5

	pointsOfPolynomialPlot[673].X = 6.73
	pointsOfPolynomialPlot[673].Y = -9.512

	pointsOfPolynomialPlot[674].X = 6.74
	pointsOfPolynomialPlot[674].Y = -9.525

	pointsOfPolynomialPlot[675].X = 6.75
	pointsOfPolynomialPlot[675].Y = -9.537

	pointsOfPolynomialPlot[676].X = 6.76
	pointsOfPolynomialPlot[676].Y = -9.55

	pointsOfPolynomialPlot[677].X = 6.77
	pointsOfPolynomialPlot[677].Y = -9.562

	pointsOfPolynomialPlot[678].X = 6.78
	pointsOfPolynomialPlot[678].Y = -9.575

	pointsOfPolynomialPlot[679].X = 6.79
	pointsOfPolynomialPlot[679].Y = -9.587

	pointsOfPolynomialPlot[680].X = 6.80
	pointsOfPolynomialPlot[680].Y = -9.6

	pointsOfPolynomialPlot[681].X = 6.81
	pointsOfPolynomialPlot[681].Y = -9.612

	pointsOfPolynomialPlot[682].X = 6.82
	pointsOfPolynomialPlot[682].Y = -9.625

	pointsOfPolynomialPlot[683].X = 6.83
	pointsOfPolynomialPlot[683].Y = -9.637

	pointsOfPolynomialPlot[684].X = 6.84
	pointsOfPolynomialPlot[684].Y = -9.649

	pointsOfPolynomialPlot[685].X = 6.85
	pointsOfPolynomialPlot[685].Y = -9.661

	pointsOfPolynomialPlot[686].X = 6.86
	pointsOfPolynomialPlot[686].Y = -9.674

	pointsOfPolynomialPlot[687].X = 6.87
	pointsOfPolynomialPlot[687].Y = -9.686

	pointsOfPolynomialPlot[688].X = 6.88
	pointsOfPolynomialPlot[688].Y = -9.698

	pointsOfPolynomialPlot[689].X = 6.89
	pointsOfPolynomialPlot[689].Y = -9.71

	pointsOfPolynomialPlot[690].X = 6.90
	pointsOfPolynomialPlot[690].Y = -9.722

	pointsOfPolynomialPlot[691].X = 6.91
	pointsOfPolynomialPlot[691].Y = -9.734

	pointsOfPolynomialPlot[692].X = 6.92
	pointsOfPolynomialPlot[692].Y = -9.746

	pointsOfPolynomialPlot[693].X = 6.93
	pointsOfPolynomialPlot[693].Y = -9.758

	pointsOfPolynomialPlot[694].X = 6.94
	pointsOfPolynomialPlot[694].Y = -9.77

	pointsOfPolynomialPlot[695].X = 6.95
	pointsOfPolynomialPlot[695].Y = -9.782

	pointsOfPolynomialPlot[696].X = 6.96
	pointsOfPolynomialPlot[696].Y = -9.794

	pointsOfPolynomialPlot[697].X = 6.97
	pointsOfPolynomialPlot[697].Y = -9.806

	pointsOfPolynomialPlot[698].X = 6.98
	pointsOfPolynomialPlot[698].Y = -9.818

	pointsOfPolynomialPlot[699].X = 6.99
	pointsOfPolynomialPlot[699].Y = -9.83

	pointsOfPolynomialPlot[700].X = 7.0
	pointsOfPolynomialPlot[700].Y = -9.842

	pointsOfPolynomialPlot[701].X = 7.01
	pointsOfPolynomialPlot[701].Y = -9.853

	pointsOfPolynomialPlot[702].X = 7.02
	pointsOfPolynomialPlot[702].Y = -9.865

	pointsOfPolynomialPlot[703].X = 7.03
	pointsOfPolynomialPlot[703].Y = -9.877

	pointsOfPolynomialPlot[704].X = 7.04
	pointsOfPolynomialPlot[704].Y = -9.888

	pointsOfPolynomialPlot[705].X = 7.05
	pointsOfPolynomialPlot[705].Y = -9.9

	pointsOfPolynomialPlot[706].X = 7.06
	pointsOfPolynomialPlot[706].Y = -9.911

	pointsOfPolynomialPlot[707].X = 7.07
	pointsOfPolynomialPlot[707].Y = -9.923

	pointsOfPolynomialPlot[708].X = 7.08
	pointsOfPolynomialPlot[708].Y = -9.934

	pointsOfPolynomialPlot[709].X = 7.09
	pointsOfPolynomialPlot[709].Y = -9.946

	pointsOfPolynomialPlot[710].X = 7.10
	pointsOfPolynomialPlot[710].Y = -9.957

	pointsOfPolynomialPlot[711].X = 7.11
	pointsOfPolynomialPlot[711].Y = -9.969

	pointsOfPolynomialPlot[712].X = 7.12
	pointsOfPolynomialPlot[712].Y = -9.98

	pointsOfPolynomialPlot[713].X = 7.13
	pointsOfPolynomialPlot[713].Y = -9.991

	pointsOfPolynomialPlot[714].X = 7.14
	pointsOfPolynomialPlot[714].Y = -10.003

	pointsOfPolynomialPlot[715].X = 7.15
	pointsOfPolynomialPlot[715].Y = -10.014

	pointsOfPolynomialPlot[716].X = 7.16
	pointsOfPolynomialPlot[716].Y = -10.025

	pointsOfPolynomialPlot[717].X = 7.17
	pointsOfPolynomialPlot[717].Y = -10.036

	pointsOfPolynomialPlot[718].X = 7.18
	pointsOfPolynomialPlot[718].Y = -10.047

	pointsOfPolynomialPlot[719].X = 7.19
	pointsOfPolynomialPlot[719].Y = -10.058

	pointsOfPolynomialPlot[720].X = 7.20
	pointsOfPolynomialPlot[720].Y = -10.069

	pointsOfPolynomialPlot[721].X = 7.21
	pointsOfPolynomialPlot[721].Y = -10.08

	pointsOfPolynomialPlot[722].X = 7.22
	pointsOfPolynomialPlot[722].Y = -10.091

	pointsOfPolynomialPlot[723].X = 7.23
	pointsOfPolynomialPlot[723].Y = -10.102

	pointsOfPolynomialPlot[724].X = 7.24
	pointsOfPolynomialPlot[724].Y = -10.113

	pointsOfPolynomialPlot[725].X = 7.25
	pointsOfPolynomialPlot[725].Y = -10.124

	pointsOfPolynomialPlot[726].X = 7.26
	pointsOfPolynomialPlot[726].Y = -10.135

	pointsOfPolynomialPlot[727].X = 7.27
	pointsOfPolynomialPlot[727].Y = -10.146

	pointsOfPolynomialPlot[728].X = 7.28
	pointsOfPolynomialPlot[728].Y = -10.156

	pointsOfPolynomialPlot[729].X = 7.29
	pointsOfPolynomialPlot[729].Y = -10.167

	pointsOfPolynomialPlot[730].X = 7.30
	pointsOfPolynomialPlot[730].Y = -10.178

	pointsOfPolynomialPlot[731].X = 7.31
	pointsOfPolynomialPlot[731].Y = -10.188

	pointsOfPolynomialPlot[732].X = 7.32
	pointsOfPolynomialPlot[732].Y = -10.199

	pointsOfPolynomialPlot[733].X = 7.33
	pointsOfPolynomialPlot[733].Y = -10.209

	pointsOfPolynomialPlot[734].X = 7.34
	pointsOfPolynomialPlot[734].Y = -10.22

	pointsOfPolynomialPlot[735].X = 7.35
	pointsOfPolynomialPlot[735].Y = -10.23

	pointsOfPolynomialPlot[736].X = 7.36
	pointsOfPolynomialPlot[736].Y = -10.241

	pointsOfPolynomialPlot[737].X = 7.37
	pointsOfPolynomialPlot[737].Y = -10.251

	pointsOfPolynomialPlot[738].X = 7.38
	pointsOfPolynomialPlot[738].Y = -10.262

	pointsOfPolynomialPlot[739].X = 7.39
	pointsOfPolynomialPlot[739].Y = -10.272

	pointsOfPolynomialPlot[740].X = 7.40
	pointsOfPolynomialPlot[740].Y = -10.282

	pointsOfPolynomialPlot[741].X = 7.41
	pointsOfPolynomialPlot[741].Y = -10.292

	pointsOfPolynomialPlot[742].X = 7.42
	pointsOfPolynomialPlot[742].Y = -10.303

	pointsOfPolynomialPlot[743].X = 7.43
	pointsOfPolynomialPlot[743].Y = -10.313

	pointsOfPolynomialPlot[744].X = 7.44
	pointsOfPolynomialPlot[744].Y = -10.323

	pointsOfPolynomialPlot[745].X = 7.45
	pointsOfPolynomialPlot[745].Y = -10.333

	pointsOfPolynomialPlot[746].X = 7.46
	pointsOfPolynomialPlot[746].Y = -10.343

	pointsOfPolynomialPlot[747].X = 7.47
	pointsOfPolynomialPlot[747].Y = -10.353

	pointsOfPolynomialPlot[748].X = 7.48
	pointsOfPolynomialPlot[748].Y = -10.363

	pointsOfPolynomialPlot[749].X = 7.49
	pointsOfPolynomialPlot[749].Y = -10.373

	pointsOfPolynomialPlot[750].X = 7.50
	pointsOfPolynomialPlot[750].Y = -10.382

	pointsOfPolynomialPlot[751].X = 7.51
	pointsOfPolynomialPlot[751].Y = -10.392

	pointsOfPolynomialPlot[752].X = 7.52
	pointsOfPolynomialPlot[752].Y = -10.402

	pointsOfPolynomialPlot[753].X = 7.53
	pointsOfPolynomialPlot[753].Y = -10.412

	pointsOfPolynomialPlot[754].X = 7.54
	pointsOfPolynomialPlot[754].Y = -10.421

	pointsOfPolynomialPlot[755].X = 7.55
	pointsOfPolynomialPlot[755].Y = -10.431

	pointsOfPolynomialPlot[756].X = 7.56
	pointsOfPolynomialPlot[756].Y = -10.44

	pointsOfPolynomialPlot[757].X = 7.57
	pointsOfPolynomialPlot[757].Y = -10.45

	pointsOfPolynomialPlot[758].X = 7.58
	pointsOfPolynomialPlot[758].Y = -10.459

	pointsOfPolynomialPlot[759].X = 7.59
	pointsOfPolynomialPlot[759].Y = -10.469

	pointsOfPolynomialPlot[760].X = 7.60
	pointsOfPolynomialPlot[760].Y = -10.478

	pointsOfPolynomialPlot[761].X = 7.61
	pointsOfPolynomialPlot[761].Y = -10.488

	pointsOfPolynomialPlot[762].X = 7.62
	pointsOfPolynomialPlot[762].Y = -10.497

	pointsOfPolynomialPlot[763].X = 7.63
	pointsOfPolynomialPlot[763].Y = -10.506

	pointsOfPolynomialPlot[764].X = 7.64
	pointsOfPolynomialPlot[764].Y = -10.515

	pointsOfPolynomialPlot[765].X = 7.65
	pointsOfPolynomialPlot[765].Y = -10.525

	pointsOfPolynomialPlot[766].X = 7.66
	pointsOfPolynomialPlot[766].Y = -10.534

	pointsOfPolynomialPlot[767].X = 7.67
	pointsOfPolynomialPlot[767].Y = -10.543

	pointsOfPolynomialPlot[768].X = 7.68
	pointsOfPolynomialPlot[768].Y = -10.552

	pointsOfPolynomialPlot[769].X = 7.69
	pointsOfPolynomialPlot[769].Y = -10.561

	pointsOfPolynomialPlot[770].X = 7.70
	pointsOfPolynomialPlot[770].Y = -10.57

	pointsOfPolynomialPlot[771].X = 7.71
	pointsOfPolynomialPlot[771].Y = -10.579

	pointsOfPolynomialPlot[772].X = 7.72
	pointsOfPolynomialPlot[772].Y = -10.588

	pointsOfPolynomialPlot[773].X = 7.73
	pointsOfPolynomialPlot[773].Y = -10.596

	pointsOfPolynomialPlot[774].X = 7.74
	pointsOfPolynomialPlot[774].Y = -10.605

	pointsOfPolynomialPlot[775].X = 7.75
	pointsOfPolynomialPlot[775].Y = -10.614

	pointsOfPolynomialPlot[776].X = 7.76
	pointsOfPolynomialPlot[776].Y = -10.622

	pointsOfPolynomialPlot[777].X = 7.77
	pointsOfPolynomialPlot[777].Y = -10.631

	pointsOfPolynomialPlot[778].X = 7.78
	pointsOfPolynomialPlot[778].Y = -10.64

	pointsOfPolynomialPlot[779].X = 7.79
	pointsOfPolynomialPlot[779].Y = -10.648

	pointsOfPolynomialPlot[780].X = 7.80
	pointsOfPolynomialPlot[780].Y = -10.657

	pointsOfPolynomialPlot[781].X = 7.81
	pointsOfPolynomialPlot[781].Y = -10.665

	pointsOfPolynomialPlot[782].X = 7.82
	pointsOfPolynomialPlot[782].Y = -10.673

	pointsOfPolynomialPlot[783].X = 7.83
	pointsOfPolynomialPlot[783].Y = -10.682

	pointsOfPolynomialPlot[784].X = 7.84
	pointsOfPolynomialPlot[784].Y = -10.69

	pointsOfPolynomialPlot[785].X = 7.85
	pointsOfPolynomialPlot[785].Y = -10.698

	pointsOfPolynomialPlot[786].X = 7.86
	pointsOfPolynomialPlot[786].Y = -10.706

	pointsOfPolynomialPlot[787].X = 7.87
	pointsOfPolynomialPlot[787].Y = -10.715

	pointsOfPolynomialPlot[788].X = 7.88
	pointsOfPolynomialPlot[788].Y = -10.723

	pointsOfPolynomialPlot[789].X = 7.89
	pointsOfPolynomialPlot[789].Y = -10.731

	pointsOfPolynomialPlot[790].X = 7.90
	pointsOfPolynomialPlot[790].Y = -10.739

	pointsOfPolynomialPlot[791].X = 7.91
	pointsOfPolynomialPlot[791].Y = -10.747

	pointsOfPolynomialPlot[792].X = 7.92
	pointsOfPolynomialPlot[792].Y = -10.754

	pointsOfPolynomialPlot[793].X = 7.93
	pointsOfPolynomialPlot[793].Y = -10.762

	pointsOfPolynomialPlot[794].X = 7.94
	pointsOfPolynomialPlot[794].Y = -10.77

	pointsOfPolynomialPlot[795].X = 7.95
	pointsOfPolynomialPlot[795].Y = -10.778

	pointsOfPolynomialPlot[796].X = 7.96
	pointsOfPolynomialPlot[796].Y = -10.785

	pointsOfPolynomialPlot[797].X = 7.97
	pointsOfPolynomialPlot[797].Y = -10.793

	pointsOfPolynomialPlot[798].X = 7.98
	pointsOfPolynomialPlot[798].Y = -10.801

	pointsOfPolynomialPlot[799].X = 7.99
	pointsOfPolynomialPlot[799].Y = -10.808

	pointsOfPolynomialPlot[800].X = 8.0
	pointsOfPolynomialPlot[800].Y = -10.816

	pointsOfPolynomialPlot[801].X = 8.01
	pointsOfPolynomialPlot[801].Y = -10.823

	pointsOfPolynomialPlot[802].X = 8.02
	pointsOfPolynomialPlot[802].Y = -10.83

	pointsOfPolynomialPlot[803].X = 8.03
	pointsOfPolynomialPlot[803].Y = -10.838

	pointsOfPolynomialPlot[804].X = 8.04
	pointsOfPolynomialPlot[804].Y = -10.845

	pointsOfPolynomialPlot[805].X = 8.05
	pointsOfPolynomialPlot[805].Y = -10.852

	pointsOfPolynomialPlot[806].X = 8.06
	pointsOfPolynomialPlot[806].Y = -10.859

	pointsOfPolynomialPlot[807].X = 8.07
	pointsOfPolynomialPlot[807].Y = -10.866

	pointsOfPolynomialPlot[808].X = 8.08
	pointsOfPolynomialPlot[808].Y = -10.873

	pointsOfPolynomialPlot[809].X = 8.09
	pointsOfPolynomialPlot[809].Y = -10.88

	pointsOfPolynomialPlot[810].X = 8.10
	pointsOfPolynomialPlot[810].Y = -10.887

	pointsOfPolynomialPlot[811].X = 8.11
	pointsOfPolynomialPlot[811].Y = -10.894

	pointsOfPolynomialPlot[812].X = 8.12
	pointsOfPolynomialPlot[812].Y = -10.901

	pointsOfPolynomialPlot[813].X = 8.13
	pointsOfPolynomialPlot[813].Y = -10.908

	pointsOfPolynomialPlot[814].X = 8.14
	pointsOfPolynomialPlot[814].Y = -10.915

	pointsOfPolynomialPlot[815].X = 8.15
	pointsOfPolynomialPlot[815].Y = -10.921

	pointsOfPolynomialPlot[816].X = 8.16
	pointsOfPolynomialPlot[816].Y = -10.928

	pointsOfPolynomialPlot[817].X = 8.17
	pointsOfPolynomialPlot[817].Y = -10.934

	pointsOfPolynomialPlot[818].X = 8.18
	pointsOfPolynomialPlot[818].Y = -10.941

	pointsOfPolynomialPlot[819].X = 8.19
	pointsOfPolynomialPlot[819].Y = -10.947

	pointsOfPolynomialPlot[820].X = 8.20
	pointsOfPolynomialPlot[820].Y = -10.954

	pointsOfPolynomialPlot[821].X = 8.21
	pointsOfPolynomialPlot[821].Y = -10.96

	pointsOfPolynomialPlot[822].X = 8.22
	pointsOfPolynomialPlot[822].Y = -10.966

	pointsOfPolynomialPlot[823].X = 8.23
	pointsOfPolynomialPlot[823].Y = -10.973

	pointsOfPolynomialPlot[824].X = 8.24
	pointsOfPolynomialPlot[824].Y = -10.979

	pointsOfPolynomialPlot[825].X = 8.25
	pointsOfPolynomialPlot[825].Y = -10.985

	pointsOfPolynomialPlot[826].X = 8.26
	pointsOfPolynomialPlot[826].Y = -10.991

	pointsOfPolynomialPlot[827].X = 8.27
	pointsOfPolynomialPlot[827].Y = -10.997

	pointsOfPolynomialPlot[828].X = 8.28
	pointsOfPolynomialPlot[828].Y = -11.003

	pointsOfPolynomialPlot[829].X = 8.29
	pointsOfPolynomialPlot[829].Y = -11.009

	pointsOfPolynomialPlot[830].X = 8.30
	pointsOfPolynomialPlot[830].Y = -11.015

	pointsOfPolynomialPlot[831].X = 8.31
	pointsOfPolynomialPlot[831].Y = -11.02

	pointsOfPolynomialPlot[832].X = 8.32
	pointsOfPolynomialPlot[832].Y = -11.026

	pointsOfPolynomialPlot[833].X = 8.33
	pointsOfPolynomialPlot[833].Y = -11.032

	pointsOfPolynomialPlot[834].X = 8.34
	pointsOfPolynomialPlot[834].Y = -11.037

	pointsOfPolynomialPlot[835].X = 8.35
	pointsOfPolynomialPlot[835].Y = -11.043

	pointsOfPolynomialPlot[836].X = 8.36
	pointsOfPolynomialPlot[836].Y = -11.048

	pointsOfPolynomialPlot[837].X = 8.37
	pointsOfPolynomialPlot[837].Y = -11.054

	pointsOfPolynomialPlot[838].X = 8.38
	pointsOfPolynomialPlot[838].Y = -11.059

	pointsOfPolynomialPlot[839].X = 8.39
	pointsOfPolynomialPlot[839].Y = -11.064

	pointsOfPolynomialPlot[840].X = 8.40
	pointsOfPolynomialPlot[840].Y = -11.07

	pointsOfPolynomialPlot[841].X = 8.41
	pointsOfPolynomialPlot[841].Y = -11.075

	pointsOfPolynomialPlot[842].X = 8.42
	pointsOfPolynomialPlot[842].Y = -11.08

	pointsOfPolynomialPlot[843].X = 8.43
	pointsOfPolynomialPlot[843].Y = -11.085

	pointsOfPolynomialPlot[844].X = 8.44
	pointsOfPolynomialPlot[844].Y = -11.09

	pointsOfPolynomialPlot[845].X = 8.45
	pointsOfPolynomialPlot[845].Y = -11.095

	pointsOfPolynomialPlot[846].X = 8.46
	pointsOfPolynomialPlot[846].Y = -11.1

	pointsOfPolynomialPlot[847].X = 8.47
	pointsOfPolynomialPlot[847].Y = -11.105

	pointsOfPolynomialPlot[848].X = 8.48
	pointsOfPolynomialPlot[848].Y = -11.109

	pointsOfPolynomialPlot[849].X = 8.49
	pointsOfPolynomialPlot[849].Y = -11.114

	pointsOfPolynomialPlot[850].X = 8.50
	pointsOfPolynomialPlot[850].Y = -11.119

	pointsOfPolynomialPlot[851].X = 8.51
	pointsOfPolynomialPlot[851].Y = -11.123

	pointsOfPolynomialPlot[852].X = 8.52
	pointsOfPolynomialPlot[852].Y = -11.128

	pointsOfPolynomialPlot[853].X = 8.53
	pointsOfPolynomialPlot[853].Y = -11.132

	pointsOfPolynomialPlot[854].X = 8.54
	pointsOfPolynomialPlot[854].Y = -11.137

	pointsOfPolynomialPlot[855].X = 8.55
	pointsOfPolynomialPlot[855].Y = -11.141

	pointsOfPolynomialPlot[856].X = 8.56
	pointsOfPolynomialPlot[856].Y = -11.145

	pointsOfPolynomialPlot[857].X = 8.57
	pointsOfPolynomialPlot[857].Y = -11.149

	pointsOfPolynomialPlot[858].X = 8.58
	pointsOfPolynomialPlot[858].Y = -11.153

	pointsOfPolynomialPlot[859].X = 8.59
	pointsOfPolynomialPlot[859].Y = -11.158

	pointsOfPolynomialPlot[860].X = 8.60
	pointsOfPolynomialPlot[860].Y = -11.162

	pointsOfPolynomialPlot[861].X = 8.61
	pointsOfPolynomialPlot[861].Y = -11.165

	pointsOfPolynomialPlot[862].X = 8.62
	pointsOfPolynomialPlot[862].Y = -11.169

	pointsOfPolynomialPlot[863].X = 8.63
	pointsOfPolynomialPlot[863].Y = -11.173

	pointsOfPolynomialPlot[864].X = 8.64
	pointsOfPolynomialPlot[864].Y = -11.177

	pointsOfPolynomialPlot[865].X = 8.65
	pointsOfPolynomialPlot[865].Y = -11.181

	pointsOfPolynomialPlot[866].X = 8.66
	pointsOfPolynomialPlot[866].Y = -11.184

	pointsOfPolynomialPlot[867].X = 8.67
	pointsOfPolynomialPlot[867].Y = -11.188

	pointsOfPolynomialPlot[868].X = 8.68
	pointsOfPolynomialPlot[868].Y = -11.191

	pointsOfPolynomialPlot[869].X = 8.69
	pointsOfPolynomialPlot[869].Y = -11.195

	pointsOfPolynomialPlot[870].X = 8.70
	pointsOfPolynomialPlot[870].Y = -11.198

	pointsOfPolynomialPlot[871].X = 8.71
	pointsOfPolynomialPlot[871].Y = -11.201

	pointsOfPolynomialPlot[872].X = 8.72
	pointsOfPolynomialPlot[872].Y = -11.205

	pointsOfPolynomialPlot[873].X = 8.73
	pointsOfPolynomialPlot[873].Y = -11.208

	pointsOfPolynomialPlot[874].X = 8.74
	pointsOfPolynomialPlot[874].Y = -11.211

	pointsOfPolynomialPlot[875].X = 8.75
	pointsOfPolynomialPlot[875].Y = -11.214

	pointsOfPolynomialPlot[876].X = 8.76
	pointsOfPolynomialPlot[876].Y = -11.217

	pointsOfPolynomialPlot[877].X = 8.77
	pointsOfPolynomialPlot[877].Y = -11.22

	pointsOfPolynomialPlot[878].X = 8.78
	pointsOfPolynomialPlot[878].Y = -11.223

	pointsOfPolynomialPlot[879].X = 8.79
	pointsOfPolynomialPlot[879].Y = -11.225

	pointsOfPolynomialPlot[880].X = 8.80
	pointsOfPolynomialPlot[880].Y = -11.228

	pointsOfPolynomialPlot[881].X = 8.81
	pointsOfPolynomialPlot[881].Y = -11.231

	pointsOfPolynomialPlot[882].X = 8.82
	pointsOfPolynomialPlot[882].Y = -11.233

	pointsOfPolynomialPlot[883].X = 8.83
	pointsOfPolynomialPlot[883].Y = -11.236

	pointsOfPolynomialPlot[884].X = 8.84
	pointsOfPolynomialPlot[884].Y = -11.238

	pointsOfPolynomialPlot[885].X = 8.85
	pointsOfPolynomialPlot[885].Y = -11.241

	pointsOfPolynomialPlot[886].X = 8.86
	pointsOfPolynomialPlot[886].Y = -11.243

	pointsOfPolynomialPlot[887].X = 8.87
	pointsOfPolynomialPlot[887].Y = -11.245

	pointsOfPolynomialPlot[888].X = 8.88
	pointsOfPolynomialPlot[888].Y = -11.247

	pointsOfPolynomialPlot[889].X = 8.89
	pointsOfPolynomialPlot[889].Y = -11.249

	pointsOfPolynomialPlot[890].X = 8.90
	pointsOfPolynomialPlot[890].Y = -11.251

	pointsOfPolynomialPlot[891].X = 8.91
	pointsOfPolynomialPlot[891].Y = -11.253

	pointsOfPolynomialPlot[892].X = 8.92
	pointsOfPolynomialPlot[892].Y = -11.255

	pointsOfPolynomialPlot[893].X = 8.93
	pointsOfPolynomialPlot[893].Y = -11.257

	pointsOfPolynomialPlot[894].X = 8.94
	pointsOfPolynomialPlot[894].Y = -11.259

	pointsOfPolynomialPlot[895].X = 8.95
	pointsOfPolynomialPlot[895].Y = -11.26

	pointsOfPolynomialPlot[896].X = 8.96
	pointsOfPolynomialPlot[896].Y = -11.262

	pointsOfPolynomialPlot[897].X = 8.97
	pointsOfPolynomialPlot[897].Y = -11.263

	pointsOfPolynomialPlot[898].X = 8.98
	pointsOfPolynomialPlot[898].Y = -11.265

	pointsOfPolynomialPlot[899].X = 8.99
	pointsOfPolynomialPlot[899].Y = -11.266

	pointsOfPolynomialPlot[900].X = 9.0
	pointsOfPolynomialPlot[900].Y = -11.268

	pointsOfPolynomialPlot[901].X = 9.01
	pointsOfPolynomialPlot[901].Y = -11.269

	pointsOfPolynomialPlot[902].X = 9.02
	pointsOfPolynomialPlot[902].Y = -11.27

	pointsOfPolynomialPlot[903].X = 9.03
	pointsOfPolynomialPlot[903].Y = -11.271

	pointsOfPolynomialPlot[904].X = 9.04
	pointsOfPolynomialPlot[904].Y = -11.272

	pointsOfPolynomialPlot[905].X = 9.05
	pointsOfPolynomialPlot[905].Y = -11.273

	pointsOfPolynomialPlot[906].X = 9.06
	pointsOfPolynomialPlot[906].Y = -11.274

	pointsOfPolynomialPlot[907].X = 9.07
	pointsOfPolynomialPlot[907].Y = -11.275

	pointsOfPolynomialPlot[908].X = 9.08
	pointsOfPolynomialPlot[908].Y = -11.275

	pointsOfPolynomialPlot[909].X = 9.09
	pointsOfPolynomialPlot[909].Y = -11.276

	pointsOfPolynomialPlot[910].X = 9.10
	pointsOfPolynomialPlot[910].Y = -11.277

	pointsOfPolynomialPlot[911].X = 9.11
	pointsOfPolynomialPlot[911].Y = -11.277

	pointsOfPolynomialPlot[912].X = 9.12
	pointsOfPolynomialPlot[912].Y = -11.278

	pointsOfPolynomialPlot[913].X = 9.13
	pointsOfPolynomialPlot[913].Y = -11.278

	pointsOfPolynomialPlot[914].X = 9.14
	pointsOfPolynomialPlot[914].Y = -11.278

	pointsOfPolynomialPlot[915].X = 9.15
	pointsOfPolynomialPlot[915].Y = -11.278

	pointsOfPolynomialPlot[916].X = 9.16
	pointsOfPolynomialPlot[916].Y = -11.279

	pointsOfPolynomialPlot[917].X = 9.17
	pointsOfPolynomialPlot[917].Y = -11.279

	pointsOfPolynomialPlot[918].X = 9.18
	pointsOfPolynomialPlot[918].Y = -11.279

	pointsOfPolynomialPlot[919].X = 9.19
	pointsOfPolynomialPlot[919].Y = -11.278

	pointsOfPolynomialPlot[920].X = 9.20
	pointsOfPolynomialPlot[920].Y = -11.278

	pointsOfPolynomialPlot[921].X = 9.21
	pointsOfPolynomialPlot[921].Y = -11.278

	pointsOfPolynomialPlot[922].X = 9.22
	pointsOfPolynomialPlot[922].Y = -11.278

	pointsOfPolynomialPlot[923].X = 9.23
	pointsOfPolynomialPlot[923].Y = -11.277

	pointsOfPolynomialPlot[924].X = 9.24
	pointsOfPolynomialPlot[924].Y = -11.277

	pointsOfPolynomialPlot[925].X = 9.25
	pointsOfPolynomialPlot[925].Y = -11.276

	pointsOfPolynomialPlot[926].X = 9.26
	pointsOfPolynomialPlot[926].Y = -11.276

	pointsOfPolynomialPlot[927].X = 9.27
	pointsOfPolynomialPlot[927].Y = -11.275

	pointsOfPolynomialPlot[928].X = 9.28
	pointsOfPolynomialPlot[928].Y = -11.274

	pointsOfPolynomialPlot[929].X = 9.29
	pointsOfPolynomialPlot[929].Y = -11.273

	pointsOfPolynomialPlot[930].X = 9.30
	pointsOfPolynomialPlot[930].Y = -11.272

	pointsOfPolynomialPlot[931].X = 9.31
	pointsOfPolynomialPlot[931].Y = -11.271

	pointsOfPolynomialPlot[932].X = 9.32
	pointsOfPolynomialPlot[932].Y = -11.27

	pointsOfPolynomialPlot[933].X = 9.33
	pointsOfPolynomialPlot[933].Y = -11.269

	pointsOfPolynomialPlot[934].X = 9.34
	pointsOfPolynomialPlot[934].Y = -11.268

	pointsOfPolynomialPlot[935].X = 9.35
	pointsOfPolynomialPlot[935].Y = -11.267

	pointsOfPolynomialPlot[936].X = 9.36
	pointsOfPolynomialPlot[936].Y = -11.265

	pointsOfPolynomialPlot[937].X = 9.37
	pointsOfPolynomialPlot[937].Y = -11.264

	pointsOfPolynomialPlot[938].X = 9.38
	pointsOfPolynomialPlot[938].Y = -11.262

	pointsOfPolynomialPlot[939].X = 9.39
	pointsOfPolynomialPlot[939].Y = -11.26

	pointsOfPolynomialPlot[940].X = 9.40
	pointsOfPolynomialPlot[940].Y = -11.259

	pointsOfPolynomialPlot[941].X = 9.41
	pointsOfPolynomialPlot[941].Y = -11.257

	pointsOfPolynomialPlot[942].X = 9.42
	pointsOfPolynomialPlot[942].Y = -11.255

	pointsOfPolynomialPlot[943].X = 9.43
	pointsOfPolynomialPlot[943].Y = -11.253

	pointsOfPolynomialPlot[944].X = 9.44
	pointsOfPolynomialPlot[944].Y = -11.251

	pointsOfPolynomialPlot[945].X = 9.45
	pointsOfPolynomialPlot[945].Y = -11.249

	pointsOfPolynomialPlot[946].X = 9.46
	pointsOfPolynomialPlot[946].Y = -11.247

	pointsOfPolynomialPlot[947].X = 9.47
	pointsOfPolynomialPlot[947].Y = -11.244

	pointsOfPolynomialPlot[948].X = 9.48
	pointsOfPolynomialPlot[948].Y = -11.242

	pointsOfPolynomialPlot[949].X = 9.49
	pointsOfPolynomialPlot[949].Y = -11.239

	pointsOfPolynomialPlot[950].X = 9.50
	pointsOfPolynomialPlot[950].Y = -11.237

	pointsOfPolynomialPlot[951].X = 9.51
	pointsOfPolynomialPlot[951].Y = -11.234

	pointsOfPolynomialPlot[952].X = 9.52
	pointsOfPolynomialPlot[952].Y = -11.232

	pointsOfPolynomialPlot[953].X = 9.53
	pointsOfPolynomialPlot[953].Y = -11.229

	pointsOfPolynomialPlot[954].X = 9.54
	pointsOfPolynomialPlot[954].Y = -11.226

	pointsOfPolynomialPlot[955].X = 9.55
	pointsOfPolynomialPlot[955].Y = -11.223

	pointsOfPolynomialPlot[956].X = 9.56
	pointsOfPolynomialPlot[956].Y = -11.22

	pointsOfPolynomialPlot[957].X = 9.57
	pointsOfPolynomialPlot[957].Y = -11.217

	pointsOfPolynomialPlot[958].X = 9.58
	pointsOfPolynomialPlot[958].Y = -11.214

	pointsOfPolynomialPlot[959].X = 9.59
	pointsOfPolynomialPlot[959].Y = -11.21

	pointsOfPolynomialPlot[960].X = 9.60
	pointsOfPolynomialPlot[960].Y = -11.207

	pointsOfPolynomialPlot[961].X = 9.61
	pointsOfPolynomialPlot[961].Y = -11.203

	pointsOfPolynomialPlot[962].X = 9.62
	pointsOfPolynomialPlot[962].Y = -11.2

	pointsOfPolynomialPlot[963].X = 9.63
	pointsOfPolynomialPlot[963].Y = -11.196

	pointsOfPolynomialPlot[964].X = 9.64
	pointsOfPolynomialPlot[964].Y = -11.192

	pointsOfPolynomialPlot[965].X = 9.65
	pointsOfPolynomialPlot[965].Y = -11.189

	pointsOfPolynomialPlot[966].X = 9.66
	pointsOfPolynomialPlot[966].Y = -11.185

	pointsOfPolynomialPlot[967].X = 9.67
	pointsOfPolynomialPlot[967].Y = -11.181

	pointsOfPolynomialPlot[968].X = 9.68
	pointsOfPolynomialPlot[968].Y = -11.177

	pointsOfPolynomialPlot[969].X = 9.69
	pointsOfPolynomialPlot[969].Y = -11.173

	pointsOfPolynomialPlot[970].X = 9.70
	pointsOfPolynomialPlot[970].Y = -11.168

	pointsOfPolynomialPlot[971].X = 9.71
	pointsOfPolynomialPlot[971].Y = -11.164

	pointsOfPolynomialPlot[972].X = 9.72
	pointsOfPolynomialPlot[972].Y = -11.16

	pointsOfPolynomialPlot[973].X = 9.73
	pointsOfPolynomialPlot[973].Y = -11.155

	pointsOfPolynomialPlot[974].X = 9.74
	pointsOfPolynomialPlot[974].Y = -11.15

	pointsOfPolynomialPlot[975].X = 9.75
	pointsOfPolynomialPlot[975].Y = -11.146

	pointsOfPolynomialPlot[976].X = 9.76
	pointsOfPolynomialPlot[976].Y = -11.141

	pointsOfPolynomialPlot[977].X = 9.77
	pointsOfPolynomialPlot[977].Y = -11.136

	pointsOfPolynomialPlot[978].X = 9.78
	pointsOfPolynomialPlot[978].Y = -11.131

	pointsOfPolynomialPlot[979].X = 9.79
	pointsOfPolynomialPlot[979].Y = -11.126

	pointsOfPolynomialPlot[980].X = 9.80
	pointsOfPolynomialPlot[980].Y = -11.121

	pointsOfPolynomialPlot[981].X = 9.81
	pointsOfPolynomialPlot[981].Y = -11.116

	pointsOfPolynomialPlot[982].X = 9.82
	pointsOfPolynomialPlot[982].Y = -11.111

	pointsOfPolynomialPlot[983].X = 9.83
	pointsOfPolynomialPlot[983].Y = -11.105

	pointsOfPolynomialPlot[984].X = 9.84
	pointsOfPolynomialPlot[984].Y = -11.1

	pointsOfPolynomialPlot[985].X = 9.85
	pointsOfPolynomialPlot[985].Y = -11.094

	pointsOfPolynomialPlot[986].X = 9.86
	pointsOfPolynomialPlot[986].Y = -11.088

	pointsOfPolynomialPlot[987].X = 9.87
	pointsOfPolynomialPlot[987].Y = -11.083

	pointsOfPolynomialPlot[988].X = 9.88
	pointsOfPolynomialPlot[988].Y = -11.077

	pointsOfPolynomialPlot[989].X = 9.89
	pointsOfPolynomialPlot[989].Y = -11.071

	pointsOfPolynomialPlot[990].X = 9.90
	pointsOfPolynomialPlot[990].Y = -11.065

	pointsOfPolynomialPlot[991].X = 9.91
	pointsOfPolynomialPlot[991].Y = -11.059

	pointsOfPolynomialPlot[992].X = 9.92
	pointsOfPolynomialPlot[992].Y = -11.053

	pointsOfPolynomialPlot[993].X = 9.93
	pointsOfPolynomialPlot[993].Y = -11.046

	pointsOfPolynomialPlot[994].X = 9.94
	pointsOfPolynomialPlot[994].Y = -11.04

	pointsOfPolynomialPlot[995].X = 9.95
	pointsOfPolynomialPlot[995].Y = -11.033

	pointsOfPolynomialPlot[996].X = 9.96
	pointsOfPolynomialPlot[996].Y = -11.027

	pointsOfPolynomialPlot[997].X = 9.97
	pointsOfPolynomialPlot[997].Y = -11.02

	pointsOfPolynomialPlot[998].X = 9.98
	pointsOfPolynomialPlot[998].Y = -11.013

	pointsOfPolynomialPlot[999].X = 9.99
	pointsOfPolynomialPlot[999].Y = -11.007

	pointsOfPolynomialPlot[1_000].X = 10.0
	pointsOfPolynomialPlot[1_000].Y = -11.0
	...
	polynomialPlot.Title.Text = "Plot of polynomial f(x) = 0.001x^4 - 0.01x^3 - 0.1x^2 + x"
	...
	if err := polynomialPlot.Save(10*vg.Inch, 10*vg.Inch,
		"Polynomial-function-plot-05.png"); err != nil {
