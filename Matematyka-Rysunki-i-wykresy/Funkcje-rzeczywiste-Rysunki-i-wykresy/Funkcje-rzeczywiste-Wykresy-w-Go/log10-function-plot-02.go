...
func main() {
	...
	pointsOfFunctionPlot[327].Y = 0.513

	pointsOfFunctionPlot[328].X = 3.28
	pointsOfFunctionPlot[328].Y = 0.514
	...
	pointsOfFunctionPlot[635].Y = 0.803
	...
	pointsOfFunctionPlot[693].Y = 0.841
	...
	pointsOfFunctionPlot[784].Y = 0.894
	...
	pointsOfFunctionPlot[889].Y = 0.949
	...
	pointsOfFunctionPlot[909].Y = 0.959
	...
	if err := plotOfFunction.Save(10*vg.Inch, 10*vg.Inch,
		"log10-function-plot-02.png"); err != nil {
