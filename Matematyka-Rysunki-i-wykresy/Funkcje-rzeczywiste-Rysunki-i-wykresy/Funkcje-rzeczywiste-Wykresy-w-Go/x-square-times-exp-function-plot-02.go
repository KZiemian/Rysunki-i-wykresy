...
func main() {
	// Plot of function f(x) = x^2 * exp(-(x - 1.0)).

	pointsOfFunctionPlot := make(plotter.XYs, 1_313)
	...
	pointsOfFunctionPlot[1_110].Y = 0.005

	pointsOfFunctionPlot[1_111].X = 11.11
	pointsOfFunctionPlot[1_111].Y = 0.005

	pointsOfFunctionPlot[1_112].X = 11.12
	pointsOfFunctionPlot[1_112].Y = 0.005

	pointsOfFunctionPlot[1_113].X = 11.13
	pointsOfFunctionPlot[1_113].Y = 0.004

	pointsOfFunctionPlot[1_114].X = 11.14
	pointsOfFunctionPlot[1_114].Y = 0.004

	pointsOfFunctionPlot[1_115].X = 11.15
	pointsOfFunctionPlot[1_115].Y = 0.004

	pointsOfFunctionPlot[1_116].X = 11.16
	pointsOfFunctionPlot[1_116].Y = 0.004

	pointsOfFunctionPlot[1_117].X = 11.17
	pointsOfFunctionPlot[1_117].Y = 0.004

	pointsOfFunctionPlot[1_118].X = 11.18
	pointsOfFunctionPlot[1_118].Y = 0.004

	pointsOfFunctionPlot[1_119].X = 11.19
	pointsOfFunctionPlot[1_119].Y = 0.004

	pointsOfFunctionPlot[1_120].X = 11.2
	pointsOfFunctionPlot[1_120].Y = 0.004

	pointsOfFunctionPlot[1_121].X = 11.21
	pointsOfFunctionPlot[1_121].Y = 0.004

	pointsOfFunctionPlot[1_122].X = 11.22
	pointsOfFunctionPlot[1_122].Y = 0.004

	pointsOfFunctionPlot[1_123].X = 11.23
	pointsOfFunctionPlot[1_123].Y = 0.004

	pointsOfFunctionPlot[1_124].X = 11.24
	pointsOfFunctionPlot[1_124].Y = 0.004

	pointsOfFunctionPlot[1_125].X = 11.25
	pointsOfFunctionPlot[1_125].Y = 0.004

	pointsOfFunctionPlot[1_126].X = 11.26
	pointsOfFunctionPlot[1_126].Y = 0.004

	pointsOfFunctionPlot[1_127].X = 11.27
	pointsOfFunctionPlot[1_127].Y = 0.004

	pointsOfFunctionPlot[1_128].X = 11.28
	pointsOfFunctionPlot[1_128].Y = 0.004

	pointsOfFunctionPlot[1_129].X = 11.29
	pointsOfFunctionPlot[1_129].Y = 0.004

	pointsOfFunctionPlot[1_130].X = 11.3
	pointsOfFunctionPlot[1_130].Y = 0.004

	pointsOfFunctionPlot[1_131].X = 11.31
	pointsOfFunctionPlot[1_131].Y = 0.004

	pointsOfFunctionPlot[1_132].X = 11.32
	pointsOfFunctionPlot[1_132].Y = 0.004

	pointsOfFunctionPlot[1_133].X = 11.33
	pointsOfFunctionPlot[1_133].Y = 0.004
	...
	pointsOfFunctionPlot[1_260].Y = 0.001

	pointsOfFunctionPlot[1_261].X = 12.61
	pointsOfFunctionPlot[1_261].Y = 0.001

	pointsOfFunctionPlot[1_262].X = 12.62
	pointsOfFunctionPlot[1_262].Y = 0.001

	pointsOfFunctionPlot[1_263].X = 12.63
	pointsOfFunctionPlot[1_263].Y = 0.001

	pointsOfFunctionPlot[1_264].X = 12.64
	pointsOfFunctionPlot[1_264].Y = 0.001

	pointsOfFunctionPlot[1_265].X = 12.65
	pointsOfFunctionPlot[1_265].Y = 0.001

	pointsOfFunctionPlot[1_266].X = 12.66
	pointsOfFunctionPlot[1_266].Y = 0.001

	pointsOfFunctionPlot[1_267].X = 12.67
	pointsOfFunctionPlot[1_267].Y = 0.001

	pointsOfFunctionPlot[1_268].X = 12.68
	pointsOfFunctionPlot[1_268].Y = 0.001

	pointsOfFunctionPlot[1_269].X = 12.69
	pointsOfFunctionPlot[1_269].Y = 0.001

	pointsOfFunctionPlot[1_270].X = 12.7
	pointsOfFunctionPlot[1_270].Y = 0.001

	pointsOfFunctionPlot[1_271].X = 12.71
	pointsOfFunctionPlot[1_271].Y = 0.001

	pointsOfFunctionPlot[1_272].X = 12.72
	pointsOfFunctionPlot[1_272].Y = 0.001

	pointsOfFunctionPlot[1_273].X = 12.73
	pointsOfFunctionPlot[1_273].Y = 0.001

	pointsOfFunctionPlot[1_274].X = 12.74
	pointsOfFunctionPlot[1_274].Y = 0.001

	pointsOfFunctionPlot[1_275].X = 12.75
	pointsOfFunctionPlot[1_275].Y = 0.001

	pointsOfFunctionPlot[1_276].X = 12.76
	pointsOfFunctionPlot[1_276].Y = 0.001

	pointsOfFunctionPlot[1_277].X = 12.77
	pointsOfFunctionPlot[1_277].Y = 0.001

	pointsOfFunctionPlot[1_278].X = 12.78
	pointsOfFunctionPlot[1_278].Y = 0.001

	pointsOfFunctionPlot[1_279].X = 12.79
	pointsOfFunctionPlot[1_279].Y = 0.001

	pointsOfFunctionPlot[1_280].X = 12.8
	pointsOfFunctionPlot[1_280].Y = 0.001

	pointsOfFunctionPlot[1_281].X = 12.81
	pointsOfFunctionPlot[1_281].Y = 0.001

	pointsOfFunctionPlot[1_282].X = 12.82
	pointsOfFunctionPlot[1_282].Y = 0.001

	pointsOfFunctionPlot[1_283].X = 12.83
	pointsOfFunctionPlot[1_283].Y = 0.001

	pointsOfFunctionPlot[1_284].X = 12.84
	pointsOfFunctionPlot[1_284].Y = 0.001

	pointsOfFunctionPlot[1_285].X = 12.85
	pointsOfFunctionPlot[1_285].Y = 0.001

	pointsOfFunctionPlot[1_286].X = 12.86
	pointsOfFunctionPlot[1_286].Y = 0.001

	pointsOfFunctionPlot[1_287].X = 12.87
	pointsOfFunctionPlot[1_287].Y = 0.001

	pointsOfFunctionPlot[1_288].X = 12.88
	pointsOfFunctionPlot[1_288].Y = 0.001

	pointsOfFunctionPlot[1_289].X = 12.89
	pointsOfFunctionPlot[1_289].Y = 0.001

	pointsOfFunctionPlot[1_290].X = 12.9
	pointsOfFunctionPlot[1_290].Y = 0.001

	pointsOfFunctionPlot[1_291].X = 12.91
	pointsOfFunctionPlot[1_291].Y = 0.001

	pointsOfFunctionPlot[1_292].X = 12.92
	pointsOfFunctionPlot[1_292].Y = 0.001

	pointsOfFunctionPlot[1_293].X = 12.93
	pointsOfFunctionPlot[1_293].Y = 0.001

	pointsOfFunctionPlot[1_294].X = 12.94
	pointsOfFunctionPlot[1_294].Y = 0.001

	pointsOfFunctionPlot[1_295].X = 12.95
	pointsOfFunctionPlot[1_295].Y = 0.001

	pointsOfFunctionPlot[1_296].X = 12.96
	pointsOfFunctionPlot[1_296].Y = 0.001

	pointsOfFunctionPlot[1_297].X = 12.97
	pointsOfFunctionPlot[1_297].Y = 0.001

	pointsOfFunctionPlot[1_298].X = 12.98
	pointsOfFunctionPlot[1_298].Y = 0.001

	pointsOfFunctionPlot[1_299].X = 12.99
	pointsOfFunctionPlot[1_299].Y = 0.001

	pointsOfFunctionPlot[1_300].X = 13.0
	pointsOfFunctionPlot[1_300].Y = 0.001
	...
	pointsOfFunctionPlot[1_303].Y = 0.001
	...
	pointsOfFunctionPlot[1_311].Y = 0.0

	pointsOfFunctionPlot[1_312].X = 14.0
	pointsOfFunctionPlot[1_312].Y = 0.0
	...
	plotOfFunction.Title.Text = "Plot of function f(x) = x^2 * exp(-(x - 1.0))"
	...
	if err := plotOfFunction.Save(10*vg.Inch, 10*vg.Inch,
		"x-square-times-exp-function-plot-02.png"); err != nil {
