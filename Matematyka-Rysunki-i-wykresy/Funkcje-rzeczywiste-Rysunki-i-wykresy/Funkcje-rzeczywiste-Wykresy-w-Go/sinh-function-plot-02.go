...
func main() {
	...
	pointsOfFunctionPlot[9].Y = -10_065.336
	...
	pointsOfFunctionPlot[16].Y = -9_384.857
	...
	pointsOfFunctionPlot[38].Y = -7_531.524
	...
	pointsOfFunctionPlot[52].Y = -6_574.593
	...
	pointsOfFunctionPlot[72].Y = -5_360.715
	...
	pointsOfFunctionPlot[87].Y = -4_614.01
	...
	pointsOfFunctionPlot[91].Y = -4_433.092

	pointsOfFunctionPlot[92].X = -9.08
	pointsOfFunctionPlot[92].Y = -4_388.982
	...
	pointsOfFunctionPlot[95].Y = -4_259.268
	...
	pointsOfFunctionPlot[120].Y = -3_317.121
	...
	pointsOfFunctionPlot[136].Y = -2_826.664
	...
	pointsOfFunctionPlot[147].Y = -2_532.222
	...
	pointsOfFunctionPlot[163].Y = -2_157.817
	...
	pointsOfFunctionPlot[186].Y = -1_714.458
	...
	pointsOfFunctionPlot[189].Y = -1_663.788

	pointsOfFunctionPlot[190].X = -8.10
	pointsOfFunctionPlot[190].Y = -1_647.233
	...
	pointsOfFunctionPlot[193].Y = -1_598.55

	pointsOfFunctionPlot[194].X = -8.06
	pointsOfFunctionPlot[194].Y = -1_582.644
	...
	pointsOfFunctionPlot[200].Y = -1_490.478
	...
	pointsOfFunctionPlot[210].Y = -1_348.64

	pointsOfFunctionPlot[211].X = -7.89
	pointsOfFunctionPlot[211].Y = -1_335.221
	...
	pointsOfFunctionPlot[214].Y = -1_295.759

	pointsOfFunctionPlot[215].X = -7.85
	pointsOfFunctionPlot[215].Y = -1_282.866
	...
	pointsOfFunctionPlot[220].Y = -1_220.3
	...
	pointsOfFunctionPlot[282].Y = -656.453

	pointsOfFunctionPlot[283].X = -7.17
	pointsOfFunctionPlot[283].Y = -649.921

	pointsOfFunctionPlot[284].X = -7.16
	pointsOfFunctionPlot[284].Y = -643.455

	pointsOfFunctionPlot[285].X = -7.15
	pointsOfFunctionPlot[285].Y = -637.052

	pointsOfFunctionPlot[286].X = -7.14
	pointsOfFunctionPlot[286].Y = -630.713

	pointsOfFunctionPlot[287].X = -7.13
	pointsOfFunctionPlot[287].Y = -624.438

	pointsOfFunctionPlot[288].X = -7.12
	pointsOfFunctionPlot[288].Y = -618.224

	pointsOfFunctionPlot[289].X = -7.11
	pointsOfFunctionPlot[289].Y = -612.073

	pointsOfFunctionPlot[290].X = -7.10
	pointsOfFunctionPlot[290].Y = -605.983

	pointsOfFunctionPlot[291].X = -7.09
	pointsOfFunctionPlot[291].Y = -599.953

	pointsOfFunctionPlot[292].X = -7.08
	pointsOfFunctionPlot[292].Y = -593.983

	pointsOfFunctionPlot[293].X = -7.07
	pointsOfFunctionPlot[293].Y = -588.073

	pointsOfFunctionPlot[294].X = -7.06
	pointsOfFunctionPlot[294].Y = -582.222

	pointsOfFunctionPlot[295].X = -7.05
	pointsOfFunctionPlot[295].Y = -576.428

	pointsOfFunctionPlot[296].X = -7.04
	pointsOfFunctionPlot[296].Y = -570.693

	pointsOfFunctionPlot[297].X = -7.03
	pointsOfFunctionPlot[297].Y = -565.014

	pointsOfFunctionPlot[298].X = -7.02
	pointsOfFunctionPlot[298].Y = -559.392

	pointsOfFunctionPlot[299].X = -7.01
	pointsOfFunctionPlot[299].Y = -553.826

	pointsOfFunctionPlot[300].X = -7.0
	pointsOfFunctionPlot[300].Y = -548.316

	pointsOfFunctionPlot[301].X = -6.99
	pointsOfFunctionPlot[301].Y = -542.86

	pointsOfFunctionPlot[302].X = -6.98
	pointsOfFunctionPlot[302].Y = -537.458

	pointsOfFunctionPlot[303].X = -6.97
	pointsOfFunctionPlot[303].Y = -532.11

	pointsOfFunctionPlot[304].X = -6.96
	pointsOfFunctionPlot[304].Y = -526.816

	pointsOfFunctionPlot[305].X = -6.95
	pointsOfFunctionPlot[305].Y = -521.574

	pointsOfFunctionPlot[306].X = -6.94
	pointsOfFunctionPlot[306].Y = -516.384

	pointsOfFunctionPlot[307].X = -6.93
	pointsOfFunctionPlot[307].Y = -511.246

	pointsOfFunctionPlot[308].X = -6.92
	pointsOfFunctionPlot[308].Y = -506.159

	pointsOfFunctionPlot[309].X = -6.91
	pointsOfFunctionPlot[309].Y = -501.123

	pointsOfFunctionPlot[310].X = -6.90
	pointsOfFunctionPlot[310].Y = -496.136

	pointsOfFunctionPlot[311].X = -6.89
	pointsOfFunctionPlot[311].Y = -491.2

	pointsOfFunctionPlot[312].X = -6.88
	pointsOfFunctionPlot[312].Y = -486.312

	pointsOfFunctionPlot[313].X = -6.87
	pointsOfFunctionPlot[313].Y = -481.473

	pointsOfFunctionPlot[314].X = -6.86
	pointsOfFunctionPlot[314].Y = -476.683

	pointsOfFunctionPlot[315].X = -6.85
	pointsOfFunctionPlot[315].Y = -471.939

	pointsOfFunctionPlot[316].X = -6.84
	pointsOfFunctionPlot[316].Y = -467.244

	pointsOfFunctionPlot[317].X = -6.83
	pointsOfFunctionPlot[317].Y = -462.594

	pointsOfFunctionPlot[318].X = -6.82
	pointsOfFunctionPlot[318].Y = -457.991

	pointsOfFunctionPlot[319].X = -6.81
	pointsOfFunctionPlot[319].Y = -453.434

	pointsOfFunctionPlot[320].X = -6.80
	pointsOfFunctionPlot[320].Y = -448.923

	pointsOfFunctionPlot[321].X = -6.79
	pointsOfFunctionPlot[321].Y = -444.456

	pointsOfFunctionPlot[322].X = -6.78
	pointsOfFunctionPlot[322].Y = -440.033

	pointsOfFunctionPlot[323].X = -6.77
	pointsOfFunctionPlot[323].Y = -435.655

	pointsOfFunctionPlot[324].X = -6.76
	pointsOfFunctionPlot[324].Y = -431.32

	pointsOfFunctionPlot[325].X = -6.75
	pointsOfFunctionPlot[325].Y = -427.028

	pointsOfFunctionPlot[326].X = -6.74
	pointsOfFunctionPlot[326].Y = -422.779

	pointsOfFunctionPlot[327].X = -6.73
	pointsOfFunctionPlot[327].Y = -418.573

	pointsOfFunctionPlot[328].X = -6.72
	pointsOfFunctionPlot[328].Y = -414.408

	pointsOfFunctionPlot[329].X = -6.71
	pointsOfFunctionPlot[329].Y = -410.284

	pointsOfFunctionPlot[330].X = -6.70
	pointsOfFunctionPlot[330].Y = -406.202

	pointsOfFunctionPlot[331].X = -6.69
	pointsOfFunctionPlot[331].Y = -402.16

	pointsOfFunctionPlot[332].X = -6.68
	pointsOfFunctionPlot[332].Y = -398.158

	pointsOfFunctionPlot[333].X = -6.67
	pointsOfFunctionPlot[333].Y = -394.197

	pointsOfFunctionPlot[334].X = -6.66
	pointsOfFunctionPlot[334].Y = -390.274

	pointsOfFunctionPlot[335].X = -6.65
	pointsOfFunctionPlot[335].Y = -386.391

	pointsOfFunctionPlot[336].X = -6.64
	pointsOfFunctionPlot[336].Y = -382.546

	pointsOfFunctionPlot[337].X = -6.63
	pointsOfFunctionPlot[337].Y = -378.74

	pointsOfFunctionPlot[338].X = -6.62
	pointsOfFunctionPlot[338].Y = -374.971

	pointsOfFunctionPlot[339].X = -6.61
	pointsOfFunctionPlot[339].Y = -371.24

	pointsOfFunctionPlot[340].X = -6.60
	pointsOfFunctionPlot[340].Y = -367.546

	pointsOfFunctionPlot[341].X = -6.59
	pointsOfFunctionPlot[341].Y = -363.889

	pointsOfFunctionPlot[342].X = -6.58
	pointsOfFunctionPlot[342].Y = -360.268

	pointsOfFunctionPlot[343].X = -6.57
	pointsOfFunctionPlot[343].Y = -356.684

	pointsOfFunctionPlot[344].X = -6.56
	pointsOfFunctionPlot[344].Y = -353.135

	pointsOfFunctionPlot[345].X = -6.55
	pointsOfFunctionPlot[345].Y = -349.621

	pointsOfFunctionPlot[346].X = -6.54
	pointsOfFunctionPlot[346].Y = -346.142

	pointsOfFunctionPlot[347].X = -6.53
	pointsOfFunctionPlot[347].Y = -342.698

	pointsOfFunctionPlot[348].X = -6.52
	pointsOfFunctionPlot[348].Y = -339.288

	pointsOfFunctionPlot[349].X = -6.51
	pointsOfFunctionPlot[349].Y = -335.912

	pointsOfFunctionPlot[350].X = -6.50
	pointsOfFunctionPlot[350].Y = -332.57

	pointsOfFunctionPlot[351].X = -6.49
	pointsOfFunctionPlot[351].Y = -329.26

	pointsOfFunctionPlot[352].X = -6.48
	pointsOfFunctionPlot[352].Y = -325.984

	pointsOfFunctionPlot[353].X = -6.47
	pointsOfFunctionPlot[353].Y = -322.741

	pointsOfFunctionPlot[354].X = -6.46
	pointsOfFunctionPlot[354].Y = -319.529

	pointsOfFunctionPlot[355].X = -6.45
	pointsOfFunctionPlot[355].Y = -316.35

	pointsOfFunctionPlot[356].X = -6.44
	pointsOfFunctionPlot[356].Y = -313.202

	pointsOfFunctionPlot[357].X = -6.43
	pointsOfFunctionPlot[357].Y = -310.086

	pointsOfFunctionPlot[358].X = -6.42
	pointsOfFunctionPlot[358].Y = -307.0

	pointsOfFunctionPlot[359].X = -6.41
	pointsOfFunctionPlot[359].Y = -303.946

	pointsOfFunctionPlot[360].X = -6.40
	pointsOfFunctionPlot[360].Y = -300.921

	pointsOfFunctionPlot[361].X = -6.39
	pointsOfFunctionPlot[361].Y = -297.927

	pointsOfFunctionPlot[362].X = -6.38
	pointsOfFunctionPlot[362].Y = -294.963

	pointsOfFunctionPlot[363].X = -6.37
	pointsOfFunctionPlot[363].Y = -292.028

	pointsOfFunctionPlot[364].X = -6.36
	pointsOfFunctionPlot[364].Y = -289.122

	pointsOfFunctionPlot[365].X = -6.35
	pointsOfFunctionPlot[365].Y = -286.245

	pointsOfFunctionPlot[366].X = -6.34
	pointsOfFunctionPlot[366].Y = -283.397

	pointsOfFunctionPlot[367].X = -6.33
	pointsOfFunctionPlot[367].Y = -280.577

	pointsOfFunctionPlot[368].X = -6.32
	pointsOfFunctionPlot[368].Y = -277.785

	pointsOfFunctionPlot[369].X = -6.31
	pointsOfFunctionPlot[369].Y = -275.021

	pointsOfFunctionPlot[370].X = -6.30
	pointsOfFunctionPlot[370].Y = -272.285

	pointsOfFunctionPlot[371].X = -6.29
	pointsOfFunctionPlot[371].Y = -269.575

	pointsOfFunctionPlot[372].X = -6.28
	pointsOfFunctionPlot[372].Y = -266.893

	pointsOfFunctionPlot[373].X = -6.27
	pointsOfFunctionPlot[373].Y = -264.237

	pointsOfFunctionPlot[374].X = -6.26
	pointsOfFunctionPlot[374].Y = -261.608

	pointsOfFunctionPlot[375].X = -6.25
	pointsOfFunctionPlot[375].Y = -259.005

	pointsOfFunctionPlot[376].X = -6.24
	pointsOfFunctionPlot[376].Y = -256.428

	pointsOfFunctionPlot[377].X = -6.23
	pointsOfFunctionPlot[377].Y = -253.876

	pointsOfFunctionPlot[378].X = -6.22
	pointsOfFunctionPlot[378].Y = -251.35

	pointsOfFunctionPlot[379].X = -6.21
	pointsOfFunctionPlot[379].Y = -248.849

	pointsOfFunctionPlot[380].X = -6.20
	pointsOfFunctionPlot[380].Y = -246.373

	pointsOfFunctionPlot[381].X = -6.19
	pointsOfFunctionPlot[381].Y = -243.922

	pointsOfFunctionPlot[382].X = -6.18
	pointsOfFunctionPlot[382].Y = -241.494

	pointsOfFunctionPlot[383].X = -6.17
	pointsOfFunctionPlot[383].Y = -239.092

	pointsOfFunctionPlot[384].X = -6.16
	pointsOfFunctionPlot[384].Y = -236.712

	pointsOfFunctionPlot[385].X = -6.15
	pointsOfFunctionPlot[385].Y = -234.357

	pointsOfFunctionPlot[386].X = -6.14
	pointsOfFunctionPlot[386].Y = -232.025

	pointsOfFunctionPlot[387].X = -6.13
	pointsOfFunctionPlot[387].Y = -229.716

	pointsOfFunctionPlot[388].X = -6.12
	pointsOfFunctionPlot[388].Y = -227.431

	pointsOfFunctionPlot[389].X = -6.11
	pointsOfFunctionPlot[389].Y = -225.168

	pointsOfFunctionPlot[390].X = -6.10
	pointsOfFunctionPlot[390].Y = -222.927

	pointsOfFunctionPlot[391].X = -6.09
	pointsOfFunctionPlot[391].Y = -220.709

	pointsOfFunctionPlot[392].X = -6.08
	pointsOfFunctionPlot[392].Y = -218.513

	pointsOfFunctionPlot[393].X = -6.07
	pointsOfFunctionPlot[393].Y = -216.339

	pointsOfFunctionPlot[394].X = -6.06
	pointsOfFunctionPlot[394].Y = -214.186

	pointsOfFunctionPlot[395].X = -6.05
	pointsOfFunctionPlot[395].Y = -212.055

	pointsOfFunctionPlot[396].X = -6.04
	pointsOfFunctionPlot[396].Y = -209.945

	pointsOfFunctionPlot[397].X = -6.03
	pointsOfFunctionPlot[397].Y = -207.856

	pointsOfFunctionPlot[398].X = -6.02
	pointsOfFunctionPlot[398].Y = -205.788

	pointsOfFunctionPlot[399].X = -6.01
	pointsOfFunctionPlot[399].Y = -203.74

	pointsOfFunctionPlot[400].X = -6.0
	pointsOfFunctionPlot[400].Y = -201.713

	pointsOfFunctionPlot[401].X = -5.99
	pointsOfFunctionPlot[401].Y = -199.706

	pointsOfFunctionPlot[402].X = -5.98
	pointsOfFunctionPlot[402].Y = -197.718

	pointsOfFunctionPlot[403].X = -5.97
	pointsOfFunctionPlot[403].Y = -195.751

	pointsOfFunctionPlot[404].X = -5.96
	pointsOfFunctionPlot[404].Y = -193.803

	pointsOfFunctionPlot[405].X = -5.95
	pointsOfFunctionPlot[405].Y = -191.875

	pointsOfFunctionPlot[406].X = -5.94
	pointsOfFunctionPlot[406].Y = -189.966

	pointsOfFunctionPlot[407].X = -5.93
	pointsOfFunctionPlot[407].Y = -188.075

	pointsOfFunctionPlot[408].X = -5.92
	pointsOfFunctionPlot[408].Y = -186.204

	pointsOfFunctionPlot[409].X = -5.91
	pointsOfFunctionPlot[409].Y = -184.351

	pointsOfFunctionPlot[410].X = -5.90
	pointsOfFunctionPlot[410].Y = -182.517

	pointsOfFunctionPlot[411].X = -5.89
	pointsOfFunctionPlot[411].Y = -180.701

	pointsOfFunctionPlot[412].X = -5.88
	pointsOfFunctionPlot[412].Y = -178.903

	pointsOfFunctionPlot[413].X = -5.87
	pointsOfFunctionPlot[413].Y = -177.123

	pointsOfFunctionPlot[414].X = -5.86
	pointsOfFunctionPlot[414].Y = -175.36

	pointsOfFunctionPlot[415].X = -5.85
	pointsOfFunctionPlot[415].Y = -173.615

	pointsOfFunctionPlot[416].X = -5.84
	pointsOfFunctionPlot[416].Y = -171.888

	pointsOfFunctionPlot[417].X = -5.83
	pointsOfFunctionPlot[417].Y = -170.177

	pointsOfFunctionPlot[418].X = -5.82
	pointsOfFunctionPlot[418].Y = -168.484

	pointsOfFunctionPlot[419].X = -5.81
	pointsOfFunctionPlot[419].Y = -166.808

	pointsOfFunctionPlot[420].X = -5.80
	pointsOfFunctionPlot[420].Y = -165.148

	pointsOfFunctionPlot[421].X = -5.79
	pointsOfFunctionPlot[421].Y = -163.504

	pointsOfFunctionPlot[422].X = -5.78
	pointsOfFunctionPlot[422].Y = -161.878

	pointsOfFunctionPlot[423].X = -5.77
	pointsOfFunctionPlot[423].Y = -160.267

	pointsOfFunctionPlot[424].X = -5.76
	pointsOfFunctionPlot[424].Y = -158.672

	pointsOfFunctionPlot[425].X = -5.75
	pointsOfFunctionPlot[425].Y = -157.093

	pointsOfFunctionPlot[426].X = -5.74
	pointsOfFunctionPlot[426].Y = -155.53

	pointsOfFunctionPlot[427].X = -5.73
	pointsOfFunctionPlot[427].Y = -153.983

	pointsOfFunctionPlot[428].X = -5.72
	pointsOfFunctionPlot[428].Y = -152.45

	pointsOfFunctionPlot[429].X = -5.71
	pointsOfFunctionPlot[429].Y = -150.933

	pointsOfFunctionPlot[430].X = -5.70
	pointsOfFunctionPlot[430].Y = -149.432

	pointsOfFunctionPlot[431].X = -5.69
	pointsOfFunctionPlot[431].Y = -147.945

	pointsOfFunctionPlot[432].X = -5.68
	pointsOfFunctionPlot[432].Y = -146.473

	pointsOfFunctionPlot[433].X = -5.67
	pointsOfFunctionPlot[433].Y = -145.015

	pointsOfFunctionPlot[434].X = -5.66
	pointsOfFunctionPlot[434].Y = -143.572

	pointsOfFunctionPlot[435].X = -5.65
	pointsOfFunctionPlot[435].Y = -142.143

	pointsOfFunctionPlot[436].X = -5.64
	pointsOfFunctionPlot[436].Y = -140.729

	pointsOfFunctionPlot[437].X = -5.63
	pointsOfFunctionPlot[437].Y = -139.329

	pointsOfFunctionPlot[438].X = -5.62
	pointsOfFunctionPlot[438].Y = -137.942

	pointsOfFunctionPlot[439].X = -5.61
	pointsOfFunctionPlot[439].Y = -136.57

	pointsOfFunctionPlot[440].X = -5.60
	pointsOfFunctionPlot[440].Y = -135.211

	pointsOfFunctionPlot[441].X = -5.59
	pointsOfFunctionPlot[441].Y = -133.865

	pointsOfFunctionPlot[442].X = -5.58
	pointsOfFunctionPlot[442].Y = -132.533

	pointsOfFunctionPlot[443].X = -5.57
	pointsOfFunctionPlot[443].Y = -131.215

	pointsOfFunctionPlot[444].X = -5.56
	pointsOfFunctionPlot[444].Y = -129.909

	pointsOfFunctionPlot[445].X = -5.55
	pointsOfFunctionPlot[445].Y = -128.616

	pointsOfFunctionPlot[446].X = -5.54
	pointsOfFunctionPlot[446].Y = -127.337

	pointsOfFunctionPlot[447].X = -5.53
	pointsOfFunctionPlot[447].Y = -126.069

	pointsOfFunctionPlot[448].X = -5.52
	pointsOfFunctionPlot[448].Y = -124.815

	pointsOfFunctionPlot[449].X = -5.51
	pointsOfFunctionPlot[449].Y = -123.573

	pointsOfFunctionPlot[450].X = -5.50
	pointsOfFunctionPlot[450].Y = -122.343

	pointsOfFunctionPlot[451].X = -5.49
	pointsOfFunctionPlot[451].Y = -121.126

	pointsOfFunctionPlot[452].X = -5.48
	pointsOfFunctionPlot[452].Y = -119.921

	pointsOfFunctionPlot[453].X = -5.47
	pointsOfFunctionPlot[453].Y = -118.727

	pointsOfFunctionPlot[454].X = -5.46
	pointsOfFunctionPlot[454].Y = -117.546

	pointsOfFunctionPlot[455].X = -5.45
	pointsOfFunctionPlot[455].Y = -116.376

	pointsOfFunctionPlot[456].X = -5.44
	pointsOfFunctionPlot[456].Y = -115.218

	pointsOfFunctionPlot[457].X = -5.43
	pointsOfFunctionPlot[457].Y = -114.072

	pointsOfFunctionPlot[458].X = -5.42
	pointsOfFunctionPlot[458].Y = -112.937

	pointsOfFunctionPlot[459].X = -5.41
	pointsOfFunctionPlot[459].Y = -111.813

	pointsOfFunctionPlot[460].X = -5.40
	pointsOfFunctionPlot[460].Y = -110.7

	pointsOfFunctionPlot[461].X = -5.39
	pointsOfFunctionPlot[461].Y = -109.599

	pointsOfFunctionPlot[462].X = -5.38
	pointsOfFunctionPlot[462].Y = -108.508

	pointsOfFunctionPlot[463].X = -5.37
	pointsOfFunctionPlot[463].Y = -107.429

	pointsOfFunctionPlot[464].X = -5.36
	pointsOfFunctionPlot[464].Y = -106.36

	pointsOfFunctionPlot[465].X = -5.35
	pointsOfFunctionPlot[465].Y = -105.301

	pointsOfFunctionPlot[466].X = -5.34
	pointsOfFunctionPlot[466].Y = -104.253

	pointsOfFunctionPlot[467].X = -5.33
	pointsOfFunctionPlot[467].Y = -103.216

	pointsOfFunctionPlot[468].X = -5.32
	pointsOfFunctionPlot[468].Y = -102.189

	pointsOfFunctionPlot[469].X = -5.31
	pointsOfFunctionPlot[469].Y = -101.172

	pointsOfFunctionPlot[470].X = -5.30
	pointsOfFunctionPlot[470].Y = -100.165

	pointsOfFunctionPlot[471].X = -5.29
	pointsOfFunctionPlot[471].Y = -99.169

	pointsOfFunctionPlot[472].X = -5.28
	pointsOfFunctionPlot[472].Y = -98.182

	pointsOfFunctionPlot[473].X = -5.27
	pointsOfFunctionPlot[473].Y = -97.205

	pointsOfFunctionPlot[474].X = -5.26
	pointsOfFunctionPlot[474].Y = -96.238

	pointsOfFunctionPlot[475].X = -5.25
	pointsOfFunctionPlot[475].Y = -95.28

	pointsOfFunctionPlot[476].X = -5.24
	pointsOfFunctionPlot[476].Y = -94.332

	pointsOfFunctionPlot[477].X = -5.23
	pointsOfFunctionPlot[477].Y = -93.393

	pointsOfFunctionPlot[478].X = -5.22
	pointsOfFunctionPlot[478].Y = -92.464

	pointsOfFunctionPlot[479].X = -5.21
	pointsOfFunctionPlot[479].Y = -91.544

	pointsOfFunctionPlot[480].X = -5.20
	pointsOfFunctionPlot[480].Y = -90.633

	pointsOfFunctionPlot[481].X = -5.19
	pointsOfFunctionPlot[481].Y = -89.731

	pointsOfFunctionPlot[482].X = -5.18
	pointsOfFunctionPlot[482].Y = -88.838

	pointsOfFunctionPlot[483].X = -5.17
	pointsOfFunctionPlot[483].Y = -87.954

	pointsOfFunctionPlot[484].X = -5.16
	pointsOfFunctionPlot[484].Y = -87.079

	pointsOfFunctionPlot[485].X = -5.15
	pointsOfFunctionPlot[485].Y = -86.212

	pointsOfFunctionPlot[486].X = -5.14
	pointsOfFunctionPlot[486].Y = -85.354

	pointsOfFunctionPlot[487].X = -5.13
	pointsOfFunctionPlot[487].Y = -84.505

	pointsOfFunctionPlot[488].X = -5.12
	pointsOfFunctionPlot[488].Y = -83.664

	pointsOfFunctionPlot[489].X = -5.11
	pointsOfFunctionPlot[489].Y = -82.832

	pointsOfFunctionPlot[490].X = -5.10
	pointsOfFunctionPlot[490].Y = -82.007

	pointsOfFunctionPlot[491].X = -5.09
	pointsOfFunctionPlot[491].Y = -81.191

	pointsOfFunctionPlot[492].X = -5.08
	pointsOfFunctionPlot[492].Y = -80.383

	pointsOfFunctionPlot[493].X = -5.07
	pointsOfFunctionPlot[493].Y = -79.584

	pointsOfFunctionPlot[494].X = -5.06
	pointsOfFunctionPlot[494].Y = -78.792

	pointsOfFunctionPlot[495].X = -5.05
	pointsOfFunctionPlot[495].Y = -78.008

	pointsOfFunctionPlot[496].X = -5.04
	pointsOfFunctionPlot[496].Y = -77.231

	pointsOfFunctionPlot[497].X = -5.03
	pointsOfFunctionPlot[497].Y = -76.463

	pointsOfFunctionPlot[498].X = -5.02
	pointsOfFunctionPlot[498].Y = -75.702

	pointsOfFunctionPlot[499].X = -5.01
	pointsOfFunctionPlot[499].Y = -74.949

	pointsOfFunctionPlot[500].X = -5.0
	pointsOfFunctionPlot[500].Y = -74.203

	pointsOfFunctionPlot[501].X = -4.99
	pointsOfFunctionPlot[501].Y = -73.464

	pointsOfFunctionPlot[502].X = -4.98
	pointsOfFunctionPlot[502].Y = -72.733

	pointsOfFunctionPlot[503].X = -4.97
	pointsOfFunctionPlot[503].Y = -72.009

	pointsOfFunctionPlot[504].X = -4.96
	pointsOfFunctionPlot[504].Y = -71.293

	pointsOfFunctionPlot[505].X = -4.95
	pointsOfFunctionPlot[505].Y = -70.538

	pointsOfFunctionPlot[506].X = -4.94
	pointsOfFunctionPlot[506].Y = -69.881

	pointsOfFunctionPlot[507].X = -4.93
	pointsOfFunctionPlot[507].Y = -69.186

	pointsOfFunctionPlot[508].X = -4.92
	pointsOfFunctionPlot[508].Y = -68.497

	pointsOfFunctionPlot[509].X = -4.91
	pointsOfFunctionPlot[509].Y = -67.817

	pointsOfFunctionPlot[510].X = -4.90
	pointsOfFunctionPlot[510].Y = -67.141

	pointsOfFunctionPlot[511].X = -4.89
	pointsOfFunctionPlot[511].Y = -66.473

	pointsOfFunctionPlot[512].X = -4.88
	pointsOfFunctionPlot[512].Y = -65.811

	pointsOfFunctionPlot[513].X = -4.87
	pointsOfFunctionPlot[513].Y = -65.156

	pointsOfFunctionPlot[514].X = -4.86
	pointsOfFunctionPlot[514].Y = -64.508

	pointsOfFunctionPlot[515].X = -4.85
	pointsOfFunctionPlot[515].Y = -63.866

	pointsOfFunctionPlot[516].X = -4.84
	pointsOfFunctionPlot[516].Y = -63.23

	pointsOfFunctionPlot[517].X = -4.83
	pointsOfFunctionPlot[517].Y = -62.601

	pointsOfFunctionPlot[518].X = -4.82
	pointsOfFunctionPlot[518].Y = -61.978

	pointsOfFunctionPlot[519].X = -4.81
	pointsOfFunctionPlot[519].Y = -61.361

	pointsOfFunctionPlot[520].X = -4.80
	pointsOfFunctionPlot[520].Y = -60.751

	pointsOfFunctionPlot[521].X = -4.79
	pointsOfFunctionPlot[521].Y = -60.146

	pointsOfFunctionPlot[522].X = -4.78
	pointsOfFunctionPlot[522].Y = -59.547

	pointsOfFunctionPlot[523].X = -4.77
	pointsOfFunctionPlot[523].Y = -58.955

	pointsOfFunctionPlot[524].X = -4.76
	pointsOfFunctionPlot[524].Y = -58.368

	pointsOfFunctionPlot[525].X = -4.75
	pointsOfFunctionPlot[525].Y = -57.787

	pointsOfFunctionPlot[526].X = -4.74
	pointsOfFunctionPlot[526].Y = -57.212

	pointsOfFunctionPlot[527].X = -4.73
	pointsOfFunctionPlot[527].Y = -56.643

	pointsOfFunctionPlot[528].X = -4.72
	pointsOfFunctionPlot[528].Y = -56.079

	pointsOfFunctionPlot[529].X = -4.71
	pointsOfFunctionPlot[529].Y = -55.521

	pointsOfFunctionPlot[530].X = -4.70
	pointsOfFunctionPlot[530].Y = -54.969

	pointsOfFunctionPlot[531].X = -4.69
	pointsOfFunctionPlot[531].Y = -54.421

	pointsOfFunctionPlot[532].X = -4.68
	pointsOfFunctionPlot[532].Y = -53.88

	pointsOfFunctionPlot[533].X = -4.67
	pointsOfFunctionPlot[533].Y = -53.344

	pointsOfFunctionPlot[534].X = -4.66
	pointsOfFunctionPlot[534].Y = -52.813

	pointsOfFunctionPlot[535].X = -4.65
	pointsOfFunctionPlot[535].Y = -52.287

	pointsOfFunctionPlot[536].X = -4.64
	pointsOfFunctionPlot[536].Y = -51.767

	pointsOfFunctionPlot[537].X = -4.63
	pointsOfFunctionPlot[537].Y = -51.252

	pointsOfFunctionPlot[538].X = -4.62
	pointsOfFunctionPlot[538].Y = -50.742

	pointsOfFunctionPlot[539].X = -4.61
	pointsOfFunctionPlot[539].Y = -50.237

	pointsOfFunctionPlot[540].X = -4.60
	pointsOfFunctionPlot[540].Y = -49.737

	pointsOfFunctionPlot[541].X = -4.59
	pointsOfFunctionPlot[541].Y = -49.242

	pointsOfFunctionPlot[542].X = -4.58
	pointsOfFunctionPlot[542].Y = -48.752

	pointsOfFunctionPlot[543].X = -4.57
	pointsOfFunctionPlot[543].Y = -48.266

	pointsOfFunctionPlot[544].X = -4.56
	pointsOfFunctionPlot[544].Y = -47.786

	pointsOfFunctionPlot[545].X = -4.55
	pointsOfFunctionPlot[545].Y = -47.31

	pointsOfFunctionPlot[546].X = -4.54
	pointsOfFunctionPlot[546].Y = -46.84

	pointsOfFunctionPlot[547].X = -4.53
	pointsOfFunctionPlot[547].Y = -46.373

	pointsOfFunctionPlot[548].X = -4.52
	pointsOfFunctionPlot[548].Y = -45.912

	pointsOfFunctionPlot[549].X = -4.51
	pointsOfFunctionPlot[549].Y = -45.455

	pointsOfFunctionPlot[550].X = -4.50
	pointsOfFunctionPlot[550].Y = -45.003

	pointsOfFunctionPlot[551].X = -4.49
	pointsOfFunctionPlot[551].Y = -44.555

	pointsOfFunctionPlot[552].X = -4.48
	pointsOfFunctionPlot[552].Y = -44.111

	pointsOfFunctionPlot[553].X = -4.47
	pointsOfFunctionPlot[553].Y = -43.672

	pointsOfFunctionPlot[554].X = -4.46
	pointsOfFunctionPlot[554].Y = -43.237

	pointsOfFunctionPlot[555].X = -4.45
	pointsOfFunctionPlot[555].Y = -42.807

	pointsOfFunctionPlot[556].X = -4.44
	pointsOfFunctionPlot[556].Y = -42.381

	pointsOfFunctionPlot[557].X = -4.43
	pointsOfFunctionPlot[557].Y = -41.959

	pointsOfFunctionPlot[558].X = -4.42
	pointsOfFunctionPlot[558].Y = -41.542

	pointsOfFunctionPlot[559].X = -4.41
	pointsOfFunctionPlot[559].Y = -41.128

	pointsOfFunctionPlot[560].X = -4.40
	pointsOfFunctionPlot[560].Y = -40.719

	pointsOfFunctionPlot[561].X = -4.39
	pointsOfFunctionPlot[561].Y = -40.314

	pointsOfFunctionPlot[562].X = -4.38
	pointsOfFunctionPlot[562].Y = -39.912

	pointsOfFunctionPlot[563].X = -4.37
	pointsOfFunctionPlot[563].Y = -39.515

	pointsOfFunctionPlot[564].X = -4.36
	pointsOfFunctionPlot[564].Y = -39.122

	pointsOfFunctionPlot[565].X = -4.35
	pointsOfFunctionPlot[565].Y = -38.732

	pointsOfFunctionPlot[566].X = -4.34
	pointsOfFunctionPlot[566].Y = -38.347

	pointsOfFunctionPlot[567].X = -4.33
	pointsOfFunctionPlot[567].Y = -37.965

	pointsOfFunctionPlot[568].X = -4.32
	pointsOfFunctionPlot[568].Y = -37.587

	pointsOfFunctionPlot[569].X = -4.31
	pointsOfFunctionPlot[569].Y = -37.213

	pointsOfFunctionPlot[570].X = -4.30
	pointsOfFunctionPlot[570].Y = -36.843

	pointsOfFunctionPlot[571].X = -4.29
	pointsOfFunctionPlot[571].Y = -36.476

	pointsOfFunctionPlot[572].X = -4.28
	pointsOfFunctionPlot[572].Y = -36.113

	pointsOfFunctionPlot[573].X = -4.27
	pointsOfFunctionPlot[573].Y = -35.753

	pointsOfFunctionPlot[574].X = -4.26
	pointsOfFunctionPlot[574].Y = -35.397

	pointsOfFunctionPlot[575].X = -4.25
	pointsOfFunctionPlot[575].Y = -35.045

	pointsOfFunctionPlot[576].X = -4.24
	pointsOfFunctionPlot[576].Y = -34.696

	pointsOfFunctionPlot[577].X = -4.23
	pointsOfFunctionPlot[577].Y = -34.351

	pointsOfFunctionPlot[578].X = -4.22
	pointsOfFunctionPlot[578].Y = -34.009

	pointsOfFunctionPlot[579].X = -4.21
	pointsOfFunctionPlot[579].Y = -33.67

	pointsOfFunctionPlot[580].X = -4.20
	pointsOfFunctionPlot[580].Y = -33.335

	pointsOfFunctionPlot[581].X = -4.19
	pointsOfFunctionPlot[581].Y = -33.003

	pointsOfFunctionPlot[582].X = -4.18
	pointsOfFunctionPlot[582].Y = -32.675

	pointsOfFunctionPlot[583].X = -4.17
	pointsOfFunctionPlot[583].Y = -32.349

	pointsOfFunctionPlot[584].X = -4.16
	pointsOfFunctionPlot[584].Y = -32.027

	pointsOfFunctionPlot[585].X = -4.15
	pointsOfFunctionPlot[585].Y = -31.709

	pointsOfFunctionPlot[586].X = -4.14
	pointsOfFunctionPlot[586].Y = -31.393

	pointsOfFunctionPlot[587].X = -4.13
	pointsOfFunctionPlot[587].Y = -31.08

	pointsOfFunctionPlot[588].X = -4.12
	pointsOfFunctionPlot[588].Y = -30.771

	pointsOfFunctionPlot[589].X = -4.11
	pointsOfFunctionPlot[589].Y = -30.465

	pointsOfFunctionPlot[590].X = -4.10
	pointsOfFunctionPlot[590].Y = -30.161

	pointsOfFunctionPlot[591].X = -4.09
	pointsOfFunctionPlot[591].Y = -29.861

	pointsOfFunctionPlot[592].X = -4.08
	pointsOfFunctionPlot[592].Y = -29.564

	pointsOfFunctionPlot[593].X = -4.07
	pointsOfFunctionPlot[593].Y = -29.269

	pointsOfFunctionPlot[594].X = -4.06
	pointsOfFunctionPlot[594].Y = -28.978

	pointsOfFunctionPlot[595].X = -4.05
	pointsOfFunctionPlot[595].Y = -28.69

	pointsOfFunctionPlot[596].X = -4.04
	pointsOfFunctionPlot[596].Y = -28.404

	pointsOfFunctionPlot[597].X = -4.03
	pointsOfFunctionPlot[597].Y = -28.121

	pointsOfFunctionPlot[598].X = -4.02
	pointsOfFunctionPlot[598].Y = -27.841

	pointsOfFunctionPlot[599].X = -4.01
	pointsOfFunctionPlot[599].Y = -27.564

	pointsOfFunctionPlot[600].X = -4.0
	pointsOfFunctionPlot[600].Y = -27.289

	pointsOfFunctionPlot[601].X = -3.99
	pointsOfFunctionPlot[601].Y = -27.018

	pointsOfFunctionPlot[602].X = -3.98
	pointsOfFunctionPlot[602].Y = -26.749

	pointsOfFunctionPlot[603].X = -3.97
	pointsOfFunctionPlot[603].Y = -26.482

	pointsOfFunctionPlot[604].X = -3.96
	pointsOfFunctionPlot[604].Y = -26.219

	pointsOfFunctionPlot[605].X = -3.95
	pointsOfFunctionPlot[605].Y = -25.958

	pointsOfFunctionPlot[606].X = -3.94
	pointsOfFunctionPlot[606].Y = -25.699

	pointsOfFunctionPlot[607].X = -3.93
	pointsOfFunctionPlot[607].Y = -25.443

	pointsOfFunctionPlot[608].X = -3.92
	pointsOfFunctionPlot[608].Y = -25.19

	pointsOfFunctionPlot[609].X = -3.91
	pointsOfFunctionPlot[609].Y = -24.939

	pointsOfFunctionPlot[610].X = -3.90
	pointsOfFunctionPlot[610].Y = -24.691

	pointsOfFunctionPlot[611].X = -3.89
	pointsOfFunctionPlot[611].Y = -24.445

	pointsOfFunctionPlot[612].X = -3.88
	pointsOfFunctionPlot[612].Y = -24.201

	pointsOfFunctionPlot[613].X = -3.87
	pointsOfFunctionPlot[613].Y = -23.96

	pointsOfFunctionPlot[614].X = -3.86
	pointsOfFunctionPlot[614].Y = -23.722

	pointsOfFunctionPlot[615].X = -3.85
	pointsOfFunctionPlot[615].Y = -23.485

	pointsOfFunctionPlot[616].X = -3.84
	pointsOfFunctionPlot[616].Y = -23.251

	pointsOfFunctionPlot[617].X = -3.83
	pointsOfFunctionPlot[617].Y = -23.02

	pointsOfFunctionPlot[618].X = -3.82
	pointsOfFunctionPlot[618].Y = -22.791

	pointsOfFunctionPlot[619].X = -3.81
	pointsOfFunctionPlot[619].Y = -22.564

	pointsOfFunctionPlot[620].X = -3.80
	pointsOfFunctionPlot[620].Y = -22.339

	pointsOfFunctionPlot[621].X = -3.79
	pointsOfFunctionPlot[621].Y = -22.116

	pointsOfFunctionPlot[622].X = -3.78
	pointsOfFunctionPlot[622].Y = -21.896

	pointsOfFunctionPlot[623].X = -3.77
	pointsOfFunctionPlot[623].Y = -21.678

	pointsOfFunctionPlot[624].X = -3.76
	pointsOfFunctionPlot[624].Y = -21.462

	pointsOfFunctionPlot[625].X = -3.75
	pointsOfFunctionPlot[625].Y = -21.248

	pointsOfFunctionPlot[626].X = -3.74
	pointsOfFunctionPlot[626].Y = -21.037

	pointsOfFunctionPlot[627].X = -3.73
	pointsOfFunctionPlot[627].Y = -20.827

	pointsOfFunctionPlot[628].X = -3.72
	pointsOfFunctionPlot[628].Y = -20.62

	pointsOfFunctionPlot[629].X = -3.71
	pointsOfFunctionPlot[629].Y = -20.414

	pointsOfFunctionPlot[630].X = -3.70
	pointsOfFunctionPlot[630].Y = -20.211

	pointsOfFunctionPlot[631].X = -3.69
	pointsOfFunctionPlot[631].Y = -20.009

	pointsOfFunctionPlot[632].X = -3.68
	pointsOfFunctionPlot[632].Y = -19.81

	pointsOfFunctionPlot[633].X = -3.67
	pointsOfFunctionPlot[633].Y = -19.613

	pointsOfFunctionPlot[634].X = -3.66
	pointsOfFunctionPlot[634].Y = -19.417

	pointsOfFunctionPlot[635].X = -3.65
	pointsOfFunctionPlot[635].Y = -19.224

	pointsOfFunctionPlot[636].X = -3.64
	pointsOfFunctionPlot[636].Y = -19.032

	pointsOfFunctionPlot[637].X = -3.63
	pointsOfFunctionPlot[637].Y = -18.843

	pointsOfFunctionPlot[638].X = -3.62
	pointsOfFunctionPlot[638].Y = -18.655

	pointsOfFunctionPlot[639].X = -3.61
	pointsOfFunctionPlot[639].Y = -18.469

	pointsOfFunctionPlot[640].X = -3.60
	pointsOfFunctionPlot[640].Y = -18.285

	pointsOfFunctionPlot[641].X = -3.59
	pointsOfFunctionPlot[641].Y = -18.103

	pointsOfFunctionPlot[642].X = -3.58
	pointsOfFunctionPlot[642].Y = -17.922

	pointsOfFunctionPlot[643].X = -3.57
	pointsOfFunctionPlot[643].Y = -17.744

	pointsOfFunctionPlot[644].X = -3.56
	pointsOfFunctionPlot[644].Y = -17.567

	pointsOfFunctionPlot[645].X = -3.55
	pointsOfFunctionPlot[645].Y = -17.392

	pointsOfFunctionPlot[646].X = -3.54
	pointsOfFunctionPlot[646].Y = -17.218

	pointsOfFunctionPlot[647].X = -3.53
	pointsOfFunctionPlot[647].Y = -17.047

	pointsOfFunctionPlot[648].X = -3.52
	pointsOfFunctionPlot[648].Y = -16.877

	pointsOfFunctionPlot[649].X = -3.51
	pointsOfFunctionPlot[649].Y = -16.709

	pointsOfFunctionPlot[650].X = -3.50
	pointsOfFunctionPlot[650].Y = -16.542

	pointsOfFunctionPlot[651].X = -3.49
	pointsOfFunctionPlot[651].Y = -16.377

	pointsOfFunctionPlot[652].X = -3.48
	pointsOfFunctionPlot[652].Y = -16.214

	pointsOfFunctionPlot[653].X = -3.47
	pointsOfFunctionPlot[653].Y = -16.052

	pointsOfFunctionPlot[654].X = -3.46
	pointsOfFunctionPlot[654].Y = -15.892

	pointsOfFunctionPlot[655].X = -3.45
	pointsOfFunctionPlot[655].Y = -15.734

	pointsOfFunctionPlot[656].X = -3.44
	pointsOfFunctionPlot[656].Y = -15.577

	pointsOfFunctionPlot[657].X = -3.43
	pointsOfFunctionPlot[657].Y = -15.442

	pointsOfFunctionPlot[658].X = -3.42
	pointsOfFunctionPlot[658].Y = -15.268

	pointsOfFunctionPlot[659].X = -3.41
	pointsOfFunctionPlot[659].Y = -15.116

	pointsOfFunctionPlot[660].X = -3.40
	pointsOfFunctionPlot[660].Y = -14.965

	pointsOfFunctionPlot[661].X = -3.39
	pointsOfFunctionPlot[661].Y = -14.816

	pointsOfFunctionPlot[662].X = -3.38
	pointsOfFunctionPlot[662].Y = -14.668

	pointsOfFunctionPlot[663].X = -3.37
	pointsOfFunctionPlot[663].Y = -14.522

	pointsOfFunctionPlot[664].X = -3.36
	pointsOfFunctionPlot[664].Y = -14.377

	pointsOfFunctionPlot[665].X = -3.35
	pointsOfFunctionPlot[665].Y = -14.233

	pointsOfFunctionPlot[666].X = -3.34
	pointsOfFunctionPlot[666].Y = -14.091

	pointsOfFunctionPlot[667].X = -3.33
	pointsOfFunctionPlot[667].Y = -13.951

	pointsOfFunctionPlot[668].X = -3.32
	pointsOfFunctionPlot[668].Y = -13.812

	pointsOfFunctionPlot[669].X = -3.31
	pointsOfFunctionPlot[669].Y = -13.674

	pointsOfFunctionPlot[670].X = -3.30
	pointsOfFunctionPlot[670].Y = -13.537

	pointsOfFunctionPlot[671].X = -3.29
	pointsOfFunctionPlot[671].Y = -13.402

	pointsOfFunctionPlot[672].X = -3.28
	pointsOfFunctionPlot[672].Y = -13.269

	pointsOfFunctionPlot[673].X = -3.27
	pointsOfFunctionPlot[673].Y = -13.136

	pointsOfFunctionPlot[674].X = -3.26
	pointsOfFunctionPlot[674].Y = -13.005

	pointsOfFunctionPlot[675].X = -3.25
	pointsOfFunctionPlot[675].Y = -12.875

	pointsOfFunctionPlot[676].X = -3.24
	pointsOfFunctionPlot[676].Y = -12.747

	pointsOfFunctionPlot[677].X = -3.23
	pointsOfFunctionPlot[677].Y = -12.62

	pointsOfFunctionPlot[678].X = -3.22
	pointsOfFunctionPlot[678].Y = -12.494

	pointsOfFunctionPlot[679].X = -3.21
	pointsOfFunctionPlot[679].Y = -12.369

	pointsOfFunctionPlot[680].X = -3.20
	pointsOfFunctionPlot[680].Y = -12.245

	pointsOfFunctionPlot[681].X = -3.19
	pointsOfFunctionPlot[681].Y = -12.123

	pointsOfFunctionPlot[682].X = -3.18
	pointsOfFunctionPlot[682].Y = -12.002

	pointsOfFunctionPlot[683].X = -3.17
	pointsOfFunctionPlot[683].Y = -11.882

	pointsOfFunctionPlot[684].X = -3.16
	pointsOfFunctionPlot[684].Y = -11.764

	pointsOfFunctionPlot[685].X = -3.15
	pointsOfFunctionPlot[685].Y = -11.646

	pointsOfFunctionPlot[686].X = -3.14
	pointsOfFunctionPlot[686].Y = -11.53

	pointsOfFunctionPlot[687].X = -3.13
	pointsOfFunctionPlot[687].Y = -11.415

	pointsOfFunctionPlot[688].X = -3.12
	pointsOfFunctionPlot[688].Y = -11.301

	pointsOfFunctionPlot[689].X = -3.11
	pointsOfFunctionPlot[689].Y = -11.188

	pointsOfFunctionPlot[690].X = -3.10
	pointsOfFunctionPlot[690].Y = -11.076

	pointsOfFunctionPlot[691].X = -3.09
	pointsOfFunctionPlot[691].Y = -10.965

	pointsOfFunctionPlot[692].X = -3.08
	pointsOfFunctionPlot[692].Y = -10.856

	pointsOfFunctionPlot[693].X = -3.07
	pointsOfFunctionPlot[693].Y = -10.747

	pointsOfFunctionPlot[694].X = -3.06
	pointsOfFunctionPlot[694].Y = -10.64

	pointsOfFunctionPlot[695].X = -3.05
	pointsOfFunctionPlot[695].Y = -10.533

	pointsOfFunctionPlot[696].X = -3.04
	pointsOfFunctionPlot[696].Y = -10.428

	pointsOfFunctionPlot[697].X = -3.03
	pointsOfFunctionPlot[697].Y = -10.324

	pointsOfFunctionPlot[698].X = -3.02
	pointsOfFunctionPlot[698].Y = -10.221

	pointsOfFunctionPlot[699].X = -3.01
	pointsOfFunctionPlot[699].Y = -10.119

	pointsOfFunctionPlot[700].X = -3.0
	pointsOfFunctionPlot[700].Y = -10.017

	pointsOfFunctionPlot[701].X = -2.99
	pointsOfFunctionPlot[701].Y = -9.917

	pointsOfFunctionPlot[702].X = -2.98
	pointsOfFunctionPlot[702].Y = -9.818

	pointsOfFunctionPlot[703].X = -2.97
	pointsOfFunctionPlot[703].Y = -9.72

	pointsOfFunctionPlot[704].X = -2.96
	pointsOfFunctionPlot[704].Y = -9.623

	pointsOfFunctionPlot[705].X = -2.95
	pointsOfFunctionPlot[705].Y = -9.526

	pointsOfFunctionPlot[706].X = -2.94
	pointsOfFunctionPlot[706].Y = -9.431

	pointsOfFunctionPlot[707].X = -2.93
	pointsOfFunctionPlot[707].Y = -9.337

	pointsOfFunctionPlot[708].X = -2.92
	pointsOfFunctionPlot[708].Y = -9.243

	pointsOfFunctionPlot[709].X = -2.91
	pointsOfFunctionPlot[709].Y = -9.151

	pointsOfFunctionPlot[710].X = -2.90
	pointsOfFunctionPlot[710].Y = -9.059

	pointsOfFunctionPlot[711].X = -2.89
	pointsOfFunctionPlot[711].Y = -8.968

	pointsOfFunctionPlot[712].X = -2.88
	pointsOfFunctionPlot[712].Y = -8.879

	pointsOfFunctionPlot[713].X = -2.87
	pointsOfFunctionPlot[713].Y = -8.79

	pointsOfFunctionPlot[714].X = -2.86
	pointsOfFunctionPlot[714].Y = -8.702

	pointsOfFunctionPlot[715].X = -2.85
	pointsOfFunctionPlot[715].Y = -8.614

	pointsOfFunctionPlot[716].X = -2.84
	pointsOfFunctionPlot[716].Y = -8.528

	pointsOfFunctionPlot[717].X = -2.83
	pointsOfFunctionPlot[717].Y = -8.443

	pointsOfFunctionPlot[718].X = -2.82
	pointsOfFunctionPlot[718].Y = -8.358

	pointsOfFunctionPlot[719].X = -2.81
	pointsOfFunctionPlot[719].Y = -8.274

	pointsOfFunctionPlot[720].X = -2.80
	pointsOfFunctionPlot[720].Y = -8.191

	pointsOfFunctionPlot[721].X = -2.79
	pointsOfFunctionPlot[721].Y = -8.109

	pointsOfFunctionPlot[722].X = -2.78
	pointsOfFunctionPlot[722].Y = -8.028

	pointsOfFunctionPlot[723].X = -2.77
	pointsOfFunctionPlot[723].Y = -7.947

	pointsOfFunctionPlot[724].X = -2.76
	pointsOfFunctionPlot[724].Y = -7.868

	pointsOfFunctionPlot[725].X = -2.75
	pointsOfFunctionPlot[725].Y = -7.789

	pointsOfFunctionPlot[726].X = -2.74
	pointsOfFunctionPlot[726].Y = -7.711

	pointsOfFunctionPlot[727].X = -2.73
	pointsOfFunctionPlot[727].Y = -7.633

	pointsOfFunctionPlot[728].X = -2.72
	pointsOfFunctionPlot[728].Y = -7.557

	pointsOfFunctionPlot[729].X = -2.71
	pointsOfFunctionPlot[729].Y = -7.481

	pointsOfFunctionPlot[730].X = -2.70
	pointsOfFunctionPlot[730].Y = -7.406

	pointsOfFunctionPlot[731].X = -2.69
	pointsOfFunctionPlot[731].Y = -7.331

	pointsOfFunctionPlot[732].X = -2.68
	pointsOfFunctionPlot[732].Y = -7.258

	pointsOfFunctionPlot[733].X = -2.67
	pointsOfFunctionPlot[733].Y = -7.185

	pointsOfFunctionPlot[734].X = -2.66
	pointsOfFunctionPlot[734].Y = -7.113

	pointsOfFunctionPlot[735].X = -2.65
	pointsOfFunctionPlot[735].Y = -7.041

	pointsOfFunctionPlot[736].X = -2.64
	pointsOfFunctionPlot[736].Y = -6.97

	pointsOfFunctionPlot[737].X = -2.63
	pointsOfFunctionPlot[737].Y = -6.9

	pointsOfFunctionPlot[738].X = -2.62
	pointsOfFunctionPlot[738].Y = -6.831

	pointsOfFunctionPlot[739].X = -2.61
	pointsOfFunctionPlot[739].Y = -6.762

	pointsOfFunctionPlot[740].X = -2.60
	pointsOfFunctionPlot[740].Y = -6.694

	pointsOfFunctionPlot[741].X = -2.59
	pointsOfFunctionPlot[741].Y = -6.627

	pointsOfFunctionPlot[742].X = -2.58
	pointsOfFunctionPlot[742].Y = -6.56

	pointsOfFunctionPlot[743].X = -2.57
	pointsOfFunctionPlot[743].Y = -6.494

	pointsOfFunctionPlot[744].X = -2.56
	pointsOfFunctionPlot[744].Y = -6.429

	pointsOfFunctionPlot[745].X = -2.55
	pointsOfFunctionPlot[745].Y = -6.364

	pointsOfFunctionPlot[746].X = -2.54
	pointsOfFunctionPlot[746].Y = -6.3

	pointsOfFunctionPlot[747].X = -2.53
	pointsOfFunctionPlot[747].Y = -6.236

	pointsOfFunctionPlot[748].X = -2.52
	pointsOfFunctionPlot[748].Y = -6.174

	pointsOfFunctionPlot[749].X = -2.51
	pointsOfFunctionPlot[749].Y = -6.111

	pointsOfFunctionPlot[750].X = -2.50
	pointsOfFunctionPlot[750].Y = -6.05

	pointsOfFunctionPlot[751].X = -2.49
	pointsOfFunctionPlot[751].Y = -5.989

	pointsOfFunctionPlot[752].X = -2.48
	pointsOfFunctionPlot[752].Y = -5.928

	pointsOfFunctionPlot[753].X = -2.47
	pointsOfFunctionPlot[753].Y = -5.868

	pointsOfFunctionPlot[754].X = -2.46
	pointsOfFunctionPlot[754].Y = -5.809

	pointsOfFunctionPlot[755].X = -2.45
	pointsOfFunctionPlot[755].Y = -5.751

	pointsOfFunctionPlot[756].X = -2.44
	pointsOfFunctionPlot[756].Y = -5.692

	pointsOfFunctionPlot[757].X = -2.43
	pointsOfFunctionPlot[757].Y = -5.635

	pointsOfFunctionPlot[758].X = -2.42
	pointsOfFunctionPlot[758].Y = -5.578

	pointsOfFunctionPlot[759].X = -2.41
	pointsOfFunctionPlot[759].Y = -5.522

	pointsOfFunctionPlot[760].X = -2.40
	pointsOfFunctionPlot[760].Y = -5.466

	pointsOfFunctionPlot[761].X = -2.39
	pointsOfFunctionPlot[761].Y = -5.41

	pointsOfFunctionPlot[762].X = -2.38
	pointsOfFunctionPlot[762].Y = -5.356

	pointsOfFunctionPlot[763].X = -2.37
	pointsOfFunctionPlot[763].Y = -5.301

	pointsOfFunctionPlot[764].X = -2.36
	pointsOfFunctionPlot[764].Y = -5.248

	pointsOfFunctionPlot[765].X = -2.35
	pointsOfFunctionPlot[765].Y = -5.195

	pointsOfFunctionPlot[766].X = -2.34
	pointsOfFunctionPlot[766].Y = -5.142

	pointsOfFunctionPlot[767].X = -2.33
	pointsOfFunctionPlot[767].Y = -5.09

	pointsOfFunctionPlot[768].X = -2.32
	pointsOfFunctionPlot[768].Y = -5.038

	pointsOfFunctionPlot[769].X = -2.31
	pointsOfFunctionPlot[769].Y = -4.987

	pointsOfFunctionPlot[770].X = -2.30
	pointsOfFunctionPlot[770].Y = -4.936

	pointsOfFunctionPlot[771].X = -2.29
	pointsOfFunctionPlot[771].Y = -4.886

	pointsOfFunctionPlot[772].X = -2.28
	pointsOfFunctionPlot[772].Y = -4.837

	pointsOfFunctionPlot[773].X = -2.27
	pointsOfFunctionPlot[773].Y = -4.788

	pointsOfFunctionPlot[774].X = -2.26
	pointsOfFunctionPlot[774].Y = -4.739

	pointsOfFunctionPlot[775].X = -2.25
	pointsOfFunctionPlot[775].Y = -4.691

	pointsOfFunctionPlot[776].X = -2.24
	pointsOfFunctionPlot[776].Y = -4.643

	pointsOfFunctionPlot[777].X = -2.23
	pointsOfFunctionPlot[777].Y = -4.596

	pointsOfFunctionPlot[778].X = -2.22
	pointsOfFunctionPlot[778].Y = -4.549

	pointsOfFunctionPlot[779].X = -2.21
	pointsOfFunctionPlot[779].Y = -4.503

	pointsOfFunctionPlot[780].X = -2.20
	pointsOfFunctionPlot[780].Y = -4.457

	pointsOfFunctionPlot[781].X = -2.19
	pointsOfFunctionPlot[781].Y = -4.411

	pointsOfFunctionPlot[782].X = -2.18
	pointsOfFunctionPlot[782].Y = -4.366

	pointsOfFunctionPlot[783].X = -2.17
	pointsOfFunctionPlot[783].Y = -4.322

	pointsOfFunctionPlot[784].X = -2.16
	pointsOfFunctionPlot[784].Y = -4.277

	pointsOfFunctionPlot[785].X = -2.15
	pointsOfFunctionPlot[785].Y = -4.234

	pointsOfFunctionPlot[786].X = -2.14
	pointsOfFunctionPlot[786].Y = -4.19

	pointsOfFunctionPlot[787].X = -2.13
	pointsOfFunctionPlot[787].Y = -4.148

	pointsOfFunctionPlot[788].X = -2.12
	pointsOfFunctionPlot[788].Y = -4.105

	pointsOfFunctionPlot[789].X = -2.11
	pointsOfFunctionPlot[789].Y = -4.063

	pointsOfFunctionPlot[790].X = -2.10
	pointsOfFunctionPlot[790].Y = -4.02

	pointsOfFunctionPlot[791].X = -2.09
	pointsOfFunctionPlot[791].Y = -3.98

	pointsOfFunctionPlot[792].X = -2.08
	pointsOfFunctionPlot[792].Y = -3.939

	pointsOfFunctionPlot[793].X = -2.07
	pointsOfFunctionPlot[793].Y = -3.899

	pointsOfFunctionPlot[794].X = -2.06
	pointsOfFunctionPlot[794].Y = -3.859

	pointsOfFunctionPlot[795].X = -2.05
	pointsOfFunctionPlot[795].Y = -3.819

	pointsOfFunctionPlot[796].X = -2.04
	pointsOfFunctionPlot[796].Y = -3.78

	pointsOfFunctionPlot[797].X = -2.03
	pointsOfFunctionPlot[797].Y = -3.741

	pointsOfFunctionPlot[798].X = -2.02
	pointsOfFunctionPlot[798].Y = -3.702

	pointsOfFunctionPlot[799].X = -2.01
	pointsOfFunctionPlot[799].Y = -3.664

	pointsOfFunctionPlot[800].X = -2.0
	pointsOfFunctionPlot[800].Y = -3.626

	pointsOfFunctionPlot[801].X = -1.99
	pointsOfFunctionPlot[801].Y = -3.589

	pointsOfFunctionPlot[802].X = -1.98
	pointsOfFunctionPlot[802].Y = -3.552

	pointsOfFunctionPlot[803].X = -1.97
	pointsOfFunctionPlot[803].Y = -3.515

	pointsOfFunctionPlot[804].X = -1.96
	pointsOfFunctionPlot[804].Y = -3.479

	pointsOfFunctionPlot[805].X = -1.95
	pointsOfFunctionPlot[805].Y = -3.443

	pointsOfFunctionPlot[806].X = -1.94
	pointsOfFunctionPlot[806].Y = -3.407

	pointsOfFunctionPlot[807].X = -1.93
	pointsOfFunctionPlot[807].Y = -3.372

	pointsOfFunctionPlot[808].X = -1.92
	pointsOfFunctionPlot[808].Y = -3.337

	pointsOfFunctionPlot[809].X = -1.91
	pointsOfFunctionPlot[809].Y = -3.302

	pointsOfFunctionPlot[810].X = -1.90
	pointsOfFunctionPlot[810].Y = -3.268

	pointsOfFunctionPlot[811].X = -1.89
	pointsOfFunctionPlot[811].Y = -3.234

	pointsOfFunctionPlot[812].X = -1.88
	pointsOfFunctionPlot[812].Y = -3.2

	pointsOfFunctionPlot[813].X = -1.87
	pointsOfFunctionPlot[813].Y = -3.167

	pointsOfFunctionPlot[814].X = -1.86
	pointsOfFunctionPlot[814].Y = -3.134

	pointsOfFunctionPlot[815].X = -1.85
	pointsOfFunctionPlot[815].Y = -3.101

	pointsOfFunctionPlot[816].X = -1.84
	pointsOfFunctionPlot[816].Y = -3.068

	pointsOfFunctionPlot[817].X = -1.83
	pointsOfFunctionPlot[817].Y = -3.036

	pointsOfFunctionPlot[818].X = -1.82
	pointsOfFunctionPlot[818].Y = -3.004

	pointsOfFunctionPlot[819].X = -1.81
	pointsOfFunctionPlot[819].Y = -2.973

	pointsOfFunctionPlot[820].X = -1.80
	pointsOfFunctionPlot[820].Y = -2.942

	pointsOfFunctionPlot[821].X = -1.79
	pointsOfFunctionPlot[821].Y = -2.911

	pointsOfFunctionPlot[822].X = -1.78
	pointsOfFunctionPlot[822].Y = -2.88

	pointsOfFunctionPlot[823].X = -1.77
	pointsOfFunctionPlot[823].Y = -2.85

	pointsOfFunctionPlot[824].X = -1.76
	pointsOfFunctionPlot[824].Y = -2.82

	pointsOfFunctionPlot[825].X = -1.75
	pointsOfFunctionPlot[825].Y = -2.79

	pointsOfFunctionPlot[826].X = -1.74
	pointsOfFunctionPlot[826].Y = -2.76

	pointsOfFunctionPlot[827].X = -1.73
	pointsOfFunctionPlot[827].Y = -2.731

	pointsOfFunctionPlot[828].X = -1.72
	pointsOfFunctionPlot[828].Y = -2.702

	pointsOfFunctionPlot[829].X = -1.71
	pointsOfFunctionPlot[829].Y = -2.674

	pointsOfFunctionPlot[830].X = -1.70
	pointsOfFunctionPlot[830].Y = -2.645

	pointsOfFunctionPlot[831].X = -1.69
	pointsOfFunctionPlot[831].Y = -2.617

	pointsOfFunctionPlot[832].X = -1.68
	pointsOfFunctionPlot[832].Y = -2.589

	pointsOfFunctionPlot[833].X = -1.67
	pointsOfFunctionPlot[833].Y = -2.561

	pointsOfFunctionPlot[834].X = -1.66
	pointsOfFunctionPlot[834].Y = -2.534

	pointsOfFunctionPlot[835].X = -1.65
	pointsOfFunctionPlot[835].Y = -2.507

	pointsOfFunctionPlot[836].X = -1.64
	pointsOfFunctionPlot[836].Y = -2.48

	pointsOfFunctionPlot[837].X = -1.63
	pointsOfFunctionPlot[837].Y = -2.453

	pointsOfFunctionPlot[838].X = -1.62
	pointsOfFunctionPlot[838].Y = -2.427

	pointsOfFunctionPlot[839].X = -1.61
	pointsOfFunctionPlot[839].Y = -2.401

	pointsOfFunctionPlot[840].X = -1.60
	pointsOfFunctionPlot[840].Y = -2.375

	pointsOfFunctionPlot[841].X = -1.59
	pointsOfFunctionPlot[841].Y = -2.349

	pointsOfFunctionPlot[842].X = -1.58
	pointsOfFunctionPlot[842].Y = -2.324

	pointsOfFunctionPlot[843].X = -1.57
	pointsOfFunctionPlot[843].Y = -2.299

	pointsOfFunctionPlot[844].X = -1.56
	pointsOfFunctionPlot[844].Y = -2.274

	pointsOfFunctionPlot[845].X = -1.55
	pointsOfFunctionPlot[845].Y = -2.249

	pointsOfFunctionPlot[846].X = -1.54
	pointsOfFunctionPlot[846].Y = -2.225

	pointsOfFunctionPlot[847].X = -1.53
	pointsOfFunctionPlot[847].Y = -2.2

	pointsOfFunctionPlot[848].X = -1.52
	pointsOfFunctionPlot[848].Y = -2.176

	pointsOfFunctionPlot[849].X = -1.51
	pointsOfFunctionPlot[849].Y = -2.152
	...
	if err := plotOfFunction.Save(10*vg.Inch, 10*vg.Inch,
		"sinh-function-plot-02.png"); err != nil {
