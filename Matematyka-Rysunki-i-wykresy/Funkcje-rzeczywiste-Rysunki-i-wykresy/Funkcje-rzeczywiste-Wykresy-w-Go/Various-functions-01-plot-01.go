...
func main() {
	...
	pointsOfFunctionPlot[150].Y = 4.036

	pointsOfFunctionPlot[151].X = 1.51
	pointsOfFunctionPlot[151].Y = 4.063

	pointsOfFunctionPlot[152].X = 1.52
	pointsOfFunctionPlot[152].Y = 4.088

	pointsOfFunctionPlot[153].X = 1.53
	pointsOfFunctionPlot[153].Y = 4.114

	pointsOfFunctionPlot[154].X = 1.54
	pointsOfFunctionPlot[154].Y = 4.139

	pointsOfFunctionPlot[155].X = 1.55
	pointsOfFunctionPlot[155].Y = 4.165

	pointsOfFunctionPlot[156].X = 1.56
	pointsOfFunctionPlot[156].Y = 4.19

	pointsOfFunctionPlot[157].X = 1.57
	pointsOfFunctionPlot[157].Y = 4.215

	pointsOfFunctionPlot[158].X = 1.58
	pointsOfFunctionPlot[158].Y = 4.239

	pointsOfFunctionPlot[159].X = 1.59
	pointsOfFunctionPlot[159].Y = 4.264

	pointsOfFunctionPlot[160].X = 1.60
	pointsOfFunctionPlot[160].Y = 4.288

	pointsOfFunctionPlot[161].X = 1.61
	pointsOfFunctionPlot[161].Y = 4.312

	pointsOfFunctionPlot[162].X = 1.62
	pointsOfFunctionPlot[162].Y = 4.336

	pointsOfFunctionPlot[163].X = 1.63
	pointsOfFunctionPlot[163].Y = 4.359

	pointsOfFunctionPlot[164].X = 1.64
	pointsOfFunctionPlot[164].Y = 4.383

	pointsOfFunctionPlot[165].X = 1.65
	pointsOfFunctionPlot[165].Y = 4.406

	pointsOfFunctionPlot[166].X = 1.66
	pointsOfFunctionPlot[166].Y = 4.429

	pointsOfFunctionPlot[167].X = 1.67
	pointsOfFunctionPlot[167].Y = 4.452

	pointsOfFunctionPlot[168].X = 1.68
	pointsOfFunctionPlot[168].Y = 4.474

	pointsOfFunctionPlot[169].X = 1.69
	pointsOfFunctionPlot[169].Y = 4.497

	pointsOfFunctionPlot[170].X = 1.70
	pointsOfFunctionPlot[170].Y = 4.519

	pointsOfFunctionPlot[171].X = 1.71
	pointsOfFunctionPlot[171].Y = 4.541

	pointsOfFunctionPlot[172].X = 1.72
	pointsOfFunctionPlot[172].Y = 4.562

	pointsOfFunctionPlot[173].X = 1.73
	pointsOfFunctionPlot[173].Y = 4.584

	pointsOfFunctionPlot[174].X = 1.74
	pointsOfFunctionPlot[174].Y = 4.605

	pointsOfFunctionPlot[175].X = 1.75
	pointsOfFunctionPlot[175].Y = 4.626

	pointsOfFunctionPlot[176].X = 1.76
	pointsOfFunctionPlot[176].Y = 4.647

	pointsOfFunctionPlot[177].X = 1.77
	pointsOfFunctionPlot[177].Y = 4.668

	pointsOfFunctionPlot[178].X = 1.78
	pointsOfFunctionPlot[178].Y = 4.688

	pointsOfFunctionPlot[179].X = 1.79
	pointsOfFunctionPlot[179].Y = 4.708

	pointsOfFunctionPlot[180].X = 1.80
	pointsOfFunctionPlot[180].Y = 4.728

	pointsOfFunctionPlot[181].X = 1.81
	pointsOfFunctionPlot[181].Y = 4.748

	pointsOfFunctionPlot[182].X = 1.82
	pointsOfFunctionPlot[182].Y = 4.767

	pointsOfFunctionPlot[183].X = 1.83
	pointsOfFunctionPlot[183].Y = 4.786

	pointsOfFunctionPlot[184].X = 1.84
	pointsOfFunctionPlot[184].Y = 4.805

	pointsOfFunctionPlot[185].X = 1.85
	pointsOfFunctionPlot[185].Y = 4.824

	pointsOfFunctionPlot[186].X = 1.86
	pointsOfFunctionPlot[186].Y = 4.843

	pointsOfFunctionPlot[187].X = 1.87
	pointsOfFunctionPlot[187].Y = 4.861

	pointsOfFunctionPlot[188].X = 1.88
	pointsOfFunctionPlot[188].Y = 4.879

	pointsOfFunctionPlot[189].X = 1.89
	pointsOfFunctionPlot[189].Y = 4.897

	pointsOfFunctionPlot[190].X = 1.90
	pointsOfFunctionPlot[190].Y = 4.915

	pointsOfFunctionPlot[191].X = 1.91
	pointsOfFunctionPlot[191].Y = 4.933

	pointsOfFunctionPlot[192].X = 1.92
	pointsOfFunctionPlot[192].Y = 4.95

	pointsOfFunctionPlot[193].X = 1.93
	pointsOfFunctionPlot[193].Y = 4.967

	pointsOfFunctionPlot[194].X = 1.94
	pointsOfFunctionPlot[194].Y = 4.984

	pointsOfFunctionPlot[195].X = 1.95
	pointsOfFunctionPlot[195].Y = 5.0

	pointsOfFunctionPlot[196].X = 1.96
	pointsOfFunctionPlot[196].Y = 5.017

	pointsOfFunctionPlot[197].X = 1.97
	pointsOfFunctionPlot[197].Y = 5.033

	pointsOfFunctionPlot[198].X = 1.98
	pointsOfFunctionPlot[198].Y = 5.049

	pointsOfFunctionPlot[199].X = 1.99
	pointsOfFunctionPlot[199].Y = 5.065

	pointsOfFunctionPlot[200].X = 2.0
	pointsOfFunctionPlot[200].Y = 5.08

	pointsOfFunctionPlot[201].X = 2.01
	pointsOfFunctionPlot[201].Y = 5.096

	pointsOfFunctionPlot[202].X = 2.02
	pointsOfFunctionPlot[202].Y = 5.111

	pointsOfFunctionPlot[203].X = 2.03
	pointsOfFunctionPlot[203].Y = 5.126

	pointsOfFunctionPlot[204].X = 2.04
	pointsOfFunctionPlot[204].Y = 5.14

	pointsOfFunctionPlot[205].X = 2.05
	pointsOfFunctionPlot[205].Y = 5.155

	pointsOfFunctionPlot[206].X = 2.06
	pointsOfFunctionPlot[206].Y = 5.169

	pointsOfFunctionPlot[207].X = 2.07
	pointsOfFunctionPlot[207].Y = 5.184

	pointsOfFunctionPlot[208].X = 2.08
	pointsOfFunctionPlot[208].Y = 5.197

	pointsOfFunctionPlot[209].X = 2.09
	pointsOfFunctionPlot[209].Y = 5.211

	pointsOfFunctionPlot[210].X = 2.10
	pointsOfFunctionPlot[210].Y = 5.225

	pointsOfFunctionPlot[211].X = 2.11
	pointsOfFunctionPlot[211].Y = 5.238

	pointsOfFunctionPlot[212].X = 2.12
	pointsOfFunctionPlot[212].Y = 5.251

	pointsOfFunctionPlot[213].X = 2.13
	pointsOfFunctionPlot[213].Y = 5.264

	pointsOfFunctionPlot[214].X = 2.14
	pointsOfFunctionPlot[214].Y = 5.277

	pointsOfFunctionPlot[215].X = 2.15
	pointsOfFunctionPlot[215].Y = 5.29

	pointsOfFunctionPlot[216].X = 2.16
	pointsOfFunctionPlot[216].Y = 5.302

	pointsOfFunctionPlot[217].X = 2.17
	pointsOfFunctionPlot[217].Y = 5.315

	pointsOfFunctionPlot[218].X = 2.18
	pointsOfFunctionPlot[218].Y = 5.327

	pointsOfFunctionPlot[219].X = 2.19
	pointsOfFunctionPlot[219].Y = 5.339

	pointsOfFunctionPlot[220].X = 2.20
	pointsOfFunctionPlot[220].Y = 5.35

	pointsOfFunctionPlot[221].X = 2.21
	pointsOfFunctionPlot[221].Y = 5.362

	pointsOfFunctionPlot[222].X = 2.22
	pointsOfFunctionPlot[222].Y = 5.374

	pointsOfFunctionPlot[223].X = 2.23
	pointsOfFunctionPlot[223].Y = 5.385

	pointsOfFunctionPlot[224].X = 2.24
	pointsOfFunctionPlot[224].Y = 5.396

	pointsOfFunctionPlot[225].X = 2.25
	pointsOfFunctionPlot[225].Y = 5.407

	pointsOfFunctionPlot[226].X = 2.26
	pointsOfFunctionPlot[226].Y = 5.418

	pointsOfFunctionPlot[227].X = 2.27
	pointsOfFunctionPlot[227].Y = 5.429

	pointsOfFunctionPlot[228].X = 2.28
	pointsOfFunctionPlot[228].Y = 5.439

	pointsOfFunctionPlot[229].X = 2.29
	pointsOfFunctionPlot[229].Y = 5.45

	pointsOfFunctionPlot[230].X = 2.30
	pointsOfFunctionPlot[230].Y = 5.46

	pointsOfFunctionPlot[231].X = 2.31
	pointsOfFunctionPlot[231].Y = 5.47

	pointsOfFunctionPlot[232].X = 2.32
	pointsOfFunctionPlot[232].Y = 5.48

	pointsOfFunctionPlot[233].X = 2.33
	pointsOfFunctionPlot[233].Y = 5.49

	pointsOfFunctionPlot[234].X = 2.34
	pointsOfFunctionPlot[234].Y = 5.5

	pointsOfFunctionPlot[235].X = 2.35
	pointsOfFunctionPlot[235].Y = 5.51

	pointsOfFunctionPlot[236].X = 2.36
	pointsOfFunctionPlot[236].Y = 5.519

	pointsOfFunctionPlot[237].X = 2.37
	pointsOfFunctionPlot[237].Y = 5.529

	pointsOfFunctionPlot[238].X = 2.38
	pointsOfFunctionPlot[238].Y = 5.538

	pointsOfFunctionPlot[239].X = 2.39
	pointsOfFunctionPlot[239].Y = 5.548

	pointsOfFunctionPlot[240].X = 2.40
	pointsOfFunctionPlot[240].Y = 5.557

	pointsOfFunctionPlot[241].X = 2.41
	pointsOfFunctionPlot[241].Y = 5.566

	pointsOfFunctionPlot[242].X = 2.42
	pointsOfFunctionPlot[242].Y = 5.575

	pointsOfFunctionPlot[243].X = 2.43
	pointsOfFunctionPlot[243].Y = 5.584

	pointsOfFunctionPlot[244].X = 2.44
	pointsOfFunctionPlot[244].Y = 5.593

	pointsOfFunctionPlot[245].X = 2.45
	pointsOfFunctionPlot[245].Y = 5.602

	pointsOfFunctionPlot[246].X = 2.46
	pointsOfFunctionPlot[246].Y = 5.611

	pointsOfFunctionPlot[247].X = 2.47
	pointsOfFunctionPlot[247].Y = 5.62

	pointsOfFunctionPlot[248].X = 2.48
	pointsOfFunctionPlot[248].Y = 5.628

	pointsOfFunctionPlot[249].X = 2.49
	pointsOfFunctionPlot[249].Y = 5.637

	pointsOfFunctionPlot[250].X = 2.50
	pointsOfFunctionPlot[250].Y = 5.646

	pointsOfFunctionPlot[251].X = 2.51
	pointsOfFunctionPlot[251].Y = 5.655

	pointsOfFunctionPlot[252].X = 2.52
	pointsOfFunctionPlot[252].Y = 5.663

	pointsOfFunctionPlot[253].X = 2.53
	pointsOfFunctionPlot[253].Y = 5.672

	pointsOfFunctionPlot[254].X = 2.54
	pointsOfFunctionPlot[254].Y = 5.68

	pointsOfFunctionPlot[255].X = 2.55
	pointsOfFunctionPlot[255].Y = 5.689

	pointsOfFunctionPlot[256].X = 2.56
	pointsOfFunctionPlot[256].Y = 5.698

	pointsOfFunctionPlot[257].X = 2.57
	pointsOfFunctionPlot[257].Y = 5.706

	pointsOfFunctionPlot[258].X = 2.58
	pointsOfFunctionPlot[258].Y = 5.715

	pointsOfFunctionPlot[259].X = 2.59
	pointsOfFunctionPlot[259].Y = 5.724

	pointsOfFunctionPlot[260].X = 2.60
	pointsOfFunctionPlot[260].Y = 5.732

	pointsOfFunctionPlot[261].X = 2.61
	pointsOfFunctionPlot[261].Y = 5.741

	pointsOfFunctionPlot[262].X = 2.62
	pointsOfFunctionPlot[262].Y = 5.75

	pointsOfFunctionPlot[263].X = 2.63
	pointsOfFunctionPlot[263].Y = 5.759

	pointsOfFunctionPlot[264].X = 2.64
	pointsOfFunctionPlot[264].Y = 5.768

	pointsOfFunctionPlot[265].X = 2.65
	pointsOfFunctionPlot[265].Y = 5.777

	pointsOfFunctionPlot[266].X = 2.66
	pointsOfFunctionPlot[266].Y = 5.786

	pointsOfFunctionPlot[267].X = 2.67
	pointsOfFunctionPlot[267].Y = 5.795

	pointsOfFunctionPlot[268].X = 2.68
	pointsOfFunctionPlot[268].Y = 5.804

	pointsOfFunctionPlot[269].X = 2.69
	pointsOfFunctionPlot[269].Y = 5.813

	pointsOfFunctionPlot[270].X = 2.70
	pointsOfFunctionPlot[270].Y = 5.823

	pointsOfFunctionPlot[271].X = 2.71
	pointsOfFunctionPlot[271].Y = 5.832

	pointsOfFunctionPlot[272].X = 2.72
	pointsOfFunctionPlot[272].Y = 5.842

	pointsOfFunctionPlot[273].X = 2.73
	pointsOfFunctionPlot[273].Y = 5.852

	pointsOfFunctionPlot[274].X = 2.74
	pointsOfFunctionPlot[274].Y = 5.862

	pointsOfFunctionPlot[275].X = 2.75
	pointsOfFunctionPlot[275].Y = 5.872

	pointsOfFunctionPlot[276].X = 2.76
	pointsOfFunctionPlot[276].Y = 5.882

	pointsOfFunctionPlot[277].X = 2.77
	pointsOfFunctionPlot[277].Y = 5.893

	pointsOfFunctionPlot[278].X = 2.78
	pointsOfFunctionPlot[278].Y = 5.903

	pointsOfFunctionPlot[279].X = 2.79
	pointsOfFunctionPlot[279].Y = 5.914

	pointsOfFunctionPlot[280].X = 2.80
	pointsOfFunctionPlot[280].Y = 5.925

	pointsOfFunctionPlot[281].X = 2.81
	pointsOfFunctionPlot[281].Y = 5.936

	pointsOfFunctionPlot[282].X = 2.82
	pointsOfFunctionPlot[282].Y = 5.948

	pointsOfFunctionPlot[283].X = 2.83
	pointsOfFunctionPlot[283].Y = 5.959

	pointsOfFunctionPlot[284].X = 2.84
	pointsOfFunctionPlot[284].Y = 5.971

	pointsOfFunctionPlot[285].X = 2.85
	pointsOfFunctionPlot[285].Y = 5.983

	pointsOfFunctionPlot[286].X = 2.86
	pointsOfFunctionPlot[286].Y = 5.995

	pointsOfFunctionPlot[287].X = 2.87
	pointsOfFunctionPlot[287].Y = 6.008

	pointsOfFunctionPlot[288].X = 2.88
	pointsOfFunctionPlot[288].Y = 6.021

	pointsOfFunctionPlot[289].X = 2.89
	pointsOfFunctionPlot[289].Y = 6.034

	pointsOfFunctionPlot[290].X = 2.90
	pointsOfFunctionPlot[290].Y = 6.047

	pointsOfFunctionPlot[291].X = 2.91
	pointsOfFunctionPlot[291].Y = 6.061

	pointsOfFunctionPlot[292].X = 2.92
	pointsOfFunctionPlot[292].Y = 6.075

	pointsOfFunctionPlot[293].X = 2.93
	pointsOfFunctionPlot[293].Y = 6.089

	pointsOfFunctionPlot[294].X = 2.94
	pointsOfFunctionPlot[294].Y = 6.104

	pointsOfFunctionPlot[295].X = 2.95
	pointsOfFunctionPlot[295].Y = 6.119

	pointsOfFunctionPlot[296].X = 2.96
	pointsOfFunctionPlot[296].Y = 6.134

	pointsOfFunctionPlot[297].X = 2.97
	pointsOfFunctionPlot[297].Y = 6.15

	pointsOfFunctionPlot[298].X = 2.98
	pointsOfFunctionPlot[298].Y = 6.166

	pointsOfFunctionPlot[299].X = 2.99
	pointsOfFunctionPlot[299].Y = 6.183

	pointsOfFunctionPlot[300].X = 3.0
	pointsOfFunctionPlot[300].Y = 6.2

	pointsOfFunctionPlot[301].X = 3.01
	pointsOfFunctionPlot[301].Y = 6.217

	pointsOfFunctionPlot[302].X = 3.02
	pointsOfFunctionPlot[302].Y = 6.234

	pointsOfFunctionPlot[303].X = 3.03
	pointsOfFunctionPlot[303].Y = 6.253

	pointsOfFunctionPlot[304].X = 3.04
	pointsOfFunctionPlot[304].Y = 6.271

	pointsOfFunctionPlot[305].X = 3.05
	pointsOfFunctionPlot[305].Y = 6.29

	pointsOfFunctionPlot[306].X = 3.06
	pointsOfFunctionPlot[306].Y = 6.31

	pointsOfFunctionPlot[307].X = 3.07
	pointsOfFunctionPlot[307].Y = 6.329

	pointsOfFunctionPlot[308].X = 3.08
	pointsOfFunctionPlot[308].Y = 6.35

	pointsOfFunctionPlot[309].X = 3.09
	pointsOfFunctionPlot[309].Y = 6.371

	pointsOfFunctionPlot[310].X = 3.10
	pointsOfFunctionPlot[310].Y = 6.392

	pointsOfFunctionPlot[311].X = 3.11
	pointsOfFunctionPlot[311].Y = 6.414

	pointsOfFunctionPlot[312].X = 3.12
	pointsOfFunctionPlot[312].Y = 6.437

	pointsOfFunctionPlot[313].X = 3.13
	pointsOfFunctionPlot[313].Y = 6.46

	pointsOfFunctionPlot[314].X = 3.14
	pointsOfFunctionPlot[314].Y = 6.483

	pointsOfFunctionPlot[315].X = 3.15
	pointsOfFunctionPlot[315].Y = 6.507

	pointsOfFunctionPlot[316].X = 3.16
	pointsOfFunctionPlot[316].Y = 6.532

	pointsOfFunctionPlot[317].X = 3.17
	pointsOfFunctionPlot[317].Y = 6.558

	pointsOfFunctionPlot[318].X = 3.18
	pointsOfFunctionPlot[318].Y = 6.584

	pointsOfFunctionPlot[319].X = 3.19
	pointsOfFunctionPlot[319].Y = 6.61

	pointsOfFunctionPlot[320].X = 3.20
	pointsOfFunctionPlot[320].Y = 6.637

	pointsOfFunctionPlot[321].X = 3.21
	pointsOfFunctionPlot[321].Y = 6.665

	pointsOfFunctionPlot[322].X = 3.22
	pointsOfFunctionPlot[322].Y = 6.694

	pointsOfFunctionPlot[323].X = 3.23
	pointsOfFunctionPlot[323].Y = 6.723

	pointsOfFunctionPlot[324].X = 3.24
	pointsOfFunctionPlot[324].Y = 6.753

	pointsOfFunctionPlot[325].X = 3.25
	pointsOfFunctionPlot[325].Y = 6.784

	pointsOfFunctionPlot[326].X = 3.26
	pointsOfFunctionPlot[326].Y = 6.815

	pointsOfFunctionPlot[327].X = 3.27
	pointsOfFunctionPlot[327].Y = 6.847

	pointsOfFunctionPlot[328].X = 3.28
	pointsOfFunctionPlot[328].Y = 6.88

	pointsOfFunctionPlot[329].X = 3.29
	pointsOfFunctionPlot[329].Y = 6.914

	pointsOfFunctionPlot[330].X = 3.30
	pointsOfFunctionPlot[330].Y = 6.948

	pointsOfFunctionPlot[331].X = 3.31
	pointsOfFunctionPlot[331].Y = 6.983

	pointsOfFunctionPlot[332].X = 3.32
	pointsOfFunctionPlot[332].Y = 7.019

	pointsOfFunctionPlot[333].X = 3.33
	pointsOfFunctionPlot[333].Y = 7.056

	pointsOfFunctionPlot[334].X = 3.34
	pointsOfFunctionPlot[334].Y = 7.094

	pointsOfFunctionPlot[335].X = 3.35
	pointsOfFunctionPlot[335].Y = 7.132

	pointsOfFunctionPlot[336].X = 3.36
	pointsOfFunctionPlot[336].Y = 7.171

	pointsOfFunctionPlot[337].X = 3.37
	pointsOfFunctionPlot[337].Y = 7.212

	pointsOfFunctionPlot[338].X = 3.38
	pointsOfFunctionPlot[338].Y = 7.253

	pointsOfFunctionPlot[339].X = 3.39
	pointsOfFunctionPlot[339].Y = 7.295

	pointsOfFunctionPlot[340].X = 3.40
	pointsOfFunctionPlot[340].Y = 7.338

	pointsOfFunctionPlot[341].X = 3.41
	pointsOfFunctionPlot[341].Y = 7.382

	pointsOfFunctionPlot[342].X = 3.42
	pointsOfFunctionPlot[342].Y = 7.427

	pointsOfFunctionPlot[343].X = 3.43
	pointsOfFunctionPlot[343].Y = 7.473

	pointsOfFunctionPlot[344].X = 3.44
	pointsOfFunctionPlot[344].Y = 7.52

	pointsOfFunctionPlot[345].X = 3.45
	pointsOfFunctionPlot[345].Y = 7.567

	pointsOfFunctionPlot[346].X = 3.46
	pointsOfFunctionPlot[346].Y = 7.616

	pointsOfFunctionPlot[347].X = 3.47
	pointsOfFunctionPlot[347].Y = 7.666

	pointsOfFunctionPlot[348].X = 3.48
	pointsOfFunctionPlot[348].Y = 7.717

	pointsOfFunctionPlot[349].X = 3.49
	pointsOfFunctionPlot[349].Y = 7.769

	pointsOfFunctionPlot[350].X = 3.50
	pointsOfFunctionPlot[350].Y = 7.822

	pointsOfFunctionPlot[351].X = 3.51
	pointsOfFunctionPlot[351].Y = 7.877

	pointsOfFunctionPlot[352].X = 3.52
	pointsOfFunctionPlot[352].Y = 7.932

	pointsOfFunctionPlot[353].X = 3.53
	pointsOfFunctionPlot[353].Y = 7.989

	pointsOfFunctionPlot[354].X = 3.54
	pointsOfFunctionPlot[354].Y = 8.046

	pointsOfFunctionPlot[355].X = 3.55
	pointsOfFunctionPlot[355].Y = 8.105

	pointsOfFunctionPlot[356].X = 3.56
	pointsOfFunctionPlot[356].Y = 8.165

	pointsOfFunctionPlot[357].X = 3.57
	pointsOfFunctionPlot[357].Y = 8.227

	pointsOfFunctionPlot[358].X = 3.58
	pointsOfFunctionPlot[358].Y = 8.289

	pointsOfFunctionPlot[359].X = 3.59
	pointsOfFunctionPlot[359].Y = 8.353

	pointsOfFunctionPlot[360].X = 3.60
	pointsOfFunctionPlot[360].Y = 8.418

	pointsOfFunctionPlot[361].X = 3.61
	pointsOfFunctionPlot[361].Y = 8.484

	pointsOfFunctionPlot[362].X = 3.62
	pointsOfFunctionPlot[362].Y = 8.552

	pointsOfFunctionPlot[363].X = 3.63
	pointsOfFunctionPlot[363].Y = 8.62

	pointsOfFunctionPlot[364].X = 3.64
	pointsOfFunctionPlot[364].Y = 8.691

	pointsOfFunctionPlot[365].X = 3.65
	pointsOfFunctionPlot[365].Y = 8.762

	pointsOfFunctionPlot[366].X = 3.66
	pointsOfFunctionPlot[366].Y = 8.835

	pointsOfFunctionPlot[367].X = 3.67
	pointsOfFunctionPlot[367].Y = 8.91

	pointsOfFunctionPlot[368].X = 3.68
	pointsOfFunctionPlot[368].Y = 8.985

	pointsOfFunctionPlot[369].X = 3.69
	pointsOfFunctionPlot[369].Y = 9.062

	pointsOfFunctionPlot[370].X = 3.70
	pointsOfFunctionPlot[370].Y = 9.141

	pointsOfFunctionPlot[371].X = 3.71
	pointsOfFunctionPlot[371].Y = 9.221

	pointsOfFunctionPlot[372].X = 3.72
	pointsOfFunctionPlot[372].Y = 9.303

	pointsOfFunctionPlot[373].X = 3.73
	pointsOfFunctionPlot[373].Y = 9.386

	pointsOfFunctionPlot[374].X = 3.74
	pointsOfFunctionPlot[374].Y = 9.47

	pointsOfFunctionPlot[375].X = 3.75
	pointsOfFunctionPlot[375].Y = 9.556

	pointsOfFunctionPlot[376].X = 3.76
	pointsOfFunctionPlot[376].Y = 9.644

	pointsOfFunctionPlot[377].X = 3.77
	pointsOfFunctionPlot[377].Y = 9.733

	pointsOfFunctionPlot[378].X = 3.78
	pointsOfFunctionPlot[378].Y = 9.824

	pointsOfFunctionPlot[379].X = 3.79
	pointsOfFunctionPlot[379].Y = 9.917

	pointsOfFunctionPlot[380].X = 3.80
	pointsOfFunctionPlot[380].Y = 10.011

	pointsOfFunctionPlot[381].X = 3.81
	pointsOfFunctionPlot[381].Y = 10.107

	pointsOfFunctionPlot[382].X = 3.82
	pointsOfFunctionPlot[382].Y = 10.204

	pointsOfFunctionPlot[383].X = 3.83
	pointsOfFunctionPlot[383].Y = 10.303

	pointsOfFunctionPlot[384].X = 3.84
	pointsOfFunctionPlot[384].Y = 10.404

	pointsOfFunctionPlot[385].X = 3.85
	pointsOfFunctionPlot[385].Y = 10.507

	pointsOfFunctionPlot[386].X = 3.86
	pointsOfFunctionPlot[386].Y = 10.611

	pointsOfFunctionPlot[387].X = 3.87
	pointsOfFunctionPlot[387].Y = 10.717

	pointsOfFunctionPlot[388].X = 3.88
	pointsOfFunctionPlot[388].Y = 10.825

	pointsOfFunctionPlot[389].X = 3.89
	pointsOfFunctionPlot[389].Y = 10.935

	pointsOfFunctionPlot[390].X = 3.90
	pointsOfFunctionPlot[390].Y = 11.046

	pointsOfFunctionPlot[391].X = 3.91
	pointsOfFunctionPlot[391].Y = 11.16

	pointsOfFunctionPlot[392].X = 3.92
	pointsOfFunctionPlot[392].Y = 11.275

	pointsOfFunctionPlot[393].X = 3.93
	pointsOfFunctionPlot[393].Y = 11.392

	pointsOfFunctionPlot[394].X = 3.94
	pointsOfFunctionPlot[394].Y = 11.511

	pointsOfFunctionPlot[395].X = 3.95
	pointsOfFunctionPlot[395].Y = 11.632

	pointsOfFunctionPlot[396].X = 3.96
	pointsOfFunctionPlot[396].Y = 11.755

	pointsOfFunctionPlot[397].X = 3.97
	pointsOfFunctionPlot[397].Y = 11.881

	pointsOfFunctionPlot[398].X = 3.98
	pointsOfFunctionPlot[398].Y = 12.008

	pointsOfFunctionPlot[399].X = 3.99
	pointsOfFunctionPlot[399].Y = 12.137

	pointsOfFunctionPlot[400].X = 4.0
	pointsOfFunctionPlot[400].Y = 12.268

	pointsOfFunctionPlot[401].X = 4.01
	pointsOfFunctionPlot[401].Y = 12.401

	pointsOfFunctionPlot[402].X = 4.02
	pointsOfFunctionPlot[402].Y = 12.536

	pointsOfFunctionPlot[403].X = 4.03
	pointsOfFunctionPlot[403].Y = 12.674

	pointsOfFunctionPlot[404].X = 4.04
	pointsOfFunctionPlot[404].Y = 12.813

	pointsOfFunctionPlot[405].X = 4.05
	pointsOfFunctionPlot[405].Y = 12.955

	pointsOfFunctionPlot[406].X = 4.06
	pointsOfFunctionPlot[406].Y = 13.099

	pointsOfFunctionPlot[407].X = 4.07
	pointsOfFunctionPlot[407].Y = 13.245

	pointsOfFunctionPlot[408].X = 4.08
	pointsOfFunctionPlot[408].Y = 13.393

	pointsOfFunctionPlot[409].X = 4.09
	pointsOfFunctionPlot[409].Y = 13.544

	pointsOfFunctionPlot[410].X = 4.10
	pointsOfFunctionPlot[410].Y = 13.697

	pointsOfFunctionPlot[411].X = 4.11
	pointsOfFunctionPlot[411].Y = 13.852

	pointsOfFunctionPlot[412].X = 4.12
	pointsOfFunctionPlot[412].Y = 14.009

	pointsOfFunctionPlot[413].X = 4.13
	pointsOfFunctionPlot[413].Y = 14.169

	pointsOfFunctionPlot[414].X = 4.14
	pointsOfFunctionPlot[414].Y = 14.331

	pointsOfFunctionPlot[415].X = 4.15
	pointsOfFunctionPlot[415].Y = 14.496

	pointsOfFunctionPlot[416].X = 4.16
	pointsOfFunctionPlot[416].Y = 14.663

	pointsOfFunctionPlot[417].X = 4.17
	pointsOfFunctionPlot[417].Y = 14.832

	pointsOfFunctionPlot[418].X = 4.18
	pointsOfFunctionPlot[418].Y = 15.004

	pointsOfFunctionPlot[419].X = 4.19
	pointsOfFunctionPlot[419].Y = 15.178

	pointsOfFunctionPlot[420].X = 4.20
	pointsOfFunctionPlot[420].Y = 15.355

	pointsOfFunctionPlot[421].X = 4.21
	pointsOfFunctionPlot[421].Y = 15.535

	pointsOfFunctionPlot[422].X = 4.22
	pointsOfFunctionPlot[422].Y = 15.717

	pointsOfFunctionPlot[423].X = 4.23
	pointsOfFunctionPlot[423].Y = 15.901

	pointsOfFunctionPlot[424].X = 4.24
	pointsOfFunctionPlot[424].Y = 16.088

	pointsOfFunctionPlot[425].X = 4.25
	pointsOfFunctionPlot[425].Y = 16.278

	pointsOfFunctionPlot[426].X = 4.26
	pointsOfFunctionPlot[426].Y = 16.47

	pointsOfFunctionPlot[427].X = 4.27
	pointsOfFunctionPlot[427].Y = 16.665

	pointsOfFunctionPlot[428].X = 4.28
	pointsOfFunctionPlot[428].Y = 16.863

	pointsOfFunctionPlot[429].X = 4.29
	pointsOfFunctionPlot[429].Y = 17.063

	pointsOfFunctionPlot[430].X = 4.30
	pointsOfFunctionPlot[430].Y = 17.267

	pointsOfFunctionPlot[431].X = 4.31
	pointsOfFunctionPlot[431].Y = 17.473

	pointsOfFunctionPlot[432].X = 4.32
	pointsOfFunctionPlot[432].Y = 17.681

	pointsOfFunctionPlot[433].X = 4.33
	pointsOfFunctionPlot[433].Y = 17.893

	pointsOfFunctionPlot[434].X = 4.34
	pointsOfFunctionPlot[434].Y = 18.107

	pointsOfFunctionPlot[435].X = 4.35
	pointsOfFunctionPlot[435].Y = 18.324

	pointsOfFunctionPlot[436].X = 4.36
	pointsOfFunctionPlot[436].Y = 18.545

	pointsOfFunctionPlot[437].X = 4.37
	pointsOfFunctionPlot[437].Y = 18.768

	pointsOfFunctionPlot[438].X = 4.38
	pointsOfFunctionPlot[438].Y = 18.994

	pointsOfFunctionPlot[439].X = 4.39
	pointsOfFunctionPlot[439].Y = 19.223

	pointsOfFunctionPlot[440].X = 4.40
	pointsOfFunctionPlot[440].Y = 19.455

	pointsOfFunctionPlot[441].X = 4.41
	pointsOfFunctionPlot[441].Y = 19.69

	pointsOfFunctionPlot[442].X = 4.42
	pointsOfFunctionPlot[442].Y = 19.928

	pointsOfFunctionPlot[443].X = 4.43
	pointsOfFunctionPlot[443].Y = 20.169

	pointsOfFunctionPlot[444].X = 4.44
	pointsOfFunctionPlot[444].Y = 20.413

	pointsOfFunctionPlot[445].X = 4.45
	pointsOfFunctionPlot[445].Y = 20.66

	pointsOfFunctionPlot[446].X = 4.46
	pointsOfFunctionPlot[446].Y = 20.911

	pointsOfFunctionPlot[447].X = 4.47
	pointsOfFunctionPlot[447].Y = 21.164

	pointsOfFunctionPlot[448].X = 4.48
	pointsOfFunctionPlot[448].Y = 21.421

	pointsOfFunctionPlot[449].X = 4.49
	pointsOfFunctionPlot[449].Y = 21.681

	pointsOfFunctionPlot[450].X = 4.50
	pointsOfFunctionPlot[450].Y = 21.944

	pointsOfFunctionPlot[451].X = 4.51
	pointsOfFunctionPlot[451].Y = 22.211

	pointsOfFunctionPlot[452].X = 4.52
	pointsOfFunctionPlot[452].Y = 22.48

	pointsOfFunctionPlot[453].X = 4.53
	pointsOfFunctionPlot[453].Y = 22.754

	pointsOfFunctionPlot[454].X = 4.54
	pointsOfFunctionPlot[454].Y = 23.03

	pointsOfFunctionPlot[455].X = 4.55
	pointsOfFunctionPlot[455].Y = 23.31

	pointsOfFunctionPlot[456].X = 4.56
	pointsOfFunctionPlot[456].Y = 23.593

	pointsOfFunctionPlot[457].X = 4.57
	pointsOfFunctionPlot[457].Y = 23.88

	pointsOfFunctionPlot[458].X = 4.58
	pointsOfFunctionPlot[458].Y = 24.17

	pointsOfFunctionPlot[459].X = 4.59
	pointsOfFunctionPlot[459].Y = 24.464

	pointsOfFunctionPlot[460].X = 4.60
	pointsOfFunctionPlot[460].Y = 24.761

	pointsOfFunctionPlot[461].X = 4.61
	pointsOfFunctionPlot[461].Y = 25.061

	pointsOfFunctionPlot[462].X = 4.62
	pointsOfFunctionPlot[462].Y = 25.366

	pointsOfFunctionPlot[463].X = 4.63
	pointsOfFunctionPlot[463].Y = 25.673

	pointsOfFunctionPlot[464].X = 4.64
	pointsOfFunctionPlot[464].Y = 25.985

	pointsOfFunctionPlot[465].X = 4.65
	pointsOfFunctionPlot[465].Y = 26.3

	pointsOfFunctionPlot[466].X = 4.66
	pointsOfFunctionPlot[466].Y = 26.618

	pointsOfFunctionPlot[467].X = 4.67
	pointsOfFunctionPlot[467].Y = 27.267

	pointsOfFunctionPlot[468].X = 4.68
	pointsOfFunctionPlot[468].Y = 27.267

	pointsOfFunctionPlot[469].X = 4.69
	pointsOfFunctionPlot[469].Y = 27.597

	pointsOfFunctionPlot[470].X = 4.70
	pointsOfFunctionPlot[470].Y = 27.931

	pointsOfFunctionPlot[471].X = 4.71
	pointsOfFunctionPlot[471].Y = 28.268

	pointsOfFunctionPlot[472].X = 4.72
	pointsOfFunctionPlot[472].Y = 28.609

	pointsOfFunctionPlot[473].X = 4.73
	pointsOfFunctionPlot[473].Y = 28.954

	pointsOfFunctionPlot[474].X = 4.74
	pointsOfFunctionPlot[474].Y = 29.303

	pointsOfFunctionPlot[475].X = 4.75
	pointsOfFunctionPlot[475].Y = 29.656

	pointsOfFunctionPlot[476].X = 4.76
	pointsOfFunctionPlot[476].Y = 30.013

	pointsOfFunctionPlot[477].X = 4.77
	pointsOfFunctionPlot[477].Y = 30.374

	pointsOfFunctionPlot[478].X = 4.78
	pointsOfFunctionPlot[478].Y = 30.739

	pointsOfFunctionPlot[479].X = 4.79
	pointsOfFunctionPlot[479].Y = 31.108

	pointsOfFunctionPlot[480].X = 4.80
	pointsOfFunctionPlot[480].Y = 31.48

	pointsOfFunctionPlot[481].X = 4.81
	pointsOfFunctionPlot[481].Y = 31.857

	pointsOfFunctionPlot[482].X = 4.82
	pointsOfFunctionPlot[482].Y = 32.238

	pointsOfFunctionPlot[483].X = 4.83
	pointsOfFunctionPlot[483].Y = 32.624

	pointsOfFunctionPlot[484].X = 4.84
	pointsOfFunctionPlot[484].Y = 33.013

	pointsOfFunctionPlot[485].X = 4.85
	pointsOfFunctionPlot[485].Y = 33.407

	pointsOfFunctionPlot[486].X = 4.86
	pointsOfFunctionPlot[486].Y = 33.804

	pointsOfFunctionPlot[487].X = 4.87
	pointsOfFunctionPlot[487].Y = 34.206

	pointsOfFunctionPlot[488].X = 4.88
	pointsOfFunctionPlot[488].Y = 34.613

	pointsOfFunctionPlot[489].X = 4.89
	pointsOfFunctionPlot[489].Y = 35.023

	pointsOfFunctionPlot[490].X = 4.90
	pointsOfFunctionPlot[490].Y = 35.438

	pointsOfFunctionPlot[491].X = 4.91
	pointsOfFunctionPlot[491].Y = 35.857

	pointsOfFunctionPlot[492].X = 4.92
	pointsOfFunctionPlot[492].Y = 36.281

	pointsOfFunctionPlot[493].X = 4.93
	pointsOfFunctionPlot[493].Y = 36.709

	pointsOfFunctionPlot[494].X = 4.94
	pointsOfFunctionPlot[494].Y = 37.141

	pointsOfFunctionPlot[495].X = 4.95
	pointsOfFunctionPlot[495].Y = 37.578

	pointsOfFunctionPlot[496].X = 4.96
	pointsOfFunctionPlot[496].Y = 38.02

	pointsOfFunctionPlot[497].X = 4.97
	pointsOfFunctionPlot[497].Y = 38.466

	pointsOfFunctionPlot[498].X = 4.98
	pointsOfFunctionPlot[498].Y = 38.916

	pointsOfFunctionPlot[499].X = 4.99
	pointsOfFunctionPlot[499].Y = 39.372

	pointsOfFunctionPlot[500].X = 5.0
	pointsOfFunctionPlot[500].Y = 39.831

	pointsOfFunctionPlot[501].X = 5.01
	pointsOfFunctionPlot[501].Y = 40.296

	pointsOfFunctionPlot[502].X = 5.02
	pointsOfFunctionPlot[502].Y = 40.765

	pointsOfFunctionPlot[503].X = 5.03
	pointsOfFunctionPlot[503].Y = 41.238

	pointsOfFunctionPlot[504].X = 5.04
	pointsOfFunctionPlot[504].Y = 41.717

	pointsOfFunctionPlot[505].X = 5.05
	pointsOfFunctionPlot[505].Y = 42.2

	pointsOfFunctionPlot[506].X = 5.06
	pointsOfFunctionPlot[506].Y = 42.688

	pointsOfFunctionPlot[507].X = 5.07
	pointsOfFunctionPlot[507].Y = 43.181

	pointsOfFunctionPlot[508].X = 5.08
	pointsOfFunctionPlot[508].Y = 43.679

	pointsOfFunctionPlot[509].X = 5.09
	pointsOfFunctionPlot[509].Y = 44.181

	pointsOfFunctionPlot[510].X = 5.10
	pointsOfFunctionPlot[510].Y = 44.689

	pointsOfFunctionPlot[511].X = 5.11
	pointsOfFunctionPlot[511].Y = 45.201

	pointsOfFunctionPlot[512].X = 5.12
	pointsOfFunctionPlot[512].Y = 45.718

	pointsOfFunctionPlot[513].X = 5.13
	pointsOfFunctionPlot[513].Y = 46.241

	pointsOfFunctionPlot[514].X = 5.14
	pointsOfFunctionPlot[514].Y = 46.768

	pointsOfFunctionPlot[515].X = 5.15
	pointsOfFunctionPlot[515].Y = 47.301

	pointsOfFunctionPlot[516].X = 5.16
	pointsOfFunctionPlot[516].Y = 47.838

	pointsOfFunctionPlot[517].X = 5.17
	pointsOfFunctionPlot[517].Y = 48.381

	pointsOfFunctionPlot[518].X = 5.18
	pointsOfFunctionPlot[518].Y = 48.928

	pointsOfFunctionPlot[519].X = 5.19
	pointsOfFunctionPlot[519].Y = 49.481

	pointsOfFunctionPlot[520].X = 5.20
	pointsOfFunctionPlot[520].Y = 50.039

	pointsOfFunctionPlot[521].X = 5.21
	pointsOfFunctionPlot[521].Y = 50.603

	pointsOfFunctionPlot[522].X = 5.22
	pointsOfFunctionPlot[522].Y = 51.171

	pointsOfFunctionPlot[523].X = 5.23
	pointsOfFunctionPlot[523].Y = 51.745

	pointsOfFunctionPlot[524].X = 5.24
	pointsOfFunctionPlot[524].Y = 52.324

	pointsOfFunctionPlot[525].X = 5.25
	pointsOfFunctionPlot[525].Y = 52.909

	pointsOfFunctionPlot[526].X = 5.26
	pointsOfFunctionPlot[526].Y = 53.499

	pointsOfFunctionPlot[527].X = 5.27
	pointsOfFunctionPlot[527].Y = 54.094

	pointsOfFunctionPlot[528].X = 5.28
	pointsOfFunctionPlot[528].Y = 54.695

	pointsOfFunctionPlot[529].X = 5.29
	pointsOfFunctionPlot[529].Y = 55.301

	pointsOfFunctionPlot[530].X = 5.30
	pointsOfFunctionPlot[530].Y = 55.913

	pointsOfFunctionPlot[531].X = 5.31
	pointsOfFunctionPlot[531].Y = 56.53

	pointsOfFunctionPlot[532].X = 5.32
	pointsOfFunctionPlot[532].Y = 57.153

	pointsOfFunctionPlot[533].X = 5.33
	pointsOfFunctionPlot[533].Y = 57.781

	pointsOfFunctionPlot[534].X = 5.34
	pointsOfFunctionPlot[534].Y = 58.415

	pointsOfFunctionPlot[535].X = 5.35
	pointsOfFunctionPlot[535].Y = 59.055

	pointsOfFunctionPlot[536].X = 5.36
	pointsOfFunctionPlot[536].Y = 59.7

	pointsOfFunctionPlot[537].X = 5.37
	pointsOfFunctionPlot[537].Y = 60.351

	pointsOfFunctionPlot[538].X = 5.38
	pointsOfFunctionPlot[538].Y = 61.008

	pointsOfFunctionPlot[539].X = 5.39
	pointsOfFunctionPlot[539].Y = 61.67

	pointsOfFunctionPlot[540].X = 5.40
	pointsOfFunctionPlot[540].Y = 62.338

	pointsOfFunctionPlot[541].X = 5.41
	pointsOfFunctionPlot[541].Y = 63.013

	pointsOfFunctionPlot[542].X = 5.42
	pointsOfFunctionPlot[542].Y = 63.693

	pointsOfFunctionPlot[543].X = 5.43
	pointsOfFunctionPlot[543].Y = 64.378

	pointsOfFunctionPlot[544].X = 5.44
	pointsOfFunctionPlot[544].Y = 65.07

	pointsOfFunctionPlot[545].X = 5.45
	pointsOfFunctionPlot[545].Y = 65.768

	pointsOfFunctionPlot[546].X = 5.46
	pointsOfFunctionPlot[546].Y = 66.472

	pointsOfFunctionPlot[547].X = 5.47
	pointsOfFunctionPlot[547].Y = 67.181

	pointsOfFunctionPlot[548].X = 5.48
	pointsOfFunctionPlot[548].Y = 67.897

	pointsOfFunctionPlot[549].X = 5.49
	pointsOfFunctionPlot[549].Y = 68.619

	pointsOfFunctionPlot[550].X = 5.50
	pointsOfFunctionPlot[550].Y = 69.347

	pointsOfFunctionPlot[551].X = 5.51
	pointsOfFunctionPlot[551].Y = 70.081

	pointsOfFunctionPlot[552].X = 5.52
	pointsOfFunctionPlot[552].Y = 70.821

	pointsOfFunctionPlot[553].X = 5.53
	pointsOfFunctionPlot[553].Y = 71.567

	pointsOfFunctionPlot[554].X = 5.54
	pointsOfFunctionPlot[554].Y = 72.32

	pointsOfFunctionPlot[555].X = 5.55
	pointsOfFunctionPlot[555].Y = 73.079

	pointsOfFunctionPlot[556].X = 5.56
	pointsOfFunctionPlot[556].Y = 73.844

	pointsOfFunctionPlot[557].X = 5.57
	pointsOfFunctionPlot[557].Y = 74.616

	pointsOfFunctionPlot[558].X = 5.58
	pointsOfFunctionPlot[558].Y = 75.393

	pointsOfFunctionPlot[559].X = 5.59
	pointsOfFunctionPlot[559].Y = 76.178

	pointsOfFunctionPlot[560].X = 5.60
	pointsOfFunctionPlot[560].Y = 76.968

	pointsOfFunctionPlot[561].X = 5.61
	pointsOfFunctionPlot[561].Y = 77.765

	pointsOfFunctionPlot[562].X = 5.62
	pointsOfFunctionPlot[562].Y = 78.569

	pointsOfFunctionPlot[563].X = 5.63
	pointsOfFunctionPlot[563].Y = 79.379

	pointsOfFunctionPlot[564].X = 5.64
	pointsOfFunctionPlot[564].Y = 80.195

	pointsOfFunctionPlot[565].X = 5.65
	pointsOfFunctionPlot[565].Y = 81.018

	pointsOfFunctionPlot[566].X = 5.66
	pointsOfFunctionPlot[566].Y = 81.848

	pointsOfFunctionPlot[567].X = 5.67
	pointsOfFunctionPlot[567].Y = 82.684

	pointsOfFunctionPlot[568].X = 5.68
	pointsOfFunctionPlot[568].Y = 83.527

	pointsOfFunctionPlot[569].X = 5.69
	pointsOfFunctionPlot[569].Y = 84.377

	pointsOfFunctionPlot[570].X = 5.70
	pointsOfFunctionPlot[570].Y = 85.233

	pointsOfFunctionPlot[571].X = 5.71
	pointsOfFunctionPlot[571].Y = 86.096

	pointsOfFunctionPlot[572].X = 5.72
	pointsOfFunctionPlot[572].Y = 86.966

	pointsOfFunctionPlot[573].X = 5.73
	pointsOfFunctionPlot[573].Y = 87.843

	pointsOfFunctionPlot[574].X = 5.74
	pointsOfFunctionPlot[574].Y = 88.726

	pointsOfFunctionPlot[575].X = 5.75
	pointsOfFunctionPlot[575].Y = 89.616

	pointsOfFunctionPlot[576].X = 5.76
	pointsOfFunctionPlot[576].Y = 90.514

	pointsOfFunctionPlot[577].X = 5.77
	pointsOfFunctionPlot[577].Y = 91.418

	pointsOfFunctionPlot[578].X = 5.78
	pointsOfFunctionPlot[578].Y = 92.329

	pointsOfFunctionPlot[579].X = 5.79
	pointsOfFunctionPlot[579].Y = 93.247

	pointsOfFunctionPlot[580].X = 5.80
	pointsOfFunctionPlot[580].Y = 94.172

	pointsOfFunctionPlot[581].X = 5.81
	pointsOfFunctionPlot[581].Y = 95.105

	pointsOfFunctionPlot[582].X = 5.82
	pointsOfFunctionPlot[582].Y = 96.044

	pointsOfFunctionPlot[583].X = 5.83
	pointsOfFunctionPlot[583].Y = 96.99

	pointsOfFunctionPlot[584].X = 5.84
	pointsOfFunctionPlot[584].Y = 97.944

	pointsOfFunctionPlot[585].X = 5.85
	pointsOfFunctionPlot[585].Y = 98.905

	pointsOfFunctionPlot[586].X = 5.86
	pointsOfFunctionPlot[586].Y = 99.873

	pointsOfFunctionPlot[587].X = 5.87
	pointsOfFunctionPlot[587].Y = 100.848

	pointsOfFunctionPlot[588].X = 5.88
	pointsOfFunctionPlot[588].Y = 101.83

	pointsOfFunctionPlot[589].X = 5.89
	pointsOfFunctionPlot[589].Y = 102.82

	pointsOfFunctionPlot[590].X = 5.90
	pointsOfFunctionPlot[590].Y = 103.817

	pointsOfFunctionPlot[591].X = 5.91
	pointsOfFunctionPlot[591].Y = 104.822

	pointsOfFunctionPlot[592].X = 5.92
	pointsOfFunctionPlot[592].Y = 105.834

	pointsOfFunctionPlot[593].X = 5.93
	pointsOfFunctionPlot[593].Y = 106.853

	pointsOfFunctionPlot[594].X = 5.94
	pointsOfFunctionPlot[594].Y = 107.88

	pointsOfFunctionPlot[595].X = 5.95
	pointsOfFunctionPlot[595].Y = 108.914

	pointsOfFunctionPlot[596].X = 5.96
	pointsOfFunctionPlot[596].Y = 109.956

	pointsOfFunctionPlot[597].X = 5.97
	pointsOfFunctionPlot[597].Y = 111.005

	pointsOfFunctionPlot[598].X = 5.98
	pointsOfFunctionPlot[598].Y = 112.062

	pointsOfFunctionPlot[599].X = 5.99
	pointsOfFunctionPlot[599].Y = 113.127

	pointsOfFunctionPlot[600].X = 6.0
	pointsOfFunctionPlot[600].Y = 114.199

	pointsOfFunctionPlot[601].X = 6.01
	pointsOfFunctionPlot[601].Y = 115.279

	pointsOfFunctionPlot[602].X = 6.02
	pointsOfFunctionPlot[602].Y = 116.366

	pointsOfFunctionPlot[603].X = 6.03
	pointsOfFunctionPlot[603].Y = 117.461

	pointsOfFunctionPlot[604].X = 6.04
	pointsOfFunctionPlot[604].Y = 118.565

	pointsOfFunctionPlot[605].X = 6.05
	pointsOfFunctionPlot[605].Y = 119.676

	pointsOfFunctionPlot[606].X = 6.06
	pointsOfFunctionPlot[606].Y = 120.794

	pointsOfFunctionPlot[607].X = 6.07
	pointsOfFunctionPlot[607].Y = 121.921

	pointsOfFunctionPlot[608].X = 6.08
	pointsOfFunctionPlot[608].Y = 123.055

	pointsOfFunctionPlot[609].X = 6.09
	pointsOfFunctionPlot[609].Y = 125.198

	pointsOfFunctionPlot[610].X = 6.10
	pointsOfFunctionPlot[610].Y = 125.348

	pointsOfFunctionPlot[611].X = 6.11
	pointsOfFunctionPlot[611].Y = 126.507

	pointsOfFunctionPlot[612].X = 6.12
	pointsOfFunctionPlot[612].Y = 127.673

	pointsOfFunctionPlot[613].X = 6.13
	pointsOfFunctionPlot[613].Y = 128.848

	pointsOfFunctionPlot[614].X = 6.14
	pointsOfFunctionPlot[614].Y = 130.03

	pointsOfFunctionPlot[615].X = 6.15
	pointsOfFunctionPlot[615].Y = 131.221

	pointsOfFunctionPlot[616].X = 6.16
	pointsOfFunctionPlot[616].Y = 132.42

	pointsOfFunctionPlot[617].X = 6.17
	pointsOfFunctionPlot[617].Y = 133.627

	pointsOfFunctionPlot[618].X = 6.18
	pointsOfFunctionPlot[618].Y = 134.842

	pointsOfFunctionPlot[619].X = 6.19
	pointsOfFunctionPlot[619].Y = 136.065

	pointsOfFunctionPlot[620].X = 6.20
	pointsOfFunctionPlot[620].Y = 137.297

	pointsOfFunctionPlot[621].X = 6.21
	pointsOfFunctionPlot[621].Y = 138.537

	pointsOfFunctionPlot[622].X = 6.22
	pointsOfFunctionPlot[622].Y = 139.786

	pointsOfFunctionPlot[623].X = 6.23
	pointsOfFunctionPlot[623].Y = 141.043

	pointsOfFunctionPlot[624].X = 6.24
	pointsOfFunctionPlot[624].Y = 142.308

	pointsOfFunctionPlot[625].X = 6.25
	pointsOfFunctionPlot[625].Y = 143.581

	pointsOfFunctionPlot[626].X = 6.26
	pointsOfFunctionPlot[626].Y = 144.864

	pointsOfFunctionPlot[627].X = 6.27
	pointsOfFunctionPlot[627].Y = 146.154

	pointsOfFunctionPlot[628].X = 6.28
	pointsOfFunctionPlot[628].Y = 147.453

	pointsOfFunctionPlot[629].X = 6.29
	pointsOfFunctionPlot[629].Y = 148.761

	pointsOfFunctionPlot[630].X = 6.30
	pointsOfFunctionPlot[630].Y = 150.077

	pointsOfFunctionPlot[631].X = 6.31
	pointsOfFunctionPlot[631].Y = 151.402

	pointsOfFunctionPlot[632].X = 6.32
	pointsOfFunctionPlot[632].Y = 152.736

	pointsOfFunctionPlot[633].X = 6.33
	pointsOfFunctionPlot[633].Y = 154.078

	pointsOfFunctionPlot[634].X = 6.34
	pointsOfFunctionPlot[634].Y = 155.429

	pointsOfFunctionPlot[635].X = 6.35
	pointsOfFunctionPlot[635].Y = 156.789

	pointsOfFunctionPlot[636].X = 6.36
	pointsOfFunctionPlot[636].Y = 158.157

	pointsOfFunctionPlot[637].X = 6.37
	pointsOfFunctionPlot[637].Y = 159.535

	pointsOfFunctionPlot[638].X = 6.38
	pointsOfFunctionPlot[638].Y = 160.921

	pointsOfFunctionPlot[639].X = 6.39
	pointsOfFunctionPlot[639].Y = 162.316

	pointsOfFunctionPlot[640].X = 6.40
	pointsOfFunctionPlot[640].Y = 163.72

	pointsOfFunctionPlot[641].X = 6.41
	pointsOfFunctionPlot[641].Y = 165.133

	pointsOfFunctionPlot[642].X = 6.42
	pointsOfFunctionPlot[642].Y = 166.555

	pointsOfFunctionPlot[643].X = 6.43
	pointsOfFunctionPlot[643].Y = 167.986

	pointsOfFunctionPlot[644].X = 6.44
	pointsOfFunctionPlot[644].Y = 169.426

	pointsOfFunctionPlot[645].X = 6.45
	pointsOfFunctionPlot[645].Y = 170.875

	pointsOfFunctionPlot[646].X = 6.46
	pointsOfFunctionPlot[646].Y = 172.333

	pointsOfFunctionPlot[647].X = 6.47
	pointsOfFunctionPlot[647].Y = 173.8

	pointsOfFunctionPlot[648].X = 6.48
	pointsOfFunctionPlot[648].Y = 175.277

	pointsOfFunctionPlot[649].X = 6.49
	pointsOfFunctionPlot[649].Y = 176.762

	pointsOfFunctionPlot[650].X = 6.50
	pointsOfFunctionPlot[650].Y = 178.257

	pointsOfFunctionPlot[651].X = 6.51
	pointsOfFunctionPlot[651].Y = 179.761

	pointsOfFunctionPlot[652].X = 6.52
	pointsOfFunctionPlot[652].Y = 181.275

	pointsOfFunctionPlot[653].X = 6.53
	pointsOfFunctionPlot[653].Y = 182.798

	pointsOfFunctionPlot[654].X = 6.54
	pointsOfFunctionPlot[654].Y = 184.33

	pointsOfFunctionPlot[655].X = 6.55
	pointsOfFunctionPlot[655].Y = 185.871

	pointsOfFunctionPlot[656].X = 6.56
	pointsOfFunctionPlot[656].Y = 187.422

	pointsOfFunctionPlot[657].X = 6.57
	pointsOfFunctionPlot[657].Y = 188.983

	pointsOfFunctionPlot[658].X = 6.58
	pointsOfFunctionPlot[658].Y = 190.552

	pointsOfFunctionPlot[659].X = 6.59
	pointsOfFunctionPlot[659].Y = 192.132

	pointsOfFunctionPlot[660].X = 6.60
	pointsOfFunctionPlot[660].Y = 193.721

	pointsOfFunctionPlot[661].X = 6.61
	pointsOfFunctionPlot[661].Y = 195.319

	pointsOfFunctionPlot[662].X = 6.62
	pointsOfFunctionPlot[662].Y = 196.927

	pointsOfFunctionPlot[663].X = 6.63
	pointsOfFunctionPlot[663].Y = 198.545

	pointsOfFunctionPlot[664].X = 6.64
	pointsOfFunctionPlot[664].Y = 200.173

	pointsOfFunctionPlot[665].X = 6.65
	pointsOfFunctionPlot[665].Y = 201.81

	pointsOfFunctionPlot[666].X = 6.66
	pointsOfFunctionPlot[666].Y = 203.457

	pointsOfFunctionPlot[667].X = 6.67
	pointsOfFunctionPlot[667].Y = 205.114

	pointsOfFunctionPlot[668].X = 6.68
	pointsOfFunctionPlot[668].Y = 206.78

	pointsOfFunctionPlot[669].X = 6.69
	pointsOfFunctionPlot[669].Y = 208.456

	pointsOfFunctionPlot[670].X = 6.70
	pointsOfFunctionPlot[670].Y = 210.143

	pointsOfFunctionPlot[671].X = 6.71
	pointsOfFunctionPlot[671].Y = 211.839

	pointsOfFunctionPlot[672].X = 6.72
	pointsOfFunctionPlot[672].Y = 213.545

	pointsOfFunctionPlot[673].X = 6.73
	pointsOfFunctionPlot[673].Y = 215.261

	pointsOfFunctionPlot[674].X = 6.74
	pointsOfFunctionPlot[674].Y = 216.987

	pointsOfFunctionPlot[675].X = 6.75
	pointsOfFunctionPlot[675].Y = 218.723

	pointsOfFunctionPlot[676].X = 6.76
	pointsOfFunctionPlot[676].Y = 220.469

	pointsOfFunctionPlot[677].X = 6.77
	pointsOfFunctionPlot[677].Y = 222.225

	pointsOfFunctionPlot[678].X = 6.78
	pointsOfFunctionPlot[678].Y = 223.992

	pointsOfFunctionPlot[679].X = 6.79
	pointsOfFunctionPlot[679].Y = 225.768

	pointsOfFunctionPlot[680].X = 6.80
	pointsOfFunctionPlot[680].Y = 227.555

	pointsOfFunctionPlot[681].X = 6.81
	pointsOfFunctionPlot[681].Y = 229.352

	pointsOfFunctionPlot[682].X = 6.82
	pointsOfFunctionPlot[682].Y = 231.159

	pointsOfFunctionPlot[683].X = 6.83
	pointsOfFunctionPlot[683].Y = 232.977

	pointsOfFunctionPlot[684].X = 6.84
	pointsOfFunctionPlot[684].Y = 234.804

	pointsOfFunctionPlot[685].X = 6.85
	pointsOfFunctionPlot[685].Y = 236.643

	pointsOfFunctionPlot[686].X = 6.86
	pointsOfFunctionPlot[686].Y = 238.491

	pointsOfFunctionPlot[687].X = 6.87
	pointsOfFunctionPlot[687].Y = 240.35

	pointsOfFunctionPlot[688].X = 6.88
	pointsOfFunctionPlot[688].Y = 242.22

	pointsOfFunctionPlot[689].X = 6.89
	pointsOfFunctionPlot[689].Y = 244.1

	pointsOfFunctionPlot[690].X = 6.90
	pointsOfFunctionPlot[690].Y = 245.99

	pointsOfFunctionPlot[691].X = 6.91
	pointsOfFunctionPlot[691].Y = 247.891

	pointsOfFunctionPlot[692].X = 6.92
	pointsOfFunctionPlot[692].Y = 249.803

	pointsOfFunctionPlot[693].X = 6.93
	pointsOfFunctionPlot[693].Y = 251.725

	pointsOfFunctionPlot[694].X = 6.94
	pointsOfFunctionPlot[694].Y = 253.658

	pointsOfFunctionPlot[695].X = 6.95
	pointsOfFunctionPlot[695].Y = 255.601

	pointsOfFunctionPlot[696].X = 6.96
	pointsOfFunctionPlot[696].Y = 257.555

	pointsOfFunctionPlot[697].X = 6.97
	pointsOfFunctionPlot[697].Y = 259.52

	pointsOfFunctionPlot[698].X = 6.98
	pointsOfFunctionPlot[698].Y = 261.496

	pointsOfFunctionPlot[699].X = 6.99
	pointsOfFunctionPlot[699].Y = 263.483

	pointsOfFunctionPlot[700].X = 7.0
	pointsOfFunctionPlot[700].Y = 265.48

	pointsOfFunctionPlot[701].X = 7.01
	pointsOfFunctionPlot[701].Y = 267.488

	pointsOfFunctionPlot[702].X = 7.02
	pointsOfFunctionPlot[702].Y = 269.508

	pointsOfFunctionPlot[703].X = 7.03
	pointsOfFunctionPlot[703].Y = 271.538

	pointsOfFunctionPlot[704].X = 7.04
	pointsOfFunctionPlot[704].Y = 273.579

	pointsOfFunctionPlot[705].X = 7.05
	pointsOfFunctionPlot[705].Y = 275.579

	pointsOfFunctionPlot[706].X = 7.06
	pointsOfFunctionPlot[706].Y = 277.694

	pointsOfFunctionPlot[707].X = 7.07
	pointsOfFunctionPlot[707].Y = 279.768

	pointsOfFunctionPlot[708].X = 7.08
	pointsOfFunctionPlot[708].Y = 281.854

	pointsOfFunctionPlot[709].X = 7.09
	pointsOfFunctionPlot[709].Y = 283.95

	pointsOfFunctionPlot[710].X = 7.10
	pointsOfFunctionPlot[710].Y = 286.058

	pointsOfFunctionPlot[711].X = 7.11
	pointsOfFunctionPlot[711].Y = 288.177

	pointsOfFunctionPlot[712].X = 7.12
	pointsOfFunctionPlot[712].Y = 290.307

	pointsOfFunctionPlot[713].X = 7.13
	pointsOfFunctionPlot[713].Y = 292.448

	pointsOfFunctionPlot[714].X = 7.14
	pointsOfFunctionPlot[714].Y = 294.601

	pointsOfFunctionPlot[715].X = 7.15
	pointsOfFunctionPlot[715].Y = 296.765

	pointsOfFunctionPlot[716].X = 7.16
	pointsOfFunctionPlot[716].Y = 298.94

	pointsOfFunctionPlot[717].X = 7.17
	pointsOfFunctionPlot[717].Y = 301.127

	pointsOfFunctionPlot[718].X = 7.18
	pointsOfFunctionPlot[718].Y = 303.325

	pointsOfFunctionPlot[719].X = 7.19
	pointsOfFunctionPlot[719].Y = 305.535

	pointsOfFunctionPlot[720].X = 7.20
	pointsOfFunctionPlot[720].Y = 307.756

	pointsOfFunctionPlot[721].X = 7.21
	pointsOfFunctionPlot[721].Y = 309.989

	pointsOfFunctionPlot[722].X = 7.22
	pointsOfFunctionPlot[722].Y = 312.233

	pointsOfFunctionPlot[723].X = 7.23
	pointsOfFunctionPlot[723].Y = 314.489

	pointsOfFunctionPlot[724].X = 7.24
	pointsOfFunctionPlot[724].Y = 316.757

	pointsOfFunctionPlot[725].X = 7.25
	pointsOfFunctionPlot[725].Y = 319.036

	pointsOfFunctionPlot[726].X = 7.26
	pointsOfFunctionPlot[726].Y = 321.327

	pointsOfFunctionPlot[727].X = 7.27
	pointsOfFunctionPlot[727].Y = 323.629

	pointsOfFunctionPlot[728].X = 7.28
	pointsOfFunctionPlot[728].Y = 325.944

	pointsOfFunctionPlot[729].X = 7.29
	pointsOfFunctionPlot[729].Y = 328.27

	pointsOfFunctionPlot[730].X = 7.30
	pointsOfFunctionPlot[730].Y = 330.608

	pointsOfFunctionPlot[731].X = 7.31
	pointsOfFunctionPlot[731].Y = 332.958

	pointsOfFunctionPlot[732].X = 7.32
	pointsOfFunctionPlot[732].Y = 335.32

	pointsOfFunctionPlot[733].X = 7.33
	pointsOfFunctionPlot[733].Y = 337.694

	pointsOfFunctionPlot[734].X = 7.34
	pointsOfFunctionPlot[734].Y = 340.079

	pointsOfFunctionPlot[735].X = 7.35
	pointsOfFunctionPlot[735].Y = 342.477

	pointsOfFunctionPlot[736].X = 7.36
	pointsOfFunctionPlot[736].Y = 344.887

	pointsOfFunctionPlot[737].X = 7.37
	pointsOfFunctionPlot[737].Y = 347.309

	pointsOfFunctionPlot[738].X = 7.38
	pointsOfFunctionPlot[738].Y = 349.743

	pointsOfFunctionPlot[739].X = 7.39
	pointsOfFunctionPlot[739].Y = 352.189

	pointsOfFunctionPlot[740].X = 7.40
	pointsOfFunctionPlot[740].Y = 354.647

	pointsOfFunctionPlot[741].X = 7.41
	pointsOfFunctionPlot[741].Y = 357.118

	pointsOfFunctionPlot[742].X = 7.42
	pointsOfFunctionPlot[742].Y = 359.6

	pointsOfFunctionPlot[743].X = 7.43
	pointsOfFunctionPlot[743].Y = 362.095

	pointsOfFunctionPlot[744].X = 7.44
	pointsOfFunctionPlot[744].Y = 364.603

	pointsOfFunctionPlot[745].X = 7.45
	pointsOfFunctionPlot[745].Y = 367.122

	pointsOfFunctionPlot[746].X = 7.46
	pointsOfFunctionPlot[746].Y = 369.654

	pointsOfFunctionPlot[747].X = 7.47
	pointsOfFunctionPlot[747].Y = 372.199

	pointsOfFunctionPlot[748].X = 7.48
	pointsOfFunctionPlot[748].Y = 374.756

	pointsOfFunctionPlot[749].X = 7.49
	pointsOfFunctionPlot[749].Y = 377.325

	pointsOfFunctionPlot[750].X = 7.50
	pointsOfFunctionPlot[750].Y = 379.907

	pointsOfFunctionPlot[751].X = 7.51
	pointsOfFunctionPlot[751].Y = 382.501

	pointsOfFunctionPlot[752].X = 7.52
	pointsOfFunctionPlot[752].Y = 385.108

	pointsOfFunctionPlot[753].X = 7.53
	pointsOfFunctionPlot[753].Y = 387.728

	pointsOfFunctionPlot[754].X = 7.54
	pointsOfFunctionPlot[754].Y = 390.36

	pointsOfFunctionPlot[755].X = 7.55
	pointsOfFunctionPlot[755].Y = 393.005

	pointsOfFunctionPlot[756].X = 7.56
	pointsOfFunctionPlot[756].Y = 395.663

	pointsOfFunctionPlot[757].X = 7.57
	pointsOfFunctionPlot[757].Y = 398.333

	pointsOfFunctionPlot[758].X = 7.58
	pointsOfFunctionPlot[758].Y = 401.017

	pointsOfFunctionPlot[759].X = 7.59
	pointsOfFunctionPlot[759].Y = 403.713

	pointsOfFunctionPlot[760].X = 7.60
	pointsOfFunctionPlot[760].Y = 406.143

	pointsOfFunctionPlot[761].X = 7.61
	pointsOfFunctionPlot[761].Y = 409.422

	pointsOfFunctionPlot[762].X = 7.62
	pointsOfFunctionPlot[762].Y = 411.878

	pointsOfFunctionPlot[763].X = 7.63
	pointsOfFunctionPlot[763].Y = 414.626

	pointsOfFunctionPlot[764].X = 7.64
	pointsOfFunctionPlot[764].Y = 417.387

	pointsOfFunctionPlot[765].X = 7.65
	pointsOfFunctionPlot[765].Y = 420.16

	pointsOfFunctionPlot[766].X = 7.66
	pointsOfFunctionPlot[766].Y = 422.947

	pointsOfFunctionPlot[767].X = 7.67
	pointsOfFunctionPlot[767].Y = 425.747

	pointsOfFunctionPlot[768].X = 7.68
	pointsOfFunctionPlot[768].Y = 428.56

	pointsOfFunctionPlot[769].X = 7.69
	pointsOfFunctionPlot[769].Y = 431.386

	pointsOfFunctionPlot[770].X = 7.70
	pointsOfFunctionPlot[770].Y = 434.226

	pointsOfFunctionPlot[771].X = 7.71
	pointsOfFunctionPlot[771].Y = 437.078

	pointsOfFunctionPlot[772].X = 7.72
	pointsOfFunctionPlot[772].Y = 439.944

	pointsOfFunctionPlot[773].X = 7.73
	pointsOfFunctionPlot[773].Y = 442.824

	pointsOfFunctionPlot[774].X = 7.74
	pointsOfFunctionPlot[774].Y = 445.716

	pointsOfFunctionPlot[775].X = 7.75
	pointsOfFunctionPlot[775].Y = 448.622

	pointsOfFunctionPlot[776].X = 7.76
	pointsOfFunctionPlot[776].Y = 451.542

	pointsOfFunctionPlot[777].X = 7.77
	pointsOfFunctionPlot[777].Y = 454.474

	pointsOfFunctionPlot[778].X = 7.78
	pointsOfFunctionPlot[778].Y = 457.421

	pointsOfFunctionPlot[779].X = 7.79
	pointsOfFunctionPlot[779].Y = 460.381

	pointsOfFunctionPlot[780].X = 7.80
	pointsOfFunctionPlot[780].Y = 463.354

	pointsOfFunctionPlot[781].X = 7.81
	pointsOfFunctionPlot[781].Y = 466.341

	pointsOfFunctionPlot[782].X = 7.82
	pointsOfFunctionPlot[782].Y = 469.342

	pointsOfFunctionPlot[783].X = 7.83
	pointsOfFunctionPlot[783].Y = 472.356

	pointsOfFunctionPlot[784].X = 7.84
	pointsOfFunctionPlot[784].Y = 475.384

	pointsOfFunctionPlot[785].X = 7.85
	pointsOfFunctionPlot[785].Y = 478.426

	pointsOfFunctionPlot[786].X = 7.86
	pointsOfFunctionPlot[786].Y = 481.482

	pointsOfFunctionPlot[787].X = 7.87
	pointsOfFunctionPlot[787].Y = 484.551

	pointsOfFunctionPlot[788].X = 7.88
	pointsOfFunctionPlot[788].Y = 487.634

	pointsOfFunctionPlot[789].X = 7.89
	pointsOfFunctionPlot[789].Y = 490.732

	pointsOfFunctionPlot[790].X = 7.90
	pointsOfFunctionPlot[790].Y = 493.843

	pointsOfFunctionPlot[791].X = 7.91
	pointsOfFunctionPlot[791].Y = 496.968

	pointsOfFunctionPlot[792].X = 7.92
	pointsOfFunctionPlot[792].Y = 500.26

	pointsOfFunctionPlot[793].X = 7.93
	pointsOfFunctionPlot[793].Y = 503.26

	pointsOfFunctionPlot[794].X = 7.94
	pointsOfFunctionPlot[794].Y = 506.427

	pointsOfFunctionPlot[795].X = 7.95
	pointsOfFunctionPlot[795].Y = 509.608

	pointsOfFunctionPlot[796].X = 7.96
	pointsOfFunctionPlot[796].Y = 512.803

	pointsOfFunctionPlot[797].X = 7.97
	pointsOfFunctionPlot[797].Y = 516.013

	pointsOfFunctionPlot[798].X = 7.98
	pointsOfFunctionPlot[798].Y = 519.237

	pointsOfFunctionPlot[799].X = 7.99
	pointsOfFunctionPlot[799].Y = 522.475

	pointsOfFunctionPlot[800].X = 8.0
	pointsOfFunctionPlot[800].Y = 525.727

	pointsOfFunctionPlot[801].X = 8.01
	pointsOfFunctionPlot[801].Y = 528.994

	pointsOfFunctionPlot[802].X = 8.02
	pointsOfFunctionPlot[802].Y = 532.275

	pointsOfFunctionPlot[803].X = 8.03
	pointsOfFunctionPlot[803].Y = 535.57

	pointsOfFunctionPlot[804].X = 8.04
	pointsOfFunctionPlot[804].Y = 538.88

	pointsOfFunctionPlot[805].X = 8.05
	pointsOfFunctionPlot[805].Y = 542.204

	pointsOfFunctionPlot[806].X = 8.06
	pointsOfFunctionPlot[806].Y = 545.543

	pointsOfFunctionPlot[807].X = 8.07
	pointsOfFunctionPlot[807].Y = 548.896

	pointsOfFunctionPlot[808].X = 8.08
	pointsOfFunctionPlot[808].Y = 552.264

	pointsOfFunctionPlot[809].X = 8.09
	pointsOfFunctionPlot[809].Y = 555.647

	pointsOfFunctionPlot[810].X = 8.10
	pointsOfFunctionPlot[810].Y = 559.044

	pointsOfFunctionPlot[811].X = 8.11
	pointsOfFunctionPlot[811].Y = 562.456

	pointsOfFunctionPlot[812].X = 8.12
	pointsOfFunctionPlot[812].Y = 565.883

	pointsOfFunctionPlot[813].X = 8.13
	pointsOfFunctionPlot[813].Y = 569.324

	pointsOfFunctionPlot[814].X = 8.14
	pointsOfFunctionPlot[814].Y = 572.781

	pointsOfFunctionPlot[815].X = 8.15
	pointsOfFunctionPlot[815].Y = 576.252

	pointsOfFunctionPlot[816].X = 8.16
	pointsOfFunctionPlot[816].Y = 579.738

	pointsOfFunctionPlot[817].X = 8.17
	pointsOfFunctionPlot[817].Y = 583.239

	pointsOfFunctionPlot[818].X = 8.18
	pointsOfFunctionPlot[818].Y = 586.755

	pointsOfFunctionPlot[819].X = 8.19
	pointsOfFunctionPlot[819].Y = 590.286

	pointsOfFunctionPlot[820].X = 8.20
	pointsOfFunctionPlot[820].Y = 593.832

	pointsOfFunctionPlot[821].X = 8.21
	pointsOfFunctionPlot[821].Y = 597.393

	pointsOfFunctionPlot[822].X = 8.22
	pointsOfFunctionPlot[822].Y = 600.969

	pointsOfFunctionPlot[823].X = 8.23
	pointsOfFunctionPlot[823].Y = 604.56

	pointsOfFunctionPlot[824].X = 8.24
	pointsOfFunctionPlot[824].Y = 608.167

	pointsOfFunctionPlot[825].X = 8.25
	pointsOfFunctionPlot[825].Y = 611.789

	pointsOfFunctionPlot[826].X = 8.26
	pointsOfFunctionPlot[826].Y = 615.426

	pointsOfFunctionPlot[827].X = 8.27
	pointsOfFunctionPlot[827].Y = 619.078

	pointsOfFunctionPlot[828].X = 8.28
	pointsOfFunctionPlot[828].Y = 622.746

	pointsOfFunctionPlot[829].X = 8.29
	pointsOfFunctionPlot[829].Y = 626.429

	pointsOfFunctionPlot[830].X = 8.30
	pointsOfFunctionPlot[830].Y = 630.127

	pointsOfFunctionPlot[831].X = 8.31
	pointsOfFunctionPlot[831].Y = 633.841

	pointsOfFunctionPlot[832].X = 8.32
	pointsOfFunctionPlot[832].Y = 637.571

	pointsOfFunctionPlot[833].X = 8.33
	pointsOfFunctionPlot[833].Y = 641.316

	pointsOfFunctionPlot[834].X = 8.34
	pointsOfFunctionPlot[834].Y = 645.077

	pointsOfFunctionPlot[835].X = 8.35
	pointsOfFunctionPlot[835].Y = 648.853

	pointsOfFunctionPlot[836].X = 8.36
	pointsOfFunctionPlot[836].Y = 652.645

	pointsOfFunctionPlot[837].X = 8.37
	pointsOfFunctionPlot[837].Y = 656.453

	pointsOfFunctionPlot[838].X = 8.38
	pointsOfFunctionPlot[838].Y = 660.276

	pointsOfFunctionPlot[839].X = 8.39
	pointsOfFunctionPlot[839].Y = 664.115

	pointsOfFunctionPlot[840].X = 8.40
	pointsOfFunctionPlot[840].Y = 667.97

	pointsOfFunctionPlot[841].X = 8.41
	pointsOfFunctionPlot[841].Y = 671.841

	pointsOfFunctionPlot[842].X = 8.42
	pointsOfFunctionPlot[842].Y = 675.728

	pointsOfFunctionPlot[843].X = 8.43
	pointsOfFunctionPlot[843].Y = 679.631

	pointsOfFunctionPlot[844].X = 8.44
	pointsOfFunctionPlot[844].Y = 683.55

	pointsOfFunctionPlot[845].X = 8.45
	pointsOfFunctionPlot[845].Y = 687.484

	pointsOfFunctionPlot[846].X = 8.46
	pointsOfFunctionPlot[846].Y = 691.435

	pointsOfFunctionPlot[847].X = 8.47
	pointsOfFunctionPlot[847].Y = 695.402

	pointsOfFunctionPlot[848].X = 8.48
	pointsOfFunctionPlot[848].Y = 699.385

	pointsOfFunctionPlot[849].X = 8.49
	pointsOfFunctionPlot[849].Y = 703.385

	pointsOfFunctionPlot[850].X = 8.50
	pointsOfFunctionPlot[850].Y = 707.4

	pointsOfFunctionPlot[851].X = 8.51
	pointsOfFunctionPlot[851].Y = 711.432

	pointsOfFunctionPlot[852].X = 8.52
	pointsOfFunctionPlot[852].Y = 715.48

	pointsOfFunctionPlot[853].X = 8.53
	pointsOfFunctionPlot[853].Y = 719.545

	pointsOfFunctionPlot[854].X = 8.54
	pointsOfFunctionPlot[854].Y = 723.626

	pointsOfFunctionPlot[855].X = 8.55
	pointsOfFunctionPlot[855].Y = 727.723

	pointsOfFunctionPlot[856].X = 8.56
	pointsOfFunctionPlot[856].Y = 731.837

	pointsOfFunctionPlot[857].X = 8.57
	pointsOfFunctionPlot[857].Y = 735.967

	pointsOfFunctionPlot[858].X = 8.58
	pointsOfFunctionPlot[858].Y = 740.114

	pointsOfFunctionPlot[859].X = 8.59
	pointsOfFunctionPlot[859].Y = 744.277

	pointsOfFunctionPlot[860].X = 8.60
	pointsOfFunctionPlot[860].Y = 748.458

	pointsOfFunctionPlot[861].X = 8.61
	pointsOfFunctionPlot[861].Y = 752.654

	pointsOfFunctionPlot[862].X = 8.62
	pointsOfFunctionPlot[862].Y = 756.868

	pointsOfFunctionPlot[863].X = 8.63
	pointsOfFunctionPlot[863].Y = 761.098

	pointsOfFunctionPlot[864].X = 8.64
	pointsOfFunctionPlot[864].Y = 765.345

	pointsOfFunctionPlot[865].X = 8.65
	pointsOfFunctionPlot[865].Y = 769.609

	pointsOfFunctionPlot[866].X = 8.66
	pointsOfFunctionPlot[866].Y = 773.89

	pointsOfFunctionPlot[867].X = 8.67
	pointsOfFunctionPlot[867].Y = 778.188

	pointsOfFunctionPlot[868].X = 8.68
	pointsOfFunctionPlot[868].Y = 782.503

	pointsOfFunctionPlot[869].X = 8.69
	pointsOfFunctionPlot[869].Y = 786.835

	pointsOfFunctionPlot[870].X = 8.70
	pointsOfFunctionPlot[870].Y = 791.184

	pointsOfFunctionPlot[871].X = 8.71
	pointsOfFunctionPlot[871].Y = 795.55

	pointsOfFunctionPlot[872].X = 8.72
	pointsOfFunctionPlot[872].Y = 799.933

	pointsOfFunctionPlot[873].X = 8.73
	pointsOfFunctionPlot[873].Y = 804.333

	pointsOfFunctionPlot[874].X = 8.74
	pointsOfFunctionPlot[874].Y = 808.751

	pointsOfFunctionPlot[875].X = 8.75
	pointsOfFunctionPlot[875].Y = 813.186

	pointsOfFunctionPlot[876].X = 8.76
	pointsOfFunctionPlot[876].Y = 817.638

	pointsOfFunctionPlot[877].X = 8.77
	pointsOfFunctionPlot[877].Y = 822.108

	pointsOfFunctionPlot[878].X = 8.78
	pointsOfFunctionPlot[878].Y = 826.595

	pointsOfFunctionPlot[879].X = 8.79
	pointsOfFunctionPlot[879].Y = 831.099

	pointsOfFunctionPlot[880].X = 8.80
	pointsOfFunctionPlot[880].Y = 835.621

	pointsOfFunctionPlot[881].X = 8.81
	pointsOfFunctionPlot[881].Y = 840.161

	pointsOfFunctionPlot[882].X = 8.82
	pointsOfFunctionPlot[882].Y = 844.718

	pointsOfFunctionPlot[883].X = 8.83
	pointsOfFunctionPlot[883].Y = 849.293

	pointsOfFunctionPlot[884].X = 8.84
	pointsOfFunctionPlot[884].Y = 853.885

	pointsOfFunctionPlot[885].X = 8.85
	pointsOfFunctionPlot[885].Y = 858.495

	pointsOfFunctionPlot[886].X = 8.86
	pointsOfFunctionPlot[886].Y = 863.123

	pointsOfFunctionPlot[887].X = 8.87
	pointsOfFunctionPlot[887].Y = 867.769

	pointsOfFunctionPlot[888].X = 8.88
	pointsOfFunctionPlot[888].Y = 872.433

	pointsOfFunctionPlot[889].X = 8.89
	pointsOfFunctionPlot[889].Y = 877.114

	pointsOfFunctionPlot[890].X = 8.90
	pointsOfFunctionPlot[890].Y = 881.814

	pointsOfFunctionPlot[891].X = 8.91
	pointsOfFunctionPlot[891].Y = 886.531

	pointsOfFunctionPlot[892].X = 8.92
	pointsOfFunctionPlot[892].Y = 891.267

	pointsOfFunctionPlot[893].X = 8.93
	pointsOfFunctionPlot[893].Y = 896.02

	pointsOfFunctionPlot[894].X = 8.94
	pointsOfFunctionPlot[894].Y = 900.792

	pointsOfFunctionPlot[895].X = 8.95
	pointsOfFunctionPlot[895].Y = 905.582

	pointsOfFunctionPlot[896].X = 8.96
	pointsOfFunctionPlot[896].Y = 910.39

	pointsOfFunctionPlot[897].X = 8.97
	pointsOfFunctionPlot[897].Y = 915.216

	pointsOfFunctionPlot[898].X = 8.98
	pointsOfFunctionPlot[898].Y = 920.061

	pointsOfFunctionPlot[899].X = 8.99
	pointsOfFunctionPlot[899].Y = 924.924

	pointsOfFunctionPlot[900].X = 9.0
	pointsOfFunctionPlot[900].Y = 929.805

	pointsOfFunctionPlot[901].X = 9.01
	pointsOfFunctionPlot[901].Y = 934.705

	pointsOfFunctionPlot[902].X = 9.02
	pointsOfFunctionPlot[902].Y = 939.623

	pointsOfFunctionPlot[903].X = 9.03
	pointsOfFunctionPlot[903].Y = 944.56

	pointsOfFunctionPlot[904].X = 9.04
	pointsOfFunctionPlot[904].Y = 949.516

	pointsOfFunctionPlot[905].X = 9.05
	pointsOfFunctionPlot[905].Y = 954.49

	pointsOfFunctionPlot[906].X = 9.06
	pointsOfFunctionPlot[906].Y = 959.482

	pointsOfFunctionPlot[907].X = 9.07
	pointsOfFunctionPlot[907].Y = 964.494

	pointsOfFunctionPlot[908].X = 9.08
	pointsOfFunctionPlot[908].Y = 969.524

	pointsOfFunctionPlot[909].X = 9.09
	pointsOfFunctionPlot[909].Y = 974.573

	pointsOfFunctionPlot[910].X = 9.10
	pointsOfFunctionPlot[910].Y = 979.641

	pointsOfFunctionPlot[911].X = 9.11
	pointsOfFunctionPlot[911].Y = 984.728

	pointsOfFunctionPlot[912].X = 9.12
	pointsOfFunctionPlot[912].Y = 989.834

	pointsOfFunctionPlot[913].X = 9.13
	pointsOfFunctionPlot[913].Y = 994.959

	pointsOfFunctionPlot[914].X = 9.14
	pointsOfFunctionPlot[914].Y = 1_000.102

	pointsOfFunctionPlot[915].X = 9.15
	pointsOfFunctionPlot[915].Y = 1_005.265

	pointsOfFunctionPlot[916].X = 9.16
	pointsOfFunctionPlot[916].Y = 1_010.447

	pointsOfFunctionPlot[917].X = 9.17
	pointsOfFunctionPlot[917].Y = 1_015.649

	pointsOfFunctionPlot[918].X = 9.18
	pointsOfFunctionPlot[918].Y = 1_020.869

	pointsOfFunctionPlot[919].X = 9.19
	pointsOfFunctionPlot[919].Y = 1_026.109

	pointsOfFunctionPlot[920].X = 9.20
	pointsOfFunctionPlot[920].Y = 1_031.368

	pointsOfFunctionPlot[921].X = 9.21
	pointsOfFunctionPlot[921].Y = 1_036.647

	pointsOfFunctionPlot[922].X = 9.22
	pointsOfFunctionPlot[922].Y = 1_041.945

	pointsOfFunctionPlot[923].X = 9.23
	pointsOfFunctionPlot[923].Y = 1_047.262

	pointsOfFunctionPlot[924].X = 9.24
	pointsOfFunctionPlot[924].Y = 1_052.599

	pointsOfFunctionPlot[925].X = 9.25
	pointsOfFunctionPlot[925].Y = 1_057.956

	pointsOfFunctionPlot[926].X = 9.26
	pointsOfFunctionPlot[926].Y = 1_063.332

	pointsOfFunctionPlot[927].X = 9.27
	pointsOfFunctionPlot[927].Y = 1_068.728

	pointsOfFunctionPlot[928].X = 9.28
	pointsOfFunctionPlot[928].Y = 1_074.143

	pointsOfFunctionPlot[929].X = 9.29
	pointsOfFunctionPlot[929].Y = 1_079.579

	pointsOfFunctionPlot[930].X = 9.30
	pointsOfFunctionPlot[930].Y = 1_085.034

	pointsOfFunctionPlot[931].X = 9.31
	pointsOfFunctionPlot[931].Y = 1_090.509

	pointsOfFunctionPlot[932].X = 9.32
	pointsOfFunctionPlot[932].Y = 1_096.004

	pointsOfFunctionPlot[933].X = 9.33
	pointsOfFunctionPlot[933].Y = 1_101.519

	pointsOfFunctionPlot[934].X = 9.34
	pointsOfFunctionPlot[934].Y = 1_107.054

	pointsOfFunctionPlot[935].X = 9.35
	pointsOfFunctionPlot[935].Y = 1_112.609

	pointsOfFunctionPlot[936].X = 9.36
	pointsOfFunctionPlot[936].Y = 1_118.184

	pointsOfFunctionPlot[937].X = 9.37
	pointsOfFunctionPlot[937].Y = 1_123.779

	pointsOfFunctionPlot[938].X = 9.38
	pointsOfFunctionPlot[938].Y = 1_129.395

	pointsOfFunctionPlot[939].X = 9.39
	pointsOfFunctionPlot[939].Y = 1_135.03

	pointsOfFunctionPlot[940].X = 9.40
	pointsOfFunctionPlot[940].Y = 1_140.686

	pointsOfFunctionPlot[941].X = 9.41
	pointsOfFunctionPlot[941].Y = 1_146.363

	pointsOfFunctionPlot[942].X = 9.42
	pointsOfFunctionPlot[942].Y = 1_152.06

	pointsOfFunctionPlot[943].X = 9.43
	pointsOfFunctionPlot[943].Y = 1_157.777

	pointsOfFunctionPlot[944].X = 9.44
	pointsOfFunctionPlot[944].Y = 1_163.515

	pointsOfFunctionPlot[945].X = 9.45
	pointsOfFunctionPlot[945].Y = 1_169.273

	pointsOfFunctionPlot[946].X = 9.46
	pointsOfFunctionPlot[946].Y = 1_175.053

	pointsOfFunctionPlot[947].X = 9.47
	pointsOfFunctionPlot[947].Y = 1_180.852

	pointsOfFunctionPlot[948].X = 9.48
	pointsOfFunctionPlot[948].Y = 1_186.673

	pointsOfFunctionPlot[949].X = 9.49
	pointsOfFunctionPlot[949].Y = 1_192.514

	pointsOfFunctionPlot[950].X = 9.50
	pointsOfFunctionPlot[950].Y = 1_198.376

	pointsOfFunctionPlot[951].X = 9.51
	pointsOfFunctionPlot[951].Y = 1_204.259

	pointsOfFunctionPlot[952].X = 9.52
	pointsOfFunctionPlot[952].Y = 1_210.163

	pointsOfFunctionPlot[953].X = 9.53
	pointsOfFunctionPlot[953].Y = 1_216.088

	pointsOfFunctionPlot[954].X = 9.54
	pointsOfFunctionPlot[954].Y = 1_222.034

	pointsOfFunctionPlot[955].X = 9.55
	pointsOfFunctionPlot[955].Y = 1_228.001

	pointsOfFunctionPlot[956].X = 9.56
	pointsOfFunctionPlot[956].Y = 1_233.989

	pointsOfFunctionPlot[957].X = 9.57
	pointsOfFunctionPlot[957].Y = 1_239.998

	pointsOfFunctionPlot[958].X = 9.58
	pointsOfFunctionPlot[958].Y = 1_246.028

	pointsOfFunctionPlot[959].X = 9.59
	pointsOfFunctionPlot[959].Y = 1_252.08

	pointsOfFunctionPlot[960].X = 9.60
	pointsOfFunctionPlot[960].Y = 1_258.153

	pointsOfFunctionPlot[961].X = 9.61
	pointsOfFunctionPlot[961].Y = 1_264.248

	pointsOfFunctionPlot[962].X = 9.62
	pointsOfFunctionPlot[962].Y = 1_270.364

	pointsOfFunctionPlot[963].X = 9.63
	pointsOfFunctionPlot[963].Y = 1_276.501

	pointsOfFunctionPlot[964].X = 9.64
	pointsOfFunctionPlot[964].Y = 1_282.66

	pointsOfFunctionPlot[965].X = 9.65
	pointsOfFunctionPlot[965].Y = 1_288.841

	pointsOfFunctionPlot[966].X = 9.66
	pointsOfFunctionPlot[966].Y = 1_295.043

	pointsOfFunctionPlot[967].X = 9.67
	pointsOfFunctionPlot[967].Y = 1_301.267

	pointsOfFunctionPlot[968].X = 9.68
	pointsOfFunctionPlot[968].Y = 1_307.513

	pointsOfFunctionPlot[969].X = 9.69
	pointsOfFunctionPlot[969].Y = 1_313.781

	pointsOfFunctionPlot[970].X = 9.70
	pointsOfFunctionPlot[970].Y = 1_320.07

	pointsOfFunctionPlot[971].X = 9.71
	pointsOfFunctionPlot[971].Y = 1_326.382

	pointsOfFunctionPlot[972].X = 9.72
	pointsOfFunctionPlot[972].Y = 1_332.715

	pointsOfFunctionPlot[973].X = 9.73
	pointsOfFunctionPlot[973].Y = 1_339.071

	pointsOfFunctionPlot[974].X = 9.74
	pointsOfFunctionPlot[974].Y = 1_345.448

	pointsOfFunctionPlot[975].X = 9.75
	pointsOfFunctionPlot[975].Y = 1_351.848

	pointsOfFunctionPlot[976].X = 9.76
	pointsOfFunctionPlot[976].Y = 1_358.27

	pointsOfFunctionPlot[977].X = 9.77
	pointsOfFunctionPlot[977].Y = 1_364.714

	pointsOfFunctionPlot[978].X = 9.78
	pointsOfFunctionPlot[978].Y = 1_371.18

	pointsOfFunctionPlot[979].X = 9.79
	pointsOfFunctionPlot[979].Y = 1_377.669

	pointsOfFunctionPlot[980].X = 9.80
	pointsOfFunctionPlot[980].Y = 1_384.18

	pointsOfFunctionPlot[981].X = 9.81
	pointsOfFunctionPlot[981].Y = 1_390.714

	pointsOfFunctionPlot[982].X = 9.82
	pointsOfFunctionPlot[982].Y = 1_397.27

	pointsOfFunctionPlot[983].X = 9.83
	pointsOfFunctionPlot[983].Y = 1_403.849

	pointsOfFunctionPlot[984].X = 9.84
	pointsOfFunctionPlot[984].Y = 1_410.45

	pointsOfFunctionPlot[985].X = 9.85
	pointsOfFunctionPlot[985].Y = 1_417.074

	pointsOfFunctionPlot[986].X = 9.86
	pointsOfFunctionPlot[986].Y = 1_423.721

	pointsOfFunctionPlot[987].X = 9.87
	pointsOfFunctionPlot[987].Y = 1_430.39

	pointsOfFunctionPlot[988].X = 9.88
	pointsOfFunctionPlot[988].Y = 1_437.083

	pointsOfFunctionPlot[989].X = 9.89
	pointsOfFunctionPlot[989].Y = 1_443.798

	pointsOfFunctionPlot[990].X = 9.90
	pointsOfFunctionPlot[990].Y = 1_450.537

	pointsOfFunctionPlot[991].X = 9.91
	pointsOfFunctionPlot[991].Y = 1_457.298

	pointsOfFunctionPlot[992].X = 9.92
	pointsOfFunctionPlot[992].Y = 1_464.082

	pointsOfFunctionPlot[993].X = 9.93
	pointsOfFunctionPlot[993].Y = 1_470.89

	pointsOfFunctionPlot[994].X = 9.94
	pointsOfFunctionPlot[994].Y = 1_477.721

	pointsOfFunctionPlot[995].X = 9.95
	pointsOfFunctionPlot[995].Y = 1_484.574

	pointsOfFunctionPlot[996].X = 9.96
	pointsOfFunctionPlot[996].Y = 1_491.452

	pointsOfFunctionPlot[997].X = 9.97
	pointsOfFunctionPlot[997].Y = 1_498.352

	pointsOfFunctionPlot[998].X = 9.98
	pointsOfFunctionPlot[998].Y = 1_505.276

	pointsOfFunctionPlot[999].X = 9.99
	pointsOfFunctionPlot[999].Y = 1_512.224

	pointsOfFunctionPlot[1_000].X = 10.0
	pointsOfFunctionPlot[1_000].Y = 1_519.195
	...
	plotOfFunction.Title.Text = "Plot of function f(x) = 0.25x^4 - x^3 + x - 5cos(x) + 5"
	...
	if err := plotOfFunction.Save(10*vg.Inch, 10*vg.Inch,
		"Various-functions-01-plot-01.png"); err != nil {
