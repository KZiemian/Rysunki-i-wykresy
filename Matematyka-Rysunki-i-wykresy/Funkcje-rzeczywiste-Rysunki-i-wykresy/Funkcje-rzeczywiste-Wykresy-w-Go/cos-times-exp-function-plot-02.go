...
func main() {
	...
	pointsOfFunctionPlot := make(plotter.XYs, 927)

	pointsOfFunctionPlot[0].X = 0.0
	pointsOfFunctionPlot[0].Y = 10.0

	pointsOfFunctionPlot[1].X = 0.01
	pointsOfFunctionPlot[1].Y = 9.9

	pointsOfFunctionPlot[2].X = 0.02
	pointsOfFunctionPlot[2].Y = 9.8

	pointsOfFunctionPlot[3].X = 0.03
	pointsOfFunctionPlot[3].Y = 9.7

	pointsOfFunctionPlot[4].X = 0.04
	pointsOfFunctionPlot[4].Y = 9.6

	pointsOfFunctionPlot[5].X = 0.05
	pointsOfFunctionPlot[5].Y = 9.5

	pointsOfFunctionPlot[6].X = 0.06
	pointsOfFunctionPlot[6].Y = 9.4

	pointsOfFunctionPlot[7].X = 0.07
	pointsOfFunctionPlot[7].Y = 9.301

	pointsOfFunctionPlot[8].X = 0.08
	pointsOfFunctionPlot[8].Y = 9.201

	pointsOfFunctionPlot[9].X = 0.09
	pointsOfFunctionPlot[9].Y = 9.102

	pointsOfFunctionPlot[10].X = 0.10
	pointsOfFunctionPlot[10].Y = 9.003

	pointsOfFunctionPlot[11].X = 0.11
	pointsOfFunctionPlot[11].Y = 8.904

	pointsOfFunctionPlot[12].X = 0.12
	pointsOfFunctionPlot[12].Y = 8.805

	pointsOfFunctionPlot[13].X = 0.13
	pointsOfFunctionPlot[13].Y = 8.706

	pointsOfFunctionPlot[14].X = 0.14
	pointsOfFunctionPlot[14].Y = 8.608

	pointsOfFunctionPlot[15].X = 0.15
	pointsOfFunctionPlot[15].Y = 8.51

	pointsOfFunctionPlot[16].X = 0.16
	pointsOfFunctionPlot[16].Y = 8.412

	pointsOfFunctionPlot[17].X = 0.17
	pointsOfFunctionPlot[17].Y = 8.315

	pointsOfFunctionPlot[18].X = 0.18
	pointsOfFunctionPlot[18].Y = 8.217

	pointsOfFunctionPlot[19].X = 0.19
	pointsOfFunctionPlot[19].Y = 8.12

	pointsOfFunctionPlot[20].X = 0.20
	pointsOfFunctionPlot[20].Y = 8.024

	pointsOfFunctionPlot[21].X = 0.21
	pointsOfFunctionPlot[21].Y = 7.927

	pointsOfFunctionPlot[22].X = 0.22
	pointsOfFunctionPlot[22].Y = 7.831

	pointsOfFunctionPlot[23].X = 0.23
	pointsOfFunctionPlot[23].Y = 7.736

	pointsOfFunctionPlot[24].X = 0.24
	pointsOfFunctionPlot[24].Y = 7.64

	pointsOfFunctionPlot[25].X = 0.25
	pointsOfFunctionPlot[25].Y = 7.545

	pointsOfFunctionPlot[26].X = 0.26
	pointsOfFunctionPlot[26].Y = 7.451

	pointsOfFunctionPlot[27].X = 0.27
	pointsOfFunctionPlot[27].Y = 7.357

	pointsOfFunctionPlot[28].X = 0.28
	pointsOfFunctionPlot[28].Y = 7.263

	pointsOfFunctionPlot[29].X = 0.29
	pointsOfFunctionPlot[29].Y = 7.17

	pointsOfFunctionPlot[30].X = 0.30
	pointsOfFunctionPlot[30].Y = 7.077

	pointsOfFunctionPlot[31].X = 0.31
	pointsOfFunctionPlot[31].Y = 6.984

	pointsOfFunctionPlot[32].X = 0.32
	pointsOfFunctionPlot[32].Y = 6.892

	pointsOfFunctionPlot[33].X = 0.33
	pointsOfFunctionPlot[33].Y = 6.801

	pointsOfFunctionPlot[34].X = 0.34
	pointsOfFunctionPlot[34].Y = 6.71

	pointsOfFunctionPlot[35].X = 0.35
	pointsOfFunctionPlot[35].Y = 6.619

	pointsOfFunctionPlot[36].X = 0.36
	pointsOfFunctionPlot[36].Y = 6.529

	pointsOfFunctionPlot[37].X = 0.37
	pointsOfFunctionPlot[37].Y = 6.439

	pointsOfFunctionPlot[38].X = 0.38
	pointsOfFunctionPlot[38].Y = 6.35

	pointsOfFunctionPlot[39].X = 0.39
	pointsOfFunctionPlot[39].Y = 6.262

	pointsOfFunctionPlot[40].X = 0.40
	pointsOfFunctionPlot[40].Y = 6.174

	pointsOfFunctionPlot[41].X = 0.41
	pointsOfFunctionPlot[41].Y = 6.086

	pointsOfFunctionPlot[42].X = 0.42
	pointsOfFunctionPlot[42].Y = 5.999

	pointsOfFunctionPlot[43].X = 0.43
	pointsOfFunctionPlot[43].Y = 5.912

	pointsOfFunctionPlot[44].X = 0.44
	pointsOfFunctionPlot[44].Y = 5.826

	pointsOfFunctionPlot[45].X = 0.45
	pointsOfFunctionPlot[45].Y = 5.741

	pointsOfFunctionPlot[46].X = 0.46
	pointsOfFunctionPlot[46].Y = 5.656

	pointsOfFunctionPlot[47].X = 0.47
	pointsOfFunctionPlot[47].Y = 5.572

	pointsOfFunctionPlot[48].X = 0.48
	pointsOfFunctionPlot[48].Y = 5.488

	pointsOfFunctionPlot[49].X = 0.49
	pointsOfFunctionPlot[49].Y = 5.405

	pointsOfFunctionPlot[50].X = 0.50
	pointsOfFunctionPlot[50].Y = 5.322

	pointsOfFunctionPlot[51].X = 0.51
	pointsOfFunctionPlot[51].Y = 5.24

	pointsOfFunctionPlot[52].X = 0.52
	pointsOfFunctionPlot[52].Y = 5.159

	pointsOfFunctionPlot[53].X = 0.53
	pointsOfFunctionPlot[53].Y = 5.078

	pointsOfFunctionPlot[54].X = 0.54
	pointsOfFunctionPlot[54].Y = 4.998

	pointsOfFunctionPlot[55].X = 0.55
	pointsOfFunctionPlot[55].Y = 4.918

	pointsOfFunctionPlot[56].X = 0.56
	pointsOfFunctionPlot[56].Y = 4.839

	pointsOfFunctionPlot[57].X = 0.57
	pointsOfFunctionPlot[57].Y = 4.761

	pointsOfFunctionPlot[58].X = 0.58
	pointsOfFunctionPlot[58].Y = 4.683

	pointsOfFunctionPlot[59].X = 0.59
	pointsOfFunctionPlot[59].Y = 4.606

	pointsOfFunctionPlot[60].X = 0.60
	pointsOfFunctionPlot[60].Y = 4.529

	pointsOfFunctionPlot[61].X = 0.61
	pointsOfFunctionPlot[61].Y = 4.453

	pointsOfFunctionPlot[62].X = 0.62
	pointsOfFunctionPlot[62].Y = 4.378

	pointsOfFunctionPlot[63].X = 0.63
	pointsOfFunctionPlot[63].Y = 4.303

	pointsOfFunctionPlot[64].X = 0.64
	pointsOfFunctionPlot[64].Y = 4.229

	pointsOfFunctionPlot[65].X = 0.65
	pointsOfFunctionPlot[65].Y = 4.155

	pointsOfFunctionPlot[66].X = 0.66
	pointsOfFunctionPlot[66].Y = 4.083

	pointsOfFunctionPlot[67].X = 0.67
	pointsOfFunctionPlot[67].Y = 4.01

	pointsOfFunctionPlot[68].X = 0.68
	pointsOfFunctionPlot[68].Y = 3.939

	pointsOfFunctionPlot[69].X = 0.69
	pointsOfFunctionPlot[69].Y = 3.868

	pointsOfFunctionPlot[70].X = 0.70
	pointsOfFunctionPlot[70].Y = 3.798

	pointsOfFunctionPlot[71].X = 0.71
	pointsOfFunctionPlot[71].Y = 3.728

	pointsOfFunctionPlot[72].X = 0.72
	pointsOfFunctionPlot[72].Y = 3.659

	pointsOfFunctionPlot[73].X = 0.73
	pointsOfFunctionPlot[73].Y = 3.591

	pointsOfFunctionPlot[74].X = 0.74
	pointsOfFunctionPlot[74].Y = 3.522

	pointsOfFunctionPlot[75].X = 0.75
	pointsOfFunctionPlot[75].Y = 3.456

	pointsOfFunctionPlot[76].X = 0.76
	pointsOfFunctionPlot[76].Y = 3.389

	pointsOfFunctionPlot[77].X = 0.77
	pointsOfFunctionPlot[77].Y = 3.324

	pointsOfFunctionPlot[78].X = 0.78
	pointsOfFunctionPlot[78].Y = 3.258

	pointsOfFunctionPlot[79].X = 0.79
	pointsOfFunctionPlot[79].Y = 3.194

	pointsOfFunctionPlot[80].X = 0.80
	pointsOfFunctionPlot[80].Y = 3.13

	pointsOfFunctionPlot[81].X = 0.81
	pointsOfFunctionPlot[81].Y = 3.067

	pointsOfFunctionPlot[82].X = 0.82
	pointsOfFunctionPlot[82].Y = 3.004

	pointsOfFunctionPlot[83].X = 0.83
	pointsOfFunctionPlot[83].Y = 2.942

	pointsOfFunctionPlot[84].X = 0.84
	pointsOfFunctionPlot[84].Y = 2.881

	pointsOfFunctionPlot[85].X = 0.85
	pointsOfFunctionPlot[85].Y = 2.82

	pointsOfFunctionPlot[86].X = 0.86
	pointsOfFunctionPlot[86].Y = 2.76

	pointsOfFunctionPlot[87].X = 0.87
	pointsOfFunctionPlot[87].Y = 2.701

	pointsOfFunctionPlot[88].X = 0.88
	pointsOfFunctionPlot[88].Y = 2.642

	pointsOfFunctionPlot[89].X = 0.89
	pointsOfFunctionPlot[89].Y = 2.584

	pointsOfFunctionPlot[90].X = 0.90
	pointsOfFunctionPlot[90].Y = 2.527

	pointsOfFunctionPlot[91].X = 0.91
	pointsOfFunctionPlot[91].Y = 2.47

	pointsOfFunctionPlot[92].X = 0.92
	pointsOfFunctionPlot[92].Y = 2.414

	pointsOfFunctionPlot[93].X = 0.93
	pointsOfFunctionPlot[93].Y = 2.358

	pointsOfFunctionPlot[94].X = 0.94
	pointsOfFunctionPlot[94].Y = 2.303

	pointsOfFunctionPlot[95].X = 0.95
	pointsOfFunctionPlot[95].Y = 2.249

	pointsOfFunctionPlot[96].X = 0.96
	pointsOfFunctionPlot[96].Y = 2.196

	pointsOfFunctionPlot[97].X = 0.97
	pointsOfFunctionPlot[97].Y = 2.143

	pointsOfFunctionPlot[98].X = 0.98
	pointsOfFunctionPlot[98].Y = 2.09

	pointsOfFunctionPlot[99].X = 0.99
	pointsOfFunctionPlot[99].Y = 2.038

	pointsOfFunctionPlot[100].X = 1.0
	pointsOfFunctionPlot[100].Y = 1.987

	pointsOfFunctionPlot[101].X = 1.01
	pointsOfFunctionPlot[101].Y = 1.937

	pointsOfFunctionPlot[102].X = 1.02
	pointsOfFunctionPlot[102].Y = 1.887

	pointsOfFunctionPlot[103].X = 1.03
	pointsOfFunctionPlot[103].Y = 1.837

	pointsOfFunctionPlot[104].X = 1.04
	pointsOfFunctionPlot[104].Y = 1.789

	pointsOfFunctionPlot[105].X = 1.05
	pointsOfFunctionPlot[105].Y = 1.741

	pointsOfFunctionPlot[106].X = 1.06
	pointsOfFunctionPlot[106].Y = 1.693

	pointsOfFunctionPlot[107].X = 1.07
	pointsOfFunctionPlot[107].Y = 1.646

	pointsOfFunctionPlot[108].X = 1.08
	pointsOfFunctionPlot[108].Y = 1.6

	pointsOfFunctionPlot[109].X = 1.09
	pointsOfFunctionPlot[109].Y = 1.555

	pointsOfFunctionPlot[110].X = 1.10
	pointsOfFunctionPlot[110].Y = 1.509

	pointsOfFunctionPlot[111].X = 1.11
	pointsOfFunctionPlot[111].Y = 1.465

	pointsOfFunctionPlot[112].X = 1.12
	pointsOfFunctionPlot[112].Y = 1.421

	pointsOfFunctionPlot[113].X = 1.13
	pointsOfFunctionPlot[113].Y = 1.378

	pointsOfFunctionPlot[114].X = 1.14
	pointsOfFunctionPlot[114].Y = 1.335

	pointsOfFunctionPlot[115].X = 1.15
	pointsOfFunctionPlot[115].Y = 1.293

	pointsOfFunctionPlot[116].X = 1.16
	pointsOfFunctionPlot[116].Y = 1.251

	pointsOfFunctionPlot[117].X = 1.17
	pointsOfFunctionPlot[117].Y = 1.21

	pointsOfFunctionPlot[118].X = 1.18
	pointsOfFunctionPlot[118].Y = 1.17

	pointsOfFunctionPlot[119].X = 1.19
	pointsOfFunctionPlot[119].Y = 1.13

	pointsOfFunctionPlot[120].X = 1.20
	pointsOfFunctionPlot[120].Y = 1.091

	pointsOfFunctionPlot[121].X = 1.21
	pointsOfFunctionPlot[121].Y = 1.052

	pointsOfFunctionPlot[122].X = 1.22
	pointsOfFunctionPlot[122].Y = 1.014

	pointsOfFunctionPlot[123].X = 1.23
	pointsOfFunctionPlot[123].Y = 0.977

	pointsOfFunctionPlot[124].X = 1.24
	pointsOfFunctionPlot[124].Y = 0.939

	pointsOfFunctionPlot[125].X = 1.25
	pointsOfFunctionPlot[125].Y = 0.903

	pointsOfFunctionPlot[126].X = 1.26
	pointsOfFunctionPlot[126].Y = 0.867

	pointsOfFunctionPlot[127].X = 1.27
	pointsOfFunctionPlot[127].Y = 0.832

	pointsOfFunctionPlot[128].X = 1.28
	pointsOfFunctionPlot[128].Y = 0.797

	pointsOfFunctionPlot[129].X = 1.29
	pointsOfFunctionPlot[129].Y = 0.762

	pointsOfFunctionPlot[130].X = 1.30
	pointsOfFunctionPlot[130].Y = 0.729

	pointsOfFunctionPlot[131].X = 1.31
	pointsOfFunctionPlot[131].Y = 0.695

	pointsOfFunctionPlot[132].X = 1.32
	pointsOfFunctionPlot[132].Y = 0.663

	pointsOfFunctionPlot[133].X = 1.33
	pointsOfFunctionPlot[133].Y = 0.63

	pointsOfFunctionPlot[134].X = 1.34
	pointsOfFunctionPlot[134].Y = 0.599

	pointsOfFunctionPlot[135].X = 1.35
	pointsOfFunctionPlot[135].Y = 0.567

	pointsOfFunctionPlot[136].X = 1.36
	pointsOfFunctionPlot[136].Y = 0.537

	pointsOfFunctionPlot[137].X = 1.37
	pointsOfFunctionPlot[137].Y = 0.506

	pointsOfFunctionPlot[138].X = 1.38
	pointsOfFunctionPlot[138].Y = 0.477

	pointsOfFunctionPlot[139].X = 1.39
	pointsOfFunctionPlot[139].Y = 0.447

	pointsOfFunctionPlot[140].X = 1.40
	pointsOfFunctionPlot[140].Y = 0.419

	pointsOfFunctionPlot[141].X = 1.41
	pointsOfFunctionPlot[141].Y = 0.39

	pointsOfFunctionPlot[142].X = 1.42
	pointsOfFunctionPlot[142].Y = 0.363

	pointsOfFunctionPlot[143].X = 1.43
	pointsOfFunctionPlot[143].Y = 0.335

	pointsOfFunctionPlot[144].X = 1.44
	pointsOfFunctionPlot[144].Y = 0.309

	pointsOfFunctionPlot[145].X = 1.45
	pointsOfFunctionPlot[145].Y = 0.282

	pointsOfFunctionPlot[146].X = 1.46
	pointsOfFunctionPlot[146].Y = 0.256

	pointsOfFunctionPlot[147].X = 1.47
	pointsOfFunctionPlot[147].Y = 0.231

	pointsOfFunctionPlot[148].X = 1.48
	pointsOfFunctionPlot[148].Y = 0.206

	pointsOfFunctionPlot[149].X = 1.49
	pointsOfFunctionPlot[149].Y = 0.181

	pointsOfFunctionPlot[150].X = 1.50
	pointsOfFunctionPlot[150].Y = 0.157

	pointsOfFunctionPlot[151].X = 1.51
	pointsOfFunctionPlot[151].Y = 0.134

	pointsOfFunctionPlot[152].X = 1.52
	pointsOfFunctionPlot[152].Y = 0.111

	pointsOfFunctionPlot[153].X = 1.53
	pointsOfFunctionPlot[153].Y = 0.088

	pointsOfFunctionPlot[154].X = 1.54
	pointsOfFunctionPlot[154].Y = 0.066

	pointsOfFunctionPlot[155].X = 1.55
	pointsOfFunctionPlot[155].Y = 0.044

	pointsOfFunctionPlot[156].X = 1.56
	pointsOfFunctionPlot[156].Y = 0.022

	pointsOfFunctionPlot[157].X = 1.57
	pointsOfFunctionPlot[157].Y = 0.001

	pointsOfFunctionPlot[158].X = 1.58
	pointsOfFunctionPlot[158].Y = -0.019

	pointsOfFunctionPlot[159].X = 1.59
	pointsOfFunctionPlot[159].Y = -0.039

	pointsOfFunctionPlot[160].X = 1.60
	pointsOfFunctionPlot[160].Y = -0.059

	pointsOfFunctionPlot[161].X = 1.61
	pointsOfFunctionPlot[161].Y = -0.078

	pointsOfFunctionPlot[162].X = 1.62
	pointsOfFunctionPlot[162].Y = -0.097

	pointsOfFunctionPlot[163].X = 1.63
	pointsOfFunctionPlot[163].Y = -0.115

	pointsOfFunctionPlot[164].X = 1.64
	pointsOfFunctionPlot[164].Y = -0.134

	pointsOfFunctionPlot[165].X = 1.65
	pointsOfFunctionPlot[165].Y = -0.152

	pointsOfFunctionPlot[166].X = 1.66
	pointsOfFunctionPlot[166].Y = -0.169

	pointsOfFunctionPlot[167].X = 1.67
	pointsOfFunctionPlot[167].Y = -0.186

	pointsOfFunctionPlot[168].X = 1.68
	pointsOfFunctionPlot[168].Y = -0.203

	pointsOfFunctionPlot[169].X = 1.69
	pointsOfFunctionPlot[169].Y = -0.219

	pointsOfFunctionPlot[170].X = 1.70
	pointsOfFunctionPlot[170].Y = -0.235

	pointsOfFunctionPlot[171].X = 1.71
	pointsOfFunctionPlot[171].Y = -0.251

	pointsOfFunctionPlot[172].X = 1.72
	pointsOfFunctionPlot[172].Y = -0.266

	pointsOfFunctionPlot[173].X = 1.73
	pointsOfFunctionPlot[173].Y = -0.281

	pointsOfFunctionPlot[174].X = 1.74
	pointsOfFunctionPlot[174].Y = -0.295

	pointsOfFunctionPlot[175].X = 1.75
	pointsOfFunctionPlot[175].Y = -0.309

	pointsOfFunctionPlot[176].X = 1.76
	pointsOfFunctionPlot[176].Y = -0.323

	pointsOfFunctionPlot[177].X = 1.77
	pointsOfFunctionPlot[177].Y = -0.337

	pointsOfFunctionPlot[178].X = 1.78
	pointsOfFunctionPlot[178].Y = -0.35

	pointsOfFunctionPlot[179].X = 1.79
	pointsOfFunctionPlot[179].Y = -0.363

	pointsOfFunctionPlot[180].X = 1.80
	pointsOfFunctionPlot[180].Y = -0.375

	pointsOfFunctionPlot[181].X = 1.81
	pointsOfFunctionPlot[181].Y = -0.387

	pointsOfFunctionPlot[182].X = 1.82
	pointsOfFunctionPlot[182].Y = -0.399

	pointsOfFunctionPlot[183].X = 1.83
	pointsOfFunctionPlot[183].Y = -0.411

	pointsOfFunctionPlot[184].X = 1.84
	pointsOfFunctionPlot[184].Y = -0.422

	pointsOfFunctionPlot[185].X = 1.85
	pointsOfFunctionPlot[185].Y = -0.433

	pointsOfFunctionPlot[186].X = 1.86
	pointsOfFunctionPlot[186].Y = -0.444

	pointsOfFunctionPlot[187].X = 1.87
	pointsOfFunctionPlot[187].Y = -0.454

	pointsOfFunctionPlot[188].X = 1.88
	pointsOfFunctionPlot[188].Y = -0.464

	pointsOfFunctionPlot[189].X = 1.89
	pointsOfFunctionPlot[189].Y = -0.474

	pointsOfFunctionPlot[190].X = 1.90
	pointsOfFunctionPlot[190].Y = -0.483

	pointsOfFunctionPlot[191].X = 1.91
	pointsOfFunctionPlot[191].Y = -0.492

	pointsOfFunctionPlot[192].X = 1.92
	pointsOfFunctionPlot[192].Y = -0.501

	pointsOfFunctionPlot[193].X = 1.93
	pointsOfFunctionPlot[193].Y = -0.51

	pointsOfFunctionPlot[194].X = 1.94
	pointsOfFunctionPlot[194].Y = -0.518

	pointsOfFunctionPlot[195].X = 1.95
	pointsOfFunctionPlot[195].Y = -0.526

	pointsOfFunctionPlot[196].X = 1.96
	pointsOfFunctionPlot[196].Y = -0.534

	pointsOfFunctionPlot[197].X = 1.97
	pointsOfFunctionPlot[197].Y = -0.542

	pointsOfFunctionPlot[198].X = 1.98
	pointsOfFunctionPlot[198].Y = -0.549

	pointsOfFunctionPlot[199].X = 1.99
	pointsOfFunctionPlot[199].Y = -0.556

	pointsOfFunctionPlot[200].X = 2.0
	pointsOfFunctionPlot[200].Y = -0.563

	pointsOfFunctionPlot[201].X = 2.01
	pointsOfFunctionPlot[201].Y = -0.569

	pointsOfFunctionPlot[202].X = 2.02
	pointsOfFunctionPlot[202].Y = -0.576

	pointsOfFunctionPlot[203].X = 2.03
	pointsOfFunctionPlot[203].Y = -0.582

	pointsOfFunctionPlot[204].X = 2.04
	pointsOfFunctionPlot[204].Y = -0.588

	pointsOfFunctionPlot[205].X = 2.05
	pointsOfFunctionPlot[205].Y = -0.593

	pointsOfFunctionPlot[206].X = 2.06
	pointsOfFunctionPlot[206].Y = -0.598

	pointsOfFunctionPlot[207].X = 2.07
	pointsOfFunctionPlot[207].Y = -0.604

	pointsOfFunctionPlot[208].X = 2.08
	pointsOfFunctionPlot[208].Y = -0.609

	pointsOfFunctionPlot[209].X = 2.09
	pointsOfFunctionPlot[209].Y = -0.613

	pointsOfFunctionPlot[210].X = 2.10
	pointsOfFunctionPlot[210].Y = -0.618

	pointsOfFunctionPlot[211].X = 2.11
	pointsOfFunctionPlot[211].Y = -0.622

	pointsOfFunctionPlot[212].X = 2.12
	pointsOfFunctionPlot[212].Y = -0.626

	pointsOfFunctionPlot[213].X = 2.13
	pointsOfFunctionPlot[213].Y = -0.63

	pointsOfFunctionPlot[214].X = 2.14
	pointsOfFunctionPlot[214].Y = -0.634

	pointsOfFunctionPlot[215].X = 2.15
	pointsOfFunctionPlot[215].Y = -0.637

	pointsOfFunctionPlot[216].X = 2.16
	pointsOfFunctionPlot[216].Y = -0.64

	pointsOfFunctionPlot[217].X = 2.17
	pointsOfFunctionPlot[217].Y = -0.643

	pointsOfFunctionPlot[218].X = 2.18
	pointsOfFunctionPlot[218].Y = -0.646

	pointsOfFunctionPlot[219].X = 2.19
	pointsOfFunctionPlot[219].Y = -0.649

	pointsOfFunctionPlot[220].X = 2.20
	pointsOfFunctionPlot[220].Y = -0.652

	pointsOfFunctionPlot[221].X = 2.21
	pointsOfFunctionPlot[221].Y = -0.654

	pointsOfFunctionPlot[222].X = 2.22
	pointsOfFunctionPlot[222].Y = -0.656

	pointsOfFunctionPlot[223].X = 2.23
	pointsOfFunctionPlot[223].Y = -0.658

	pointsOfFunctionPlot[224].X = 2.24
	pointsOfFunctionPlot[224].Y = -0.66

	pointsOfFunctionPlot[225].X = 2.25
	pointsOfFunctionPlot[225].Y = -0.662

	pointsOfFunctionPlot[226].X = 2.26
	pointsOfFunctionPlot[226].Y = -0.663

	pointsOfFunctionPlot[227].X = 2.27
	pointsOfFunctionPlot[227].Y = -0.664

	pointsOfFunctionPlot[228].X = 2.28
	pointsOfFunctionPlot[228].Y = -0.666

	pointsOfFunctionPlot[229].X = 2.29
	pointsOfFunctionPlot[229].Y = -0.667

	pointsOfFunctionPlot[230].X = 2.30
	pointsOfFunctionPlot[230].Y = -0.668

	pointsOfFunctionPlot[231].X = 2.31
	pointsOfFunctionPlot[231].Y = -0.668

	pointsOfFunctionPlot[232].X = 2.32
	pointsOfFunctionPlot[232].Y = -0.669

	pointsOfFunctionPlot[233].X = 2.33
	pointsOfFunctionPlot[233].Y = -0.669

	pointsOfFunctionPlot[234].X = 2.34
	pointsOfFunctionPlot[234].Y = -0.67

	pointsOfFunctionPlot[235].X = 2.35
	pointsOfFunctionPlot[235].Y = -0.67

	pointsOfFunctionPlot[236].X = 2.36
	pointsOfFunctionPlot[236].Y = -0.67

	pointsOfFunctionPlot[237].X = 2.37
	pointsOfFunctionPlot[237].Y = -0.67

	pointsOfFunctionPlot[238].X = 2.38
	pointsOfFunctionPlot[238].Y = -0.669

	pointsOfFunctionPlot[239].X = 2.39
	pointsOfFunctionPlot[239].Y = -0.669

	pointsOfFunctionPlot[240].X = 2.40
	pointsOfFunctionPlot[240].Y = -0.668

	pointsOfFunctionPlot[241].X = 2.41
	pointsOfFunctionPlot[241].Y = -0.668

	pointsOfFunctionPlot[242].X = 2.42
	pointsOfFunctionPlot[242].Y = -0.667

	pointsOfFunctionPlot[243].X = 2.43
	pointsOfFunctionPlot[243].Y = -0.666

	pointsOfFunctionPlot[244].X = 2.44
	pointsOfFunctionPlot[244].Y = -0.665

	pointsOfFunctionPlot[245].X = 2.45
	pointsOfFunctionPlot[245].Y = -0.664

	pointsOfFunctionPlot[246].X = 2.46
	pointsOfFunctionPlot[246].Y = -0.663

	pointsOfFunctionPlot[247].X = 2.47
	pointsOfFunctionPlot[247].Y = -0.662

	pointsOfFunctionPlot[248].X = 2.48
	pointsOfFunctionPlot[248].Y = -0.66

	pointsOfFunctionPlot[249].X = 2.49
	pointsOfFunctionPlot[249].Y = -0.659

	pointsOfFunctionPlot[250].X = 2.50
	pointsOfFunctionPlot[250].Y = -0.657

	pointsOfFunctionPlot[251].X = 2.51
	pointsOfFunctionPlot[251].Y = -0.655

	pointsOfFunctionPlot[252].X = 2.52
	pointsOfFunctionPlot[252].Y = -0.654

	pointsOfFunctionPlot[253].X = 2.53
	pointsOfFunctionPlot[253].Y = -0.652

	pointsOfFunctionPlot[254].X = 2.54
	pointsOfFunctionPlot[254].Y = -0.65

	pointsOfFunctionPlot[255].X = 2.55
	pointsOfFunctionPlot[255].Y = -0.648

	pointsOfFunctionPlot[256].X = 2.56
	pointsOfFunctionPlot[256].Y = -0.645

	pointsOfFunctionPlot[257].X = 2.57
	pointsOfFunctionPlot[257].Y = -0.643

	pointsOfFunctionPlot[258].X = 2.58
	pointsOfFunctionPlot[258].Y = -0.641

	pointsOfFunctionPlot[259].X = 2.59
	pointsOfFunctionPlot[259].Y = -0.638
	...
	pointsOfFunctionPlot[528].Y = 0.027

	pointsOfFunctionPlot[529].X = 5.29
	pointsOfFunctionPlot[529].Y = 0.027

	pointsOfFunctionPlot[530].X = 5.30
	pointsOfFunctionPlot[530].Y = 0.027

	pointsOfFunctionPlot[531].X = 5.31
	pointsOfFunctionPlot[531].Y = 0.027

	pointsOfFunctionPlot[532].X = 5.32
	pointsOfFunctionPlot[532].Y = 0.027

	pointsOfFunctionPlot[533].X = 5.33
	pointsOfFunctionPlot[533].Y = 0.028

	pointsOfFunctionPlot[534].X = 5.34
	pointsOfFunctionPlot[534].Y = 0.028

	pointsOfFunctionPlot[535].X = 5.35
	pointsOfFunctionPlot[535].Y = 0.028

	pointsOfFunctionPlot[536].X = 5.36
	pointsOfFunctionPlot[536].Y = 0.028

	pointsOfFunctionPlot[537].X = 5.37
	pointsOfFunctionPlot[537].Y = 0.028

	pointsOfFunctionPlot[538].X = 5.38
	pointsOfFunctionPlot[538].Y = 0.028

	pointsOfFunctionPlot[539].X = 5.39
	pointsOfFunctionPlot[539].Y = 0.028

	pointsOfFunctionPlot[540].X = 5.40
	pointsOfFunctionPlot[540].Y = 0.028

	pointsOfFunctionPlot[541].X = 5.41
	pointsOfFunctionPlot[541].Y = 0.028

	pointsOfFunctionPlot[542].X = 5.42
	pointsOfFunctionPlot[542].Y = 0.028

	pointsOfFunctionPlot[543].X = 5.43
	pointsOfFunctionPlot[543].Y = 0.028

	pointsOfFunctionPlot[544].X = 5.44
	pointsOfFunctionPlot[544].Y = 0.028

	pointsOfFunctionPlot[545].X = 5.45
	pointsOfFunctionPlot[545].Y = 0.028

	pointsOfFunctionPlot[546].X = 5.46
	pointsOfFunctionPlot[546].Y = 0.028

	pointsOfFunctionPlot[547].X = 5.47
	pointsOfFunctionPlot[547].Y = 0.028

	pointsOfFunctionPlot[548].X = 5.48
	pointsOfFunctionPlot[548].Y = 0.029

	pointsOfFunctionPlot[549].X = 5.49
	pointsOfFunctionPlot[549].Y = 0.029

	pointsOfFunctionPlot[550].X = 5.50
	pointsOfFunctionPlot[550].Y = 0.029

	pointsOfFunctionPlot[551].X = 5.51
	pointsOfFunctionPlot[551].Y = 0.029

	pointsOfFunctionPlot[552].X = 5.52
	pointsOfFunctionPlot[552].Y = 0.028

	pointsOfFunctionPlot[553].X = 5.53
	pointsOfFunctionPlot[553].Y = 0.028

	pointsOfFunctionPlot[554].X = 5.54
	pointsOfFunctionPlot[554].Y = 0.028

	pointsOfFunctionPlot[555].X = 5.55
	pointsOfFunctionPlot[555].Y = 0.028

	pointsOfFunctionPlot[556].X = 5.56
	pointsOfFunctionPlot[556].Y = 0.028

	pointsOfFunctionPlot[557].X = 5.57
	pointsOfFunctionPlot[557].Y = 0.028

	pointsOfFunctionPlot[558].X = 5.58
	pointsOfFunctionPlot[558].Y = 0.028

	pointsOfFunctionPlot[559].X = 5.59
	pointsOfFunctionPlot[559].Y = 0.028

	pointsOfFunctionPlot[560].X = 5.60
	pointsOfFunctionPlot[560].Y = 0.028

	pointsOfFunctionPlot[561].X = 5.61
	pointsOfFunctionPlot[561].Y = 0.028

	pointsOfFunctionPlot[562].X = 5.62
	pointsOfFunctionPlot[562].Y = 0.028

	pointsOfFunctionPlot[563].X = 5.63
	pointsOfFunctionPlot[563].Y = 0.028

	pointsOfFunctionPlot[564].X = 5.64
	pointsOfFunctionPlot[564].Y = 0.028

	pointsOfFunctionPlot[565].X = 5.65
	pointsOfFunctionPlot[565].Y = 0.028

	pointsOfFunctionPlot[566].X = 5.66
	pointsOfFunctionPlot[566].Y = 0.028

	pointsOfFunctionPlot[567].X = 5.67
	pointsOfFunctionPlot[567].Y = 0.028

	pointsOfFunctionPlot[568].X = 5.68
	pointsOfFunctionPlot[568].Y = 0.028

	pointsOfFunctionPlot[569].X = 5.69
	pointsOfFunctionPlot[569].Y = 0.028

	pointsOfFunctionPlot[570].X = 5.70
	pointsOfFunctionPlot[570].Y = 0.027

	pointsOfFunctionPlot[571].X = 5.71
	pointsOfFunctionPlot[571].Y = 0.027

	pointsOfFunctionPlot[572].X = 5.72
	pointsOfFunctionPlot[572].Y = 0.027

	pointsOfFunctionPlot[573].X = 5.73
	pointsOfFunctionPlot[573].Y = 0.027

	pointsOfFunctionPlot[574].X = 5.74
	pointsOfFunctionPlot[574].Y = 0.027

	pointsOfFunctionPlot[575].X = 5.75
	pointsOfFunctionPlot[575].Y = 0.027

	pointsOfFunctionPlot[576].X = 5.76
	pointsOfFunctionPlot[576].Y = 0.027

	pointsOfFunctionPlot[577].X = 5.77
	pointsOfFunctionPlot[577].Y = 0.027

	pointsOfFunctionPlot[578].X = 5.78
	pointsOfFunctionPlot[578].Y = 0.027

	pointsOfFunctionPlot[579].X = 5.79
	pointsOfFunctionPlot[579].Y = 0.026

	pointsOfFunctionPlot[580].X = 5.80
	pointsOfFunctionPlot[580].Y = 0.026

	pointsOfFunctionPlot[581].X = 5.81
	pointsOfFunctionPlot[581].Y = 0.026

	pointsOfFunctionPlot[582].X = 5.82
	pointsOfFunctionPlot[582].Y = 0.026

	pointsOfFunctionPlot[583].X = 5.83
	pointsOfFunctionPlot[583].Y = 0.026

	pointsOfFunctionPlot[584].X = 5.84
	pointsOfFunctionPlot[584].Y = 0.026

	pointsOfFunctionPlot[585].X = 5.85
	pointsOfFunctionPlot[585].Y = 0.026

	pointsOfFunctionPlot[586].X = 5.86
	pointsOfFunctionPlot[586].Y = 0.026

	pointsOfFunctionPlot[587].X = 5.87
	pointsOfFunctionPlot[587].Y = 0.025

	pointsOfFunctionPlot[588].X = 5.88
	pointsOfFunctionPlot[588].Y = 0.025

	pointsOfFunctionPlot[589].X = 5.89
	pointsOfFunctionPlot[589].Y = 0.025

	pointsOfFunctionPlot[590].X = 5.90
	pointsOfFunctionPlot[590].Y = 0.025

	pointsOfFunctionPlot[591].X = 5.91
	pointsOfFunctionPlot[591].Y = 0.025

	pointsOfFunctionPlot[592].X = 5.92
	pointsOfFunctionPlot[592].Y = 0.025

	pointsOfFunctionPlot[593].X = 5.93
	pointsOfFunctionPlot[593].Y = 0.024

	pointsOfFunctionPlot[594].X = 5.94
	pointsOfFunctionPlot[594].Y = 0.024

	pointsOfFunctionPlot[595].X = 5.95
	pointsOfFunctionPlot[595].Y = 0.024

	pointsOfFunctionPlot[596].X = 5.96
	pointsOfFunctionPlot[596].Y = 0.024

	pointsOfFunctionPlot[597].X = 5.97
	pointsOfFunctionPlot[597].Y = 0.024

	pointsOfFunctionPlot[598].X = 5.98
	pointsOfFunctionPlot[598].Y = 0.024

	pointsOfFunctionPlot[599].X = 5.99
	pointsOfFunctionPlot[599].Y = 0.024

	pointsOfFunctionPlot[600].X = 6.0
	pointsOfFunctionPlot[600].Y = 0.023

	pointsOfFunctionPlot[601].X = 6.01
	pointsOfFunctionPlot[601].Y = 0.023

	pointsOfFunctionPlot[602].X = 6.02
	pointsOfFunctionPlot[602].Y = 0.023

	pointsOfFunctionPlot[603].X = 6.03
	pointsOfFunctionPlot[603].Y = 0.023

	pointsOfFunctionPlot[604].X = 6.04
	pointsOfFunctionPlot[604].Y = 0.023

	pointsOfFunctionPlot[605].X = 6.05
	pointsOfFunctionPlot[605].Y = 0.022

	pointsOfFunctionPlot[606].X = 6.06
	pointsOfFunctionPlot[606].Y = 0.022

	pointsOfFunctionPlot[607].X = 6.07
	pointsOfFunctionPlot[607].Y = 0.022

	pointsOfFunctionPlot[608].X = 6.08
	pointsOfFunctionPlot[608].Y = 0.022

	pointsOfFunctionPlot[609].X = 6.09
	pointsOfFunctionPlot[609].Y = 0.022

	pointsOfFunctionPlot[610].X = 6.10
	pointsOfFunctionPlot[610].Y = 0.022

	pointsOfFunctionPlot[611].X = 6.11
	pointsOfFunctionPlot[611].Y = 0.021

	pointsOfFunctionPlot[612].X = 6.12
	pointsOfFunctionPlot[612].Y = 0.021

	pointsOfFunctionPlot[613].X = 6.13
	pointsOfFunctionPlot[613].Y = 0.021
	...
	pointsOfFunctionPlot[708].Y = 0.005
	...
	pointsOfFunctionPlot[717].Y = 0.004

	pointsOfFunctionPlot[718].X = 7.18
	pointsOfFunctionPlot[718].Y = 0.004

	pointsOfFunctionPlot[719].X = 7.19
	pointsOfFunctionPlot[719].Y = 0.004

	pointsOfFunctionPlot[720].X = 7.20
	pointsOfFunctionPlot[720].Y = 0.004

	pointsOfFunctionPlot[721].X = 7.21
	pointsOfFunctionPlot[721].Y = 0.004

	pointsOfFunctionPlot[722].X = 7.22
	pointsOfFunctionPlot[722].Y = 0.004

	pointsOfFunctionPlot[723].X = 7.23
	pointsOfFunctionPlot[723].Y = 0.004

	pointsOfFunctionPlot[724].X = 7.24
	pointsOfFunctionPlot[724].Y = 0.004

	pointsOfFunctionPlot[725].X = 7.25
	pointsOfFunctionPlot[725].Y = 0.004

	pointsOfFunctionPlot[726].X = 7.26
	pointsOfFunctionPlot[726].Y = 0.003

	pointsOfFunctionPlot[727].X = 7.27
	pointsOfFunctionPlot[727].Y = 0.003

	pointsOfFunctionPlot[728].X = 7.28
	pointsOfFunctionPlot[728].Y = 0.003

	pointsOfFunctionPlot[729].X = 7.29
	pointsOfFunctionPlot[729].Y = 0.003

	pointsOfFunctionPlot[730].X = 7.30
	pointsOfFunctionPlot[730].Y = 0.003

	pointsOfFunctionPlot[731].X = 7.31
	pointsOfFunctionPlot[731].Y = 0.003

	pointsOfFunctionPlot[732].X = 7.32
	pointsOfFunctionPlot[732].Y = 0.003

	pointsOfFunctionPlot[733].X = 7.33
	pointsOfFunctionPlot[733].Y = 0.003

	pointsOfFunctionPlot[734].X = 7.34
	pointsOfFunctionPlot[734].Y = 0.003

	pointsOfFunctionPlot[735].X = 7.35
	pointsOfFunctionPlot[735].Y = 0.003

	pointsOfFunctionPlot[736].X = 7.36
	pointsOfFunctionPlot[736].Y = 0.003

	pointsOfFunctionPlot[737].X = 7.37
	pointsOfFunctionPlot[737].Y = 0.002

	pointsOfFunctionPlot[738].X = 7.38
	pointsOfFunctionPlot[738].Y = 0.002

	pointsOfFunctionPlot[739].X = 7.39
	pointsOfFunctionPlot[739].Y = 0.002

	pointsOfFunctionPlot[740].X = 7.40
	pointsOfFunctionPlot[740].Y = 0.002

	pointsOfFunctionPlot[741].X = 7.41
	pointsOfFunctionPlot[741].Y = 0.002

	pointsOfFunctionPlot[742].X = 7.42
	pointsOfFunctionPlot[742].Y = 0.002

	pointsOfFunctionPlot[743].X = 7.43
	pointsOfFunctionPlot[743].Y = 0.002

	pointsOfFunctionPlot[744].X = 7.44
	pointsOfFunctionPlot[744].Y = 0.002

	pointsOfFunctionPlot[745].X = 7.45
	pointsOfFunctionPlot[745].Y = 0.002

	pointsOfFunctionPlot[746].X = 7.46
	pointsOfFunctionPlot[746].Y = 0.002

	pointsOfFunctionPlot[747].X = 7.47
	pointsOfFunctionPlot[747].Y = 0.002

	pointsOfFunctionPlot[748].X = 7.48
	pointsOfFunctionPlot[748].Y = 0.002

	pointsOfFunctionPlot[749].X = 7.49
	pointsOfFunctionPlot[749].Y = 0.002

	pointsOfFunctionPlot[750].X = 7.50
	pointsOfFunctionPlot[750].Y = 0.001

	pointsOfFunctionPlot[751].X = 7.51
	pointsOfFunctionPlot[751].Y = 0.001

	pointsOfFunctionPlot[752].X = 7.52
	pointsOfFunctionPlot[752].Y = 0.001

	pointsOfFunctionPlot[753].X = 7.53
	pointsOfFunctionPlot[753].Y = 0.001

	pointsOfFunctionPlot[754].X = 7.54
	pointsOfFunctionPlot[754].Y = 0.001

	pointsOfFunctionPlot[755].X = 7.55
	pointsOfFunctionPlot[755].Y = 0.001

	pointsOfFunctionPlot[756].X = 7.56
	pointsOfFunctionPlot[756].Y = 0.001

	pointsOfFunctionPlot[757].X = 7.57
	pointsOfFunctionPlot[757].Y = 0.001

	pointsOfFunctionPlot[758].X = 7.58
	pointsOfFunctionPlot[758].Y = 0.001

	pointsOfFunctionPlot[759].X = 7.59
	pointsOfFunctionPlot[759].Y = 0.001

	pointsOfFunctionPlot[760].X = 7.60
	pointsOfFunctionPlot[760].Y = 0.001

	pointsOfFunctionPlot[761].X = 7.61
	pointsOfFunctionPlot[761].Y = 0.001

	pointsOfFunctionPlot[762].X = 7.62
	pointsOfFunctionPlot[762].Y = 0.001

	pointsOfFunctionPlot[763].X = 7.63
	pointsOfFunctionPlot[763].Y = 0.001

	pointsOfFunctionPlot[764].X = 7.64
	pointsOfFunctionPlot[764].Y = 0.001

	pointsOfFunctionPlot[765].X = 7.65
	pointsOfFunctionPlot[765].Y = 0.001

	pointsOfFunctionPlot[766].X = 7.66
	pointsOfFunctionPlot[766].Y = 0.0

	pointsOfFunctionPlot[767].X = 7.67
	pointsOfFunctionPlot[767].Y = 0.0

	pointsOfFunctionPlot[768].X = 7.68
	pointsOfFunctionPlot[768].Y = 0.0

	pointsOfFunctionPlot[769].X = 7.69
	pointsOfFunctionPlot[769].Y = 0.0

	pointsOfFunctionPlot[770].X = 7.70
	pointsOfFunctionPlot[770].Y = 0.0

	pointsOfFunctionPlot[771].X = 7.71
	pointsOfFunctionPlot[771].Y = 0.0

	pointsOfFunctionPlot[772].X = 7.72
	pointsOfFunctionPlot[772].Y = 0.0

	pointsOfFunctionPlot[773].X = 7.73
	pointsOfFunctionPlot[773].Y = 0.0

	pointsOfFunctionPlot[774].X = 7.74
	pointsOfFunctionPlot[774].Y = 0.0

	pointsOfFunctionPlot[775].X = 7.75
	pointsOfFunctionPlot[775].Y = 0.0

	pointsOfFunctionPlot[776].X = 7.76
	pointsOfFunctionPlot[776].Y = 0.0

	pointsOfFunctionPlot[777].X = 7.77
	pointsOfFunctionPlot[777].Y = 0.0

	pointsOfFunctionPlot[778].X = 7.78
	pointsOfFunctionPlot[778].Y = 0.0

	pointsOfFunctionPlot[779].X = 7.79
	pointsOfFunctionPlot[779].Y = 0.0

	pointsOfFunctionPlot[780].X = 7.80
	pointsOfFunctionPlot[780].Y = 0.0

	pointsOfFunctionPlot[781].X = 7.81
	pointsOfFunctionPlot[781].Y = 0.0

	pointsOfFunctionPlot[782].X = 7.82
	pointsOfFunctionPlot[782].Y = 0.0

	pointsOfFunctionPlot[783].X = 7.83
	pointsOfFunctionPlot[783].Y = 0.0

	pointsOfFunctionPlot[784].X = 7.84
	pointsOfFunctionPlot[784].Y = 0.0
	...
	pointsOfFunctionPlot[918].Y = -0.001

	pointsOfFunctionPlot[919].X = 9.19
	pointsOfFunctionPlot[919].Y = -0.001

	pointsOfFunctionPlot[920].X = 9.20
	pointsOfFunctionPlot[920].Y = -0.001

	pointsOfFunctionPlot[921].X = 9.21
	pointsOfFunctionPlot[921].Y = -0.001

	pointsOfFunctionPlot[922].X = 9.22
	pointsOfFunctionPlot[922].Y = -0.001

	pointsOfFunctionPlot[923].X = 9.23
	pointsOfFunctionPlot[923].Y = -0.001

	pointsOfFunctionPlot[924].X = 9.24
	pointsOfFunctionPlot[924].Y = -0.001

	pointsOfFunctionPlot[925].X = 9.25
	pointsOfFunctionPlot[925].Y = 0.0

	pointsOfFunctionPlot[926].X = 10.0
	pointsOfFunctionPlot[926].Y = 0.0
	...
	plotOfFunction.Title.Text = "Plot of function f(x) = 10.0 * cos(x) * exp(-x)"
	...
	if err := plotOfFunction.Save(10*vg.Inch, 10*vg.Inch,
		"cos-times-exp-function-plot-02.png"); err != nil {
