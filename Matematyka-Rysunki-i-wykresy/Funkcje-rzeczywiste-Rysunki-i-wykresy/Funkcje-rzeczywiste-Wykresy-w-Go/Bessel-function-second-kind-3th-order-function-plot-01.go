...
func main() {
	// Plot of function Y3(x).

	pointsOfFunctionPlot := make(plotter.XYs, 2_001)

	pointsOfFunctionPlot[0].X = 0.02
	pointsOfFunctionPlot[0].Y = -636_651.604

	pointsOfFunctionPlot[1].X = 0.025
	pointsOfFunctionPlot[1].Y = -325_974.79

	pointsOfFunctionPlot[2].X = 0.03
	pointsOfFunctionPlot[2].Y = -188_649.303

	pointsOfFunctionPlot[3].X = 0.035
	pointsOfFunctionPlot[3].Y = -118_804.388

	pointsOfFunctionPlot[4].X = 0.04
	pointsOfFunctionPlot[4].Y = -79_593.39

	pointsOfFunctionPlot[5].X = 0.05
	pointsOfFunctionPlot[5].Y = -40_756.401

	pointsOfFunctionPlot[6].X = 0.06
	pointsOfFunctionPlot[6].Y = -23_589.125

	pointsOfFunctionPlot[7].X = 0.07
	pointsOfFunctionPlot[7].Y = -14_857.374

	pointsOfFunctionPlot[8].X = 0.08
	pointsOfFunctionPlot[8].Y = -9_955.148

	pointsOfFunctionPlot[9].X = 0.09
	pointsOfFunctionPlot[9].Y = -6_993.305

	pointsOfFunctionPlot[10].X = 0.10
	pointsOfFunctionPlot[10].Y = -5_099.332

	pointsOfFunctionPlot[11].X = 0.11
	pointsOfFunctionPlot[11].Y = -3_832.211

	pointsOfFunctionPlot[12].X = 0.12
	pointsOfFunctionPlot[12].Y = -2_952.628

	pointsOfFunctionPlot[13].X = 0.13
	pointsOfFunctionPlot[13].Y = -2_323.049

	pointsOfFunctionPlot[14].X = 0.14
	pointsOfFunctionPlot[14].Y = -1_860.592

	pointsOfFunctionPlot[15].X = 0.15
	pointsOfFunctionPlot[15].Y = -1_513.28

	pointsOfFunctionPlot[16].X = 0.16
	pointsOfFunctionPlot[16].Y = -1_247.389

	pointsOfFunctionPlot[17].X = 0.17
	pointsOfFunctionPlot[17].Y = -1_040.387

	pointsOfFunctionPlot[18].X = 0.18
	pointsOfFunctionPlot[18].Y = -876.829

	pointsOfFunctionPlot[19].X = 0.19
	pointsOfFunctionPlot[19].Y = -745.887

	pointsOfFunctionPlot[20].X = 0.20
	pointsOfFunctionPlot[20].Y = -639.819

	pointsOfFunctionPlot[21].X = 0.21
	pointsOfFunctionPlot[21].Y = -552.984

	pointsOfFunctionPlot[22].X = 0.22
	pointsOfFunctionPlot[22].Y = -481.213

	pointsOfFunctionPlot[23].X = 0.23
	pointsOfFunctionPlot[23].Y = -421.374

	pointsOfFunctionPlot[24].X = 0.24
	pointsOfFunctionPlot[24].Y = -371.086

	pointsOfFunctionPlot[25].X = 0.25
	pointsOfFunctionPlot[25].Y = -328.516

	pointsOfFunctionPlot[26].X = 0.26
	pointsOfFunctionPlot[26].Y = -292.237

	pointsOfFunctionPlot[27].X = 0.27
	pointsOfFunctionPlot[27].Y = -261.129

	pointsOfFunctionPlot[28].X = 0.28
	pointsOfFunctionPlot[28].Y = -234.3

	pointsOfFunctionPlot[29].X = 0.29
	pointsOfFunctionPlot[29].Y = -211.04

	pointsOfFunctionPlot[30].X = 0.30
	pointsOfFunctionPlot[30].Y = -190.774

	pointsOfFunctionPlot[31].X = 0.31
	pointsOfFunctionPlot[31].Y = -173.035

	pointsOfFunctionPlot[32].X = 0.32
	pointsOfFunctionPlot[32].Y = -157.44

	pointsOfFunctionPlot[33].X = 0.33
	pointsOfFunctionPlot[33].Y = -143.675

	pointsOfFunctionPlot[34].X = 0.34
	pointsOfFunctionPlot[34].Y = -131.479

	pointsOfFunctionPlot[35].X = 0.35
	pointsOfFunctionPlot[35].Y = -120.634

	pointsOfFunctionPlot[36].X = 0.36
	pointsOfFunctionPlot[36].Y = -110.958

	pointsOfFunctionPlot[37].X = 0.37
	pointsOfFunctionPlot[37].Y = -102.297

	pointsOfFunctionPlot[38].X = 0.38
	pointsOfFunctionPlot[38].Y = -94.522

	pointsOfFunctionPlot[39].X = 0.39
	pointsOfFunctionPlot[39].Y = -87.522

	pointsOfFunctionPlot[40].X = 0.40
	pointsOfFunctionPlot[40].Y = -81.202

	pointsOfFunctionPlot[41].X = 0.41
	pointsOfFunctionPlot[41].Y = -75.482

	pointsOfFunctionPlot[42].X = 0.42
	pointsOfFunctionPlot[42].Y = -70.293

	pointsOfFunctionPlot[43].X = 0.43
	pointsOfFunctionPlot[43].Y = -65.573

	pointsOfFunctionPlot[44].X = 0.44
	pointsOfFunctionPlot[44].Y = -61.271

	pointsOfFunctionPlot[45].X = 0.45
	pointsOfFunctionPlot[45].Y = -57.342

	pointsOfFunctionPlot[46].X = 0.46
	pointsOfFunctionPlot[46].Y = -53.746

	pointsOfFunctionPlot[47].X = 0.47
	pointsOfFunctionPlot[47].Y = -50.448

	pointsOfFunctionPlot[48].X = 0.48
	pointsOfFunctionPlot[48].Y = -47.418

	pointsOfFunctionPlot[49].X = 0.49
	pointsOfFunctionPlot[49].Y = -44.63

	pointsOfFunctionPlot[50].X = 0.50
	pointsOfFunctionPlot[50].Y = -42.059

	pointsOfFunctionPlot[51].X = 0.51
	pointsOfFunctionPlot[51].Y = -39.685

	pointsOfFunctionPlot[52].X = 0.52
	pointsOfFunctionPlot[52].Y = -37.489

	pointsOfFunctionPlot[53].X = 0.53
	pointsOfFunctionPlot[53].Y = -35.455

	pointsOfFunctionPlot[54].X = 0.54
	pointsOfFunctionPlot[54].Y = -33.568

	pointsOfFunctionPlot[55].X = 0.55
	pointsOfFunctionPlot[55].Y = -31.816

	pointsOfFunctionPlot[56].X = 0.56
	pointsOfFunctionPlot[56].Y = -30.185

	pointsOfFunctionPlot[57].X = 0.57
	pointsOfFunctionPlot[57].Y = -28.666

	pointsOfFunctionPlot[58].X = 0.58
	pointsOfFunctionPlot[58].Y = -27.25

	pointsOfFunctionPlot[59].X = 0.59
	pointsOfFunctionPlot[59].Y = -25.927

	pointsOfFunctionPlot[60].X = 0.60
	pointsOfFunctionPlot[60].Y = -24.691

	pointsOfFunctionPlot[61].X = 0.61
	pointsOfFunctionPlot[61].Y = -23.534

	pointsOfFunctionPlot[62].X = 0.62
	pointsOfFunctionPlot[62].Y = -22.45

	pointsOfFunctionPlot[63].X = 0.63
	pointsOfFunctionPlot[63].Y = -21.433

	pointsOfFunctionPlot[64].X = 0.64
	pointsOfFunctionPlot[64].Y = -20.478

	pointsOfFunctionPlot[65].X = 0.65
	pointsOfFunctionPlot[65].Y = -19.581

	pointsOfFunctionPlot[66].X = 0.66
	pointsOfFunctionPlot[66].Y = -18.737

	pointsOfFunctionPlot[67].X = 0.67
	pointsOfFunctionPlot[67].Y = -17.942

	pointsOfFunctionPlot[68].X = 0.68
	pointsOfFunctionPlot[68].Y = -17.193

	pointsOfFunctionPlot[69].X = 0.69
	pointsOfFunctionPlot[69].Y = -16.486

	pointsOfFunctionPlot[70].X = 0.70
	pointsOfFunctionPlot[70].Y = -15.819

	pointsOfFunctionPlot[71].X = 0.71
	pointsOfFunctionPlot[71].Y = -15.189

	pointsOfFunctionPlot[72].X = 0.72
	pointsOfFunctionPlot[72].Y = -14.592

	pointsOfFunctionPlot[73].X = 0.73
	pointsOfFunctionPlot[73].Y = -14.028

	pointsOfFunctionPlot[74].X = 0.74
	pointsOfFunctionPlot[74].Y = -13.494

	pointsOfFunctionPlot[75].X = 0.75
	pointsOfFunctionPlot[75].Y = -12.987

	pointsOfFunctionPlot[76].X = 0.76
	pointsOfFunctionPlot[76].Y = -12.507

	pointsOfFunctionPlot[77].X = 0.77
	pointsOfFunctionPlot[77].Y = -12.051

	pointsOfFunctionPlot[78].X = 0.78
	pointsOfFunctionPlot[78].Y = -11.618

	pointsOfFunctionPlot[79].X = 0.79
	pointsOfFunctionPlot[79].Y = -11.206

	pointsOfFunctionPlot[80].X = 0.80
	pointsOfFunctionPlot[80].Y = -10.814

	pointsOfFunctionPlot[81].X = 0.81
	pointsOfFunctionPlot[81].Y = -10.441

	pointsOfFunctionPlot[82].X = 0.82
	pointsOfFunctionPlot[82].Y = -10.087

	pointsOfFunctionPlot[83].X = 0.83
	pointsOfFunctionPlot[83].Y = -9.748

	pointsOfFunctionPlot[84].X = 0.84
	pointsOfFunctionPlot[84].Y = -9.426

	pointsOfFunctionPlot[85].X = 0.85
	pointsOfFunctionPlot[85].Y = -9.118

	pointsOfFunctionPlot[86].X = 0.86
	pointsOfFunctionPlot[86].Y = -8.825

	pointsOfFunctionPlot[87].X = 0.87
	pointsOfFunctionPlot[87].Y = -8.544

	pointsOfFunctionPlot[88].X = 0.88
	pointsOfFunctionPlot[88].Y = -8.276

	pointsOfFunctionPlot[89].X = 0.89
	pointsOfFunctionPlot[89].Y = -8.02

	pointsOfFunctionPlot[90].X = 0.90
	pointsOfFunctionPlot[90].Y = -7.775

	pointsOfFunctionPlot[91].X = 0.91
	pointsOfFunctionPlot[91].Y = -7.54

	pointsOfFunctionPlot[92].X = 0.92
	pointsOfFunctionPlot[92].Y = -7.316

	pointsOfFunctionPlot[93].X = 0.93
	pointsOfFunctionPlot[93].Y = -7.101

	pointsOfFunctionPlot[94].X = 0.94
	pointsOfFunctionPlot[94].Y = -6.894

	pointsOfFunctionPlot[95].X = 0.95
	pointsOfFunctionPlot[95].Y = -6.697

	pointsOfFunctionPlot[96].X = 0.96
	pointsOfFunctionPlot[96].Y = -6.507

	pointsOfFunctionPlot[97].X = 0.97
	pointsOfFunctionPlot[97].Y = -6.325

	pointsOfFunctionPlot[98].X = 0.98
	pointsOfFunctionPlot[98].Y = -6.15

	pointsOfFunctionPlot[99].X = 0.99
	pointsOfFunctionPlot[99].Y = -5.982

	pointsOfFunctionPlot[100].X = 1.0
	pointsOfFunctionPlot[100].Y = -5.821

	pointsOfFunctionPlot[101].X = 1.01
	pointsOfFunctionPlot[101].Y = -5.666

	pointsOfFunctionPlot[102].X = 1.02
	pointsOfFunctionPlot[102].Y = -5.517

	pointsOfFunctionPlot[103].X = 1.03
	pointsOfFunctionPlot[103].Y = -5.373

	pointsOfFunctionPlot[104].X = 1.04
	pointsOfFunctionPlot[104].Y = -5.235

	pointsOfFunctionPlot[105].X = 1.05
	pointsOfFunctionPlot[105].Y = -5.102

	pointsOfFunctionPlot[106].X = 1.06
	pointsOfFunctionPlot[106].Y = -4.974

	pointsOfFunctionPlot[107].X = 1.07
	pointsOfFunctionPlot[107].Y = -4.851

	pointsOfFunctionPlot[108].X = 1.08
	pointsOfFunctionPlot[108].Y = -4.732

	pointsOfFunctionPlot[109].X = 1.09
	pointsOfFunctionPlot[109].Y = -4.617

	pointsOfFunctionPlot[110].X = 1.10
	pointsOfFunctionPlot[110].Y = -4.507

	pointsOfFunctionPlot[111].X = 1.11
	pointsOfFunctionPlot[111].Y = -4.4

	pointsOfFunctionPlot[112].X = 1.12
	pointsOfFunctionPlot[112].Y = -4.297

	pointsOfFunctionPlot[113].X = 1.13
	pointsOfFunctionPlot[113].Y = -4.198

	pointsOfFunctionPlot[114].X = 1.14
	pointsOfFunctionPlot[114].Y = -4.102

	pointsOfFunctionPlot[115].X = 1.15
	pointsOfFunctionPlot[115].Y = -4.009

	pointsOfFunctionPlot[116].X = 1.16
	pointsOfFunctionPlot[116].Y = -3.919

	pointsOfFunctionPlot[117].X = 1.17
	pointsOfFunctionPlot[117].Y = -3.833

	pointsOfFunctionPlot[118].X = 1.18
	pointsOfFunctionPlot[118].Y = -3.749

	pointsOfFunctionPlot[119].X = 1.19
	pointsOfFunctionPlot[119].Y = -3.668

	pointsOfFunctionPlot[120].X = 1.20
	pointsOfFunctionPlot[120].Y = -3.589

	pointsOfFunctionPlot[121].X = 1.21
	pointsOfFunctionPlot[121].Y = -3.514

	pointsOfFunctionPlot[122].X = 1.22
	pointsOfFunctionPlot[122].Y = -3.44

	pointsOfFunctionPlot[123].X = 1.23
	pointsOfFunctionPlot[123].Y = -3.369

	pointsOfFunctionPlot[124].X = 1.24
	pointsOfFunctionPlot[124].Y = -3.3

	pointsOfFunctionPlot[125].X = 1.25
	pointsOfFunctionPlot[125].Y = -3.233

	pointsOfFunctionPlot[126].X = 1.26
	pointsOfFunctionPlot[126].Y = -3.169

	pointsOfFunctionPlot[127].X = 1.27
	pointsOfFunctionPlot[127].Y = -3.106

	pointsOfFunctionPlot[128].X = 1.28
	pointsOfFunctionPlot[128].Y = -3.045

	pointsOfFunctionPlot[129].X = 1.29
	pointsOfFunctionPlot[129].Y = -2.986

	pointsOfFunctionPlot[130].X = 1.30
	pointsOfFunctionPlot[130].Y = -2.929

	pointsOfFunctionPlot[131].X = 1.31
	pointsOfFunctionPlot[131].Y = -2.874

	pointsOfFunctionPlot[132].X = 1.32
	pointsOfFunctionPlot[132].Y = -2.82

	pointsOfFunctionPlot[133].X = 1.33
	pointsOfFunctionPlot[133].Y = -2.768

	pointsOfFunctionPlot[134].X = 1.34
	pointsOfFunctionPlot[134].Y = -2.717

	pointsOfFunctionPlot[135].X = 1.35
	pointsOfFunctionPlot[135].Y = -2.668

	pointsOfFunctionPlot[136].X = 1.36
	pointsOfFunctionPlot[136].Y = -2.62

	pointsOfFunctionPlot[137].X = 1.37
	pointsOfFunctionPlot[137].Y = -2.573

	pointsOfFunctionPlot[138].X = 1.38
	pointsOfFunctionPlot[138].Y = -2.528

	pointsOfFunctionPlot[139].X = 1.39
	pointsOfFunctionPlot[139].Y = -2.484

	pointsOfFunctionPlot[140].X = 1.40
	pointsOfFunctionPlot[140].Y = -2.441

	pointsOfFunctionPlot[141].X = 1.41
	pointsOfFunctionPlot[141].Y = -2.4

	pointsOfFunctionPlot[142].X = 1.42
	pointsOfFunctionPlot[142].Y = -2.36

	pointsOfFunctionPlot[143].X = 1.43
	pointsOfFunctionPlot[143].Y = -2.32

	pointsOfFunctionPlot[144].X = 1.44
	pointsOfFunctionPlot[144].Y = -2.282

	pointsOfFunctionPlot[145].X = 1.45
	pointsOfFunctionPlot[145].Y = -2.245

	pointsOfFunctionPlot[146].X = 1.46
	pointsOfFunctionPlot[146].Y = -2.209

	pointsOfFunctionPlot[147].X = 1.47
	pointsOfFunctionPlot[147].Y = -2.173

	pointsOfFunctionPlot[148].X = 1.48
	pointsOfFunctionPlot[148].Y = -2.139

	pointsOfFunctionPlot[149].X = 1.49
	pointsOfFunctionPlot[149].Y = -2.106

	pointsOfFunctionPlot[150].X = 1.50
	pointsOfFunctionPlot[150].Y = -2.073

	pointsOfFunctionPlot[151].X = 1.51
	pointsOfFunctionPlot[151].Y = -2.041

	pointsOfFunctionPlot[152].X = 1.52
	pointsOfFunctionPlot[152].Y = -2.01

	pointsOfFunctionPlot[153].X = 1.53
	pointsOfFunctionPlot[153].Y = -1.98

	pointsOfFunctionPlot[154].X = 1.54
	pointsOfFunctionPlot[154].Y = -1.951

	pointsOfFunctionPlot[155].X = 1.55
	pointsOfFunctionPlot[155].Y = -1.922

	pointsOfFunctionPlot[156].X = 1.56
	pointsOfFunctionPlot[156].Y = -1.894

	pointsOfFunctionPlot[157].X = 1.57
	pointsOfFunctionPlot[157].Y = -1.867

	pointsOfFunctionPlot[158].X = 1.58
	pointsOfFunctionPlot[158].Y = -1.84

	pointsOfFunctionPlot[159].X = 1.59
	pointsOfFunctionPlot[159].Y = -1.814

	pointsOfFunctionPlot[160].X = 1.60
	pointsOfFunctionPlot[160].Y = -1.789

	pointsOfFunctionPlot[161].X = 1.61
	pointsOfFunctionPlot[161].Y = -1.764

	pointsOfFunctionPlot[162].X = 1.62
	pointsOfFunctionPlot[162].Y = -1.74

	pointsOfFunctionPlot[163].X = 1.63
	pointsOfFunctionPlot[163].Y = -1.717

	pointsOfFunctionPlot[164].X = 1.64
	pointsOfFunctionPlot[164].Y = -1.694

	pointsOfFunctionPlot[165].X = 1.65
	pointsOfFunctionPlot[165].Y = -1.671

	pointsOfFunctionPlot[166].X = 1.66
	pointsOfFunctionPlot[166].Y = -1.649

	pointsOfFunctionPlot[167].X = 1.67
	pointsOfFunctionPlot[167].Y = -1.628

	pointsOfFunctionPlot[168].X = 1.68
	pointsOfFunctionPlot[168].Y = -1.607

	pointsOfFunctionPlot[169].X = 1.69
	pointsOfFunctionPlot[169].Y = -1.587

	pointsOfFunctionPlot[170].X = 1.70
	pointsOfFunctionPlot[170].Y = -1.567

	pointsOfFunctionPlot[171].X = 1.71
	pointsOfFunctionPlot[171].Y = -1.547

	pointsOfFunctionPlot[172].X = 1.72
	pointsOfFunctionPlot[172].Y = -1.528

	pointsOfFunctionPlot[173].X = 1.73
	pointsOfFunctionPlot[173].Y = -1.509

	pointsOfFunctionPlot[174].X = 1.74
	pointsOfFunctionPlot[174].Y = -1.491

	pointsOfFunctionPlot[175].X = 1.75
	pointsOfFunctionPlot[175].Y = -1.473

	pointsOfFunctionPlot[176].X = 1.76
	pointsOfFunctionPlot[176].Y = -1.455

	pointsOfFunctionPlot[177].X = 1.77
	pointsOfFunctionPlot[177].Y = -1.438

	pointsOfFunctionPlot[178].X = 1.78
	pointsOfFunctionPlot[178].Y = -1.422

	pointsOfFunctionPlot[179].X = 1.79
	pointsOfFunctionPlot[179].Y = -1.405

	pointsOfFunctionPlot[180].X = 1.80
	pointsOfFunctionPlot[180].Y = -1.389

	pointsOfFunctionPlot[181].X = 1.81
	pointsOfFunctionPlot[181].Y = -1.373

	pointsOfFunctionPlot[182].X = 1.82
	pointsOfFunctionPlot[182].Y = -1.358

	pointsOfFunctionPlot[183].X = 1.83
	pointsOfFunctionPlot[183].Y = -1.343

	pointsOfFunctionPlot[184].X = 1.84
	pointsOfFunctionPlot[184].Y = -1.328

	pointsOfFunctionPlot[185].X = 1.85
	pointsOfFunctionPlot[185].Y = -1.314

	pointsOfFunctionPlot[186].X = 1.86
	pointsOfFunctionPlot[186].Y = -1.299

	pointsOfFunctionPlot[187].X = 1.87
	pointsOfFunctionPlot[187].Y = -1.285

	pointsOfFunctionPlot[188].X = 1.88
	pointsOfFunctionPlot[188].Y = -1.272

	pointsOfFunctionPlot[189].X = 1.89
	pointsOfFunctionPlot[189].Y = -1.258

	pointsOfFunctionPlot[190].X = 1.90
	pointsOfFunctionPlot[190].Y = -1.245

	pointsOfFunctionPlot[191].X = 1.91
	pointsOfFunctionPlot[191].Y = -1.233

	pointsOfFunctionPlot[192].X = 1.92
	pointsOfFunctionPlot[192].Y = -1.22

	pointsOfFunctionPlot[193].X = 1.93
	pointsOfFunctionPlot[193].Y = -1.208

	pointsOfFunctionPlot[194].X = 1.94
	pointsOfFunctionPlot[194].Y = -1.195

	pointsOfFunctionPlot[195].X = 1.95
	pointsOfFunctionPlot[195].Y = -1.184

	pointsOfFunctionPlot[196].X = 1.96
	pointsOfFunctionPlot[196].Y = -1.172

	pointsOfFunctionPlot[197].X = 1.97
	pointsOfFunctionPlot[197].Y = -1.16

	pointsOfFunctionPlot[198].X = 1.98
	pointsOfFunctionPlot[198].Y = -1.149

	pointsOfFunctionPlot[199].X = 1.99
	pointsOfFunctionPlot[199].Y = -1.138

	pointsOfFunctionPlot[200].X = 2.0
	pointsOfFunctionPlot[200].Y = -1.127

	pointsOfFunctionPlot[201].X = 2.01
	pointsOfFunctionPlot[201].Y = -1.117

	pointsOfFunctionPlot[202].X = 2.02
	pointsOfFunctionPlot[202].Y = -1.106

	pointsOfFunctionPlot[203].X = 2.03
	pointsOfFunctionPlot[203].Y = -1.096

	pointsOfFunctionPlot[204].X = 2.04
	pointsOfFunctionPlot[204].Y = -1.086

	pointsOfFunctionPlot[205].X = 2.05
	pointsOfFunctionPlot[205].Y = -1.076

	pointsOfFunctionPlot[206].X = 2.06
	pointsOfFunctionPlot[206].Y = -1.066

	pointsOfFunctionPlot[207].X = 2.07
	pointsOfFunctionPlot[207].Y = -1.057

	pointsOfFunctionPlot[208].X = 2.08
	pointsOfFunctionPlot[208].Y = -1.047

	pointsOfFunctionPlot[209].X = 2.09
	pointsOfFunctionPlot[209].Y = -1.038

	pointsOfFunctionPlot[210].X = 2.10
	pointsOfFunctionPlot[210].Y = -1.029

	pointsOfFunctionPlot[211].X = 2.11
	pointsOfFunctionPlot[211].Y = -1.02

	pointsOfFunctionPlot[212].X = 2.12
	pointsOfFunctionPlot[212].Y = -1.011

	pointsOfFunctionPlot[213].X = 2.13
	pointsOfFunctionPlot[213].Y = -1.002

	pointsOfFunctionPlot[214].X = 2.14
	pointsOfFunctionPlot[214].Y = -0.994

	pointsOfFunctionPlot[215].X = 2.15
	pointsOfFunctionPlot[215].Y = -0.985

	pointsOfFunctionPlot[216].X = 2.16
	pointsOfFunctionPlot[216].Y = -0.977

	pointsOfFunctionPlot[217].X = 2.17
	pointsOfFunctionPlot[217].Y = -0.969

	pointsOfFunctionPlot[218].X = 2.18
	pointsOfFunctionPlot[218].Y = -0.961

	pointsOfFunctionPlot[219].X = 2.19
	pointsOfFunctionPlot[219].Y = -0.953

	pointsOfFunctionPlot[220].X = 2.20
	pointsOfFunctionPlot[220].Y = -0.945

	pointsOfFunctionPlot[221].X = 2.21
	pointsOfFunctionPlot[221].Y = -0.938

	pointsOfFunctionPlot[222].X = 2.22
	pointsOfFunctionPlot[222].Y = -0.93

	pointsOfFunctionPlot[223].X = 2.23
	pointsOfFunctionPlot[223].Y = -0.923

	pointsOfFunctionPlot[224].X = 2.24
	pointsOfFunctionPlot[224].Y = -0.915

	pointsOfFunctionPlot[225].X = 2.25
	pointsOfFunctionPlot[225].Y = -0.908

	pointsOfFunctionPlot[226].X = 2.26
	pointsOfFunctionPlot[226].Y = -0.901

	pointsOfFunctionPlot[227].X = 2.27
	pointsOfFunctionPlot[227].Y = -0.894

	pointsOfFunctionPlot[228].X = 2.28
	pointsOfFunctionPlot[228].Y = -0.888

	pointsOfFunctionPlot[229].X = 2.29
	pointsOfFunctionPlot[229].Y = -0.88

	pointsOfFunctionPlot[230].X = 2.30
	pointsOfFunctionPlot[230].Y = -0.874

	pointsOfFunctionPlot[231].X = 2.31
	pointsOfFunctionPlot[231].Y = -0.867

	pointsOfFunctionPlot[232].X = 2.32
	pointsOfFunctionPlot[232].Y = -0.861

	pointsOfFunctionPlot[233].X = 2.33
	pointsOfFunctionPlot[233].Y = -0.854

	pointsOfFunctionPlot[234].X = 2.34
	pointsOfFunctionPlot[234].Y = -0.848

	pointsOfFunctionPlot[235].X = 2.35
	pointsOfFunctionPlot[235].Y = -0.841

	pointsOfFunctionPlot[236].X = 2.36
	pointsOfFunctionPlot[236].Y = -0.835

	pointsOfFunctionPlot[237].X = 2.37
	pointsOfFunctionPlot[237].Y = -0.829

	pointsOfFunctionPlot[238].X = 2.38
	pointsOfFunctionPlot[238].Y = -0.823

	pointsOfFunctionPlot[239].X = 2.39
	pointsOfFunctionPlot[239].Y = -0.817

	pointsOfFunctionPlot[240].X = 2.40
	pointsOfFunctionPlot[240].Y = -0.811

	pointsOfFunctionPlot[241].X = 2.41
	pointsOfFunctionPlot[241].Y = -0.805

	pointsOfFunctionPlot[242].X = 2.42
	pointsOfFunctionPlot[242].Y = -0.799

	pointsOfFunctionPlot[243].X = 2.43
	pointsOfFunctionPlot[243].Y = -0.794

	pointsOfFunctionPlot[244].X = 2.44
	pointsOfFunctionPlot[244].Y = -0.788

	pointsOfFunctionPlot[245].X = 2.45
	pointsOfFunctionPlot[245].Y = -0.783

	pointsOfFunctionPlot[246].X = 2.46
	pointsOfFunctionPlot[246].Y = -0.777

	pointsOfFunctionPlot[247].X = 2.47
	pointsOfFunctionPlot[247].Y = -0.772

	pointsOfFunctionPlot[248].X = 2.48
	pointsOfFunctionPlot[248].Y = -0.766

	pointsOfFunctionPlot[249].X = 2.49
	pointsOfFunctionPlot[249].Y = -0.761

	pointsOfFunctionPlot[250].X = 2.50
	pointsOfFunctionPlot[250].Y = -0.756

	pointsOfFunctionPlot[251].X = 2.51
	pointsOfFunctionPlot[251].Y = -0.75

	pointsOfFunctionPlot[252].X = 2.52
	pointsOfFunctionPlot[252].Y = -0.745

	pointsOfFunctionPlot[253].X = 2.53
	pointsOfFunctionPlot[253].Y = -0.74

	pointsOfFunctionPlot[254].X = 2.54
	pointsOfFunctionPlot[254].Y = -0.735

	pointsOfFunctionPlot[255].X = 2.55
	pointsOfFunctionPlot[255].Y = -0.73

	pointsOfFunctionPlot[256].X = 2.56
	pointsOfFunctionPlot[256].Y = -0.725

	pointsOfFunctionPlot[257].X = 2.57
	pointsOfFunctionPlot[257].Y = -0.72

	pointsOfFunctionPlot[258].X = 2.58
	pointsOfFunctionPlot[258].Y = -0.715

	pointsOfFunctionPlot[259].X = 2.59
	pointsOfFunctionPlot[259].Y = -0.71

	pointsOfFunctionPlot[260].X = 2.60
	pointsOfFunctionPlot[260].Y = -0.705

	pointsOfFunctionPlot[261].X = 2.61
	pointsOfFunctionPlot[261].Y = -0.701

	pointsOfFunctionPlot[262].X = 2.62
	pointsOfFunctionPlot[262].Y = -0.696

	pointsOfFunctionPlot[263].X = 2.63
	pointsOfFunctionPlot[263].Y = -0.691

	pointsOfFunctionPlot[264].X = 2.64
	pointsOfFunctionPlot[264].Y = -0.687

	pointsOfFunctionPlot[265].X = 2.65
	pointsOfFunctionPlot[265].Y = -0.682

	pointsOfFunctionPlot[266].X = 2.66
	pointsOfFunctionPlot[266].Y = -0.677

	pointsOfFunctionPlot[267].X = 2.67
	pointsOfFunctionPlot[267].Y = -0.673

	pointsOfFunctionPlot[268].X = 2.68
	pointsOfFunctionPlot[268].Y = -0.668

	pointsOfFunctionPlot[269].X = 2.69
	pointsOfFunctionPlot[269].Y = -0.664

	pointsOfFunctionPlot[270].X = 2.70
	pointsOfFunctionPlot[270].Y = -0.66

	pointsOfFunctionPlot[271].X = 2.71
	pointsOfFunctionPlot[271].Y = -0.655

	pointsOfFunctionPlot[272].X = 2.72
	pointsOfFunctionPlot[272].Y = -0.651

	pointsOfFunctionPlot[273].X = 2.73
	pointsOfFunctionPlot[273].Y = -0.646

	pointsOfFunctionPlot[274].X = 2.74
	pointsOfFunctionPlot[274].Y = -0.642

	pointsOfFunctionPlot[275].X = 2.75
	pointsOfFunctionPlot[275].Y = -0.638

	pointsOfFunctionPlot[276].X = 2.76
	pointsOfFunctionPlot[276].Y = -0.634

	pointsOfFunctionPlot[277].X = 2.77
	pointsOfFunctionPlot[277].Y = -0.629

	pointsOfFunctionPlot[278].X = 2.78
	pointsOfFunctionPlot[278].Y = -0.625

	pointsOfFunctionPlot[279].X = 2.79
	pointsOfFunctionPlot[279].Y = -0.621

	pointsOfFunctionPlot[280].X = 2.80
	pointsOfFunctionPlot[280].Y = -0.617

	pointsOfFunctionPlot[281].X = 2.81
	pointsOfFunctionPlot[281].Y = -0.613

	pointsOfFunctionPlot[282].X = 2.82
	pointsOfFunctionPlot[282].Y = -0.609

	pointsOfFunctionPlot[283].X = 2.83
	pointsOfFunctionPlot[283].Y = -0.605

	pointsOfFunctionPlot[284].X = 2.84
	pointsOfFunctionPlot[284].Y = -0.6

	pointsOfFunctionPlot[285].X = 2.85
	pointsOfFunctionPlot[285].Y = -0.596

	pointsOfFunctionPlot[286].X = 2.86
	pointsOfFunctionPlot[286].Y = -0.592

	pointsOfFunctionPlot[287].X = 2.87
	pointsOfFunctionPlot[287].Y = -0.588

	pointsOfFunctionPlot[288].X = 2.88
	pointsOfFunctionPlot[288].Y = -0.584

	pointsOfFunctionPlot[289].X = 2.89
	pointsOfFunctionPlot[289].Y = -0.581

	pointsOfFunctionPlot[290].X = 2.90
	pointsOfFunctionPlot[290].Y = -0.577

	pointsOfFunctionPlot[291].X = 2.91
	pointsOfFunctionPlot[291].Y = -0.573

	pointsOfFunctionPlot[292].X = 2.92
	pointsOfFunctionPlot[292].Y = -0.569

	pointsOfFunctionPlot[293].X = 2.93
	pointsOfFunctionPlot[293].Y = -0.565

	pointsOfFunctionPlot[294].X = 2.94
	pointsOfFunctionPlot[294].Y = -0.561

	pointsOfFunctionPlot[295].X = 2.95
	pointsOfFunctionPlot[295].Y = -0.557

	pointsOfFunctionPlot[296].X = 2.96
	pointsOfFunctionPlot[296].Y = -0.553

	pointsOfFunctionPlot[297].X = 2.97
	pointsOfFunctionPlot[297].Y = -0.549

	pointsOfFunctionPlot[298].X = 2.98
	pointsOfFunctionPlot[298].Y = -0.546

	pointsOfFunctionPlot[299].X = 2.99
	pointsOfFunctionPlot[299].Y = -0.542

	pointsOfFunctionPlot[300].X = 3.0
	pointsOfFunctionPlot[300].Y = -0.538

	pointsOfFunctionPlot[301].X = 3.01
	pointsOfFunctionPlot[301].Y = -0.534

	pointsOfFunctionPlot[302].X = 3.02
	pointsOfFunctionPlot[302].Y = -0.531

	pointsOfFunctionPlot[303].X = 3.03
	pointsOfFunctionPlot[303].Y = -0.527

	pointsOfFunctionPlot[304].X = 3.04
	pointsOfFunctionPlot[304].Y = -0.523

	pointsOfFunctionPlot[305].X = 3.05
	pointsOfFunctionPlot[305].Y = -0.519

	pointsOfFunctionPlot[306].X = 3.06
	pointsOfFunctionPlot[306].Y = -0.516

	pointsOfFunctionPlot[307].X = 3.07
	pointsOfFunctionPlot[307].Y = -0.512

	pointsOfFunctionPlot[308].X = 3.08
	pointsOfFunctionPlot[308].Y = -0.508

	pointsOfFunctionPlot[309].X = 3.09
	pointsOfFunctionPlot[309].Y = -0.504

	pointsOfFunctionPlot[310].X = 3.10
	pointsOfFunctionPlot[310].Y = -0.501

	pointsOfFunctionPlot[311].X = 3.11
	pointsOfFunctionPlot[311].Y = -0.497

	pointsOfFunctionPlot[312].X = 3.12
	pointsOfFunctionPlot[312].Y = -0.493

	pointsOfFunctionPlot[313].X = 3.13
	pointsOfFunctionPlot[313].Y = -0.49

	pointsOfFunctionPlot[314].X = 3.14
	pointsOfFunctionPlot[314].Y = -0.486

	pointsOfFunctionPlot[315].X = 3.15
	pointsOfFunctionPlot[315].Y = -0.483

	pointsOfFunctionPlot[316].X = 3.16
	pointsOfFunctionPlot[316].Y = -0.479

	pointsOfFunctionPlot[317].X = 3.17
	pointsOfFunctionPlot[317].Y = -0.475

	pointsOfFunctionPlot[318].X = 3.18
	pointsOfFunctionPlot[318].Y = -0.472

	pointsOfFunctionPlot[319].X = 3.19
	pointsOfFunctionPlot[319].Y = -0.468

	pointsOfFunctionPlot[320].X = 3.20
	pointsOfFunctionPlot[320].Y = -0.464

	pointsOfFunctionPlot[321].X = 3.21
	pointsOfFunctionPlot[321].Y = -0.461

	pointsOfFunctionPlot[322].X = 3.22
	pointsOfFunctionPlot[322].Y = -0.457

	pointsOfFunctionPlot[323].X = 3.23
	pointsOfFunctionPlot[323].Y = -0.454

	pointsOfFunctionPlot[324].X = 3.24
	pointsOfFunctionPlot[324].Y = -0.45

	pointsOfFunctionPlot[325].X = 3.25
	pointsOfFunctionPlot[325].Y = -0.446

	pointsOfFunctionPlot[326].X = 3.26
	pointsOfFunctionPlot[326].Y = -0.443

	pointsOfFunctionPlot[327].X = 3.27
	pointsOfFunctionPlot[327].Y = -0.439

	pointsOfFunctionPlot[328].X = 3.28
	pointsOfFunctionPlot[328].Y = -0.436

	pointsOfFunctionPlot[329].X = 3.29
	pointsOfFunctionPlot[329].Y = -0.432

	pointsOfFunctionPlot[330].X = 3.30
	pointsOfFunctionPlot[330].Y = -0.429

	pointsOfFunctionPlot[331].X = 3.31
	pointsOfFunctionPlot[331].Y = -0.425

	pointsOfFunctionPlot[332].X = 3.32
	pointsOfFunctionPlot[332].Y = -0.421

	pointsOfFunctionPlot[333].X = 3.33
	pointsOfFunctionPlot[333].Y = -0.418

	pointsOfFunctionPlot[334].X = 3.34
	pointsOfFunctionPlot[334].Y = -0.414

	pointsOfFunctionPlot[335].X = 3.35
	pointsOfFunctionPlot[335].Y = -0.411

	pointsOfFunctionPlot[336].X = 3.36
	pointsOfFunctionPlot[336].Y = -0.407

	pointsOfFunctionPlot[337].X = 3.37
	pointsOfFunctionPlot[337].Y = -0.404

	pointsOfFunctionPlot[338].X = 3.38
	pointsOfFunctionPlot[338].Y = -0.4

	pointsOfFunctionPlot[339].X = 3.39
	pointsOfFunctionPlot[339].Y = -0.397

	pointsOfFunctionPlot[340].X = 3.40
	pointsOfFunctionPlot[340].Y = -0.393

	pointsOfFunctionPlot[341].X = 3.41
	pointsOfFunctionPlot[341].Y = -0.39

	pointsOfFunctionPlot[342].X = 3.42
	pointsOfFunctionPlot[342].Y = -0.386

	pointsOfFunctionPlot[343].X = 3.43
	pointsOfFunctionPlot[343].Y = -0.383

	pointsOfFunctionPlot[344].X = 3.44
	pointsOfFunctionPlot[344].Y = -0.379

	pointsOfFunctionPlot[345].X = 3.45
	pointsOfFunctionPlot[345].Y = -0.375

	pointsOfFunctionPlot[346].X = 3.46
	pointsOfFunctionPlot[346].Y = -0.372

	pointsOfFunctionPlot[347].X = 3.47
	pointsOfFunctionPlot[347].Y = -0.368

	pointsOfFunctionPlot[348].X = 3.48
	pointsOfFunctionPlot[348].Y = -0.365

	pointsOfFunctionPlot[349].X = 3.49
	pointsOfFunctionPlot[349].Y = -0.361

	pointsOfFunctionPlot[350].X = 3.50
	pointsOfFunctionPlot[350].Y = -0.358

	pointsOfFunctionPlot[351].X = 3.51
	pointsOfFunctionPlot[351].Y = -0.354

	pointsOfFunctionPlot[352].X = 3.52
	pointsOfFunctionPlot[352].Y = -0.351

	pointsOfFunctionPlot[353].X = 3.53
	pointsOfFunctionPlot[353].Y = -0.347

	pointsOfFunctionPlot[354].X = 3.54
	pointsOfFunctionPlot[354].Y = -0.344

	pointsOfFunctionPlot[355].X = 3.55
	pointsOfFunctionPlot[355].Y = -0.34

	pointsOfFunctionPlot[356].X = 3.56
	pointsOfFunctionPlot[356].Y = -0.337

	pointsOfFunctionPlot[357].X = 3.57
	pointsOfFunctionPlot[357].Y = -0.333

	pointsOfFunctionPlot[358].X = 3.58
	pointsOfFunctionPlot[358].Y = -0.33

	pointsOfFunctionPlot[359].X = 3.59
	pointsOfFunctionPlot[359].Y = -0.326

	pointsOfFunctionPlot[360].X = 3.60
	pointsOfFunctionPlot[360].Y = -0.323

	pointsOfFunctionPlot[361].X = 3.61
	pointsOfFunctionPlot[361].Y = -0.319

	pointsOfFunctionPlot[362].X = 3.62
	pointsOfFunctionPlot[362].Y = -0.316

	pointsOfFunctionPlot[363].X = 3.63
	pointsOfFunctionPlot[363].Y = -0.312

	pointsOfFunctionPlot[364].X = 3.64
	pointsOfFunctionPlot[364].Y = -0.309

	pointsOfFunctionPlot[365].X = 3.65
	pointsOfFunctionPlot[365].Y = -0.305

	pointsOfFunctionPlot[366].X = 3.66
	pointsOfFunctionPlot[366].Y = -0.301

	pointsOfFunctionPlot[367].X = 3.67
	pointsOfFunctionPlot[367].Y = -0.298

	pointsOfFunctionPlot[368].X = 3.68
	pointsOfFunctionPlot[368].Y = -0.294

	pointsOfFunctionPlot[369].X = 3.69
	pointsOfFunctionPlot[369].Y = -0.291

	pointsOfFunctionPlot[370].X = 3.70
	pointsOfFunctionPlot[370].Y = -0.287

	pointsOfFunctionPlot[371].X = 3.71
	pointsOfFunctionPlot[371].Y = -0.284

	pointsOfFunctionPlot[372].X = 3.72
	pointsOfFunctionPlot[372].Y = -0.28

	pointsOfFunctionPlot[373].X = 3.73
	pointsOfFunctionPlot[373].Y = -0.277

	pointsOfFunctionPlot[374].X = 3.74
	pointsOfFunctionPlot[374].Y = -0.273

	pointsOfFunctionPlot[375].X = 3.75
	pointsOfFunctionPlot[375].Y = -0.27

	pointsOfFunctionPlot[376].X = 3.76
	pointsOfFunctionPlot[376].Y = -0.266

	pointsOfFunctionPlot[377].X = 3.77
	pointsOfFunctionPlot[377].Y = -0.263

	pointsOfFunctionPlot[378].X = 3.78
	pointsOfFunctionPlot[378].Y = -0.259

	pointsOfFunctionPlot[379].X = 3.79
	pointsOfFunctionPlot[379].Y = -0.256

	pointsOfFunctionPlot[380].X = 3.80
	pointsOfFunctionPlot[380].Y = -0.252

	pointsOfFunctionPlot[381].X = 3.81
	pointsOfFunctionPlot[381].Y = -0.249

	pointsOfFunctionPlot[382].X = 3.82
	pointsOfFunctionPlot[382].Y = -0.245

	pointsOfFunctionPlot[383].X = 3.83
	pointsOfFunctionPlot[383].Y = -0.241

	pointsOfFunctionPlot[384].X = 3.84
	pointsOfFunctionPlot[384].Y = -0.238

	pointsOfFunctionPlot[385].X = 3.85
	pointsOfFunctionPlot[385].Y = -0.234

	pointsOfFunctionPlot[386].X = 3.86
	pointsOfFunctionPlot[386].Y = -0.231

	pointsOfFunctionPlot[387].X = 3.87
	pointsOfFunctionPlot[387].Y = -0.227

	pointsOfFunctionPlot[388].X = 3.88
	pointsOfFunctionPlot[388].Y = -0.224

	pointsOfFunctionPlot[389].X = 3.89
	pointsOfFunctionPlot[389].Y = -0.22

	pointsOfFunctionPlot[390].X = 3.90
	pointsOfFunctionPlot[390].Y = -0.217

	pointsOfFunctionPlot[391].X = 3.91
	pointsOfFunctionPlot[391].Y = -0.213

	pointsOfFunctionPlot[392].X = 3.92
	pointsOfFunctionPlot[392].Y = -0.21

	pointsOfFunctionPlot[393].X = 3.93
	pointsOfFunctionPlot[393].Y = -0.206

	pointsOfFunctionPlot[394].X = 3.94
	pointsOfFunctionPlot[394].Y = -0.203

	pointsOfFunctionPlot[395].X = 3.95
	pointsOfFunctionPlot[395].Y = -0.199

	pointsOfFunctionPlot[396].X = 3.96
	pointsOfFunctionPlot[396].Y = -0.196

	pointsOfFunctionPlot[397].X = 3.97
	pointsOfFunctionPlot[397].Y = -0.192

	pointsOfFunctionPlot[398].X = 3.98
	pointsOfFunctionPlot[398].Y = -0.189

	pointsOfFunctionPlot[399].X = 3.99
	pointsOfFunctionPlot[399].Y = -0.185

	pointsOfFunctionPlot[400].X = 4.0
	pointsOfFunctionPlot[400].Y = -0.182

	pointsOfFunctionPlot[401].X = 4.01
	pointsOfFunctionPlot[401].Y = -0.178

	pointsOfFunctionPlot[402].X = 4.02
	pointsOfFunctionPlot[402].Y = -0.174

	pointsOfFunctionPlot[403].X = 4.03
	pointsOfFunctionPlot[403].Y = -0.171

	pointsOfFunctionPlot[404].X = 4.04
	pointsOfFunctionPlot[404].Y = -0.167

	pointsOfFunctionPlot[405].X = 4.05
	pointsOfFunctionPlot[405].Y = -0.164

	pointsOfFunctionPlot[406].X = 4.06
	pointsOfFunctionPlot[406].Y = -0.16

	pointsOfFunctionPlot[407].X = 4.07
	pointsOfFunctionPlot[407].Y = -0.157

	pointsOfFunctionPlot[408].X = 4.08
	pointsOfFunctionPlot[408].Y = -0.153

	pointsOfFunctionPlot[409].X = 4.09
	pointsOfFunctionPlot[409].Y = -0.15

	pointsOfFunctionPlot[410].X = 4.10
	pointsOfFunctionPlot[410].Y = -0.146

	pointsOfFunctionPlot[411].X = 4.11
	pointsOfFunctionPlot[411].Y = -0.143

	pointsOfFunctionPlot[412].X = 4.12
	pointsOfFunctionPlot[412].Y = -0.139

	pointsOfFunctionPlot[413].X = 4.13
	pointsOfFunctionPlot[413].Y = -0.136

	pointsOfFunctionPlot[414].X = 4.14
	pointsOfFunctionPlot[414].Y = -0.132

	pointsOfFunctionPlot[415].X = 4.15
	pointsOfFunctionPlot[415].Y = -0.129

	pointsOfFunctionPlot[416].X = 4.16
	pointsOfFunctionPlot[416].Y = -0.125

	pointsOfFunctionPlot[417].X = 4.17
	pointsOfFunctionPlot[417].Y = -0.122

	pointsOfFunctionPlot[418].X = 4.18
	pointsOfFunctionPlot[418].Y = -0.118

	pointsOfFunctionPlot[419].X = 4.19
	pointsOfFunctionPlot[419].Y = -0.115

	pointsOfFunctionPlot[420].X = 4.20
	pointsOfFunctionPlot[420].Y = -0.111

	pointsOfFunctionPlot[421].X = 4.21
	pointsOfFunctionPlot[421].Y = -0.108

	pointsOfFunctionPlot[422].X = 4.22
	pointsOfFunctionPlot[422].Y = -0.104

	pointsOfFunctionPlot[423].X = 4.23
	pointsOfFunctionPlot[423].Y = -0.101

	pointsOfFunctionPlot[424].X = 4.24
	pointsOfFunctionPlot[424].Y = -0.097

	pointsOfFunctionPlot[425].X = 4.25
	pointsOfFunctionPlot[425].Y = -0.094

	pointsOfFunctionPlot[426].X = 4.26
	pointsOfFunctionPlot[426].Y = -0.09

	pointsOfFunctionPlot[427].X = 4.27
	pointsOfFunctionPlot[427].Y = -0.087

	pointsOfFunctionPlot[428].X = 4.28
	pointsOfFunctionPlot[428].Y = -0.084

	pointsOfFunctionPlot[429].X = 4.29
	pointsOfFunctionPlot[429].Y = -0.08

	pointsOfFunctionPlot[430].X = 4.30
	pointsOfFunctionPlot[430].Y = -0.077

	pointsOfFunctionPlot[431].X = 4.31
	pointsOfFunctionPlot[431].Y = -0.073

	pointsOfFunctionPlot[432].X = 4.32
	pointsOfFunctionPlot[432].Y = -0.07

	pointsOfFunctionPlot[433].X = 4.33
	pointsOfFunctionPlot[433].Y = -0.066

	pointsOfFunctionPlot[434].X = 4.34
	pointsOfFunctionPlot[434].Y = -0.063

	pointsOfFunctionPlot[435].X = 4.35
	pointsOfFunctionPlot[435].Y = -0.059

	pointsOfFunctionPlot[436].X = 4.36
	pointsOfFunctionPlot[436].Y = -0.056

	pointsOfFunctionPlot[437].X = 4.37
	pointsOfFunctionPlot[437].Y = -0.053

	pointsOfFunctionPlot[438].X = 4.38
	pointsOfFunctionPlot[438].Y = -0.049

	pointsOfFunctionPlot[439].X = 4.39
	pointsOfFunctionPlot[439].Y = -0.046

	pointsOfFunctionPlot[440].X = 4.40
	pointsOfFunctionPlot[440].Y = -0.042

	pointsOfFunctionPlot[441].X = 4.41
	pointsOfFunctionPlot[441].Y = -0.039

	pointsOfFunctionPlot[442].X = 4.42
	pointsOfFunctionPlot[442].Y = -0.035

	pointsOfFunctionPlot[443].X = 4.43
	pointsOfFunctionPlot[443].Y = -0.032

	pointsOfFunctionPlot[444].X = 4.44
	pointsOfFunctionPlot[444].Y = -0.029

	pointsOfFunctionPlot[445].X = 4.45
	pointsOfFunctionPlot[445].Y = -0.025

	pointsOfFunctionPlot[446].X = 4.46
	pointsOfFunctionPlot[446].Y = -0.022

	pointsOfFunctionPlot[447].X = 4.47
	pointsOfFunctionPlot[447].Y = -0.019

	pointsOfFunctionPlot[448].X = 4.48
	pointsOfFunctionPlot[448].Y = -0.015

	pointsOfFunctionPlot[449].X = 4.49
	pointsOfFunctionPlot[449].Y = -0.012

	pointsOfFunctionPlot[450].X = 4.50
	pointsOfFunctionPlot[450].Y = -0.009

	pointsOfFunctionPlot[451].X = 4.51
	pointsOfFunctionPlot[451].Y = -0.005

	pointsOfFunctionPlot[452].X = 4.52
	pointsOfFunctionPlot[452].Y = -0.002

	pointsOfFunctionPlot[453].X = 4.53
	pointsOfFunctionPlot[453].Y = 0.0

	pointsOfFunctionPlot[454].X = 4.54
	pointsOfFunctionPlot[454].Y = 0.004

	pointsOfFunctionPlot[455].X = 4.55
	pointsOfFunctionPlot[455].Y = 0.007

	pointsOfFunctionPlot[456].X = 4.56
	pointsOfFunctionPlot[456].Y = 0.01

	pointsOfFunctionPlot[457].X = 4.57
	pointsOfFunctionPlot[457].Y = 0.014

	pointsOfFunctionPlot[458].X = 4.58
	pointsOfFunctionPlot[458].Y = 0.017

	pointsOfFunctionPlot[459].X = 4.59
	pointsOfFunctionPlot[459].Y = 0.02

	pointsOfFunctionPlot[460].X = 4.60
	pointsOfFunctionPlot[460].Y = 0.024

	pointsOfFunctionPlot[461].X = 4.61
	pointsOfFunctionPlot[461].Y = 0.027

	pointsOfFunctionPlot[462].X = 4.62
	pointsOfFunctionPlot[462].Y = 0.03

	pointsOfFunctionPlot[463].X = 4.63
	pointsOfFunctionPlot[463].Y = 0.033

	pointsOfFunctionPlot[464].X = 4.64
	pointsOfFunctionPlot[464].Y = 0.037

	pointsOfFunctionPlot[465].X = 4.65
	pointsOfFunctionPlot[465].Y = 0.04

	pointsOfFunctionPlot[466].X = 4.66
	pointsOfFunctionPlot[466].Y = 0.043

	pointsOfFunctionPlot[467].X = 4.67
	pointsOfFunctionPlot[467].Y = 0.046

	pointsOfFunctionPlot[468].X = 4.68
	pointsOfFunctionPlot[468].Y = 0.049

	pointsOfFunctionPlot[469].X = 4.69
	pointsOfFunctionPlot[469].Y = 0.053

	pointsOfFunctionPlot[470].X = 4.70
	pointsOfFunctionPlot[470].Y = 0.056

	pointsOfFunctionPlot[471].X = 4.71
	pointsOfFunctionPlot[471].Y = 0.059

	pointsOfFunctionPlot[472].X = 4.72
	pointsOfFunctionPlot[472].Y = 0.062

	pointsOfFunctionPlot[473].X = 4.73
	pointsOfFunctionPlot[473].Y = 0.065

	pointsOfFunctionPlot[474].X = 4.74
	pointsOfFunctionPlot[474].Y = 0.068

	pointsOfFunctionPlot[475].X = 4.75
	pointsOfFunctionPlot[475].Y = 0.072

	pointsOfFunctionPlot[476].X = 4.76
	pointsOfFunctionPlot[476].Y = 0.075

	pointsOfFunctionPlot[477].X = 4.77
	pointsOfFunctionPlot[477].Y = 0.078

	pointsOfFunctionPlot[478].X = 4.78
	pointsOfFunctionPlot[478].Y = 0.081

	pointsOfFunctionPlot[479].X = 4.79
	pointsOfFunctionPlot[479].Y = 0.084

	pointsOfFunctionPlot[480].X = 4.80
	pointsOfFunctionPlot[480].Y = 0.087

	pointsOfFunctionPlot[481].X = 4.81
	pointsOfFunctionPlot[481].Y = 0.09

	pointsOfFunctionPlot[482].X = 4.82
	pointsOfFunctionPlot[482].Y = 0.093

	pointsOfFunctionPlot[483].X = 4.83
	pointsOfFunctionPlot[483].Y = 0.096

	pointsOfFunctionPlot[484].X = 4.84
	pointsOfFunctionPlot[484].Y = 0.099

	pointsOfFunctionPlot[485].X = 4.85
	pointsOfFunctionPlot[485].Y = 0.102

	pointsOfFunctionPlot[486].X = 4.86
	pointsOfFunctionPlot[486].Y = 0.105

	pointsOfFunctionPlot[487].X = 4.87
	pointsOfFunctionPlot[487].Y = 0.108

	pointsOfFunctionPlot[488].X = 4.88
	pointsOfFunctionPlot[488].Y = 0.111

	pointsOfFunctionPlot[489].X = 4.89
	pointsOfFunctionPlot[489].Y = 0.114

	pointsOfFunctionPlot[490].X = 4.90
	pointsOfFunctionPlot[490].Y = 0.117

	pointsOfFunctionPlot[491].X = 4.91
	pointsOfFunctionPlot[491].Y = 0.12

	pointsOfFunctionPlot[492].X = 4.92
	pointsOfFunctionPlot[492].Y = 0.123

	pointsOfFunctionPlot[493].X = 4.93
	pointsOfFunctionPlot[493].Y = 0.126

	pointsOfFunctionPlot[494].X = 4.94
	pointsOfFunctionPlot[494].Y = 0.129
	...
	pointsOfFunctionPlot[1_318].Y = 0.219

	pointsOfFunctionPlot[1_319].X = 13.19
	pointsOfFunctionPlot[1_319].Y = 0.219

	pointsOfFunctionPlot[1_320].X = 13.20
	pointsOfFunctionPlot[1_320].Y = 0.218

	pointsOfFunctionPlot[1_321].X = 13.21
	pointsOfFunctionPlot[1_321].Y = 0.218
	...
	pointsOfFunctionPlot[1_958].Y = 0.178

	pointsOfFunctionPlot[1_959].X = 19.59
	pointsOfFunctionPlot[1_959].Y = 0.178

	pointsOfFunctionPlot[1_960].X = 19.60
	pointsOfFunctionPlot[1_960].Y = 0.178

	pointsOfFunctionPlot[1_961].X = 19.61
	pointsOfFunctionPlot[1_961].Y = 0.177

	pointsOfFunctionPlot[1_962].X = 19.62
	pointsOfFunctionPlot[1_962].Y = 0.177

	pointsOfFunctionPlot[1_963].X = 19.63
	pointsOfFunctionPlot[1_963].Y = 0.176

	pointsOfFunctionPlot[1_964].X = 19.64
	pointsOfFunctionPlot[1_964].Y = 0.176

	pointsOfFunctionPlot[1_965].X = 19.65
	pointsOfFunctionPlot[1_965].Y = 0.175

	pointsOfFunctionPlot[1_966].X = 19.66
	pointsOfFunctionPlot[1_966].Y = 0.175

	pointsOfFunctionPlot[1_967].X = 19.67
	pointsOfFunctionPlot[1_967].Y = 0.174

	pointsOfFunctionPlot[1_968].X = 19.68
	pointsOfFunctionPlot[1_968].Y = 0.174

	pointsOfFunctionPlot[1_969].X = 19.69
	pointsOfFunctionPlot[1_969].Y = 0.173

	pointsOfFunctionPlot[1_970].X = 19.70
	pointsOfFunctionPlot[1_970].Y = 0.173

	pointsOfFunctionPlot[1_971].X = 19.71
	pointsOfFunctionPlot[1_971].Y = 0.172

	pointsOfFunctionPlot[1_972].X = 19.72
	pointsOfFunctionPlot[1_972].Y = 0.172

	pointsOfFunctionPlot[1_973].X = 19.73
	pointsOfFunctionPlot[1_973].Y = 0.171

	pointsOfFunctionPlot[1_974].X = 19.74
	pointsOfFunctionPlot[1_974].Y = 0.171

	pointsOfFunctionPlot[1_975].X = 19.75
	pointsOfFunctionPlot[1_975].Y = 0.17

	pointsOfFunctionPlot[1_976].X = 19.76
	pointsOfFunctionPlot[1_976].Y = 0.169

	pointsOfFunctionPlot[1_977].X = 19.77
	pointsOfFunctionPlot[1_977].Y = 0.169

	pointsOfFunctionPlot[1_978].X = 19.78
	pointsOfFunctionPlot[1_978].Y = 0.168

	pointsOfFunctionPlot[1_979].X = 19.79
	pointsOfFunctionPlot[1_979].Y = 0.167

	pointsOfFunctionPlot[1_980].X = 19.80
	pointsOfFunctionPlot[1_980].Y = 0.167

	pointsOfFunctionPlot[1_981].X = 19.81
	pointsOfFunctionPlot[1_981].Y = 0.166

	pointsOfFunctionPlot[1_982].X = 19.82
	pointsOfFunctionPlot[1_982].Y = 0.165

	pointsOfFunctionPlot[1_983].X = 19.83
	pointsOfFunctionPlot[1_983].Y = 0.164

	pointsOfFunctionPlot[1_984].X = 19.84
	pointsOfFunctionPlot[1_984].Y = 0.164

	pointsOfFunctionPlot[1_985].X = 19.85
	pointsOfFunctionPlot[1_985].Y = 0.163

	pointsOfFunctionPlot[1_986].X = 19.86
	pointsOfFunctionPlot[1_986].Y = 0.162

	pointsOfFunctionPlot[1_987].X = 19.87
	pointsOfFunctionPlot[1_987].Y = 0.161

	pointsOfFunctionPlot[1_988].X = 19.88
	pointsOfFunctionPlot[1_988].Y = 0.16

	pointsOfFunctionPlot[1_989].X = 19.89
	pointsOfFunctionPlot[1_989].Y = 0.159

	pointsOfFunctionPlot[1_990].X = 19.90
	pointsOfFunctionPlot[1_990].Y = 0.159

	pointsOfFunctionPlot[1_991].X = 19.91
	pointsOfFunctionPlot[1_991].Y = 0.158

	pointsOfFunctionPlot[1_992].X = 19.92
	pointsOfFunctionPlot[1_992].Y = 0.157

	pointsOfFunctionPlot[1_993].X = 19.93
	pointsOfFunctionPlot[1_993].Y = 0.156

	pointsOfFunctionPlot[1_994].X = 19.94
	pointsOfFunctionPlot[1_994].Y = 0.155

	pointsOfFunctionPlot[1_995].X = 19.95
	pointsOfFunctionPlot[1_995].Y = 0.154

	pointsOfFunctionPlot[1_996].X = 19.96
	pointsOfFunctionPlot[1_996].Y = 0.153

	pointsOfFunctionPlot[1_997].X = 19.97
	pointsOfFunctionPlot[1_997].Y = 0.152

	pointsOfFunctionPlot[1_998].X = 19.98
	pointsOfFunctionPlot[1_998].Y = 0.151

	pointsOfFunctionPlot[1_999].X = 19.99
	pointsOfFunctionPlot[1_999].Y = 0.15

	pointsOfFunctionPlot[2_000].X = 20.0
	pointsOfFunctionPlot[2_000].Y = 0.149
	...
	plotOfFunction.Title.Text = "Plot of function Y3(x)"
	...
	plotOfFunction.Legend.Add("Y3(x)", plotLine)

	if err := plotOfFunction.Save(10*vg.Inch, 10*vg.Inch,
		"Bessel-function-second-kind-3th-order-function-plot-01.png"); err != nil {
