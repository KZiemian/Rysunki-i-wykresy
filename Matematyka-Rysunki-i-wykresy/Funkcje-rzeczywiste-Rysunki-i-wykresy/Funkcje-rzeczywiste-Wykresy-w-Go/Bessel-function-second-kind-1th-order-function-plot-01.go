...
func main() {
	...
	pointsOfFunctionPlot[700].Y = -0.302

	pointsOfFunctionPlot[701].X = 7.01
	pointsOfFunctionPlot[701].Y = -0.302

	pointsOfFunctionPlot[702].X = 7.02
	pointsOfFunctionPlot[702].Y = -0.302

	pointsOfFunctionPlot[703].X = 7.03
	pointsOfFunctionPlot[703].Y = -0.302

	pointsOfFunctionPlot[704].X = 7.04
	pointsOfFunctionPlot[704].Y = -0.301

	pointsOfFunctionPlot[705].X = 7.05
	pointsOfFunctionPlot[705].Y = -0.301

	pointsOfFunctionPlot[706].X = 7.06
	pointsOfFunctionPlot[706].Y = -0.301

	pointsOfFunctionPlot[707].X = 7.07
	pointsOfFunctionPlot[707].Y = -0.3

	pointsOfFunctionPlot[708].X = 7.08
	pointsOfFunctionPlot[708].Y = -0.3
	...
	pointsOfFunctionPlot[1_004].Y = 0.25

	pointsOfFunctionPlot[1_005].X = 10.05
	pointsOfFunctionPlot[1_005].Y = 0.25

	pointsOfFunctionPlot[1_006].X = 10.06
	pointsOfFunctionPlot[1_006].Y = 0.25

	pointsOfFunctionPlot[1_007].X = 10.07
	pointsOfFunctionPlot[1_007].Y = 0.25

	pointsOfFunctionPlot[1_008].X = 10.08
	pointsOfFunctionPlot[1_008].Y = 0.25

	pointsOfFunctionPlot[1_009].X = 10.09
	pointsOfFunctionPlot[1_009].Y = 0.25

	pointsOfFunctionPlot[1_010].X = 10.10
	pointsOfFunctionPlot[1_010].Y = 0.25

	pointsOfFunctionPlot[1_011].X = 10.11
	pointsOfFunctionPlot[1_011].Y = 0.25

	pointsOfFunctionPlot[1_012].X = 10.12
	pointsOfFunctionPlot[1_012].Y = 0.25

	pointsOfFunctionPlot[1_013].X = 10.13
	pointsOfFunctionPlot[1_013].Y = 0.25

	pointsOfFunctionPlot[1_014].X = 10.14
	pointsOfFunctionPlot[1_014].Y = 0.25
	...
	pointsOfFunctionPlot[1_017].Y = 0.25

	pointsOfFunctionPlot[1_018].X = 10.18
	pointsOfFunctionPlot[1_018].Y = 0.25

	pointsOfFunctionPlot[1_019].X = 10.19
	pointsOfFunctionPlot[1_019].Y = 0.25

	pointsOfFunctionPlot[1_020].X = 10.20
	pointsOfFunctionPlot[1_020].Y = 0.25
	...
	pointsOfFunctionPlot[1_322].Y = -0.218

	pointsOfFunctionPlot[1_323].X = 13.23
	pointsOfFunctionPlot[1_323].Y = -0.218

	pointsOfFunctionPlot[1_324].X = 13.24
	pointsOfFunctionPlot[1_324].Y = -0.218

	pointsOfFunctionPlot[1_325].X = 13.25
	pointsOfFunctionPlot[1_325].Y = -0.218

	pointsOfFunctionPlot[1_326].X = 13.26
	pointsOfFunctionPlot[1_326].Y = -0.218
	...
	pointsOfFunctionPlot[1_343].Y = -0.216
	...
	pointsOfFunctionPlot[1_640].Y = 0.196
	...
	pointsOfFunctionPlot[1_946].Y = -0.178

	pointsOfFunctionPlot[1_947].X = 19.47
	pointsOfFunctionPlot[1_947].Y = -0.178

	pointsOfFunctionPlot[1_948].X = 19.48
	pointsOfFunctionPlot[1_948].Y = -0.179

	pointsOfFunctionPlot[1_949].X = 19.49
	pointsOfFunctionPlot[1_949].Y = -0.179

	pointsOfFunctionPlot[1_950].X = 19.50
	pointsOfFunctionPlot[1_950].Y = -0.179
	...
	pointsOfFunctionPlot[1_972].Y = -0.178
	...
	pointsOfFunctionPlot[1_976].Y = -0.177
	...
	plotOfFunction.Title.Text = "Plot of function Y1(x)"
	...
	plotOfFunction.Legend.Add("Y1(x)", plotLine)

	if err := plotOfFunction.Save(10*vg.Inch, 10*vg.Inch,
		"Bessel-function-second-kind-1th-order-function-plot-01.png"); err != nil {
