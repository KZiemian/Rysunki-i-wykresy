...
func main() {
	...
	pointsOfFunctionPlot[861].Y = 0.271

	pointsOfFunctionPlot[862].X = 8.62
	pointsOfFunctionPlot[862].Y = 0.271

	pointsOfFunctionPlot[863].X = 8.63
	pointsOfFunctionPlot[863].Y = 0.271
	...
	pointsOfFunctionPlot[866].Y = 0.27
	...
	pointsOfFunctionPlot[1_486].Y = 0.206

	pointsOfFunctionPlot[1_487].X = 14.87
	pointsOfFunctionPlot[1_487].Y = 0.206
	...
	pointsOfFunctionPlot[1_497].Y = 0.206
	...
	pointsOfFunctionPlot[1_801].Y = -0.187

	pointsOfFunctionPlot[1_802].X = 18.02
	pointsOfFunctionPlot[1_802].Y = -0.187
	...
	pointsOfFunctionPlot[1_812].Y = -0.187

	pointsOfFunctionPlot[1_813].X = 18.13
	pointsOfFunctionPlot[1_813].Y = -0.187
	...
	pointsOfFunctionPlot[1_817].Y = -0.186
	...
	plotOfFunction.Title.Text = "Plot of function Y0(x)"
	...
	plotOfFunction.Legend.Add("Y0(x)", plotLine)

	if err := plotOfFunction.Save(10*vg.Inch, 10*vg.Inch,
		"Bessel-function-second-kind-0th-order-function-plot-01.png"); err != nil {
