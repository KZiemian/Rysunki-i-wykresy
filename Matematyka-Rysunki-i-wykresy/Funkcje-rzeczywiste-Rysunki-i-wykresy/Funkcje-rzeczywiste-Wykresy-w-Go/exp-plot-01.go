...
func main() {
	...
	pointsOfFunctionPlot[319].Y = 0.001

	pointsOfFunctionPlot[320].X = -6.8
	pointsOfFunctionPlot[320].Y = 0.001

	pointsOfFunctionPlot[321].X = -6.79
	pointsOfFunctionPlot[321].Y = 0.001

	pointsOfFunctionPlot[322].X = -6.78
	pointsOfFunctionPlot[322].Y = 0.001

	pointsOfFunctionPlot[323].X = -6.77
	pointsOfFunctionPlot[323].Y = 0.001

	pointsOfFunctionPlot[324].X = -6.76
	pointsOfFunctionPlot[324].Y = 0.001

	pointsOfFunctionPlot[325].X = -6.75
	pointsOfFunctionPlot[325].Y = 0.001

	pointsOfFunctionPlot[326].X = -6.74
	pointsOfFunctionPlot[326].Y = 0.001

	pointsOfFunctionPlot[327].X = -6.73
	pointsOfFunctionPlot[327].Y = 0.001

	pointsOfFunctionPlot[328].X = -6.72
	pointsOfFunctionPlot[328].Y = 0.001

	pointsOfFunctionPlot[329].X = -6.71
	pointsOfFunctionPlot[329].Y = 0.001

	pointsOfFunctionPlot[330].X = -6.7
	pointsOfFunctionPlot[330].Y = 0.001

	pointsOfFunctionPlot[331].X = -6.69
	pointsOfFunctionPlot[331].Y = 0.001

	pointsOfFunctionPlot[332].X = -6.68
	pointsOfFunctionPlot[332].Y = 0.001

	pointsOfFunctionPlot[333].X = -6.67
	pointsOfFunctionPlot[333].Y = 0.001

	pointsOfFunctionPlot[334].X = -6.66
	pointsOfFunctionPlot[334].Y = 0.001

	pointsOfFunctionPlot[335].X = -6.65
	pointsOfFunctionPlot[335].Y = 0.001

	pointsOfFunctionPlot[336].X = -6.64
	pointsOfFunctionPlot[336].Y = 0.001

	pointsOfFunctionPlot[337].X = -6.63
	pointsOfFunctionPlot[337].Y = 0.001

	pointsOfFunctionPlot[338].X = -6.62
	pointsOfFunctionPlot[338].Y = 0.001

	pointsOfFunctionPlot[339].X = -6.61
	pointsOfFunctionPlot[339].Y = 0.001

	pointsOfFunctionPlot[340].X = -6.6
	pointsOfFunctionPlot[340].Y = 0.001

	pointsOfFunctionPlot[341].X = -6.59
	pointsOfFunctionPlot[341].Y = 0.001

	pointsOfFunctionPlot[342].X = -6.58
	pointsOfFunctionPlot[342].Y = 0.001

	pointsOfFunctionPlot[343].X = -6.57
	pointsOfFunctionPlot[343].Y = 0.001

	pointsOfFunctionPlot[344].X = -6.56
	pointsOfFunctionPlot[344].Y = 0.001

	pointsOfFunctionPlot[345].X = -6.55
	pointsOfFunctionPlot[345].Y = 0.001

	pointsOfFunctionPlot[346].X = -6.54
	pointsOfFunctionPlot[346].Y = 0.001

	pointsOfFunctionPlot[347].X = -6.53
	pointsOfFunctionPlot[347].Y = 0.001

	pointsOfFunctionPlot[348].X = -6.52
	pointsOfFunctionPlot[348].Y = 0.001

	pointsOfFunctionPlot[349].X = -6.51
	pointsOfFunctionPlot[349].Y = 0.001

	pointsOfFunctionPlot[350].X = -6.5
	pointsOfFunctionPlot[350].Y = 0.001

	pointsOfFunctionPlot[351].X = -6.49
	pointsOfFunctionPlot[351].Y = 0.001

	pointsOfFunctionPlot[352].X = -6.48
	pointsOfFunctionPlot[352].Y = 0.001

	pointsOfFunctionPlot[353].X = -6.47
	pointsOfFunctionPlot[353].Y = 0.001

	pointsOfFunctionPlot[354].X = -6.46
	pointsOfFunctionPlot[354].Y = 0.001

	pointsOfFunctionPlot[355].X = -6.45
	pointsOfFunctionPlot[355].Y = 0.001

	pointsOfFunctionPlot[356].X = -6.44
	pointsOfFunctionPlot[356].Y = 0.001

	pointsOfFunctionPlot[357].X = -6.43
	pointsOfFunctionPlot[357].Y = 0.001

	pointsOfFunctionPlot[358].X = -6.42
	pointsOfFunctionPlot[358].Y = 0.001

	pointsOfFunctionPlot[359].X = -6.41
	pointsOfFunctionPlot[359].Y = 0.001

	pointsOfFunctionPlot[360].X = -6.4
	pointsOfFunctionPlot[360].Y = 0.001

	pointsOfFunctionPlot[361].X = -6.39
	pointsOfFunctionPlot[361].Y = 0.001

	pointsOfFunctionPlot[362].X = -6.38
	pointsOfFunctionPlot[362].Y = 0.001

	pointsOfFunctionPlot[363].X = -6.37
	pointsOfFunctionPlot[363].Y = 0.001

	pointsOfFunctionPlot[364].X = -6.36
	pointsOfFunctionPlot[364].Y = 0.001

	pointsOfFunctionPlot[365].X = -6.35
	pointsOfFunctionPlot[365].Y = 0.001

	pointsOfFunctionPlot[366].X = -6.34
	pointsOfFunctionPlot[366].Y = 0.001

	pointsOfFunctionPlot[367].X = -6.33
	pointsOfFunctionPlot[367].Y = 0.001

	pointsOfFunctionPlot[368].X = -6.32
	pointsOfFunctionPlot[368].Y = 0.001

	pointsOfFunctionPlot[369].X = -6.31
	pointsOfFunctionPlot[369].Y = 0.001

	pointsOfFunctionPlot[370].X = -6.3
	pointsOfFunctionPlot[370].Y = 0.001

	pointsOfFunctionPlot[371].X = -6.29
	pointsOfFunctionPlot[371].Y = 0.001

	pointsOfFunctionPlot[372].X = -6.28
	pointsOfFunctionPlot[372].Y = 0.001

	pointsOfFunctionPlot[373].X = -6.27
	pointsOfFunctionPlot[373].Y = 0.001

	pointsOfFunctionPlot[374].X = -6.26
	pointsOfFunctionPlot[374].Y = 0.001

	pointsOfFunctionPlot[375].X = -6.25
	pointsOfFunctionPlot[375].Y = 0.001

	pointsOfFunctionPlot[376].X = -6.24
	pointsOfFunctionPlot[376].Y = 0.001

	pointsOfFunctionPlot[377].X = -6.23
	pointsOfFunctionPlot[377].Y = 0.002

	pointsOfFunctionPlot[378].X = -6.22
	pointsOfFunctionPlot[378].Y = 0.002

	pointsOfFunctionPlot[379].X = -6.21
	pointsOfFunctionPlot[379].Y = 0.002

	pointsOfFunctionPlot[380].X = -6.2
	pointsOfFunctionPlot[380].Y = 0.002

	pointsOfFunctionPlot[381].X = -6.19
	pointsOfFunctionPlot[381].Y = 0.002

	pointsOfFunctionPlot[382].X = -6.18
	pointsOfFunctionPlot[382].Y = 0.002

	pointsOfFunctionPlot[383].X = -6.17
	pointsOfFunctionPlot[383].Y = 0.002

	pointsOfFunctionPlot[384].X = -6.16
	pointsOfFunctionPlot[384].Y = 0.002

	pointsOfFunctionPlot[385].X = -6.15
	pointsOfFunctionPlot[385].Y = 0.002

	pointsOfFunctionPlot[386].X = -6.14
	pointsOfFunctionPlot[386].Y = 0.002

	pointsOfFunctionPlot[387].X = -6.13
	pointsOfFunctionPlot[387].Y = 0.002

	pointsOfFunctionPlot[388].X = -6.12
	pointsOfFunctionPlot[388].Y = 0.002

	pointsOfFunctionPlot[389].X = -6.11
	pointsOfFunctionPlot[389].Y = 0.002

	pointsOfFunctionPlot[390].X = -6.1
	pointsOfFunctionPlot[390].Y = 0.002

	pointsOfFunctionPlot[391].X = -6.09
	pointsOfFunctionPlot[391].Y = 0.002

	pointsOfFunctionPlot[392].X = -6.08
	pointsOfFunctionPlot[392].Y = 0.002

	pointsOfFunctionPlot[393].X = -6.07
	pointsOfFunctionPlot[393].Y = 0.002

	pointsOfFunctionPlot[394].X = -6.06
	pointsOfFunctionPlot[394].Y = 0.002

	pointsOfFunctionPlot[395].X = -6.05
	pointsOfFunctionPlot[395].Y = 0.002

	pointsOfFunctionPlot[396].X = -6.04
	pointsOfFunctionPlot[396].Y = 0.002

	pointsOfFunctionPlot[397].X = -6.03
	pointsOfFunctionPlot[397].Y = 0.002

	pointsOfFunctionPlot[398].X = -6.02
	pointsOfFunctionPlot[398].Y = 0.002

	pointsOfFunctionPlot[399].X = -6.01
	pointsOfFunctionPlot[399].Y = 0.002

	pointsOfFunctionPlot[400].X = -6.0
	pointsOfFunctionPlot[400].Y = 0.002

	pointsOfFunctionPlot[401].X = -5.99
	pointsOfFunctionPlot[401].Y = 0.002

	pointsOfFunctionPlot[402].X = -5.98
	pointsOfFunctionPlot[402].Y = 0.002

	pointsOfFunctionPlot[403].X = -5.97
	pointsOfFunctionPlot[403].Y = 0.002

	pointsOfFunctionPlot[404].X = -5.96
	pointsOfFunctionPlot[404].Y = 0.002

	pointsOfFunctionPlot[405].X = -5.95
	pointsOfFunctionPlot[405].Y = 0.002

	pointsOfFunctionPlot[406].X = -5.94
	pointsOfFunctionPlot[406].Y = 0.002

	pointsOfFunctionPlot[407].X = -5.93
	pointsOfFunctionPlot[407].Y = 0.002

	pointsOfFunctionPlot[408].X = -5.92
	pointsOfFunctionPlot[408].Y = 0.002

	pointsOfFunctionPlot[409].X = -5.91
	pointsOfFunctionPlot[409].Y = 0.002

	pointsOfFunctionPlot[410].X = -5.9
	pointsOfFunctionPlot[410].Y = 0.002

	pointsOfFunctionPlot[411].X = -5.89
	pointsOfFunctionPlot[411].Y = 0.002

	pointsOfFunctionPlot[412].X = -5.88
	pointsOfFunctionPlot[412].Y = 0.002

	pointsOfFunctionPlot[413].X = -5.87
	pointsOfFunctionPlot[413].Y = 0.002

	pointsOfFunctionPlot[414].X = -5.86
	pointsOfFunctionPlot[414].Y = 0.002

	pointsOfFunctionPlot[415].X = -5.85
	pointsOfFunctionPlot[415].Y = 0.002

	pointsOfFunctionPlot[416].X = -5.84
	pointsOfFunctionPlot[416].Y = 0.002

	pointsOfFunctionPlot[417].X = -5.82
	pointsOfFunctionPlot[417].Y = 0.002

	pointsOfFunctionPlot[418].X = -5.82
	pointsOfFunctionPlot[418].Y = 0.003

	pointsOfFunctionPlot[419].X = -5.81
	pointsOfFunctionPlot[419].Y = 0.003

	pointsOfFunctionPlot[420].X = -5.8
	pointsOfFunctionPlot[420].Y = 0.003

	pointsOfFunctionPlot[421].X = -5.79
	pointsOfFunctionPlot[421].Y = 0.003

	pointsOfFunctionPlot[422].X = -5.78
	pointsOfFunctionPlot[422].Y = 0.003

	pointsOfFunctionPlot[423].X = -5.77
	pointsOfFunctionPlot[423].Y = 0.003

	pointsOfFunctionPlot[424].X = -5.76
	pointsOfFunctionPlot[424].Y = 0.003

	pointsOfFunctionPlot[425].X = -5.75
	pointsOfFunctionPlot[425].Y = 0.003

	pointsOfFunctionPlot[426].X = -5.74
	pointsOfFunctionPlot[426].Y = 0.003

	pointsOfFunctionPlot[427].X = -5.73
	pointsOfFunctionPlot[427].Y = 0.003

	pointsOfFunctionPlot[428].X = -5.72
	pointsOfFunctionPlot[428].Y = 0.003

	pointsOfFunctionPlot[429].X = -5.71
	pointsOfFunctionPlot[429].Y = 0.003

	pointsOfFunctionPlot[430].X = -5.7
	pointsOfFunctionPlot[430].Y = 0.003

	pointsOfFunctionPlot[431].X = -5.69
	pointsOfFunctionPlot[431].Y = 0.003

	pointsOfFunctionPlot[432].X = -5.68
	pointsOfFunctionPlot[432].Y = 0.003

	pointsOfFunctionPlot[433].X = -5.67
	pointsOfFunctionPlot[433].Y = 0.003

	pointsOfFunctionPlot[434].X = -5.66
	pointsOfFunctionPlot[434].Y = 0.003

	pointsOfFunctionPlot[435].X = -5.65
	pointsOfFunctionPlot[435].Y = 0.003

	pointsOfFunctionPlot[436].X = -5.64
	pointsOfFunctionPlot[436].Y = 0.003

	pointsOfFunctionPlot[437].X = -5.63
	pointsOfFunctionPlot[437].Y = 0.003

	pointsOfFunctionPlot[438].X = -5.62
	pointsOfFunctionPlot[438].Y = 0.003
	...
	pointsOfFunctionPlot[491].Y = 0.006

	pointsOfFunctionPlot[492].X = -5.08
	pointsOfFunctionPlot[492].Y = 0.006

	pointsOfFunctionPlot[493].X = -5.07
	pointsOfFunctionPlot[493].Y = 0.006

	pointsOfFunctionPlot[494].X = -5.06
	pointsOfFunctionPlot[494].Y = 0.006
	...
	pointsOfFunctionPlot[699].Y = 0.049

	pointsOfFunctionPlot[700].X = -3.0
	pointsOfFunctionPlot[700].Y = 0.049

	pointsOfFunctionPlot[701].X = -2.99
	pointsOfFunctionPlot[701].Y = 0.05

	pointsOfFunctionPlot[702].X = -2.98
	pointsOfFunctionPlot[702].Y = 0.05

	pointsOfFunctionPlot[703].X = -2.97
	pointsOfFunctionPlot[703].Y = 0.051

	pointsOfFunctionPlot[704].X = -2.96
	pointsOfFunctionPlot[704].Y = 0.051

	pointsOfFunctionPlot[705].X = -2.95
	pointsOfFunctionPlot[705].Y = 0.052

	pointsOfFunctionPlot[706].X = -2.94
	pointsOfFunctionPlot[706].Y = 0.052

	pointsOfFunctionPlot[707].X = -2.93
	pointsOfFunctionPlot[707].Y = 0.053

	pointsOfFunctionPlot[708].X = -2.92
	pointsOfFunctionPlot[708].Y = 0.053

	pointsOfFunctionPlot[709].X = -2.91
	pointsOfFunctionPlot[709].Y = 0.054

	pointsOfFunctionPlot[710].X = -2.9
	pointsOfFunctionPlot[710].Y = 0.055

	pointsOfFunctionPlot[711].X = -2.89
	pointsOfFunctionPlot[711].Y = 0.055

	pointsOfFunctionPlot[712].X = -2.88
	pointsOfFunctionPlot[712].Y = 0.056

	pointsOfFunctionPlot[713].X = -2.87
	pointsOfFunctionPlot[713].Y = 0.056

	pointsOfFunctionPlot[714].X = -2.86
	pointsOfFunctionPlot[714].Y = 0.057

	pointsOfFunctionPlot[715].X = -2.85
	pointsOfFunctionPlot[715].Y = 0.057

	pointsOfFunctionPlot[716].X = -2.84
	pointsOfFunctionPlot[716].Y = 0.058

	pointsOfFunctionPlot[717].X = -2.83
	pointsOfFunctionPlot[717].Y = 0.059

	pointsOfFunctionPlot[718].X = -2.82
	pointsOfFunctionPlot[718].Y = 0.059

	pointsOfFunctionPlot[719].X = -2.81
	pointsOfFunctionPlot[719].Y = 0.06

	pointsOfFunctionPlot[720].X = -2.8
	pointsOfFunctionPlot[720].Y = 0.06

	pointsOfFunctionPlot[721].X = -2.79
	pointsOfFunctionPlot[721].Y = 0.061

	pointsOfFunctionPlot[722].X = -2.78
	pointsOfFunctionPlot[722].Y = 0.062

	pointsOfFunctionPlot[723].X = -2.77
	pointsOfFunctionPlot[723].Y = 0.062

	pointsOfFunctionPlot[724].X = -2.76
	pointsOfFunctionPlot[724].Y = 0.063

	pointsOfFunctionPlot[725].X = -2.75
	pointsOfFunctionPlot[725].Y = 0.063

	pointsOfFunctionPlot[726].X = -2.74
	pointsOfFunctionPlot[726].Y = 0.064

	pointsOfFunctionPlot[727].X = -2.73
	pointsOfFunctionPlot[727].Y = 0.065

	pointsOfFunctionPlot[728].X = -2.72
	pointsOfFunctionPlot[728].Y = 0.065

	pointsOfFunctionPlot[729].X = -2.71
	pointsOfFunctionPlot[729].Y = 0.066

	pointsOfFunctionPlot[730].X = -2.7
	pointsOfFunctionPlot[730].Y = 0.067

	pointsOfFunctionPlot[731].X = -2.69
	pointsOfFunctionPlot[731].Y = 0.067
	...
	pointsOfFunctionPlot[734].Y = 0.069

	pointsOfFunctionPlot[735].X = -2.65
	pointsOfFunctionPlot[735].Y = 0.07

	pointsOfFunctionPlot[736].X = -2.64
	pointsOfFunctionPlot[736].Y = 0.071

	pointsOfFunctionPlot[737].X = -2.63
	pointsOfFunctionPlot[737].Y = 0.072

	pointsOfFunctionPlot[738].X = -2.62
	pointsOfFunctionPlot[738].Y = 0.072

	pointsOfFunctionPlot[739].X = -2.61
	pointsOfFunctionPlot[739].Y = 0.073

	pointsOfFunctionPlot[740].X = -2.6
	pointsOfFunctionPlot[740].Y = 0.074

	pointsOfFunctionPlot[741].X = -2.59
	pointsOfFunctionPlot[741].Y = 0.075

	pointsOfFunctionPlot[742].X = -2.58
	pointsOfFunctionPlot[742].Y = 0.075

	pointsOfFunctionPlot[743].X = -2.57
	pointsOfFunctionPlot[743].Y = 0.076

	pointsOfFunctionPlot[744].X = -2.56
	pointsOfFunctionPlot[744].Y = 0.077

	pointsOfFunctionPlot[745].X = -2.55
	pointsOfFunctionPlot[745].Y = 0.078

	pointsOfFunctionPlot[746].X = -2.54
	pointsOfFunctionPlot[746].Y = 0.078

	pointsOfFunctionPlot[747].X = -2.53
	pointsOfFunctionPlot[747].Y = 0.079

	pointsOfFunctionPlot[748].X = -2.52
	pointsOfFunctionPlot[748].Y = 0.08

	pointsOfFunctionPlot[749].X = -2.51
	pointsOfFunctionPlot[749].Y = 0.081

	pointsOfFunctionPlot[750].X = -2.5
	pointsOfFunctionPlot[750].Y = 0.082

	pointsOfFunctionPlot[751].X = -2.49
	pointsOfFunctionPlot[751].Y = 0.082

	pointsOfFunctionPlot[752].X = -2.48
	pointsOfFunctionPlot[752].Y = 0.083

	pointsOfFunctionPlot[753].X = -2.47
	pointsOfFunctionPlot[753].Y = 0.084

	pointsOfFunctionPlot[754].X = -2.46
	pointsOfFunctionPlot[754].Y = 0.085

	pointsOfFunctionPlot[755].X = -2.45
	pointsOfFunctionPlot[755].Y = 0.086

	pointsOfFunctionPlot[756].X = -2.44
	pointsOfFunctionPlot[756].Y = 0.087

	pointsOfFunctionPlot[757].X = -2.43
	pointsOfFunctionPlot[757].Y = 0.088

	pointsOfFunctionPlot[758].X = -2.42
	pointsOfFunctionPlot[758].Y = 0.088

	pointsOfFunctionPlot[759].X = -2.41
	pointsOfFunctionPlot[759].Y = 0.089

	pointsOfFunctionPlot[760].X = -2.4
	pointsOfFunctionPlot[760].Y = 0.09

	pointsOfFunctionPlot[761].X = -2.39
	pointsOfFunctionPlot[761].Y = 0.091

	pointsOfFunctionPlot[762].X = -2.38
	pointsOfFunctionPlot[762].Y = 0.092

	pointsOfFunctionPlot[763].X = -2.37
	pointsOfFunctionPlot[763].Y = 0.093

	pointsOfFunctionPlot[764].X = -2.36
	pointsOfFunctionPlot[764].Y = 0.094

	pointsOfFunctionPlot[765].X = -2.35
	pointsOfFunctionPlot[765].Y = 0.095

	pointsOfFunctionPlot[766].X = -2.34
	pointsOfFunctionPlot[766].Y = 0.096

	pointsOfFunctionPlot[767].X = -2.33
	pointsOfFunctionPlot[767].Y = 0.097

	pointsOfFunctionPlot[768].X = -2.32
	pointsOfFunctionPlot[768].Y = 0.098

	pointsOfFunctionPlot[769].X = -2.31
	pointsOfFunctionPlot[769].Y = 0.099

	pointsOfFunctionPlot[770].X = -2.3
	pointsOfFunctionPlot[770].Y = 0.1

	pointsOfFunctionPlot[771].X = -2.29
	pointsOfFunctionPlot[771].Y = 0.101

	pointsOfFunctionPlot[772].X = -2.28
	pointsOfFunctionPlot[772].Y = 0.102

	pointsOfFunctionPlot[773].X = -2.27
	pointsOfFunctionPlot[773].Y = 0.103

	pointsOfFunctionPlot[774].X = -2.26
	pointsOfFunctionPlot[774].Y = 0.104

	pointsOfFunctionPlot[775].X = -2.25
	pointsOfFunctionPlot[775].Y = 0.105

	pointsOfFunctionPlot[776].X = -2.24
	pointsOfFunctionPlot[776].Y = 0.106

	pointsOfFunctionPlot[777].X = -2.23
	pointsOfFunctionPlot[777].Y = 0.107

	pointsOfFunctionPlot[778].X = -2.22
	pointsOfFunctionPlot[778].Y = 0.108

	pointsOfFunctionPlot[779].X = -2.21
	pointsOfFunctionPlot[779].Y = 0.109

	pointsOfFunctionPlot[780].X = -2.2
	pointsOfFunctionPlot[780].Y = 0.11

	pointsOfFunctionPlot[781].X = -2.19
	pointsOfFunctionPlot[781].Y = 0.111

	pointsOfFunctionPlot[782].X = -2.18
	pointsOfFunctionPlot[782].Y = 0.113

	pointsOfFunctionPlot[783].X = -2.17
	pointsOfFunctionPlot[783].Y = 0.114

	pointsOfFunctionPlot[784].X = -2.16
	pointsOfFunctionPlot[784].Y = 0.115

	pointsOfFunctionPlot[785].X = -2.15
	pointsOfFunctionPlot[785].Y = 0.116

	pointsOfFunctionPlot[786].X = -2.14
	pointsOfFunctionPlot[786].Y = 0.117

	pointsOfFunctionPlot[787].X = -2.13
	pointsOfFunctionPlot[787].Y = 0.118

	pointsOfFunctionPlot[788].X = -2.12
	pointsOfFunctionPlot[788].Y = 0.12

	pointsOfFunctionPlot[789].X = -2.11
	pointsOfFunctionPlot[789].Y = 0.121

	pointsOfFunctionPlot[790].X = -2.1
	pointsOfFunctionPlot[790].Y = 0.122

	pointsOfFunctionPlot[791].X = -2.09
	pointsOfFunctionPlot[791].Y = 0.123

	pointsOfFunctionPlot[792].X = -2.08
	pointsOfFunctionPlot[792].Y = 0.124

	pointsOfFunctionPlot[793].X = -2.07
	pointsOfFunctionPlot[793].Y = 0.126

	pointsOfFunctionPlot[794].X = -2.06
	pointsOfFunctionPlot[794].Y = 0.127

	pointsOfFunctionPlot[795].X = -2.05
	pointsOfFunctionPlot[795].Y = 0.128

	pointsOfFunctionPlot[796].X = -2.04
	pointsOfFunctionPlot[796].Y = 0.13

	pointsOfFunctionPlot[797].X = -2.03
	pointsOfFunctionPlot[797].Y = 0.131

	pointsOfFunctionPlot[798].X = -2.02
	pointsOfFunctionPlot[798].Y = 0.132

	pointsOfFunctionPlot[799].X = -2.01
	pointsOfFunctionPlot[799].Y = 0.134

	pointsOfFunctionPlot[800].X = -2.0
	pointsOfFunctionPlot[800].Y = 0.135

	pointsOfFunctionPlot[801].X = -1.99
	pointsOfFunctionPlot[801].Y = 0.135

	pointsOfFunctionPlot[802].X = -1.98
	pointsOfFunctionPlot[802].Y = 0.136

	pointsOfFunctionPlot[803].X = -1.97
	pointsOfFunctionPlot[803].Y = 0.139

	pointsOfFunctionPlot[804].X = -1.96
	pointsOfFunctionPlot[804].Y = 0.14

	pointsOfFunctionPlot[805].X = -1.95
	pointsOfFunctionPlot[805].Y = 0.142

	pointsOfFunctionPlot[806].X = -1.94
	pointsOfFunctionPlot[806].Y = 0.143

	pointsOfFunctionPlot[807].X = -1.93
	pointsOfFunctionPlot[807].Y = 0.145

	pointsOfFunctionPlot[808].X = -1.92
	pointsOfFunctionPlot[808].Y = 0.146

	pointsOfFunctionPlot[809].X = -1.91
	pointsOfFunctionPlot[809].Y = 0.148

	pointsOfFunctionPlot[810].X = -1.9
	pointsOfFunctionPlot[810].Y = 0.149

	pointsOfFunctionPlot[811].X = -1.89
	pointsOfFunctionPlot[811].Y = 0.151

	pointsOfFunctionPlot[812].X = -1.88
	pointsOfFunctionPlot[812].Y = 0.152

	pointsOfFunctionPlot[813].X = -1.87
	pointsOfFunctionPlot[813].Y = 0.154

	pointsOfFunctionPlot[814].X = -1.86
	pointsOfFunctionPlot[814].Y = 0.155

	pointsOfFunctionPlot[815].X = -1.85
	pointsOfFunctionPlot[815].Y = 0.157

	pointsOfFunctionPlot[816].X = -1.84
	pointsOfFunctionPlot[816].Y = 0.158

	pointsOfFunctionPlot[817].X = -1.83
	pointsOfFunctionPlot[817].Y = 0.16

	pointsOfFunctionPlot[818].X = -1.82
	pointsOfFunctionPlot[818].Y = 0.162

	pointsOfFunctionPlot[819].X = -1.81
	pointsOfFunctionPlot[819].Y = 0.163

	pointsOfFunctionPlot[820].X = -1.8
	pointsOfFunctionPlot[820].Y = 0.165

	pointsOfFunctionPlot[821].X = -1.79
	pointsOfFunctionPlot[821].Y = 0.167

	pointsOfFunctionPlot[822].X = -1.78
	pointsOfFunctionPlot[822].Y = 0.168

	pointsOfFunctionPlot[823].X = -1.77
	pointsOfFunctionPlot[823].Y = 0.17

	pointsOfFunctionPlot[824].X = -1.76
	pointsOfFunctionPlot[824].Y = 0.172

	pointsOfFunctionPlot[825].X = -1.75
	pointsOfFunctionPlot[825].Y = 0.173

	pointsOfFunctionPlot[826].X = -1.74
	pointsOfFunctionPlot[826].Y = 0.175

	pointsOfFunctionPlot[827].X = -1.73
	pointsOfFunctionPlot[827].Y = 0.177

	pointsOfFunctionPlot[828].X = -1.72
	pointsOfFunctionPlot[828].Y = 0.179

	pointsOfFunctionPlot[829].X = -1.71
	pointsOfFunctionPlot[829].Y = 0.18

	pointsOfFunctionPlot[830].X = -1.7
	pointsOfFunctionPlot[830].Y = 0.182

	pointsOfFunctionPlot[831].X = -1.69
	pointsOfFunctionPlot[831].Y = 0.184

	pointsOfFunctionPlot[832].X = -1.68
	pointsOfFunctionPlot[832].Y = 0.186

	pointsOfFunctionPlot[833].X = -1.67
	pointsOfFunctionPlot[833].Y = 0.188

	pointsOfFunctionPlot[834].X = -1.66
	pointsOfFunctionPlot[834].Y = 0.19

	pointsOfFunctionPlot[835].X = -1.65
	pointsOfFunctionPlot[835].Y = 0.192

	pointsOfFunctionPlot[836].X = -1.64
	pointsOfFunctionPlot[836].Y = 0.194

	pointsOfFunctionPlot[837].X = -1.63
	pointsOfFunctionPlot[837].Y = 0.195

	pointsOfFunctionPlot[838].X = -1.62
	pointsOfFunctionPlot[838].Y = 0.197

	pointsOfFunctionPlot[839].X = -1.61
	pointsOfFunctionPlot[839].Y = 0.199

	pointsOfFunctionPlot[840].X = -1.6
	pointsOfFunctionPlot[840].Y = 0.201

	pointsOfFunctionPlot[841].X = -1.59
	pointsOfFunctionPlot[841].Y = 0.203

	pointsOfFunctionPlot[842].X = -1.58
	pointsOfFunctionPlot[842].Y = 0.206

	pointsOfFunctionPlot[843].X = -1.57
	pointsOfFunctionPlot[843].Y = 0.208

	pointsOfFunctionPlot[844].X = -1.56
	pointsOfFunctionPlot[844].Y = 0.21

	pointsOfFunctionPlot[845].X = -1.55
	pointsOfFunctionPlot[845].Y = 0.212

	pointsOfFunctionPlot[846].X = -1.54
	pointsOfFunctionPlot[846].Y = 0.214

	pointsOfFunctionPlot[847].X = -1.53
	pointsOfFunctionPlot[847].Y = 0.216

	pointsOfFunctionPlot[848].X = -1.52
	pointsOfFunctionPlot[848].Y = 0.218

	pointsOfFunctionPlot[849].X = -1.51
	pointsOfFunctionPlot[849].Y = 0.22

	pointsOfFunctionPlot[850].X = -1.5
	pointsOfFunctionPlot[850].Y = 0.223

	pointsOfFunctionPlot[851].X = -1.49
	pointsOfFunctionPlot[851].Y = 0.225

	pointsOfFunctionPlot[852].X = -1.48
	pointsOfFunctionPlot[852].Y = 0.227

	pointsOfFunctionPlot[853].X = -1.47
	pointsOfFunctionPlot[853].Y = 0.229

	pointsOfFunctionPlot[854].X = -1.46
	pointsOfFunctionPlot[854].Y = 0.232

	pointsOfFunctionPlot[855].X = -1.45
	pointsOfFunctionPlot[855].Y = 0.234

	pointsOfFunctionPlot[856].X = -1.44
	pointsOfFunctionPlot[856].Y = 0.236

	pointsOfFunctionPlot[857].X = -1.43
	pointsOfFunctionPlot[857].Y = 0.239

	pointsOfFunctionPlot[858].X = -1.42
	pointsOfFunctionPlot[858].Y = 0.241

	pointsOfFunctionPlot[859].X = -1.41
	pointsOfFunctionPlot[859].Y = 0.244

	pointsOfFunctionPlot[860].X = -1.4
	pointsOfFunctionPlot[860].Y = 0.246

	pointsOfFunctionPlot[861].X = -1.39
	pointsOfFunctionPlot[861].Y = 0.249

	pointsOfFunctionPlot[862].X = -1.38
	pointsOfFunctionPlot[862].Y = 0.251

	pointsOfFunctionPlot[863].X = -1.37
	pointsOfFunctionPlot[863].Y = 0.254

	pointsOfFunctionPlot[864].X = -1.36
	pointsOfFunctionPlot[864].Y = 0.256

	pointsOfFunctionPlot[865].X = -1.35
	pointsOfFunctionPlot[865].Y = 0.259

	pointsOfFunctionPlot[866].X = -1.34
	pointsOfFunctionPlot[866].Y = 0.261

	pointsOfFunctionPlot[867].X = -1.33
	pointsOfFunctionPlot[867].Y = 0.264

	pointsOfFunctionPlot[868].X = -1.32
	pointsOfFunctionPlot[868].Y = 0.267

	pointsOfFunctionPlot[869].X = -1.31
	pointsOfFunctionPlot[869].Y = 0.269

	pointsOfFunctionPlot[870].X = -1.3
	pointsOfFunctionPlot[870].Y = 0.272

	pointsOfFunctionPlot[871].X = -1.29
	pointsOfFunctionPlot[871].Y = 0.275

	pointsOfFunctionPlot[872].X = -1.28
	pointsOfFunctionPlot[872].Y = 0.278

	pointsOfFunctionPlot[873].X = -1.27
	pointsOfFunctionPlot[873].Y = 0.28

	pointsOfFunctionPlot[874].X = -1.26
	pointsOfFunctionPlot[874].Y = 0.283

	pointsOfFunctionPlot[875].X = -1.25
	pointsOfFunctionPlot[875].Y = 0.286

	pointsOfFunctionPlot[876].X = -1.24
	pointsOfFunctionPlot[876].Y = 0.289

	pointsOfFunctionPlot[877].X = -1.23
	pointsOfFunctionPlot[877].Y = 0.292

	pointsOfFunctionPlot[878].X = -1.22
	pointsOfFunctionPlot[878].Y = 0.295

	pointsOfFunctionPlot[879].X = -1.21
	pointsOfFunctionPlot[879].Y = 0.298

	pointsOfFunctionPlot[880].X = -1.2
	pointsOfFunctionPlot[880].Y = 0.301

	pointsOfFunctionPlot[881].X = -1.19
	pointsOfFunctionPlot[881].Y = 0.304

	pointsOfFunctionPlot[882].X = -1.18
	pointsOfFunctionPlot[882].Y = 0.307

	pointsOfFunctionPlot[883].X = -1.17
	pointsOfFunctionPlot[883].Y = 0.31

	pointsOfFunctionPlot[884].X = -1.16
	pointsOfFunctionPlot[884].Y = 0.313

	pointsOfFunctionPlot[885].X = -1.15
	pointsOfFunctionPlot[885].Y = 0.316

	pointsOfFunctionPlot[886].X = -1.14
	pointsOfFunctionPlot[886].Y = 0.319

	pointsOfFunctionPlot[887].X = -1.13
	pointsOfFunctionPlot[887].Y = 0.323

	pointsOfFunctionPlot[888].X = -1.12
	pointsOfFunctionPlot[888].Y = 0.326

	pointsOfFunctionPlot[889].X = -1.11
	pointsOfFunctionPlot[889].Y = 0.329

	pointsOfFunctionPlot[890].X = -1.1
	pointsOfFunctionPlot[890].Y = 0.332

	pointsOfFunctionPlot[891].X = -1.09
	pointsOfFunctionPlot[891].Y = 0.336

	pointsOfFunctionPlot[892].X = -1.08
	pointsOfFunctionPlot[892].Y = 0.339

	pointsOfFunctionPlot[893].X = -1.07
	pointsOfFunctionPlot[893].Y = 0.343

	pointsOfFunctionPlot[894].X = -1.06
	pointsOfFunctionPlot[894].Y = 0.346

	pointsOfFunctionPlot[895].X = -1.05
	pointsOfFunctionPlot[895].Y = 0.349

	pointsOfFunctionPlot[896].X = -1.04
	pointsOfFunctionPlot[896].Y = 0.353

	pointsOfFunctionPlot[897].X = -1.03
	pointsOfFunctionPlot[897].Y = 0.357

	pointsOfFunctionPlot[898].X = -1.02
	pointsOfFunctionPlot[898].Y = 0.36

	pointsOfFunctionPlot[899].X = -1.01
	pointsOfFunctionPlot[899].Y = 0.364

	pointsOfFunctionPlot[900].X = -1.0
	pointsOfFunctionPlot[900].Y = 0.367

	pointsOfFunctionPlot[901].X = -0.99
	pointsOfFunctionPlot[901].Y = 0.371

	pointsOfFunctionPlot[902].X = -0.98
	pointsOfFunctionPlot[902].Y = 0.375

	pointsOfFunctionPlot[903].X = -0.97
	pointsOfFunctionPlot[903].Y = 0.379

	pointsOfFunctionPlot[904].X = -0.96
	pointsOfFunctionPlot[904].Y = 0.382

	pointsOfFunctionPlot[905].X = -0.95
	pointsOfFunctionPlot[905].Y = 0.386

	pointsOfFunctionPlot[906].X = -0.94
	pointsOfFunctionPlot[906].Y = 0.39

	pointsOfFunctionPlot[907].X = -0.93
	pointsOfFunctionPlot[907].Y = 0.394

	pointsOfFunctionPlot[908].X = -0.92
	pointsOfFunctionPlot[908].Y = 0.398

	pointsOfFunctionPlot[909].X = -0.91
	pointsOfFunctionPlot[909].Y = 0.402

	pointsOfFunctionPlot[910].X = -0.9
	pointsOfFunctionPlot[910].Y = 0.406

	pointsOfFunctionPlot[911].X = -0.89
	pointsOfFunctionPlot[911].Y = 0.41

	pointsOfFunctionPlot[912].X = -0.88
	pointsOfFunctionPlot[912].Y = 0.414

	pointsOfFunctionPlot[913].X = -0.87
	pointsOfFunctionPlot[913].Y = 0.419

	pointsOfFunctionPlot[914].X = -0.86
	pointsOfFunctionPlot[914].Y = 0.423

	pointsOfFunctionPlot[915].X = -0.85
	pointsOfFunctionPlot[915].Y = 0.427

	pointsOfFunctionPlot[916].X = -0.84
	pointsOfFunctionPlot[916].Y = 0.431

	pointsOfFunctionPlot[917].X = -0.83
	pointsOfFunctionPlot[917].Y = 0.436

	pointsOfFunctionPlot[918].X = -0.82
	pointsOfFunctionPlot[918].Y = 0.44

	pointsOfFunctionPlot[919].X = -0.81
	pointsOfFunctionPlot[919].Y = 0.444

	pointsOfFunctionPlot[920].X = -0.8
	pointsOfFunctionPlot[920].Y = 0.449

	pointsOfFunctionPlot[921].X = -0.79
	pointsOfFunctionPlot[921].Y = 0.453

	pointsOfFunctionPlot[922].X = -0.78
	pointsOfFunctionPlot[922].Y = 0.458

	pointsOfFunctionPlot[923].X = -0.77
	pointsOfFunctionPlot[923].Y = 0.463

	pointsOfFunctionPlot[924].X = -0.76
	pointsOfFunctionPlot[924].Y = 0.467

	pointsOfFunctionPlot[925].X = -0.75
	pointsOfFunctionPlot[925].Y = 0.472

	pointsOfFunctionPlot[926].X = -0.74
	pointsOfFunctionPlot[926].Y = 0.477

	pointsOfFunctionPlot[927].X = -0.73
	pointsOfFunctionPlot[927].Y = 0.481

	pointsOfFunctionPlot[928].X = -0.72
	pointsOfFunctionPlot[928].Y = 0.486

	pointsOfFunctionPlot[929].X = -0.71
	pointsOfFunctionPlot[929].Y = 0.491

	pointsOfFunctionPlot[930].X = -0.7
	pointsOfFunctionPlot[930].Y = 0.496

	pointsOfFunctionPlot[931].X = -0.69
	pointsOfFunctionPlot[931].Y = 0.501

	pointsOfFunctionPlot[932].X = -0.68
	pointsOfFunctionPlot[932].Y = 0.506

	pointsOfFunctionPlot[933].X = -0.67
	pointsOfFunctionPlot[933].Y = 0.511

	pointsOfFunctionPlot[934].X = -0.66
	pointsOfFunctionPlot[934].Y = 0.516

	pointsOfFunctionPlot[935].X = -0.65
	pointsOfFunctionPlot[935].Y = 0.522

	pointsOfFunctionPlot[936].X = -0.64
	pointsOfFunctionPlot[936].Y = 0.527

	pointsOfFunctionPlot[937].X = -0.63
	pointsOfFunctionPlot[937].Y = 0.532

	pointsOfFunctionPlot[938].X = -0.62
	pointsOfFunctionPlot[938].Y = 0.537

	pointsOfFunctionPlot[939].X = -0.61
	pointsOfFunctionPlot[939].Y = 0.543

	pointsOfFunctionPlot[940].X = -0.6
	pointsOfFunctionPlot[940].Y = 0.548

	pointsOfFunctionPlot[941].X = -0.59
	pointsOfFunctionPlot[941].Y = 0.554

	pointsOfFunctionPlot[942].X = -0.58
	pointsOfFunctionPlot[942].Y = 0.559

	pointsOfFunctionPlot[943].X = -0.57
	pointsOfFunctionPlot[943].Y = 0.565

	pointsOfFunctionPlot[944].X = -0.56
	pointsOfFunctionPlot[944].Y = 0.571

	pointsOfFunctionPlot[945].X = -0.55
	pointsOfFunctionPlot[945].Y = 0.576

	pointsOfFunctionPlot[946].X = -0.54
	pointsOfFunctionPlot[946].Y = 0.582

	pointsOfFunctionPlot[947].X = -0.53
	pointsOfFunctionPlot[947].Y = 0.588

	pointsOfFunctionPlot[948].X = -0.52
	pointsOfFunctionPlot[948].Y = 0.594

	pointsOfFunctionPlot[949].X = -0.51
	pointsOfFunctionPlot[949].Y = 0.6

	pointsOfFunctionPlot[950].X = -0.5
	pointsOfFunctionPlot[950].Y = 0.606

	pointsOfFunctionPlot[951].X = -0.49
	pointsOfFunctionPlot[951].Y = 0.612

	pointsOfFunctionPlot[952].X = -0.48
	pointsOfFunctionPlot[952].Y = 0.618

	pointsOfFunctionPlot[953].X = -0.47
	pointsOfFunctionPlot[953].Y = 0.625

	pointsOfFunctionPlot[954].X = -0.46
	pointsOfFunctionPlot[954].Y = 0.631

	pointsOfFunctionPlot[955].X = -0.45
	pointsOfFunctionPlot[955].Y = 0.637

	pointsOfFunctionPlot[956].X = -0.44
	pointsOfFunctionPlot[956].Y = 0.644

	pointsOfFunctionPlot[957].X = -0.43
	pointsOfFunctionPlot[957].Y = 0.65

	pointsOfFunctionPlot[958].X = -0.42
	pointsOfFunctionPlot[958].Y = 0.657

	pointsOfFunctionPlot[959].X = -0.41
	pointsOfFunctionPlot[959].Y = 0.663

	pointsOfFunctionPlot[960].X = -0.4
	pointsOfFunctionPlot[960].Y = 0.67

	pointsOfFunctionPlot[961].X = -0.39
	pointsOfFunctionPlot[961].Y = 0.677

	pointsOfFunctionPlot[962].X = -0.38
	pointsOfFunctionPlot[962].Y = 0.683

	pointsOfFunctionPlot[963].X = -0.37
	pointsOfFunctionPlot[963].Y = 0.69

	pointsOfFunctionPlot[964].X = -0.36
	pointsOfFunctionPlot[964].Y = 0.697

	pointsOfFunctionPlot[965].X = -0.35
	pointsOfFunctionPlot[965].Y = 0.704

	pointsOfFunctionPlot[966].X = -0.34
	pointsOfFunctionPlot[966].Y = 0.711

	pointsOfFunctionPlot[967].X = -0.33
	pointsOfFunctionPlot[967].Y = 0.718

	pointsOfFunctionPlot[968].X = -0.32
	pointsOfFunctionPlot[968].Y = 0.726

	pointsOfFunctionPlot[969].X = -0.31
	pointsOfFunctionPlot[969].Y = 0.733

	pointsOfFunctionPlot[970].X = -0.3
	pointsOfFunctionPlot[970].Y = 0.74

	pointsOfFunctionPlot[971].X = -0.29
	pointsOfFunctionPlot[971].Y = 0.748

	pointsOfFunctionPlot[972].X = -0.28
	pointsOfFunctionPlot[972].Y = 0.755

	pointsOfFunctionPlot[973].X = -0.27
	pointsOfFunctionPlot[973].Y = 0.763

	pointsOfFunctionPlot[974].X = -0.26
	pointsOfFunctionPlot[974].Y = 0.771

	pointsOfFunctionPlot[975].X = -0.25
	pointsOfFunctionPlot[975].Y = 0.778

	pointsOfFunctionPlot[976].X = -0.24
	pointsOfFunctionPlot[976].Y = 0.786

	pointsOfFunctionPlot[977].X = -0.23
	pointsOfFunctionPlot[977].Y = 0.794

	pointsOfFunctionPlot[978].X = -0.22
	pointsOfFunctionPlot[978].Y = 0.802

	pointsOfFunctionPlot[979].X = -0.21
	pointsOfFunctionPlot[979].Y = 0.81

	pointsOfFunctionPlot[980].X = -0.2
	pointsOfFunctionPlot[980].Y = 0.818

	pointsOfFunctionPlot[981].X = -0.19
	pointsOfFunctionPlot[981].Y = 0.827

	pointsOfFunctionPlot[982].X = -0.18
	pointsOfFunctionPlot[982].Y = 0.835

	pointsOfFunctionPlot[983].X = -0.17
	pointsOfFunctionPlot[983].Y = 0.843

	pointsOfFunctionPlot[984].X = -0.16
	pointsOfFunctionPlot[984].Y = 0.852

	pointsOfFunctionPlot[985].X = -0.15
	pointsOfFunctionPlot[985].Y = 0.86

	pointsOfFunctionPlot[986].X = -0.14
	pointsOfFunctionPlot[986].Y = 0.869

	pointsOfFunctionPlot[987].X = -0.13
	pointsOfFunctionPlot[987].Y = 0.878

	pointsOfFunctionPlot[988].X = -0.12
	pointsOfFunctionPlot[988].Y = 0.886

	pointsOfFunctionPlot[989].X = -0.11
	pointsOfFunctionPlot[989].Y = 0.895

	pointsOfFunctionPlot[990].X = -0.1
	pointsOfFunctionPlot[990].Y = 0.904

	pointsOfFunctionPlot[991].X = -0.09
	pointsOfFunctionPlot[991].Y = 0.913

	pointsOfFunctionPlot[992].X = -0.08
	pointsOfFunctionPlot[992].Y = 0.923

	pointsOfFunctionPlot[993].X = -0.07
	pointsOfFunctionPlot[993].Y = 0.932

	pointsOfFunctionPlot[994].X = -0.06
	pointsOfFunctionPlot[994].Y = 0.941

	pointsOfFunctionPlot[995].X = -0.05
	pointsOfFunctionPlot[995].Y = 0.951

	pointsOfFunctionPlot[996].X = -0.04
	pointsOfFunctionPlot[996].Y = 0.96

	pointsOfFunctionPlot[997].X = -0.03
	pointsOfFunctionPlot[997].Y = 0.97

	pointsOfFunctionPlot[998].X = -0.02
	pointsOfFunctionPlot[998].Y = 0.98

	pointsOfFunctionPlot[999].X = -0.01
	pointsOfFunctionPlot[999].Y = 0.99

	pointsOfFunctionPlot[1_000].X = 0.0
	pointsOfFunctionPlot[1_000].Y = 1.0

	pointsOfFunctionPlot[1_001].X = 0.01
	pointsOfFunctionPlot[1_001].Y = 1.01

	pointsOfFunctionPlot[1_002].X = 0.02
	pointsOfFunctionPlot[1_002].Y = 1.02

	pointsOfFunctionPlot[1_003].X = 0.03
	pointsOfFunctionPlot[1_003].Y = 1.03

	pointsOfFunctionPlot[1_004].X = 0.04
	pointsOfFunctionPlot[1_004].Y = 1.04

	pointsOfFunctionPlot[1_005].X = 0.05
	pointsOfFunctionPlot[1_005].Y = 1.051

	pointsOfFunctionPlot[1_006].X = 0.06
	pointsOfFunctionPlot[1_006].Y = 1.061

	pointsOfFunctionPlot[1_007].X = 0.07
	pointsOfFunctionPlot[1_007].Y = 1.072

	pointsOfFunctionPlot[1_008].X = 0.08
	pointsOfFunctionPlot[1_008].Y = 1.083

	pointsOfFunctionPlot[1_009].X = 0.09
	pointsOfFunctionPlot[1_009].Y = 1.094

	pointsOfFunctionPlot[1_010].X = 0.1
	pointsOfFunctionPlot[1_010].Y = 1.105

	pointsOfFunctionPlot[1_011].X = 0.11
	pointsOfFunctionPlot[1_011].Y = 1.116

	pointsOfFunctionPlot[1_012].X = 0.12
	pointsOfFunctionPlot[1_012].Y = 1.127

	pointsOfFunctionPlot[1_013].X = 0.13
	pointsOfFunctionPlot[1_013].Y = 1.138

	pointsOfFunctionPlot[1_014].X = 0.14
	pointsOfFunctionPlot[1_014].Y = 1.15

	pointsOfFunctionPlot[1_015].X = 0.15
	pointsOfFunctionPlot[1_015].Y = 1.161

	pointsOfFunctionPlot[1_016].X = 0.16
	pointsOfFunctionPlot[1_016].Y = 1.173

	pointsOfFunctionPlot[1_017].X = 0.17
	pointsOfFunctionPlot[1_017].Y = 1.185

	pointsOfFunctionPlot[1_018].X = 0.18
	pointsOfFunctionPlot[1_018].Y = 1.197

	pointsOfFunctionPlot[1_019].X = 0.19
	pointsOfFunctionPlot[1_019].Y = 1.209

	pointsOfFunctionPlot[1_020].X = 0.2
	pointsOfFunctionPlot[1_020].Y = 1.221

	pointsOfFunctionPlot[1_021].X = 0.21
	pointsOfFunctionPlot[1_021].Y = 1.233

	pointsOfFunctionPlot[1_022].X = 0.22
	pointsOfFunctionPlot[1_022].Y = 1.246

	pointsOfFunctionPlot[1_023].X = 0.23
	pointsOfFunctionPlot[1_023].Y = 1.258

	pointsOfFunctionPlot[1_024].X = 0.24
	pointsOfFunctionPlot[1_024].Y = 1.271

	pointsOfFunctionPlot[1_025].X = 0.25
	pointsOfFunctionPlot[1_025].Y = 1.284

	pointsOfFunctionPlot[1_026].X = 0.26
	pointsOfFunctionPlot[1_026].Y = 1.296

	pointsOfFunctionPlot[1_027].X = 0.27
	pointsOfFunctionPlot[1_027].Y = 1.31

	pointsOfFunctionPlot[1_028].X = 0.28
	pointsOfFunctionPlot[1_028].Y = 1.323

	pointsOfFunctionPlot[1_029].X = 0.29
	pointsOfFunctionPlot[1_029].Y = 1.336

	pointsOfFunctionPlot[1_030].X = 0.3
	pointsOfFunctionPlot[1_030].Y = 1.349

	pointsOfFunctionPlot[1_031].X = 0.31
	pointsOfFunctionPlot[1_031].Y = 1.363

	pointsOfFunctionPlot[1_032].X = 0.32
	pointsOfFunctionPlot[1_032].Y = 1.377

	pointsOfFunctionPlot[1_033].X = 0.33
	pointsOfFunctionPlot[1_033].Y = 1.391

	pointsOfFunctionPlot[1_034].X = 0.34
	pointsOfFunctionPlot[1_034].Y = 1.404

	pointsOfFunctionPlot[1_035].X = 0.35
	pointsOfFunctionPlot[1_035].Y = 1.419

	pointsOfFunctionPlot[1_036].X = 0.36
	pointsOfFunctionPlot[1_036].Y = 1.433

	pointsOfFunctionPlot[1_037].X = 0.37
	pointsOfFunctionPlot[1_037].Y = 1.447

	pointsOfFunctionPlot[1_038].X = 0.38
	pointsOfFunctionPlot[1_038].Y = 1.462

	pointsOfFunctionPlot[1_039].X = 0.39
	pointsOfFunctionPlot[1_039].Y = 1.477

	pointsOfFunctionPlot[1_040].X = 0.40
	pointsOfFunctionPlot[1_040].Y = 1.491

	pointsOfFunctionPlot[1_041].X = 0.41
	pointsOfFunctionPlot[1_041].Y = 1.506

	pointsOfFunctionPlot[1_042].X = 0.42
	pointsOfFunctionPlot[1_042].Y = 1.522

	pointsOfFunctionPlot[1_043].X = 0.43
	pointsOfFunctionPlot[1_043].Y = 1.537

	pointsOfFunctionPlot[1_044].X = 0.44
	pointsOfFunctionPlot[1_044].Y = 1.552

	pointsOfFunctionPlot[1_045].X = 0.45
	pointsOfFunctionPlot[1_045].Y = 1.568

	pointsOfFunctionPlot[1_046].X = 0.46
	pointsOfFunctionPlot[1_046].Y = 1.584

	pointsOfFunctionPlot[1_047].X = 0.47
	pointsOfFunctionPlot[1_047].Y = 1.6

	pointsOfFunctionPlot[1_048].X = 0.48
	pointsOfFunctionPlot[1_048].Y = 1.616

	pointsOfFunctionPlot[1_049].X = 0.49
	pointsOfFunctionPlot[1_049].Y = 1.632

	pointsOfFunctionPlot[1_050].X = 0.5
	pointsOfFunctionPlot[1_050].Y = 1.648

	pointsOfFunctionPlot[1_051].X = 0.51
	pointsOfFunctionPlot[1_051].Y = 1.665

	pointsOfFunctionPlot[1_052].X = 0.52
	pointsOfFunctionPlot[1_052].Y = 1.682

	pointsOfFunctionPlot[1_053].X = 0.53
	pointsOfFunctionPlot[1_053].Y = 1.698

	pointsOfFunctionPlot[1_054].X = 0.54
	pointsOfFunctionPlot[1_054].Y = 1.716

	pointsOfFunctionPlot[1_055].X = 0.55
	pointsOfFunctionPlot[1_055].Y = 1.733

	pointsOfFunctionPlot[1_056].X = 0.56
	pointsOfFunctionPlot[1_056].Y = 1.75

	pointsOfFunctionPlot[1_057].X = 0.57
	pointsOfFunctionPlot[1_057].Y = 1.768

	pointsOfFunctionPlot[1_058].X = 0.58
	pointsOfFunctionPlot[1_058].Y = 1.786

	pointsOfFunctionPlot[1_059].X = 0.59
	pointsOfFunctionPlot[1_059].Y = 1.804

	pointsOfFunctionPlot[1_060].X = 0.6
	pointsOfFunctionPlot[1_060].Y = 1.822

	pointsOfFunctionPlot[1_061].X = 0.61
	pointsOfFunctionPlot[1_061].Y = 1.84

	pointsOfFunctionPlot[1_062].X = 0.62
	pointsOfFunctionPlot[1_062].Y = 1.858

	pointsOfFunctionPlot[1_063].X = 0.63
	pointsOfFunctionPlot[1_063].Y = 1.877

	pointsOfFunctionPlot[1_064].X = 0.64
	pointsOfFunctionPlot[1_064].Y = 1.896

	pointsOfFunctionPlot[1_065].X = 0.65
	pointsOfFunctionPlot[1_065].Y = 1.915

	pointsOfFunctionPlot[1_066].X = 0.66
	pointsOfFunctionPlot[1_066].Y = 1.938

	pointsOfFunctionPlot[1_067].X = 0.67
	pointsOfFunctionPlot[1_067].Y = 1.954

	pointsOfFunctionPlot[1_068].X = 0.68
	pointsOfFunctionPlot[1_068].Y = 1.973

	pointsOfFunctionPlot[1_069].X = 0.69
	pointsOfFunctionPlot[1_069].Y = 1.993

	pointsOfFunctionPlot[1_070].X = 0.7
	pointsOfFunctionPlot[1_070].Y = 2.013

	pointsOfFunctionPlot[1_071].X = 0.71
	pointsOfFunctionPlot[1_071].Y = 2.034

	pointsOfFunctionPlot[1_072].X = 0.72
	pointsOfFunctionPlot[1_072].Y = 2.054

	pointsOfFunctionPlot[1_073].X = 0.73
	pointsOfFunctionPlot[1_073].Y = 2.075

	pointsOfFunctionPlot[1_074].X = 0.74
	pointsOfFunctionPlot[1_074].Y = 2.095

	pointsOfFunctionPlot[1_075].X = 0.75
	pointsOfFunctionPlot[1_075].Y = 2.117

	pointsOfFunctionPlot[1_076].X = 0.76
	pointsOfFunctionPlot[1_076].Y = 2.138

	pointsOfFunctionPlot[1_077].X = 0.77
	pointsOfFunctionPlot[1_077].Y = 2.159

	pointsOfFunctionPlot[1_078].X = 0.78
	pointsOfFunctionPlot[1_078].Y = 2.181

	pointsOfFunctionPlot[1_079].X = 0.79
	pointsOfFunctionPlot[1_079].Y = 2.203

	pointsOfFunctionPlot[1_080].X = 0.8
	pointsOfFunctionPlot[1_080].Y = 2.225

	pointsOfFunctionPlot[1_081].X = 0.81
	pointsOfFunctionPlot[1_081].Y = 2.247

	pointsOfFunctionPlot[1_082].X = 0.82
	pointsOfFunctionPlot[1_082].Y = 2.27

	pointsOfFunctionPlot[1_083].X = 0.83
	pointsOfFunctionPlot[1_083].Y = 2.293

	pointsOfFunctionPlot[1_084].X = 0.84
	pointsOfFunctionPlot[1_084].Y = 2.316

	pointsOfFunctionPlot[1_085].X = 0.85
	pointsOfFunctionPlot[1_085].Y = 2.339

	pointsOfFunctionPlot[1_086].X = 0.86
	pointsOfFunctionPlot[1_086].Y = 2.363

	pointsOfFunctionPlot[1_087].X = 0.87
	pointsOfFunctionPlot[1_087].Y = 2.386

	pointsOfFunctionPlot[1_088].X = 0.88
	pointsOfFunctionPlot[1_088].Y = 2.41

	pointsOfFunctionPlot[1_089].X = 0.89
	pointsOfFunctionPlot[1_089].Y = 2.435

	pointsOfFunctionPlot[1_090].X = 0.9
	pointsOfFunctionPlot[1_090].Y = 2.459

	pointsOfFunctionPlot[1_091].X = 0.91
	pointsOfFunctionPlot[1_091].Y = 2.484

	pointsOfFunctionPlot[1_092].X = 0.92
	pointsOfFunctionPlot[1_092].Y = 2.509

	pointsOfFunctionPlot[1_093].X = 0.93
	pointsOfFunctionPlot[1_093].Y = 2.534

	pointsOfFunctionPlot[1_094].X = 0.94
	pointsOfFunctionPlot[1_094].Y = 2.56

	pointsOfFunctionPlot[1_095].X = 0.95
	pointsOfFunctionPlot[1_095].Y = 2.585

	pointsOfFunctionPlot[1_096].X = 0.96
	pointsOfFunctionPlot[1_096].Y = 2.611

	pointsOfFunctionPlot[1_097].X = 0.97
	pointsOfFunctionPlot[1_097].Y = 2.637

	pointsOfFunctionPlot[1_098].X = 0.98
	pointsOfFunctionPlot[1_098].Y = 2.664

	pointsOfFunctionPlot[1_099].X = 0.99
	pointsOfFunctionPlot[1_099].Y = 2.691

	pointsOfFunctionPlot[1_100].X = 1.0
	pointsOfFunctionPlot[1_100].Y = 2.718

	pointsOfFunctionPlot[1_101].X = 1.01
	pointsOfFunctionPlot[1_101].Y = 2.745

	pointsOfFunctionPlot[1_102].X = 1.02
	pointsOfFunctionPlot[1_102].Y = 2.773

	pointsOfFunctionPlot[1_103].X = 1.03
	pointsOfFunctionPlot[1_103].Y = 2.801

	pointsOfFunctionPlot[1_104].X = 1.04
	pointsOfFunctionPlot[1_104].Y = 2.829

	pointsOfFunctionPlot[1_105].X = 1.05
	pointsOfFunctionPlot[1_105].Y = 2.857

	pointsOfFunctionPlot[1_106].X = 1.06
	pointsOfFunctionPlot[1_106].Y = 2.886

	pointsOfFunctionPlot[1_107].X = 1.07
	pointsOfFunctionPlot[1_107].Y = 2.915

	pointsOfFunctionPlot[1_108].X = 1.08
	pointsOfFunctionPlot[1_108].Y = 2.944

	pointsOfFunctionPlot[1_109].X = 1.09
	pointsOfFunctionPlot[1_109].Y = 2.974

	pointsOfFunctionPlot[1_110].X = 1.1
	pointsOfFunctionPlot[1_110].Y = 3.004

	pointsOfFunctionPlot[1_111].X = 1.11
	pointsOfFunctionPlot[1_111].Y = 3.034

	pointsOfFunctionPlot[1_112].X = 1.12
	pointsOfFunctionPlot[1_112].Y = 3.064

	pointsOfFunctionPlot[1_113].X = 1.13
	pointsOfFunctionPlot[1_113].Y = 3.095

	pointsOfFunctionPlot[1_114].X = 1.14
	pointsOfFunctionPlot[1_114].Y = 3.126

	pointsOfFunctionPlot[1_115].X = 1.15
	pointsOfFunctionPlot[1_115].Y = 3.158

	pointsOfFunctionPlot[1_116].X = 1.16
	pointsOfFunctionPlot[1_116].Y = 3.189

	pointsOfFunctionPlot[1_117].X = 1.17
	pointsOfFunctionPlot[1_117].Y = 3.222

	pointsOfFunctionPlot[1_118].X = 1.18
	pointsOfFunctionPlot[1_118].Y = 3.254

	pointsOfFunctionPlot[1_119].X = 1.19
	pointsOfFunctionPlot[1_119].Y = 3.287

	pointsOfFunctionPlot[1_120].X = 1.2
	pointsOfFunctionPlot[1_120].Y = 3.32

	pointsOfFunctionPlot[1_121].X = 1.21
	pointsOfFunctionPlot[1_121].Y = 3.353

	pointsOfFunctionPlot[1_122].X = 1.22
	pointsOfFunctionPlot[1_122].Y = 3.387

	pointsOfFunctionPlot[1_123].X = 1.23
	pointsOfFunctionPlot[1_123].Y = 3.421

	pointsOfFunctionPlot[1_124].X = 1.24
	pointsOfFunctionPlot[1_124].Y = 3.455

	pointsOfFunctionPlot[1_125].X = 1.25
	pointsOfFunctionPlot[1_125].Y = 3.49

	pointsOfFunctionPlot[1_126].X = 1.26
	pointsOfFunctionPlot[1_126].Y = 3.525

	pointsOfFunctionPlot[1_127].X = 1.27
	pointsOfFunctionPlot[1_127].Y = 3.56

	pointsOfFunctionPlot[1_128].X = 1.28
	pointsOfFunctionPlot[1_128].Y = 3.596

	pointsOfFunctionPlot[1_129].X = 1.29
	pointsOfFunctionPlot[1_129].Y = 3.632

	pointsOfFunctionPlot[1_130].X = 1.3
	pointsOfFunctionPlot[1_130].Y = 3.669

	pointsOfFunctionPlot[1_131].X = 1.31
	pointsOfFunctionPlot[1_131].Y = 3.706

	pointsOfFunctionPlot[1_132].X = 1.32
	pointsOfFunctionPlot[1_132].Y = 3.743

	pointsOfFunctionPlot[1_133].X = 1.33
	pointsOfFunctionPlot[1_133].Y = 3.781

	pointsOfFunctionPlot[1_134].X = 1.34
	pointsOfFunctionPlot[1_134].Y = 3.819

	pointsOfFunctionPlot[1_135].X = 1.35
	pointsOfFunctionPlot[1_135].Y = 3.857

	pointsOfFunctionPlot[1_136].X = 1.36
	pointsOfFunctionPlot[1_136].Y = 3.896

	pointsOfFunctionPlot[1_137].X = 1.37
	pointsOfFunctionPlot[1_137].Y = 3.935

	pointsOfFunctionPlot[1_138].X = 1.38
	pointsOfFunctionPlot[1_138].Y = 3.974

	pointsOfFunctionPlot[1_139].X = 1.39
	pointsOfFunctionPlot[1_139].Y = 4.014

	pointsOfFunctionPlot[1_140].X = 1.40
	pointsOfFunctionPlot[1_140].Y = 4.055

	pointsOfFunctionPlot[1_141].X = 1.41
	pointsOfFunctionPlot[1_141].Y = 4.096

	pointsOfFunctionPlot[1_142].X = 1.42
	pointsOfFunctionPlot[1_142].Y = 4.137

	pointsOfFunctionPlot[1_143].X = 1.43
	pointsOfFunctionPlot[1_143].Y = 4.178

	pointsOfFunctionPlot[1_144].X = 1.44
	pointsOfFunctionPlot[1_144].Y = 4.22

	pointsOfFunctionPlot[1_145].X = 1.45
	pointsOfFunctionPlot[1_145].Y = 4.263

	pointsOfFunctionPlot[1_146].X = 1.46
	pointsOfFunctionPlot[1_146].Y = 4.306

	pointsOfFunctionPlot[1_147].X = 1.47
	pointsOfFunctionPlot[1_147].Y = 4.349

	pointsOfFunctionPlot[1_148].X = 1.48
	pointsOfFunctionPlot[1_148].Y = 4.392

	pointsOfFunctionPlot[1_149].X = 1.49
	pointsOfFunctionPlot[1_149].Y = 4.437

	pointsOfFunctionPlot[1_150].X = 1.5
	pointsOfFunctionPlot[1_150].Y = 4.481

	pointsOfFunctionPlot[1_151].X = 1.51
	pointsOfFunctionPlot[1_151].Y = 4.526

	pointsOfFunctionPlot[1_152].X = 1.52
	pointsOfFunctionPlot[1_152].Y = 4.572

	pointsOfFunctionPlot[1_153].X = 1.53
	pointsOfFunctionPlot[1_153].Y = 4.618

	pointsOfFunctionPlot[1_154].X = 1.54
	pointsOfFunctionPlot[1_154].Y = 4.664

	pointsOfFunctionPlot[1_155].X = 1.55
	pointsOfFunctionPlot[1_155].Y = 4.711

	pointsOfFunctionPlot[1_156].X = 1.56
	pointsOfFunctionPlot[1_156].Y = 4.758

	pointsOfFunctionPlot[1_157].X = 1.57
	pointsOfFunctionPlot[1_157].Y = 4.806

	pointsOfFunctionPlot[1_158].X = 1.58
	pointsOfFunctionPlot[1_158].Y = 4.855

	pointsOfFunctionPlot[1_159].X = 1.59
	pointsOfFunctionPlot[1_159].Y = 4.903

	pointsOfFunctionPlot[1_160].X = 1.6
	pointsOfFunctionPlot[1_160].Y = 4.953

	pointsOfFunctionPlot[1_161].X = 1.61
	pointsOfFunctionPlot[1_161].Y = 5.002

	pointsOfFunctionPlot[1_162].X = 1.62
	pointsOfFunctionPlot[1_162].Y = 5.053

	pointsOfFunctionPlot[1_163].X = 1.63
	pointsOfFunctionPlot[1_163].Y = 5.103

	pointsOfFunctionPlot[1_164].X = 1.64
	pointsOfFunctionPlot[1_164].Y = 5.155

	pointsOfFunctionPlot[1_165].X = 1.65
	pointsOfFunctionPlot[1_165].Y = 5.207

	pointsOfFunctionPlot[1_166].X = 1.66
	pointsOfFunctionPlot[1_166].Y = 5.259

	pointsOfFunctionPlot[1_167].X = 1.67
	pointsOfFunctionPlot[1_167].Y = 5.312

	pointsOfFunctionPlot[1_168].X = 1.68
	pointsOfFunctionPlot[1_168].Y = 5.365

	pointsOfFunctionPlot[1_169].X = 1.69
	pointsOfFunctionPlot[1_169].Y = 5.419

	pointsOfFunctionPlot[1_170].X = 1.7
	pointsOfFunctionPlot[1_170].Y = 5.473

	pointsOfFunctionPlot[1_171].X = 1.71
	pointsOfFunctionPlot[1_171].Y = 5.529

	pointsOfFunctionPlot[1_172].X = 1.72
	pointsOfFunctionPlot[1_172].Y = 5.584

	pointsOfFunctionPlot[1_173].X = 1.73
	pointsOfFunctionPlot[1_173].Y = 5.64

	pointsOfFunctionPlot[1_174].X = 1.74
	pointsOfFunctionPlot[1_174].Y = 5.697

	pointsOfFunctionPlot[1_175].X = 1.75
	pointsOfFunctionPlot[1_175].Y = 5.754

	pointsOfFunctionPlot[1_176].X = 1.76
	pointsOfFunctionPlot[1_176].Y = 5.812

	pointsOfFunctionPlot[1_177].X = 1.77
	pointsOfFunctionPlot[1_177].Y = 5.87

	pointsOfFunctionPlot[1_178].X = 1.78
	pointsOfFunctionPlot[1_178].Y = 5.929

	pointsOfFunctionPlot[1_179].X = 1.79
	pointsOfFunctionPlot[1_179].Y = 5.989

	pointsOfFunctionPlot[1_180].X = 1.8
	pointsOfFunctionPlot[1_180].Y = 6.049

	pointsOfFunctionPlot[1_181].X = 1.81
	pointsOfFunctionPlot[1_181].Y = 6.11

	pointsOfFunctionPlot[1_182].X = 1.82
	pointsOfFunctionPlot[1_182].Y = 6.171

	pointsOfFunctionPlot[1_183].X = 1.83
	pointsOfFunctionPlot[1_183].Y = 6.233

	pointsOfFunctionPlot[1_184].X = 1.84
	pointsOfFunctionPlot[1_184].Y = 6.296

	pointsOfFunctionPlot[1_185].X = 1.85
	pointsOfFunctionPlot[1_185].Y = 6.359

	pointsOfFunctionPlot[1_186].X = 1.86
	pointsOfFunctionPlot[1_186].Y = 6.423

	pointsOfFunctionPlot[1_187].X = 1.87
	pointsOfFunctionPlot[1_187].Y = 6.488

	pointsOfFunctionPlot[1_188].X = 1.88
	pointsOfFunctionPlot[1_188].Y = 6.553

	pointsOfFunctionPlot[1_189].X = 1.89
	pointsOfFunctionPlot[1_189].Y = 6.619

	pointsOfFunctionPlot[1_190].X = 1.9
	pointsOfFunctionPlot[1_190].Y = 6.685

	pointsOfFunctionPlot[1_191].X = 1.91
	pointsOfFunctionPlot[1_191].Y = 6.753

	pointsOfFunctionPlot[1_192].X = 1.92
	pointsOfFunctionPlot[1_192].Y = 6.821

	pointsOfFunctionPlot[1_193].X = 1.93
	pointsOfFunctionPlot[1_193].Y = 6.889

	pointsOfFunctionPlot[1_194].X = 1.94
	pointsOfFunctionPlot[1_194].Y = 6.958

	pointsOfFunctionPlot[1_195].X = 1.95
	pointsOfFunctionPlot[1_195].Y = 7.028

	pointsOfFunctionPlot[1_196].X = 1.96
	pointsOfFunctionPlot[1_196].Y = 7.099

	pointsOfFunctionPlot[1_197].X = 1.97
	pointsOfFunctionPlot[1_197].Y = 7.17

	pointsOfFunctionPlot[1_198].X = 1.98
	pointsOfFunctionPlot[1_198].Y = 7.242

	pointsOfFunctionPlot[1_199].X = 1.99
	pointsOfFunctionPlot[1_199].Y = 7.315
	...
	pointsOfFunctionPlot[1_740].X = 7.4
	...
	pointsOfFunctionPlot[1_840].X = 8.4
	...
	pointsOfFunctionPlot[1_940].X = 9.4
