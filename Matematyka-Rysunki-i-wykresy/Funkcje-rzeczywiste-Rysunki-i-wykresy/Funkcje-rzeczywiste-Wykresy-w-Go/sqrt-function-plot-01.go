...
func main() {
	...
	pointsOfFunctionPlot[8].Y = 0.282
	...
	pointsOfFunctionPlot[191].Y = 1.382
	...
	pointsOfFunctionPlot[324].Y = 1.799
	...
	pointsOfFunctionPlot[819].Y = 2.861
	...
	if err := plotOfFunction.Save(10*vg.Inch, 10*vg.Inch,
		"sqrt-function-plot-01.png"); err != nil {
