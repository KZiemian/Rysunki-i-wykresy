...
func main() {
	...
	plotOfFunction.Title.Text = "Plot of function log_4(x)"
	...
	plotOfFunction.Legend.Add("log_4(x)", plotLine)

	if err := plotOfFunction.Save(10*vg.Inch, 10*vg.Inch,
		"log4-function-plot-01.png"); err != nil {
